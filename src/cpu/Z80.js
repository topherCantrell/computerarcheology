...
{"mnem":"ADC A,(IX+i)", "code":"DD8Eii",     "bus":"r"     },
{"mnem":"ADC A,(IY+i)", "code":"FD8Eii",     "bus":"r"     },
...
{"mnem":"ADD A,(IX+i)", "code":"DD86ii",     "bus":"r"     },
{"mnem":"ADD A,(IY+i)", "code":"FD86ii",     "bus":"r"     },
...
{"mnem":"AND (IX+i)",   "code":"DDA6ii",     "bus":"r"     },
{"mnem":"AND (IY+i)",   "code":"FDA6ii",     "bus":"r"     },
...
{"mnem":"OR (IX+i)",    "code":"DDB6ii",     "bus":"r"     },
{"mnem":"OR (IY+i)",    "code":"FDB6ii",     "bus":"r"     },
...
{"mnem":"XOR (IX+i)",   "code":"DDAEii",     "bus":"r"     },
{"mnem":"XOR (IY+i)",   "code":"FDAEii",     "bus":"r"     },
...
{"mnem":"BIT 0,(IX+i)", "code":"DDCBii46",   "bus":"r"     },
{"mnem":"BIT 0,(IY+i)", "code":"FDCBii46",   "bus":"r"     },
{"mnem":"BIT 1,(IX+i)", "code":"DDCBii4E",   "bus":"r"     },
{"mnem":"BIT 1,(IY+i)", "code":"FDCBii4E",   "bus":"r"     },
{"mnem":"BIT 2,(IX+i)", "code":"DDCBii56",   "bus":"r"     },
{"mnem":"BIT 2,(IY+i)", "code":"FDCBii56",   "bus":"r"     },
{"mnem":"BIT 3,(IX+i)", "code":"DDCBii5E",   "bus":"r"     },
{"mnem":"BIT 3,(IY+i)", "code":"FDCBii5E",   "bus":"r"     },
{"mnem":"BIT 4,(IX+i)", "code":"DDCBii66",   "bus":"r"     },
{"mnem":"BIT 4,(IY+i)", "code":"FDCBii66",   "bus":"r"     },
{"mnem":"BIT 5,(IX+i)", "code":"DDCBii6E",   "bus":"r"     },
{"mnem":"BIT 5,(IY+i)", "code":"FDCBii6E",   "bus":"r"     },
{"mnem":"BIT 6,(IX+i)", "code":"DDCBii76",   "bus":"r"     },
{"mnem":"BIT 6,(IY+i)", "code":"FDCBii76",   "bus":"r"     },
{"mnem":"BIT 7,(IX+i)", "code":"DDCBii7E",   "bus":"r"     },
{"mnem":"BIT 7,(IY+i)", "code":"FDCBii7E",   "bus":"r"     },
...
{"mnem":"CALL C,t",     "code":"FDDCtltm",   "bus":""      },
{"mnem":"CALL PO,t",    "code":"E4tltm",     "bus":""      },
{"mnem":"CALL PE,t",    "code":"ECtltm",     "bus":""      },
{"mnem":"CALL P,t",     "code":"F4tltm",     "bus":""      },
{"mnem":"CALL M,t",     "code":"FCtltm",     "bus":""      },
...
{"mnem":"CP (IX+i)",    "code":"DDBEii",     "bus":"r"     },
{"mnem":"CP (IY+i)",    "code":"FDBEii",     "bus":"r"     },
...
{"mnem":"DEC (IX+i)",   "code":"DD35ii",     "bus":"rw"    },
{"mnem":"DEC (IY+i)",   "code":"FD35ii",     "bus":"rw"    },
...
{"mnem":"EX (SP),HL",   "code":"E3",         "bus":"rw"    },
{"mnem":"EX (SP),IX",   "code":"DDE3",       "bus":"rw"    },
{"mnem":"EX (SP),IY",   "code":"FDE3",       "bus":"rw"    },
...
{"mnem":"INC (IX+i)",   "code":"DD34ii",     "bus":"rw"    },
{"mnem":"INC (IY+i)",   "code":"FD34ii",     "bus":"rw"    },
...
{"mnem":"JP (IX)",      "code":"DDE9",       "bus":"r"     },
{"mnem":"JP (IY)",      "code":"FDE9",       "bus":"r"     },
...
{"mnem":"JP PO,t",      "code":"E2tltm",     "bus":""      },
{"mnem":"JP PE,t",      "code":"EAtltm",     "bus":""      },
{"mnem":"JP P,t",       "code":"F2tltm",     "bus":""      },
{"mnem":"JP M,t",       "code":"FAtltm",     "bus":""      },
...
{"mnem":"LD A,(IX+i)",  "code":"DD7Eii",     "bus":"r"     },
{"mnem":"LD A,(IY+i)",  "code":"FD7Eii",     "bus":"r"     },
...
{"mnem":"LD B,(IX+i)",  "code":"DD46ii",     "bus":"r"     },
{"mnem":"LD B,(IY+i)",  "code":"FD46ii",     "bus":"r"     },
...
{"mnem":"LD C,(IX+i)",  "code":"DD4Eii",     "bus":"r"     },
{"mnem":"LD C,(IY+i)",  "code":"FD4Eii",     "bus":"r"     },
...
{"mnem":"LD D,(IX+i)",  "code":"DD56ii",     "bus":"r"     },
{"mnem":"LD D,(IY+i)",  "code":"FD56ii",     "bus":"r"     },
...
{"mnem":"LD E,(IX+i)",  "code":"DD5Eii",     "bus":"r"     },
{"mnem":"LD E,(IY+i)",  "code":"FD5Eii",     "bus":"r"     },
...
{"mnem":"LD H,(IX+i)",  "code":"DD66ii",     "bus":"r"     },
{"mnem":"LD H,(IY+i)",  "code":"FD66ii",     "bus":"r"     },
...
{"mnem":"LD L,(IX+i)",  "code":"DD6Eii",     "bus":"r"     },
{"mnem":"LD L,(IY+i)",  "code":"FD6Eii",     "bus":"r"     },
...
{"mnem":"LD (IX+i),B",  "code":"DD70ii",     "bus":"w"     },
{"mnem":"LD (IX+i),C",  "code":"DD71ii",     "bus":"w"     },
{"mnem":"LD (IX+i),D",  "code":"DD72ii",     "bus":"w"     },
{"mnem":"LD (IX+i),E",  "code":"DD73ii",     "bus":"w"     },
{"mnem":"LD (IX+i),H",  "code":"DD74ii",     "bus":"w"     },
{"mnem":"LD (IX+i),L",  "code":"DD75ii",     "bus":"w"     },
{"mnem":"LD (IY+i),A",  "code":"FD77ii",     "bus":"w"     },
{"mnem":"LD (IY+i),B",  "code":"FD70ii",     "bus":"w"     },
{"mnem":"LD (IY+i),C",  "code":"FD71ii",     "bus":"w"     },
{"mnem":"LD (IY+i),D",  "code":"FD72ii",     "bus":"w"     },
{"mnem":"LD (IY+i),E",  "code":"FD73ii",     "bus":"w"     },
{"mnem":"LD (IY+i),H",  "code":"FD74ii",     "bus":"w"     },
{"mnem":"LD (IY+i),L",  "code":"FD75ii",     "bus":"w"     },
...
{"mnem":"LD (IX+i),b",  "code":"DD36iibb",   "bus":"w"     },
{"mnem":"LD (IY+i),b",  "code":"FD36iibb",   "bus":"w"     },
...
{"mnem":"RES 0,(IX+i)", "code":"DDCBii86",   "bus":"r"     },
{"mnem":"RES 0,(IY+i)", "code":"FDCBii86",   "bus":"r"     },
{"mnem":"RES 1,(IX+i)", "code":"DDCBii8E",   "bus":"r"     },
{"mnem":"RES 1,(IY+i)", "code":"FDCBii8E",   "bus":"r"     },
{"mnem":"RES 2,(IX+i)", "code":"DDCBii96",   "bus":"r"     },
{"mnem":"RES 2,(IY+i)", "code":"FDCBii96",   "bus":"r"     },
{"mnem":"RES 3,(IX+i)", "code":"DDCBii9E",   "bus":"r"     },
{"mnem":"RES 3,(IY+i)", "code":"FDCBii9E",   "bus":"r"     },
{"mnem":"RES 4,(IX+i)", "code":"DDCBiiA6",   "bus":"r"     },
{"mnem":"RES 4,(IY+i)", "code":"FDCBiiA6",   "bus":"r"     },
{"mnem":"RES 5,(IX+i)", "code":"DDCBiiAE",   "bus":"r"     },
{"mnem":"RES 5,(IY+i)", "code":"FDCBiiAE",   "bus":"r"     },
{"mnem":"RES 6,(IX+i)", "code":"DDCBiiB6",   "bus":"r"     },
{"mnem":"RES 6,(IY+i)", "code":"FDCBiiB6",   "bus":"r"     },
{"mnem":"RES 7,(IX+i)", "code":"DDCBiiBE",   "bus":"r"     },
{"mnem":"RES 7,(IY+i)", "code":"FDCBiiBE",   "bus":"r"     },
...
{"mnem":"SET 0,(IX+i)", "code":"DDCBiiC6",   "bus":"r"     },
{"mnem":"SET 0,(IY+i)", "code":"FDCBiiC6",   "bus":"r"     },
{"mnem":"SET 1,(IX+i)", "code":"DDCBiiCE",   "bus":"r"     },
{"mnem":"SET 1,(IY+i)", "code":"FDCBiiCE",   "bus":"r"     },
{"mnem":"SET 2,(IX+i)", "code":"DDCBiiD6",   "bus":"r"     },
{"mnem":"SET 2,(IY+i)", "code":"FDCBiiD6",   "bus":"r"     },
{"mnem":"SET 3,(IX+i)", "code":"DDCBiiDE",   "bus":"r"     },
{"mnem":"SET 3,(IY+i)", "code":"FDCBiiDE",   "bus":"r"     },
{"mnem":"SET 4,(IX+i)", "code":"DDCBiiE6",   "bus":"r"     },
{"mnem":"SET 4,(IY+i)", "code":"FDCBiiE6",   "bus":"r"     },
{"mnem":"SET 5,(IX+i)", "code":"DDCBiiEE",   "bus":"r"     },
{"mnem":"SET 5,(IY+i)", "code":"FDCBiiEE",   "bus":"r"     },
{"mnem":"SET 6,(IX+i)", "code":"DDCBiiF6",   "bus":"r"     },
{"mnem":"SET 6,(IY+i)", "code":"FDCBiiF6",   "bus":"r"     },
{"mnem":"SET 7,(IX+i)", "code":"DDCBiiFE",   "bus":"r"     },
{"mnem":"SET 7,(IY+i)", "code":"FDCBiiFE",   "bus":"r"     },
{"mnem":"RET",          "code":"C9",         "bus":""      },
{"mnem":"POP BC",       "code":"C1",         "bus":"r"     },
{"mnem":"POP DE",       "code":"D1",         "bus":"r"     },
{"mnem":"POP HL",       "code":"E1",         "bus":"r"     },
{"mnem":"POP AF",       "code":"F1",         "bus":"r"     },
{"mnem":"POP IX",       "code":"DDE1",       "bus":"r"     },
...
{"mnem":"RL (IX+i)",    "code":"DDCBii16",   "bus":"rw"    },
{"mnem":"RL (IY+i)",    "code":"FDCBii16",   "bus":"rw"    },
...
{"mnem":"RLC (IX+i)",   "code":"DDCBii06",   "bus":"rw"    },
{"mnem":"RLC (IY+i)",   "code":"FDCBii06",   "bus":"rw"    },
...
{"mnem":"RRC (IX+i)",   "code":"DDCBii0E",   "bus":"rw"    },
{"mnem":"RRC (IY+i)",   "code":"FDCBii0E",   "bus":"rw"    },
...
{"mnem":"SLA (IX+i)",   "code":"DDCBii26",   "bus":"rw"    },
{"mnem":"SLA (IY+i)",   "code":"FDCBii26",   "bus":"rw"    },
...
{"mnem":"SRA (IX+i)",   "code":"DDCBii2E",   "bus":"rw"    },
{"mnem":"SRA (IY+i)",   "code":"FDCBii2E",   "bus":"rw"    },
...
{"mnem":"SRL (IX+i)",   "code":"DDCBii3E",   "bus":"rw"    },
{"mnem":"SRL (IY+i)",   "code":"FDCBii3E",   "bus":"rw"    },
...
{"mnem":"SBC A,(IX+i)", "code":"DD9Eii",     "bus":"r"     },
{"mnem":"SBC A,(IY+i)", "code":"FD9Eii",     "bus":"r"     },
...
{"mnem":"SUB (IX+i)",   "code":"DD96ii",     "bus":"r"     },
{"mnem":"SUB (IY+i)",   "code":"FD96ii",     "bus":"r"     },
