...
0000: C3 72 28        JP      $2872               ; {code.TableJump} RST 0 rerouted to table-jumper
0003: 00              NOP                         
0004: 00              NOP                         
...
0100: 00              NOP                         
0101: C3 50 01        JP      $0150               ; {code.Startup} Start game
...
0166: CD A8 28        CALL    $28A8               ; {code.ClearMap} Fill Background Tile Table with 7Fs
0169: CD 8A 29        CALL    $298A               ; {code.ClearRAM} Clear RAM and HRAM
...
03AA: 3E 01           LD      A,$01               
03AC: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
04A5: 28 4E           JR      Z,$4F5              ; {}
04A7: F5              PUSH    AF                  
04A8: CD 81 28        CALL    $2881               ; {code.LCDOff}
04AB: F1              POP     AF                  
...
04F3: 39              ADD     HL,SP               
04F4: 2D              DEC     L                   
04F5: CD 81 28        CALL    $2881               ; {code.LCDOff}
...
074A: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
...
07BC: EA AF DB        LD      ($DBAF),A           ; {ram.curBank} Remember what bank we are in
07BF: C9              RET                         ; Back

SwitchBankSave:
07C0: F5              PUSH    AF                  
07C1: FA AF DB        LD      A,($DBAF)           ; {ram.curBank}
...
0884: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
...
08CE: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
08D1: 3E 01           LD      A,$01               
...
0A8D: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
...
0B08: 3E 17           LD      A,$17               
0B0A: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
0B1E: F1              POP     AF                  
0B1F: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
0B22: 3E 03           LD      A,$03               
...
0B4B: 3E 01           LD      A,$01               
0B4D: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
0B50: C3 1E 43        JP      $431E               
0B53: 3E 02           LD      A,$02               
0B55: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
0B7D: CD C0 07        CALL    $07C0               ; {code.SwitchBankSave}
...
0BCA: 3E 02           LD      A,$02               
0BCC: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
0BF5: 3E 19           LD      A,$19               
0BF7: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
0C2A: 3E 14           LD      A,$14               
0C2C: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
0C2F: CD B0 59        CALL    $59B0               
0C32: 3E 0F           LD      A,$0F               
0C34: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
0D4F: 3E 19           LD      A,$19               
0D51: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
0D54: C3 A9 5C        JP      $5CA9               
0D57: 3E 01           LD      A,$01               
0D59: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
0D5C: C3 84 41        JP      $4184               
0D5F: 3E 02           LD      A,$02               
0D61: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
12B1: 3E 02           LD      A,$02               
12B3: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
...
14EB: 3E 02           LD      A,$02               
14ED: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
15EC: F5              PUSH    AF                  
15ED: 3E 04           LD      A,$04               
15EF: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
15F2: F1              POP     AF                  
...
1ADB: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
1ADE: C9              RET                         
...
1BEB: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
...
1E42: 66              LD      H,(HL)              
1E43: 6F              LD      L,A                 
1E44: C3 C5 28        JP      $28C5               ; {code.CopyHLtoDE}
...
1E76: 3E 02           LD      A,$02               
1E78: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
...
20AE: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
20B1: 3E 05           LD      A,$05               
...
20CB: 1E 01           LD      E,$01               
20CD: 3E 03           LD      A,$03               
20CF: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
24AF: CB 23           SLA     E                   
24B1: CB 12           RL      D                   
24B3: CD C0 07        CALL    $07C0               ; {code.SwitchBankSave}
...
2655: 3E 02           LD      A,$02               
2657: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
2682: CD C0 07        CALL    $07C0               ; {code.SwitchBankSave}
2685: C9              RET                         
...
27DF: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
27E2: 3E 01           LD      A,$01               
...
2898: 3E 01           LD      A,$01               
289A: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
28BC: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
28BF: 3E 01           LD      A,$01               
...
28CA: B1              OR      C                   ; ... zero?
28CB: 20 F8           JR      NZ,$28C5            ; {code.CopyHLtoDE} No ... keep copying
28CD: C9              RET                         ; Done
...
2990: CD 99 29        CALL    $2999               ; {code.ClearRAMHL}
...
299C: 78              LD      A,B                 ; All ...
299D: B1              OR      C                   ; ... done?
299E: 20 F9           JR      NZ,$2999            ; {code.ClearRAMHL} No... keep clearing
29A0: C9              RET                         ; Out
...
29C0: 19              ADD     HL,DE               
29C1: 7E              LD      A,(HL)              
29C2: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
...
29D8: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
29DB: 3E 08           LD      A,$08               
29DD: EA 00 21        LD      ($2100),A           ; {}
29E0: 21 10 51        LD      HL,$5110            
29E3: 19              ADD     HL,DE               
29E4: 7E              LD      A,(HL)              
29E5: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
29E8: 3E 08           LD      A,$08               
...
2AB0: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
2AB3: 21 00 58        LD      HL,$5800            
2AB6: 11 00 88        LD      DE,$8800            
2AB9: 01 00 10        LD      BC,$1000            
2ABC: C3 C5 28        JP      $28C5               ; {code.CopyHLtoDE}
...
2ADB: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
...
2AEF: C3 C5 28        JP      $28C5               ; {code.CopyHLtoDE}
...
2C29: 2E 00           LD      L,$00               
2C2B: 3E 12           LD      A,$12               
2C2D: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
2C42: 3E 0C           LD      A,$0C               
2C44: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
2C47: 21 00 4C        LD      HL,$4C00            
2C4A: 11 00 8C        LD      DE,$8C00            
2C4D: 01 00 03        LD      BC,$0300            
2C50: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
...
2C8C: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
2C8F: 21 00 4C        LD      HL,$4C00            
2C92: 11 00 8C        LD      DE,$8C00            
2C95: 01 00 04        LD      BC,$0400            
2C98: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
...
2E51: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
2E54: C9              RET                         
2E55: 3E 0F           LD      A,$0F               
...
2E68: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
2E6B: C9              RET                         
2E6C: 3E 08           LD      A,$08               
2E6E: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
3754: 18 F6           JR      $374C               ; {}
3756: CD C0 07        CALL    $07C0               ; {code.SwitchBankSave}
3759: C9              RET                         
...
37F5: C9              RET                         
37F6: 3E 19           LD      A,$19               
37F8: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
37FB: CD C2 77        CALL    $77C2               
37FE: 3E 03           LD      A,$03               
3800: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
3803: 3E 03           LD      A,$03               
3805: EA 00 21        LD      ($2100),A           ; {}
3808: CD 41 54        CALL    $5441               
380B: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
380E: 3E 14           LD      A,$14               
3810: EA 00 21        LD      ($2100),A           ; {}
3813: CD 64 59        CALL    $5964               
3816: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3819: 3E 01           LD      A,$01               
381B: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
381E: CD 6B 5D        CALL    $5D6B               
3821: 3E 02           LD      A,$02               
3823: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
3826: 3E 03           LD      A,$03               
3828: EA 00 21        LD      ($2100),A           ; {}
382B: CD B0 48        CALL    $48B0               
382E: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3831: 3E 14           LD      A,$14               
...
38AB: 3E 02           LD      A,$02               
38AD: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
3916: 3E 14           LD      A,$14               
3918: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
...
394C: 19              ADD     HL,DE               
394D: 7E              LD      A,(HL)              
394E: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
3951: 7B              LD      A,E                 
3952: C7              RST     0X00                
3953: 4B              LD      C,E                 
3954: 6A              LD      L,D                 
...
3C0B: CB 1D           RR      L                   
3C0D: CD C0 07        CALL    $07C0               ; {code.SwitchBankSave}
3C10: CB 15           RL      L                   
3C12: C9              RET                         
3C13: F5              PUSH    AF                  
3C14: 3E 03           LD      A,$03               
...
3C1D: CB 1D           RR      L                   
3C1F: CD C0 07        CALL    $07C0               ; {code.SwitchBankSave}
3C22: CB 15           RL      L                   
3C24: C9              RET                         
3C25: 21 00 21        LD      HL,$2100            
3C28: 36 03           LD      (HL),$03            
3C2A: CD 99 7E        CALL    $7E99               
3C2D: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
...
3D7F: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
...
3DD8: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3DDB: 21 00 21        LD      HL,$2100            
3DDE: 36 04           LD      (HL),$04            
3DE0: CD 10 5A        CALL    $5A10               
3DE3: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3DE6: 21 00 21        LD      HL,$2100            
3DE9: 36 04           LD      (HL),$04            
3DEB: CD 80 56        CALL    $5680               
3DEE: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3DF1: 21 00 21        LD      HL,$2100            
3DF4: 36 04           LD      (HL),$04            
3DF6: CD 4D 50        CALL    $504D               
3DF9: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3DFC: 21 00 21        LD      HL,$2100            
3DFF: 36 04           LD      (HL),$04            
3E01: CD B5 49        CALL    $49B5               
3E04: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E07: 21 00 21        LD      HL,$2100            
3E0A: 36 04           LD      (HL),$04            
3E0C: CD 00 40        CALL    $4000               
3E0F: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E12: 21 00 21        LD      HL,$2100            
3E15: 36 05           LD      (HL),$05            
3E17: CD 2B 6C        CALL    $6C2B               
3E1A: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E1D: 21 00 21        LD      HL,$2100            
3E20: 36 05           LD      (HL),$05            
3E22: CD 76 67        CALL    $6776               
3E25: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E28: 21 00 21        LD      HL,$2100            
3E2B: 36 05           LD      (HL),$05            
3E2D: CD 4F 62        CALL    $624F               
3E30: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E33: 21 00 21        LD      HL,$2100            
3E36: 36 05           LD      (HL),$05            
3E38: CD 59 59        CALL    $5959               
3E3B: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E3E: 21 00 21        LD      HL,$2100            
3E41: 36 05           LD      (HL),$05            
3E43: CD 9F 54        CALL    $549F               
3E46: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E49: FA AF DB        LD      A,($DBAF)           ; {ram.curBank}
3E4C: F5              PUSH    AF                  
3E4D: 3E 02           LD      A,$02               
3E4F: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
3E52: CD B1 6F        CALL    $6FB1               
3E55: F1              POP     AF                  
3E56: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
3E59: 21 00 21        LD      HL,$2100            
3E5C: 36 04           LD      (HL),$04            
3E5E: CD 5A 5C        CALL    $5C5A               
3E61: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E64: 21 00 21        LD      HL,$2100            
3E67: 36 03           LD      (HL),$03            
3E69: CD 64 54        CALL    $5464               
3E6C: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E6F: 21 00 21        LD      HL,$2100            
3E72: 36 02           LD      (HL),$02            
3E74: CD D1 5F        CALL    $5FD1               
3E77: CD 17 61        CALL    $6117               
3E7A: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E7D: 3E 02           LD      A,$02               
3E7F: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
3E82: CD BA 41        CALL    $41BA               
3E85: 3E 03           LD      A,$03               
3E87: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
3E8A: 21 00 21        LD      HL,$2100            
3E8D: 36 02           LD      (HL),$02            
3E8F: CD E7 61        CALL    $61E7               
3E92: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3E95: 21 00 21        LD      HL,$2100            
3E98: 36 03           LD      (HL),$03            
3E9A: CD 97 64        CALL    $6497               
3E9D: C3 C0 07        JP      $07C0               ; {code.SwitchBankSave}
3EA0: 3E 06           LD      A,$06               
3EA2: CD B9 07        CALL    $07B9               ; {code.SwitchBank}
3EA5: CD 40 79        CALL    $7940               
3EA8: 3E 03           LD      A,$03               
3EAA: C3 B9 07        JP      $07B9               ; {code.SwitchBank}
3EAD: 1E 10           LD      E,$10               
...
3F85: CD C0 07        CALL    $07C0               ; {code.SwitchBankSave}
...
3FCB: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
...
3FE1: CD C5 28        CALL    $28C5               ; {code.CopyHLtoDE}
