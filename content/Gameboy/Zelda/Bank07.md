...
>>> binary 4000:roms/zelda.gb[1C000:20000]
...
404A: F0 EC           LD      A,($EC)             
404C: 96              SUB     (HL)                
404D: E0 EC           LD      ($FF00+$EC),A       
404F: 21 40 C4        LD      HL,$C440            
4052: 09              ADD     HL,BC               
4053: 7E              LD      A,(HL)              
4054: E0 F1           LD      ($FF00+$F1),A       
...
4370: 19              ADD     HL,DE               
4371: 77              LD      (HL),A              
4372: E0 EE           LD      ($FF00+$EE),A       
4374: F0 D8           LD      A,($D8)             
4376: C6 08           ADD     $08                 
4378: 21 10 C2        LD      HL,$C210            
437B: 19              ADD     HL,DE               
437C: 77              LD      (HL),A              
437D: E0 EC           LD      ($FF00+$EC),A       
...
4397: 3E 08           LD      A,$08               
4399: E0 F2           LD      ($FF00+$F2),A       
439B: 3E 0C           LD      A,$0C               
439D: EA 0E DB        LD      ($DB0E),A           
43A0: 3E 0D           LD      A,$0D               
43A2: E0 A5           LD      ($FF00+$A5),A       
43A4: 3E 03           LD      A,$03               
43A6: CD 87 3B        CALL    $3B87               
43A9: C9              RET                         
43AA: 3E 02           LD      A,$02               
43AC: E0 A1           LD      ($FF00+$A1),A       
...
4448: F0 EC           LD      A,($EC)             
444A: D6 0F           SUB     $0F                 
444C: E0 99           LD      ($FF00+$99),A       
444E: 3E 02           LD      A,$02               
4450: E0 9B           LD      ($FF00+$9B),A       
4452: 3E 01           LD      A,$01               
...
452D: F0 EC           LD      A,($EC)             
452F: C6 0B           ADD     $0B                 
4531: E0 EC           LD      ($FF00+$EC),A       
4533: AF              XOR     A                   
4534: E0 F1           LD      ($FF00+$F1),A       
...
462C: F0 99           LD      A,($99)             
462E: D6 03           SUB     $03                 
4630: E0 D8           LD      ($FF00+$D8),A       
4632: F0 98           LD      A,($98)             
4634: E0 D7           LD      ($FF00+$D7),A       
4636: 3E 0E           LD      A,$0E               
4638: E0 F2           LD      ($FF00+$F2),A       
463A: 3E 01           LD      A,$01               
...
46FF: C9              RET                         
4700: F0 EC           LD      A,($EC)             
4702: E0 D8           LD      ($FF00+$D8),A       
4704: F0 EE           LD      A,($EE)             
4706: E0 D7           LD      ($FF00+$D7),A       
4708: 3E 01           LD      A,$01               
470A: CD 53 09        CALL    $0953               
470D: 3E 0E           LD      A,$0E               
470F: E0 F2           LD      ($FF00+$F2),A       
4711: C9              RET                         
4712: F0 F0           LD      A,($F0)             
4714: C7              RST     0X00                
4715: 1D              DEC     E                   
...
487C: F0 EE           LD      A,($EE)             
487E: C6 10           ADD     $10                 
4880: E0 EE           LD      ($FF00+$EE),A       
4882: F0 EC           LD      A,($EC)             
4884: D6 10           SUB     $10                 
4886: E0 EC           LD      ($FF00+$EC),A       
4888: AF              XOR     A                   
4889: E0 F1           LD      ($FF00+$F1),A       
...
4921: 3E 0D           LD      A,$0D               
4923: E0 A5           LD      ($FF00+$A5),A       
4925: C3 8D 3B        JP      $3B8D               
4928: 3E 02           LD      A,$02               
492A: E0 A1           LD      ($FF00+$A1),A       
492C: 3E 01           LD      A,$01               
...
49A4: E0 F1           LD      ($FF00+$F1),A       
49A6: 3E 4A           LD      A,$4A               
49A8: E0 EC           LD      ($FF00+$EC),A       
49AA: 11 9B 49        LD      DE,$499B            
49AD: CD 3B 3C        CALL    $3C3B               
49B0: 3E 68           LD      A,$68               
49B2: E0 EE           LD      ($FF00+$EE),A       
...
49C1: 3E 74           LD      A,$74               
49C3: E0 EE           LD      ($FF00+$EE),A       
49C5: 3E 38           LD      A,$38               
49C7: E0 EC           LD      ($FF00+$EC),A       
...
4A77: F5              PUSH    AF                  
4A78: 3E 10           LD      A,$10               
4A7A: E0 99           LD      ($FF00+$99),A       
4A7C: 7B              LD      A,E                 
4A7D: CD 85 21        CALL    $2185               
4A80: F1              POP     AF                  
4A81: E0 99           LD      ($FF00+$99),A       
4A83: C9              RET                         
4A84: 70              LD      (HL),B              
4A85: 00              NOP                         
4A86: 70              LD      (HL),B              
4A87: 20 F0           JR      NZ,$4A79            ; {}
4A89: F8 E6           LD      HL,SP+$E6           
...
4BEF: E0 D8           LD      ($FF00+$D8),A       
4BF1: 10 18           ;;STOP    $18                 
4BF3: 18 20           JR      $4C15               ; {}
4BF5: 20 28           JR      NZ,$4C1F            ; {}
4BF7: 00              NOP                         
4BF8: F8 08           LD      HL,SP+$08           
4BFA: F8 08           LD      HL,SP+$08           
4BFC: 00              NOP                         
4BFD: 00              NOP                         
4BFE: 08 F8 08        LD      ($08F8),SP          
4C01: F8 00           LD      HL,SP+$00           
4C03: 00              NOP                         
4C04: F8 08           LD      HL,SP+$08           
4C06: F8 08           LD      HL,SP+$08           
4C08: 00              NOP                         
4C09: 00              NOP                         
4C0A: 08 F8 08        LD      ($08F8),SP          
4C0D: F8 00           LD      HL,SP+$00           
4C0F: 10 18           ;;STOP    $18                 
4C11: 18 20           JR      $4C33               ; {}
4C13: 20 28           JR      NZ,$4C3D            ; {}
4C15: F0 E8           LD      A,($E8)             
4C17: E8 E0           ADD     SP,$E0              
4C19: E0 D8           LD      ($FF00+$D8),A       
4C1B: 3E 22           LD      A,$22               
4C1D: E0 F2           LD      ($FF00+$F2),A       
...
4C6F: 09              ADD     HL,BC               
4C70: 86              ADD     A,(HL)              
4C71: E0 99           LD      ($FF00+$99),A       
4C73: C1              POP     BC                  
4C74: 3E 24           LD      A,$24               
4C76: CD 25 3C        CALL    $3C25               
4C79: F1              POP     AF                  
4C7A: E0 99           LD      ($FF00+$99),A       
4C7C: F1              POP     AF                  
4C7D: E0 98           LD      ($FF00+$98),A       
...
4D45: 00              NOP                         
4D46: 3E 01           LD      A,$01               
4D48: E0 A1           LD      ($FF00+$A1),A       
4D4A: EA 67 C1        LD      ($C167),A           
4D4D: CD 91 08        CALL    $0891               
4D50: FE 30           CP      $30                 
4D52: 38 18           JR      C,$4D6C             ; {}
4D54: AF              XOR     A                   
4D55: E0 F1           LD      ($FF00+$F1),A       
4D57: F0 EC           LD      A,($EC)             
4D59: D6 10           SUB     $10                 
4D5B: E0 EC           LD      ($FF00+$EC),A       
...
4D8D: E0 B0           LD      ($FF00+$B0),A       
4D8F: CD 91 08        CALL    $0891               
4D92: 36 C0           LD      (HL),$C0            
4D94: CD 8D 3B        CALL    $3B8D               
4D97: C9              RET                         
4D98: 3E 01           LD      A,$01               
4D9A: E0 F1           LD      ($FF00+$F1),A       
4D9C: F0 EE           LD      A,($EE)             
4D9E: D6 0C           SUB     $0C                 
4DA0: E0 EE           LD      ($FF00+$EE),A       
...
4DF4: 3E 01           LD      A,$01               
4DF6: E0 F1           LD      ($FF00+$F1),A       
4DF8: F0 EE           LD      A,($EE)             
4DFA: D6 0E           SUB     $0E                 
4DFC: E0 EE           LD      ($FF00+$EE),A       
4DFE: F0 EC           LD      A,($EC)             
4E00: D6 08           SUB     $08                 
4E02: E0 EC           LD      ($FF00+$EC),A       
4E04: 18 09           JR      $4E0F               ; {}
4E06: AF              XOR     A                   
4E07: E0 F1           LD      ($FF00+$F1),A       
4E09: F0 EC           LD      A,($EC)             
4E0B: D6 10           SUB     $10                 
4E0D: E0 EC           LD      ($FF00+$EC),A       
...
4E29: E0 00           LD      ($FF00+$00),A       
4E2B: 00              NOP                         
4E2C: E0 00           LD      ($FF00+$00),A       
...
4F72: F0 10           LD      A,($10)             
4F74: 3E 01           LD      A,$01               
4F76: E0 A1           LD      ($FF00+$A1),A       
4F78: 3E 3E           LD      A,$3E               
4F7A: E0 F2           LD      ($FF00+$F2),A       
4F7C: F0 CC           LD      A,($CC)             
4F7E: E6 0F           AND     $0F                 
4F80: 57              LD      D,A                 
...
4FB6: 7E              LD      A,(HL)              
4FB7: D6 10           SUB     $10                 
4FB9: E0 CD           LD      ($FF00+$CD),A       
4FBB: 21 00 C2        LD      HL,$C200            
4FBE: 09              ADD     HL,BC               
4FBF: 7E              LD      A,(HL)              
4FC0: D6 08           SUB     $08                 
4FC2: E0 CE           LD      ($FF00+$CE),A       
4FC4: CB 37           SWAP    1,E                 
4FC6: E6 0F           AND     $0F                 
4FC8: 5F              LD      E,A                 
4FC9: F0 CD           LD      A,($CD)             
...
5046: F0 EE           LD      A,($EE)             
5048: E0 D7           LD      ($FF00+$D7),A       
504A: F0 EC           LD      A,($EC)             
504C: E0 D8           LD      ($FF00+$D8),A       
504E: 3E 2F           LD      A,$2F               
5050: E0 F2           LD      ($FF00+$F2),A       
5052: 3E 02           LD      A,$02               
...
51CD: 09              ADD     HL,BC               
51CE: 7E              LD      A,(HL)              
51CF: E0 98           LD      ($FF00+$98),A       
51D1: 21 C0 C2        LD      HL,$C2C0            
51D4: 09              ADD     HL,BC               
51D5: 7E              LD      A,(HL)              
51D6: E0 99           LD      ($FF00+$99),A       
51D8: 3E 10           LD      A,$10               
...
5209: 36 20           LD      (HL),$20            
520B: F1              POP     AF                  
520C: E0 99           LD      ($FF00+$99),A       
520E: F1              POP     AF                  
520F: E0 98           LD      ($FF00+$98),A       
...
5252: CB 2F           SRA     1,E                 
5254: CB 2F           SRA     1,E                 
5256: E0 D7           LD      ($FF00+$D7),A       
5258: E0 D9           LD      ($FF00+$D9),A       
525A: F0 EC           LD      A,($EC)             
...
5261: CB 2F           SRA     1,E                 
5263: CB 2F           SRA     1,E                 
5265: E0 D8           LD      ($FF00+$D8),A       
5267: E0 DA           LD      ($FF00+$DA),A       
...
529A: 86              ADD     A,(HL)              
529B: E0 D7           LD      ($FF00+$D7),A       
529D: F0 D8           LD      A,($D8)             
529F: 21 DA FF        LD      HL,$FFDA            
52A2: 86              ADD     A,(HL)              
52A3: E0 D8           LD      ($FF00+$D8),A       
52A5: F0 DB           LD      A,($DB)             
52A7: 3D              DEC     A                   
...
5381: 77              LD      (HL),A              
5382: 3E 6C           LD      A,$6C               
5384: E0 9D           LD      ($FF00+$9D),A       
5386: 3E 02           LD      A,$02               
5388: E0 A1           LD      ($FF00+$A1),A       
538A: 3E 03           LD      A,$03               
538C: E0 9E           LD      ($FF00+$9E),A       
538E: AF              XOR     A                   
...
5536: 00              NOP                         
5537: 00              NOP                         
5538: F8 08           LD      HL,SP+$08           
553A: 20 E0           JR      NZ,$551C            ; {}
553C: 00              NOP                         
553D: 00              NOP                         
553E: 00              NOP                         
553F: 00              NOP                         
5540: E0 20           LD      ($FF00+$20),A       
5542: 3E 0A           LD      A,$0A               
...
55F5: AF              XOR     A                   
55F6: E0 F1           LD      ($FF00+$F1),A       
55F8: F0 EC           LD      A,($EC)             
55FA: D6 0E           SUB     $0E                 
55FC: E0 EC           LD      ($FF00+$EC),A       
...
56D5: 36 80           LD      (HL),$80            
56D7: 3E 01           LD      A,$01               
56D9: E0 F2           LD      ($FF00+$F2),A       
56DB: CD 8D 3B        CALL    $3B8D               
56DE: 3E 02           LD      A,$02               
56E0: E0 A1           LD      ($FF00+$A1),A       
56E2: C9              RET                         
56E3: 9A              SBC     D                   
56E4: 10 9C           ;;STOP    $9C                 
56E6: 10 3E           ;;STOP    $3E                 
...
57DC: 19              ADD     HL,DE               
57DD: 7E              LD      A,(HL)              
57DE: E0 CD           LD      ($FF00+$CD),A       
57E0: 3E 40           LD      A,$40               
57E2: E0 CE           LD      ($FF00+$CE),A       
...
586E: 19              ADD     HL,DE               
586F: 7E              LD      A,(HL)              
5870: E0 98           LD      ($FF00+$98),A       
5872: 21 10 C2        LD      HL,$C210            
5875: 19              ADD     HL,DE               
5876: 7E              LD      A,(HL)              
5877: E0 99           LD      ($FF00+$99),A       
5879: 3E 14           LD      A,$14               
587B: CD 25 3C        CALL    $3C25               
587E: F1              POP     AF                  
587F: E0 99           LD      ($FF00+$99),A       
5881: F1              POP     AF                  
5882: E0 98           LD      ($FF00+$98),A       
...
58F6: 09              ADD     HL,BC               
58F7: 7E              LD      A,(HL)              
58F8: E0 98           LD      ($FF00+$98),A       
58FA: 21 C0 C2        LD      HL,$C2C0            
58FD: 09              ADD     HL,BC               
58FE: 7E              LD      A,(HL)              
58FF: E0 99           LD      ($FF00+$99),A       
...
593E: F1              POP     AF                  
593F: E0 99           LD      ($FF00+$99),A       
5941: F1              POP     AF                  
5942: E0 98           LD      ($FF00+$98),A       
...
5DE3: 09              ADD     HL,BC               
5DE4: 7E              LD      A,(HL)              
5DE5: E0 E9           LD      ($FF00+$E9),A       
5DE7: E6 80           AND     $80                 
5DE9: E0 E8           LD      ($FF00+$E8),A       
...
5F33: 3E 25           LD      A,$25               
5F35: E0 F4           LD      ($FF00+$F4),A       
5F37: 3E 0B           LD      A,$0B               
5F39: E0 F2           LD      ($FF00+$F2),A       
...
5FED: F0 EF           LD      A,($EF)             
5FEF: D6 10           SUB     $10                 
5FF1: E0 CD           LD      ($FF00+$CD),A       
5FF3: E6 F0           AND     $F0                 
5FF5: 5F              LD      E,A                 
5FF6: F0 EE           LD      A,($EE)             
5FF8: D6 08           SUB     $08                 
5FFA: E0 CE           LD      ($FF00+$CE),A       
5FFC: CB 37           SWAP    1,E                 
5FFE: E6 0F           AND     $0F                 
6000: B3              OR      E                   
6001: 5F              LD      E,A                 
...
6133: 7E              LD      A,(HL)              
6134: D6 10           SUB     $10                 
6136: E0 99           LD      ($FF00+$99),A       
6138: F0 9A           LD      A,($9A)             
613A: F5              PUSH    AF                  
613B: F0 E8           LD      A,($E8)             
613D: E0 9A           LD      ($FF00+$9A),A       
...
6148: C1              POP     BC                  
6149: F1              POP     AF                  
614A: E0 9A           LD      ($FF00+$9A),A       
614C: 3E 02           LD      A,$02               
614E: E0 9B           LD      ($FF00+$9B),A       
6150: 3E 01           LD      A,$01               
...
62FF: FF              RST     0X38                
6300: FF              RST     0X38                
6301: F8 00           LD      HL,SP+$00           
6303: 74              LD      (HL),H              
6304: 00              NOP                         
6305: F8 08           LD      HL,SP+$08           
6307: 74              LD      (HL),H              
...
638C: 7F              LD      A,A                 
638D: AF              XOR     A                   
638E: E0 96           LD      ($FF00+$96),A       
6390: E0 97           LD      ($FF00+$97),A       
...
68C6: 19              ADD     HL,DE               
68C7: 7E              LD      A,(HL)              
68C8: E0 CD           LD      ($FF00+$CD),A       
68CA: 3E 20           LD      A,$20               
68CC: E0 CE           LD      ($FF00+$CE),A       
...
6E6C: 72              LD      (HL),D              
6E6D: 00              NOP                         
6E6E: F8 08           LD      HL,SP+$08           
6E70: 74              LD      (HL),H              
6E71: 00              NOP                         
6E72: F8 00           LD      HL,SP+$00           
6E74: 74              LD      (HL),H              
...
7007: F0 D7           LD      A,($D7)             
7009: E0 9B           LD      ($FF00+$9B),A       
700B: F0 D8           LD      A,($D8)             
700D: E0 9A           LD      ($FF00+$9A),A       
700F: 3E 02           LD      A,$02               
7011: EA 46 C1        LD      ($C146),A           
7014: 3E 13           LD      A,$13               
7016: E0 A3           LD      ($FF00+$A3),A       
7018: 3E 08           LD      A,$08               
701A: EA 94 DB        LD      ($DB94),A           
701D: 3E 20           LD      A,$20               
701F: EA C7 DB        LD      ($DBC7),A           
7022: 3E 03           LD      A,$03               
7024: E0 F3           LD      ($FF00+$F3),A       
7026: C9              RET                         
7027: 12              LD      (DE),A              
7028: 14              INC     D                   
7029: 16 18           LD      D,$18               
...
70FD: F0 EE           LD      A,($EE)             
70FF: D6 08           SUB     $08                 
7101: E0 CE           LD      ($FF00+$CE),A       
7103: F0 EF           LD      A,($EF)             
7105: D6 10           SUB     $10                 
7107: E0 CD           LD      ($FF00+$CD),A       
7109: F0 CE           LD      A,($CE)             
710B: CB 37           SWAP    1,E                 
710D: E6 0F           AND     $0F                 
710F: 5F              LD      E,A                 
...
79E1: C5              PUSH    BC                  
79E2: F0 EC           LD      A,($EC)             
79E4: E0 D7           LD      ($FF00+$D7),A       
79E6: F0 EE           LD      A,($EE)             
79E8: E0 D8           LD      ($FF00+$D8),A       
79EA: F0 F1           LD      A,($F1)             
79EC: 5F              LD      E,A                 
79ED: 50              LD      D,B                 
...
7E16: F0 EE           LD      A,($EE)             
7E18: E0 D7           LD      ($FF00+$D7),A       
7E1A: F0 EC           LD      A,($EC)             
7E1C: E0 D8           LD      ($FF00+$D8),A       
7E1E: 3E 02           LD      A,$02               
7E20: CD 53 09        CALL    $0953               
7E23: 3E 13           LD      A,$13               
7E25: E0 F4           LD      ($FF00+$F4),A       
7E27: C9              RET                         
7E28: 3E 36           LD      A,$36               
