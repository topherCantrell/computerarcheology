...
42DE: EF              RST     0X28                
42DF: 48              LD      C,B                 
42E0: FA 48 FF        LD      A,($FF48)           ; {hard.OBJ0PAL}
42E3: 48              LD      C,B                 
42E4: 0A              LD      A,(BC)              
42E5: 49              LD      C,C                 
...
4C01: CC FF FF        CALL    Z,$FFFF             ; {hard.ISWITCH}
4C04: 14              INC     D                   
4C05: 35              DEC     (HL)                
4C06: FF              RST     0X38                
4C07: FF              RST     0X38                
...
4C21: FF              RST     0X38                
4C22: 15              DEC     D                   
4C23: CC FF FF        CALL    Z,$FFFF             ; {hard.ISWITCH}
4C26: 34              INC     (HL)                
...
510F: 47              LD      B,A                 
5110: C3 FF FF        JP      $FFFF               ; {hard.ISWITCH}
5113: 35              DEC     (HL)                
5114: C7              RST     0X00                
5115: 63              LD      H,E                 
5116: C7              RST     0X00                
...
513F: 41              LD      B,C                 
5140: 24              INC     H                   
5141: C2 FF FF        JP      NZ,$FFFF            ; {hard.ISWITCH}
5144: 32              LD      (HLD),A             
5145: 0D              DEC     C                   
5146: 36 0D           LD      (HL),$0D            
5148: FF              RST     0X38                
...
51EF: CC FF FF        CALL    Z,$FFFF             ; {hard.ISWITCH}
51F2: 45              LD      B,L                 
51F3: 41              LD      B,C                 
51F4: FF              RST     0X38                
51F5: 24              INC     H                   
