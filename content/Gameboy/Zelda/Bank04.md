...
>>> binary 4000:roms/zelda.gb[10000:14000]
...
40BA: 3E 09           LD      A,$09               
40BC: E0 F2           LD      ($FF00+$F2),A       
40BE: 3E 10           LD      A,$10               
40C0: EA 3E C1        LD      ($C13E),A           
40C3: 3E 14           LD      A,$14               
40C5: CD 30 3C        CALL    $3C30               
40C8: F0 D7           LD      A,($D7)             
40CA: E0 9B           LD      ($FF00+$9B),A       
40CC: F0 D8           LD      A,($D8)             
40CE: E0 9A           LD      ($FF00+$9A),A       
...
40E2: 36 10           LD      (HL),$10            
40E4: 3E 20           LD      A,$20               
40E6: E0 F2           LD      ($FF00+$F2),A       
40E8: F0 98           LD      A,($98)             
40EA: F5              PUSH    AF                  
40EB: 3E 50           LD      A,$50               
40ED: E0 98           LD      ($FF00+$98),A       
40EF: F0 99           LD      A,($99)             
40F1: F5              PUSH    AF                  
40F2: 3E 48           LD      A,$48               
40F4: E0 99           LD      ($FF00+$99),A       
40F6: 3E 08           LD      A,$08               
...
4117: 34              INC     (HL)                
4118: F1              POP     AF                  
4119: E0 99           LD      ($FF00+$99),A       
411B: F1              POP     AF                  
411C: E0 98           LD      ($FF00+$98),A       
...
42BF: F0 EF           LD      A,($EF)             
42C1: C6 0A           ADD     $0A                 
42C3: E0 EC           LD      ($FF00+$EC),A       
42C5: AF              XOR     A                   
42C6: E0 F1           LD      ($FF00+$F1),A       
...
44D5: F1              POP     AF                  
44D6: E0 99           LD      ($FF00+$99),A       
44D8: F1              POP     AF                  
44D9: E0 98           LD      ($FF00+$98),A       
44DB: C9              RET                         
...
45DE: C1              POP     BC                  
45DF: 3E 28           LD      A,$28               
45E1: E0 F4           LD      ($FF00+$F4),A       
45E3: C9              RET                         
45E4: F0 98           LD      A,($98)             
45E6: F5              PUSH    AF                  
45E7: 3E 50           LD      A,$50               
45E9: E0 98           LD      ($FF00+$98),A       
45EB: F0 99           LD      A,($99)             
45ED: F5              PUSH    AF                  
45EE: 3E 48           LD      A,$48               
45F0: E0 99           LD      ($FF00+$99),A       
45F2: 3E 20           LD      A,$20               
...
4617: 77              LD      (HL),A              
4618: F1              POP     AF                  
4619: E0 99           LD      ($FF00+$99),A       
461B: F1              POP     AF                  
461C: E0 98           LD      ($FF00+$98),A       
...
46FB: 09              ADD     HL,BC               
46FC: 7E              LD      A,(HL)              
46FD: E0 EC           LD      ($FF00+$EC),A       
46FF: 21 40 C4        LD      HL,$C440            
4702: 09              ADD     HL,BC               
4703: 7E              LD      A,(HL)              
4704: E0 EE           LD      ($FF00+$EE),A       
...
4728: F0 EC           LD      A,($EC)             
472A: C6 10           ADD     $10                 
472C: E0 EC           LD      ($FF00+$EC),A       
472E: F0 E7           LD      A,($E7)             
4730: 1F              RRA                         
4731: 1F              RRA                         
4732: 1F              RRA                         
4733: E6 01           AND     $01                 
4735: E0 F1           LD      ($FF00+$F1),A       
...
4962: C9              RET                         
4963: EE 12           XOR     $12                 
4965: F8 08           LD      HL,SP+$08           
4967: AF              XOR     A                   
4968: E0 E8           LD      ($FF00+$E8),A       
496A: 3E 5B           LD      A,$5B               
...
4E57: 3E 02           LD      A,$02               
4E59: E0 A1           LD      ($FF00+$A1),A       
4E5B: 3E 6A           LD      A,$6A               
4E5D: E0 9D           LD      ($FF00+$9D),A       
4E5F: C9              RET                         
...
4E77: 36 02           LD      (HL),$02            
4E79: 3E 24           LD      A,$24               
4E7B: E0 F2           LD      ($FF00+$F2),A       
4E7D: CD AF 3D        CALL    $3DAF               
4E80: 18 01           JR      $4E83               ; {}
4E82: 34              INC     (HL)                
4E83: CD 4A 6D        CALL    $6D4A               ; {}
4E86: AF              XOR     A                   
4E87: E0 E8           LD      ($FF00+$E8),A       
4E89: F0 F0           LD      A,($F0)             
4E8B: C7              RST     0X00                
4E8C: A4              AND     H                   
4E8D: 4E              LD      C,(HL)              
...
5399: F0 70           LD      A,($70)             
539B: 00              NOP                         
539C: F8 F8           LD      HL,SP+$F8           
539E: 72              LD      (HL),D              
539F: 00              NOP                         
53A0: F8 10           LD      HL,SP+$10           
53A2: 72              LD      (HL),D              
53A3: 20 F8           JR      NZ,$539D            ; {}
53A5: 18 70           JR      $5417               ; {}
53A7: 20 08           JR      NZ,$53B1            ; {}
53A9: F8 7C           LD      HL,SP+$7C           
53AB: 00              NOP                         
...
53B9: F0 74           LD      A,($74)             
53BB: 00              NOP                         
53BC: F8 F8           LD      HL,SP+$F8           
53BE: 76              HALT                        
53BF: 00              NOP                         
53C0: F8 10           LD      HL,SP+$10           
53C2: 76              HALT                        
53C3: 20 F8           JR      NZ,$53BD            ; {}
53C5: 18 74           JR      $543B               ; {}
53C7: 20 08           JR      NZ,$53D1            ; {}
53C9: F8 7C           LD      HL,SP+$7C           
53CB: 00              NOP                         
...
53D9: F0 74           LD      A,($74)             
53DB: 00              NOP                         
53DC: F8 F8           LD      HL,SP+$F8           
53DE: 76              HALT                        
53DF: 00              NOP                         
53E0: F8 10           LD      HL,SP+$10           
53E2: 76              HALT                        
53E3: 20 F8           JR      NZ,$53DD            ; {}
53E5: 18 74           JR      $545B               ; {}
53E7: 20 08           JR      NZ,$53F1            ; {}
53E9: F8 60           LD      HL,SP+$60           
53EB: 00              NOP                         
...
53F9: F0 78           LD      A,($78)             
53FB: 00              NOP                         
53FC: F8 F8           LD      HL,SP+$F8           
53FE: 7A              LD      A,D                 
53FF: 00              NOP                         
5400: F8 10           LD      HL,SP+$10           
5402: 7A              LD      A,D                 
5403: 20 F8           JR      NZ,$53FD            ; {}
5405: 18 78           JR      $547F               ; {}
5407: 20 08           JR      NZ,$5411            ; {}
5409: F8 60           LD      HL,SP+$60           
540B: 00              NOP                         
...
5419: F0 70           LD      A,($70)             
541B: 00              NOP                         
541C: F8 F8           LD      HL,SP+$F8           
541E: 72              LD      (HL),D              
541F: 00              NOP                         
5420: F8 10           LD      HL,SP+$10           
5422: 72              LD      (HL),D              
5423: 20 F8           JR      NZ,$541D            ; {}
5425: 18 70           JR      $5497               ; {}
5427: 20 08           JR      NZ,$5431            ; {}
5429: F8 60           LD      HL,SP+$60           
542B: 00              NOP                         
...
54C0: 2F              CPL                         
54C1: 3C              INC     A                   
54C2: E0 9B           LD      ($FF00+$9B),A       
54C4: F0 D8           LD      A,($D8)             
54C6: 2F              CPL                         
54C7: 3C              INC     A                   
54C8: E0 9A           LD      ($FF00+$9A),A       
54CA: C5              PUSH    BC                  
...
5627: 3E 0D           LD      A,$0D               
5629: E0 D7           LD      ($FF00+$D7),A       
562B: D5              PUSH    DE                  
562C: F0 EF           LD      A,($EF)             
562E: D6 0F           SUB     $0F                 
5630: E0 CD           LD      ($FF00+$CD),A       
5632: F0 EE           LD      A,($EE)             
5634: D6 07           SUB     $07                 
5636: E0 CE           LD      ($FF00+$CE),A       
5638: CB 37           SWAP    1,E                 
563A: E6 0F           AND     $0F                 
563C: 5F              LD      E,A                 
563D: F0 CD           LD      A,($CD)             
...
5727: F0 EE           LD      A,($EE)             
5729: 86              ADD     A,(HL)              
572A: E0 EE           LD      ($FF00+$EE),A       
572C: 21 0A 57        LD      HL,$570A            
572F: 19              ADD     HL,DE               
5730: F0 EC           LD      A,($EC)             
5732: 86              ADD     A,(HL)              
5733: E0 EC           LD      ($FF00+$EC),A       
...
57E7: C9              RET                         
57E8: F8 F8           LD      HL,SP+$F8           
57EA: 60              LD      H,B                 
57EB: 00              NOP                         
57EC: F8 00           LD      HL,SP+$00           
57EE: 62              LD      H,D                 
57EF: 00              NOP                         
57F0: F8 08           LD      HL,SP+$08           
57F2: 62              LD      H,D                 
57F3: 20 F8           JR      NZ,$57ED            ; {}
57F5: 10 60           ;;STOP    $60                 
57F7: 20 08           JR      NZ,$5801            ; {}
57F9: F8 64           LD      HL,SP+$64           
57FB: 00              NOP                         
...
5809: F8 60           LD      HL,SP+$60           
580B: 00              NOP                         
580C: F8 00           LD      HL,SP+$00           
580E: 62              LD      H,D                 
580F: 00              NOP                         
5810: F8 08           LD      HL,SP+$08           
5812: 62              LD      H,D                 
5813: 20 F8           JR      NZ,$580D            ; {}
5815: 10 60           ;;STOP    $60                 
5817: 20 08           JR      NZ,$5821            ; {}
5819: F8 6C           LD      HL,SP+$6C           
581B: 00              NOP                         
...
5827: 60              LD      H,B                 
5828: F8 F8           LD      HL,SP+$F8           
582A: 68              LD      L,B                 
582B: 00              NOP                         
582C: F8 00           LD      HL,SP+$00           
582E: 6A              LD      L,D                 
582F: 00              NOP                         
5830: F8 08           LD      HL,SP+$08           
5832: 62              LD      H,D                 
5833: 20 F8           JR      NZ,$582D            ; {}
5835: 10 60           ;;STOP    $60                 
5837: 20 08           JR      NZ,$5841            ; {}
5839: F8 68           LD      HL,SP+$68           
583B: 40              LD      B,B                 
...
5847: 60              LD      H,B                 
5848: F8 F8           LD      HL,SP+$F8           
584A: 6C              LD      L,H                 
584B: 40              LD      B,B                 
584C: F8 00           LD      HL,SP+$00           
584E: 6E              LD      L,(HL)              
584F: 40              LD      B,B                 
5850: F8 08           LD      HL,SP+$08           
5852: 62              LD      H,D                 
5853: 20 F8           JR      NZ,$584D            ; {}
5855: 10 60           ;;STOP    $60                 
5857: 20 08           JR      NZ,$5861            ; {}
5859: F8 60           LD      HL,SP+$60           
585B: 40              LD      B,B                 
...
5867: 60              LD      H,B                 
5868: F8 F8           LD      HL,SP+$F8           
586A: 64              LD      H,H                 
586B: 40              LD      B,B                 
586C: F8 00           LD      HL,SP+$00           
586E: 66              LD      H,(HL)              
586F: 40              LD      B,B                 
5870: F8 08           LD      HL,SP+$08           
5872: 66              LD      H,(HL)              
5873: 60              LD      H,B                 
5874: F8 10           LD      HL,SP+$10           
5876: 64              LD      H,H                 
5877: 60              LD      H,B                 
...
5887: 60              LD      H,B                 
5888: F8 F8           LD      HL,SP+$F8           
588A: 60              LD      H,B                 
588B: 00              NOP                         
588C: F8 00           LD      HL,SP+$00           
588E: 62              LD      H,D                 
588F: 00              NOP                         
5890: F8 08           LD      HL,SP+$08           
5892: 6E              LD      L,(HL)              
5893: 60              LD      H,B                 
5894: F8 10           LD      HL,SP+$10           
5896: 6C              LD      L,H                 
5897: 60              LD      H,B                 
...
58A7: 60              LD      H,B                 
58A8: F8 F8           LD      HL,SP+$F8           
58AA: 60              LD      H,B                 
58AB: 00              NOP                         
58AC: F8 00           LD      HL,SP+$00           
58AE: 62              LD      H,D                 
58AF: 00              NOP                         
58B0: F8 08           LD      HL,SP+$08           
58B2: 6A              LD      L,D                 
58B3: 20 F8           JR      NZ,$58AD            ; {}
58B5: 10 68           ;;STOP    $68                 
58B7: 20 08           JR      NZ,$58C1            ; {}
58B9: F8 60           LD      HL,SP+$60           
58BB: 40              LD      B,B                 
...
58C7: 60              LD      H,B                 
58C8: F8 F8           LD      HL,SP+$F8           
58CA: 60              LD      H,B                 
58CB: 00              NOP                         
58CC: F8 00           LD      HL,SP+$00           
58CE: 62              LD      H,D                 
58CF: 00              NOP                         
58D0: F8 08           LD      HL,SP+$08           
58D2: 62              LD      H,D                 
58D3: 20 F8           JR      NZ,$58CD            ; {}
58D5: 10 60           ;;STOP    $60                 
58D7: 20 08           JR      NZ,$58E1            ; {}
58D9: F8 60           LD      HL,SP+$60           
58DB: 40              LD      B,B                 
...
5941: 19              ADD     HL,DE               
5942: 7E              LD      A,(HL)              
5943: E0 EE           LD      ($FF00+$EE),A       
5945: 21 00 D1        LD      HL,$D100            
5948: 19              ADD     HL,DE               
5949: 7E              LD      A,(HL)              
594A: E0 EC           LD      ($FF00+$EC),A       
594C: 3E 00           LD      A,$00               
594E: E0 F1           LD      ($FF00+$F1),A       
...
596B: 19              ADD     HL,DE               
596C: 7E              LD      A,(HL)              
596D: E0 EE           LD      ($FF00+$EE),A       
596F: 21 00 D1        LD      HL,$D100            
5972: 19              ADD     HL,DE               
5973: 7E              LD      A,(HL)              
5974: E0 EC           LD      ($FF00+$EC),A       
5976: 3E 00           LD      A,$00               
5978: E0 F1           LD      ($FF00+$F1),A       
...
5994: 19              ADD     HL,DE               
5995: 7E              LD      A,(HL)              
5996: E0 EE           LD      ($FF00+$EE),A       
5998: 21 00 D1        LD      HL,$D100            
599B: 19              ADD     HL,DE               
599C: 7E              LD      A,(HL)              
599D: E0 EC           LD      ($FF00+$EC),A       
599F: 3E 01           LD      A,$01               
59A1: E0 F1           LD      ($FF00+$F1),A       
...
59BC: 19              ADD     HL,DE               
59BD: 7E              LD      A,(HL)              
59BE: E0 EE           LD      ($FF00+$EE),A       
59C0: 21 00 D1        LD      HL,$D100            
59C3: 19              ADD     HL,DE               
59C4: 7E              LD      A,(HL)              
59C5: E0 EC           LD      ($FF00+$EC),A       
59C7: F0 E7           LD      A,($E7)             
59C9: 1F              RRA                         
59CA: 1F              RRA                         
59CB: 1F              RRA                         
...
59FE: F0 EE           LD      A,($EE)             
5A00: E0 D7           LD      ($FF00+$D7),A       
5A02: F0 EC           LD      A,($EC)             
5A04: E0 D8           LD      ($FF00+$D8),A       
5A06: 3E 02           LD      A,$02               
5A08: CD 53 09        CALL    $0953               
5A0B: 3E 13           LD      A,$13               
5A0D: E0 F4           LD      ($FF00+$F4),A       
5A0F: C9              RET                         
...
5BB4: 19              ADD     HL,DE               
5BB5: 7E              LD      A,(HL)              
5BB6: E0 EC           LD      ($FF00+$EC),A       
5BB8: 3E 08           LD      A,$08               
5BBA: E0 F1           LD      ($FF00+$F1),A       
...
5BE1: 19              ADD     HL,DE               
5BE2: 7E              LD      A,(HL)              
5BE3: E0 EC           LD      ($FF00+$EC),A       
5BE5: 3E 09           LD      A,$09               
5BE7: E0 F1           LD      ($FF00+$F1),A       
...
5D1B: 35              DEC     (HL)                
5D1C: C9              RET                         
5D1D: F8 F8           LD      HL,SP+$F8           
5D1F: 60              LD      H,B                 
5D20: 00              NOP                         
5D21: F8 00           LD      HL,SP+$00           
5D23: 62              LD      H,D                 
5D24: 00              NOP                         
5D25: F8 08           LD      HL,SP+$08           
5D27: 62              LD      H,D                 
5D28: 20 F8           JR      NZ,$5D22            ; {}
5D2A: 10 60           ;;STOP    $60                 
5D2C: 20 08           JR      NZ,$5D36            ; {}
5D2E: F8 64           LD      HL,SP+$64           
5D30: 00              NOP                         
...
5D3C: 00              NOP                         
5D3D: F8 F8           LD      HL,SP+$F8           
5D3F: 60              LD      H,B                 
5D40: 00              NOP                         
5D41: F8 00           LD      HL,SP+$00           
5D43: 62              LD      H,D                 
5D44: 00              NOP                         
5D45: F8 08           LD      HL,SP+$08           
5D47: 62              LD      H,D                 
5D48: 20 F8           JR      NZ,$5D42            ; {}
5D4A: 10 60           ;;STOP    $60                 
5D4C: 20 08           JR      NZ,$5D56            ; {}
5D4E: F8 64           LD      HL,SP+$64           
5D50: 00              NOP                         
...
5D5C: 00              NOP                         
5D5D: F8 F8           LD      HL,SP+$F8           
5D5F: 60              LD      H,B                 
5D60: 00              NOP                         
5D61: F8 00           LD      HL,SP+$00           
5D63: 62              LD      H,D                 
5D64: 00              NOP                         
5D65: F8 08           LD      HL,SP+$08           
5D67: 62              LD      H,D                 
5D68: 20 F8           JR      NZ,$5D62            ; {}
5D6A: 10 60           ;;STOP    $60                 
5D6C: 20 08           JR      NZ,$5D76            ; {}
5D6E: F8 6A           LD      HL,SP+$6A           
...
5D7E: F8 60           LD      HL,SP+$60           
5D80: 00              NOP                         
5D81: F8 00           LD      HL,SP+$00           
5D83: 62              LD      H,D                 
5D84: 00              NOP                         
5D85: F8 08           LD      HL,SP+$08           
5D87: 62              LD      H,D                 
5D88: 20 F8           JR      NZ,$5D82            ; {}
5D8A: 10 60           ;;STOP    $60                 
5D8C: 20 08           JR      NZ,$5D96            ; {}
5D8E: F8 6A           LD      HL,SP+$6A           
...
5DA3: 17              RLA                         
5DA4: E6 40           AND     $40                 
5DA6: E0 D7           LD      ($FF00+$D7),A       
5DA8: F1              POP     AF                  
5DA9: E6 0F           AND     $0F                 
5DAB: E0 ED           LD      ($FF00+$ED),A       
...
5DEF: F0 EE           LD      A,($EE)             
5DF1: D6 08           SUB     $08                 
5DF3: E0 EE           LD      ($FF00+$EE),A       
5DF5: 3E 06           LD      A,$06               
5DF7: E0 F1           LD      ($FF00+$F1),A       
5DF9: 11 C9 5D        LD      DE,$5DC9            
5DFC: CD 3B 3C        CALL    $3C3B               
5DFF: F0 EE           LD      A,($EE)             
5E01: C6 10           ADD     $10                 
5E03: E0 EE           LD      ($FF00+$EE),A       
5E05: 3E 07           LD      A,$07               
5E07: E0 F1           LD      ($FF00+$F1),A       
...
6062: 00              NOP                         
6063: 00              NOP                         
6064: F8 F8           LD      HL,SP+$F8           
6066: F8 F2           LD      HL,SP+$F2           
6068: FE E8           CP      $E8                 
606A: 00              NOP                         
606B: E0 E8           LD      ($FF00+$E8),A       
606D: 00              NOP                         
606E: 00              NOP                         
606F: 00              NOP                         
6070: 00              NOP                         
...
60F9: 19              ADD     HL,DE               
60FA: 7E              LD      A,(HL)              
60FB: E0 9D           LD      ($FF00+$9D),A       
60FD: 21 55 60        LD      HL,$6055            
6100: 19              ADD     HL,DE               
6101: F0 98           LD      A,($98)             
6103: 86              ADD     A,(HL)              
6104: E0 EE           LD      ($FF00+$EE),A       
6106: 21 5F 60        LD      HL,$605F            
6109: 19              ADD     HL,DE               
610A: F0 99           LD      A,($99)             
610C: 86              ADD     A,(HL)              
610D: E0 EC           LD      ($FF00+$EC),A       
...
619D: F0 98           LD      A,($98)             
619F: 86              ADD     A,(HL)              
61A0: E0 EE           LD      ($FF00+$EE),A       
61A2: 21 72 60        LD      HL,$6072            
61A5: 19              ADD     HL,DE               
61A6: F0 99           LD      A,($99)             
61A8: 86              ADD     A,(HL)              
61A9: E0 EC           LD      ($FF00+$EC),A       
61AB: AF              XOR     A                   
61AC: E0 F1           LD      ($FF00+$F1),A       
...
62B6: F0 EC           LD      A,($EC)             
62B8: E0 D8           LD      ($FF00+$D8),A       
62BA: F0 EE           LD      A,($EE)             
62BC: E0 D7           LD      ($FF00+$D7),A       
62BE: 3E 01           LD      A,$01               
62C0: CD 53 09        CALL    $0953               
62C3: 3E 0E           LD      A,$0E               
62C5: E0 F2           LD      ($FF00+$F2),A       
62C7: C9              RET                         
...
6321: F5              PUSH    AF                  
6322: D6 17           SUB     $17                 
6324: E0 98           LD      ($FF00+$98),A       
6326: 3E 04           LD      A,$04               
6328: CD 25 3C        CALL    $3C25               
632B: F1              POP     AF                  
632C: E0 98           LD      ($FF00+$98),A       
632E: F0 EC           LD      A,($EC)             
6330: FE 25           CP      $25                 
...
64D9: 86              ADD     A,(HL)              
64DA: E0 98           LD      ($FF00+$98),A       
64DC: FA 01 D0        LD      A,($D001)           
64DF: E0 99           LD      ($FF00+$99),A       
64E1: 3E 04           LD      A,$04               
64E3: CD 25 3C        CALL    $3C25               
64E6: F1              POP     AF                  
64E7: E0 99           LD      ($FF00+$99),A       
64E9: F1              POP     AF                  
64EA: E0 98           LD      ($FF00+$98),A       
...
6503: C6 04           ADD     $04                 
6505: E0 98           LD      ($FF00+$98),A       
6507: FA 01 D0        LD      A,($D001)           
650A: E0 99           LD      ($FF00+$99),A       
650C: 3E 10           LD      A,$10               
650E: CD 25 3C        CALL    $3C25               
6511: F1              POP     AF                  
6512: E0 99           LD      ($FF00+$99),A       
6514: F1              POP     AF                  
6515: E0 98           LD      ($FF00+$98),A       
...
656D: F5              PUSH    AF                  
656E: 3E 00           LD      A,$00               
6570: E0 98           LD      ($FF00+$98),A       
6572: 3E 59           LD      A,$59               
6574: E0 99           LD      ($FF00+$99),A       
6576: 3E 08           LD      A,$08               
...
6596: 35              DEC     (HL)                
6597: F1              POP     AF                  
6598: E0 99           LD      ($FF00+$99),A       
659A: F1              POP     AF                  
659B: E0 98           LD      ($FF00+$98),A       
659D: F0 CC           LD      A,($CC)             
659F: E6 30           AND     $30                 
...
65B5: F5              PUSH    AF                  
65B6: D6 14           SUB     $14                 
65B8: E0 98           LD      ($FF00+$98),A       
65BA: F0 99           LD      A,($99)             
65BC: F5              PUSH    AF                  
65BD: C6 08           ADD     $08                 
65BF: E0 99           LD      ($FF00+$99),A       
65C1: 3E 03           LD      A,$03               
...
65E7: 35              DEC     (HL)                
65E8: F1              POP     AF                  
65E9: E0 99           LD      ($FF00+$99),A       
65EB: F1              POP     AF                  
65EC: E0 98           LD      ($FF00+$98),A       
...
683B: 2F              CPL                         
683C: 3C              INC     A                   
683D: E0 9B           LD      ($FF00+$9B),A       
683F: F0 D8           LD      A,($D8)             
6841: CB 43           BIT     1,E                 
6843: 28 02           JR      Z,$6847             ; {}
6845: 2F              CPL                         
6846: 3C              INC     A                   
6847: E0 9A           LD      ($FF00+$9A),A       
6849: C5              PUSH    BC                  
684A: CD D6 20        CALL    $20D6               
684D: CD 49 3E        CALL    $3E49               
6850: C1              POP     BC                  
6851: F1              POP     AF                  
6852: E0 9B           LD      ($FF00+$9B),A       
6854: F1              POP     AF                  
6855: E0 9A           LD      ($FF00+$9A),A       
6857: AF              XOR     A                   
...
687A: F0 EE           LD      A,($EE)             
687C: E0 98           LD      ($FF00+$98),A       
687E: F0 EC           LD      A,($EC)             
6880: E0 99           LD      ($FF00+$99),A       
6882: 3E 06           LD      A,$06               
...
68F4: F5              PUSH    AF                  
68F5: F0 EE           LD      A,($EE)             
68F7: E0 98           LD      ($FF00+$98),A       
68F9: F0 EF           LD      A,($EF)             
68FB: E0 99           LD      ($FF00+$99),A       
...
6960: 77              LD      (HL),A              
6961: F1              POP     AF                  
6962: E0 99           LD      ($FF00+$99),A       
6964: F1              POP     AF                  
6965: E0 98           LD      ($FF00+$98),A       
6967: C1              POP     BC                  
6968: D1              POP     DE                  
6969: 1D              DEC     E                   
696A: 7B              LD      A,E                 
...
6B05: 86              ADD     A,(HL)              
6B06: C6 F0           ADD     $F0                 
6B08: E0 EC           LD      ($FF00+$EC),A       
6B0A: 21 7B 6A        LD      HL,$6A7B            
6B0D: 19              ADD     HL,DE               
6B0E: F0 EE           LD      A,($EE)             
6B10: 86              ADD     A,(HL)              
6B11: C6 F3           ADD     $F3                 
6B13: E0 EE           LD      ($FF00+$EE),A       
6B15: 3E 02           LD      A,$02               
6B17: E0 F1           LD      ($FF00+$F1),A       
...
6B4B: CB 2F           SRA     1,E                 
6B4D: CB 2F           SRA     1,E                 
6B4F: E0 D7           LD      ($FF00+$D7),A       
6B51: E0 D9           LD      ($FF00+$D9),A       
6B53: F0 EC           LD      A,($EC)             
...
6B5A: CB 2F           SRA     1,E                 
6B5C: CB 2F           SRA     1,E                 
6B5E: E0 D8           LD      ($FF00+$D8),A       
6B60: E0 DA           LD      ($FF00+$DA),A       
...
6B92: 86              ADD     A,(HL)              
6B93: E0 D7           LD      ($FF00+$D7),A       
6B95: F0 D8           LD      A,($D8)             
6B97: 21 DA FF        LD      HL,$FFDA            
6B9A: 86              ADD     A,(HL)              
6B9B: E0 D8           LD      ($FF00+$D8),A       
6B9D: F0 DB           LD      A,($DB)             
6B9F: 3D              DEC     A                   
...
6BE3: 36 08           LD      (HL),$08            
6BE5: 3E 07           LD      A,$07               
6BE7: E0 F2           LD      ($FF00+$F2),A       
6BE9: F0 EE           LD      A,($EE)             
6BEB: E0 D7           LD      ($FF00+$D7),A       
6BED: F0 EC           LD      A,($EC)             
6BEF: E0 D8           LD      ($FF00+$D8),A       
6BF1: 3E 05           LD      A,$05               
...
70F5: 3E 01           LD      A,$01               
70F7: E0 A1           LD      ($FF00+$A1),A       
70F9: 3E 02           LD      A,$02               
70FB: E0 9E           LD      ($FF00+$9E),A       
70FD: C9              RET                         
...
720F: F5              PUSH    AF                  
7210: 3E 16           LD      A,$16               
7212: E0 99           LD      ($FF00+$99),A       
7214: 3E 18           LD      A,$18               
7216: E0 98           LD      ($FF00+$98),A       
...
723B: C1              POP     BC                  
723C: F1              POP     AF                  
723D: E0 99           LD      ($FF00+$99),A       
723F: F1              POP     AF                  
7240: E0 98           LD      ($FF00+$98),A       
...
73A8: E0 EE           LD      ($FF00+$EE),A       
73AA: FA 05 D2        LD      A,($D205)           
73AD: C6 10           ADD     $10                 
73AF: E0 EC           LD      ($FF00+$EC),A       
73B1: 3E 05           LD      A,$05               
73B3: E0 F1           LD      ($FF00+$F1),A       
...
73C4: E0 EE           LD      ($FF00+$EE),A       
73C6: FA 05 D2        LD      A,($D205)           
73C9: C6 20           ADD     $20                 
73CB: E0 EC           LD      ($FF00+$EC),A       
73CD: AF              XOR     A                   
73CE: E0 F1           LD      ($FF00+$F1),A       
...
7AEC: 3D              DEC     A                   
7AED: E0 F1           LD      ($FF00+$F1),A       
7AEF: 21 C3 7A        LD      HL,$7AC3            
7AF2: F0 E6           LD      A,($E6)             
7AF4: 5F              LD      E,A                 
7AF5: 19              ADD     HL,DE               
7AF6: 7E              LD      A,(HL)              
7AF7: E0 EE           LD      ($FF00+$EE),A       
7AF9: 3E 32           LD      A,$32               
7AFB: E0 EC           LD      ($FF00+$EC),A       
7AFD: F0 F1           LD      A,($F1)             
7AFF: FE 01           CP      $01                 
...
7B2C: 3D              DEC     A                   
7B2D: E0 F1           LD      ($FF00+$F1),A       
7B2F: 3E 01           LD      A,$01               
7B31: EA 5C C1        LD      ($C15C),A           
7B34: CD 3B 09        CALL    $093B               
7B37: F0 98           LD      A,($98)             
7B39: E0 EE           LD      ($FF00+$EE),A       
7B3B: F0 99           LD      A,($99)             
7B3D: D6 0E           SUB     $0E                 
7B3F: E0 EC           LD      ($FF00+$EC),A       
7B41: F0 F1           LD      A,($F1)             
7B43: FE 05           CP      $05                 
