...
>>> binary 4000:roms/zelda.gb[C000:10000]
...
4BB0: E0 B0           LD      ($FF00+$B0),A       
4BB2: E0 BD           LD      ($FF00+$BD),A       
4BB4: E0 BF           LD      ($FF00+$BF),A       
4BB6: C9              RET                         
4BB7: AF              XOR     A                   
...
4C9E: 3E 2F           LD      A,$2F               
4CA0: E0 B1           LD      ($FF00+$B1),A       
4CA2: E0 B0           LD      ($FF00+$B0),A       
4CA4: E0 BD           LD      ($FF00+$BD),A       
...
4DF0: F0 EC           LD      A,($EC)             
4DF2: 86              ADD     A,(HL)              
4DF3: E0 EC           LD      ($FF00+$EC),A       
4DF5: 7B              LD      A,E                 
4DF6: FE 03           CP      $03                 
4DF8: 20 0B           JR      NZ,$4E05            ; {}
4DFA: AF              XOR     A                   
4DFB: E0 F1           LD      ($FF00+$F1),A       
...
4E2D: 09              ADD     HL,BC               
4E2E: 7E              LD      A,(HL)              
4E2F: E0 98           LD      ($FF00+$98),A       
4E31: F0 99           LD      A,($99)             
4E33: F5              PUSH    AF                  
4E34: 21 C0 C4        LD      HL,$C4C0            
4E37: 09              ADD     HL,BC               
4E38: 7E              LD      A,(HL)              
4E39: E0 99           LD      ($FF00+$99),A       
4E3B: 7B              LD      A,E                 
4E3C: CD 99 7E        CALL    $7E99               ; {}
4E3F: F1              POP     AF                  
4E40: E0 99           LD      ($FF00+$99),A       
4E42: F1              POP     AF                  
4E43: E0 98           LD      ($FF00+$98),A       
...
525B: F0 EF           LD      A,($EF)             
525D: D6 0F           SUB     $0F                 
525F: E0 CD           LD      ($FF00+$CD),A       
5261: F0 EE           LD      A,($EE)             
5263: D6 07           SUB     $07                 
5265: E0 CE           LD      ($FF00+$CE),A       
5267: CB 37           SWAP    1,E                 
5269: E6 0F           AND     $0F                 
526B: 5F              LD      E,A                 
526C: F0 CD           LD      A,($CD)             
...
54B6: 3E 30           LD      A,$30               
54B8: E0 CE           LD      ($FF00+$CE),A       
54BA: 3E 20           LD      A,$20               
54BC: E0 CD           LD      ($FF00+$CD),A       
54BE: 3E 19           LD      A,$19               
54C0: E0 DF           LD      ($FF00+$DF),A       
...
5877: F8 00           LD      HL,SP+$00           
5879: 00              NOP                         
587A: 00              NOP                         
587B: 00              NOP                         
587C: F8 08           LD      HL,SP+$08           
587E: 06 04           LD      B,$04               
5880: 02              LD      (BC),A              
5881: 00              NOP                         
5882: F0 F7           LD      A,($F7)             
...
5995: F8 04           LD      HL,SP+$04           
5997: FC                              
5998: FC                              
5999: FC                              
599A: F8 00           LD      HL,SP+$00           
599C: 20 E0           JR      NZ,$597E            ; {}
599E: 00              NOP                         
599F: 00              NOP                         
59A0: 00              NOP                         
59A1: 00              NOP                         
59A2: E0 20           LD      ($FF00+$20),A       
59A4: 3E 0C           LD      A,$0C               
...
59EC: 00              NOP                         
59ED: F8 08           LD      HL,SP+$08           
59EF: 20 E0           JR      NZ,$59D1            ; {}
59F1: 00              NOP                         
59F2: 00              NOP                         
59F3: E0 20           LD      ($FF00+$20),A       
59F5: 3E 0A           LD      A,$0A               
...
5A78: 77              LD      (HL),A              
5A79: 3E 6C           LD      A,$6C               
5A7B: E0 9D           LD      ($FF00+$9D),A       
5A7D: 3E 03           LD      A,$03               
5A7F: E0 9E           LD      ($FF00+$9E),A       
5A81: AF              XOR     A                   
...
5A92: 77              LD      (HL),A              
5A93: 3E 02           LD      A,$02               
5A95: E0 A1           LD      ($FF00+$A1),A       
5A97: C9              RET                         
5A98: AC              XOR     H                   
5A99: 00              NOP                         
5A9A: AC              XOR     H                   
5A9B: 20 F0           JR      NZ,$5A8D            ; {}
5A9D: F8 E6           LD      HL,SP+$E6           
5A9F: 10 C2           ;;STOP    $C2                 
5AA1: B7              OR      A                   
5AA2: 3F              CCF                         
5AA3: F0 F0           LD      A,($F0)             
...
5AC3: C9              RET                         
5AC4: 3E 03           LD      A,$03               
5AC6: E0 90           LD      ($FF00+$90),A       
5AC8: CD 8D 3B        CALL    $3B8D               
5ACB: C9              RET                         
5ACC: 3E 04           LD      A,$04               
5ACE: E0 90           LD      ($FF00+$90),A       
...
5B4B: 3E 05           LD      A,$05               
5B4D: E0 90           LD      ($FF00+$90),A       
5B4F: CD 8D 3B        CALL    $3B8D               
5B52: C9              RET                         
5B53: 3E 06           LD      A,$06               
5B55: E0 90           LD      ($FF00+$90),A       
5B57: CD B7 3F        CALL    $3FB7               
5B5A: 3E 0D           LD      A,$0D               
5B5C: E0 A5           LD      ($FF00+$A5),A       
...
5B81: 3E 6B           LD      A,$6B               
5B83: E0 EC           LD      ($FF00+$EC),A       
5B85: FA 5C DB        LD      A,($DB5C)           
5B88: E0 F1           LD      ($FF00+$F1),A       
5B8A: 3E 8B           LD      A,$8B               
5B8C: E0 EE           LD      ($FF00+$EE),A       
...
5C16: 3E 05           LD      A,$05               
5C18: E0 B0           LD      ($FF00+$B0),A       
5C1A: E0 BF           LD      ($FF00+$BF),A       
...
5C89: 3E 07           LD      A,$07               
5C8B: E0 F2           LD      ($FF00+$F2),A       
5C8D: C9              RET                         
5C8E: 8A              ADC     A,D                 
5C8F: 10 F0           ;;STOP    $F0                 
5C91: F8 E6           LD      HL,SP+$E6           
5C93: 10 C2           ;;STOP    $C2                 
5C95: B7              OR      A                   
5C96: 3F              CCF                         
...
63C8: F5              PUSH    AF                  
63C9: C6 04           ADD     $04                 
63CB: E0 98           LD      ($FF00+$98),A       
63CD: CD 43 64        CALL    $6443               ; {}
63D0: F1              POP     AF                  
63D1: E0 98           LD      ($FF00+$98),A       
63D3: 18 22           JR      $63F7               ; {}
63D5: AF              XOR     A                   
...
643D: 3E 49           LD      A,$49               
643F: E0 BD           LD      ($FF00+$BD),A       
6441: E0 BF           LD      ($FF00+$BF),A       
6443: 1E 03           LD      E,$03               
6445: 16 00           LD      D,$00               
6447: D5              PUSH    DE                  
...
644C: F0 98           LD      A,($98)             
644E: 86              ADD     A,(HL)              
644F: E0 D7           LD      ($FF00+$D7),A       
6451: 21 17 64        LD      HL,$6417            
6454: 19              ADD     HL,DE               
6455: F0 99           LD      A,($99)             
6457: 86              ADD     A,(HL)              
6458: E0 D8           LD      ($FF00+$D8),A       
645A: 3E 07           LD      A,$07               
...
6519: 09              ADD     HL,BC               
651A: 7E              LD      A,(HL)              
651B: E0 D7           LD      ($FF00+$D7),A       
651D: 21 10 C2        LD      HL,$C210            
6520: 09              ADD     HL,BC               
6521: 7E              LD      A,(HL)              
6522: E0 D8           LD      ($FF00+$D8),A       
6524: 21 80 C3        LD      HL,$C380            
6527: 09              ADD     HL,BC               
6528: 7E              LD      A,(HL)              
6529: E0 D9           LD      ($FF00+$D9),A       
652B: 21 10 C3        LD      HL,$C310            
652E: 09              ADD     HL,BC               
652F: 7E              LD      A,(HL)              
6530: E0 DA           LD      ($FF00+$DA),A       
...
655C: 80              ADD     A,B                 
655D: 10 F8           ;;STOP    $F8                 
655F: F8 32           LD      HL,SP+$32           
6561: 00              NOP                         
6562: F8 00           LD      HL,SP+$00           
6564: 32              LD      (HLD),A             
6565: 20 F8           JR      NZ,$655F            ; {}
6567: 08 32 00        LD      ($0032),SP          
656A: F8 10           LD      HL,SP+$10           
656C: 32              LD      (HLD),A             
656D: 20 08           JR      NZ,$6577            ; {}
656F: F8 32           LD      HL,SP+$32           
6571: 00              NOP                         
...
657F: F8 10           LD      HL,SP+$10           
6581: 00              NOP                         
6582: F8 00           LD      HL,SP+$00           
6584: 12              LD      (DE),A              
6585: 00              NOP                         
6586: F8 08           LD      HL,SP+$08           
6588: 12              LD      (DE),A              
6589: 20 F8           JR      NZ,$6583            ; {}
658B: 10 10           ;;STOP    $10                 
658D: 20 08           JR      NZ,$6597            ; {}
658F: F8 10           LD      HL,SP+$10           
6591: 40              LD      B,B                 
...
67C0: 67              LD      H,A                 
67C1: 79              LD      A,C                 
67C2: E0 E9           LD      ($FF00+$E9),A       
67C4: 7E              LD      A,(HL)              
67C5: E0 AF           LD      ($FF00+$AF),A       
67C7: 5F              LD      E,A                 
67C8: FE BB           CP      $BB                 
...
67D6: 3E 02           LD      A,$02               
67D8: E0 F2           LD      ($FF00+$F2),A       
67DA: F0 CD           LD      A,($CD)             
67DC: E6 E0           AND     $E0                 
67DE: E0 CD           LD      ($FF00+$CD),A       
67E0: F0 CE           LD      A,($CE)             
67E2: E6 E0           AND     $E0                 
67E4: E0 CE           LD      ($FF00+$CE),A       
...
6949: A7              AND     A                   
694A: 7E              LD      A,(HL)              
694B: E0 AF           LD      ($FF00+$AF),A       
694D: 20 11           JR      NZ,$6960            ; {}
694F: E0 E9           LD      ($FF00+$E9),A       
6951: FE 0A           CP      $0A                 
...
69A6: EE 01           XOR     $01                 
69A8: 77              LD      (HL),A              
69A9: E0 F1           LD      ($FF00+$F1),A       
69AB: F0 E9           LD      A,($E9)             
69AD: FE 0A           CP      $0A                 
69AF: 20 05           JR      NZ,$69B6            ; {}
69B1: 3E FF           LD      A,$FF               
69B3: 77              LD      (HL),A              
69B4: E0 F1           LD      ($FF00+$F1),A       
69B6: D5              PUSH    DE                  
69B7: C1              POP     BC                  
...
6A1F: F0 CE           LD      A,($CE)             
6A21: C6 08           ADD     $08                 
6A23: E0 D7           LD      ($FF00+$D7),A       
6A25: F0 CD           LD      A,($CD)             
6A27: C6 10           ADD     $10                 
6A29: E0 D8           LD      ($FF00+$D8),A       
6A2B: 3E 08           LD      A,$08               
6A2D: CD 53 09        CALL    $0953               
6A30: 3E 13           LD      A,$13               
6A32: E0 F4           LD      ($FF00+$F4),A       
6A34: C9              RET                         
6A35: 6C              LD      L,H                 
6A36: 00              NOP                         
6A37: 6C              LD      L,H                 
...
6C49: 36 02           LD      (HL),$02            
6C4B: 3E 07           LD      A,$07               
6C4D: E0 F2           LD      ($FF00+$F2),A       
6C4F: F0 EF           LD      A,($EF)             
6C51: E0 D8           LD      ($FF00+$D8),A       
6C53: F0 EE           LD      A,($EE)             
6C55: E0 D7           LD      ($FF00+$D7),A       
6C57: 3E 05           LD      A,$05               
...
6D09: 3E F0           LD      A,$F0               
6D0B: E0 9B           LD      ($FF00+$9B),A       
6D0D: CD AF 3D        CALL    $3DAF               
6D10: 3E 0E           LD      A,$0E               
6D12: E0 F3           LD      ($FF00+$F3),A       
6D14: C9              RET                         
6D15: F0 EB           LD      A,($EB)             
6D17: FE 9F           CP      $9F                 
...
6D44: 36 30           LD      (HL),$30            
6D46: 3E 0E           LD      A,$0E               
6D48: E0 F3           LD      ($FF00+$F3),A       
6D4A: F0 F9           LD      A,($F9)             
6D4C: A7              AND     A                   
6D4D: 20 05           JR      NZ,$6D54            ; {}
6D4F: 3E 10           LD      A,$10               
6D51: E0 A3           LD      ($FF00+$A3),A       
6D53: C9              RET                         
6D54: 3E F0           LD      A,$F0               
6D56: E0 9B           LD      ($FF00+$9B),A       
6D58: C9              RET                         
6D59: F0 EB           LD      A,($EB)             
6D5B: FE 1C           CP      $1C                 
...
6E30: 19              ADD     HL,DE               
6E31: 7E              LD      A,(HL)              
6E32: E0 9A           LD      ($FF00+$9A),A       
6E34: 3E F4           LD      A,$F4               
6E36: E0 9B           LD      ($FF00+$9B),A       
6E38: AF              XOR     A                   
6E39: E0 9C           LD      ($FF00+$9C),A       
6E3B: 37              SCF                         
6E3C: C9              RET                         
...
6FC6: 2F              CPL                         
6FC7: 3C              INC     A                   
6FC8: E0 9A           LD      ($FF00+$9A),A       
6FCA: AF              XOR     A                   
6FCB: E0 9B           LD      ($FF00+$9B),A       
6FCD: C9              RET                         
6FCE: 3E 12           LD      A,$12               
...
714C: F0 EE           LD      A,($EE)             
714E: E0 D7           LD      ($FF00+$D7),A       
7150: F0 EC           LD      A,($EC)             
7152: E0 D8           LD      ($FF00+$D8),A       
...
72F8: FA AF DB        LD      A,($DBAF)           ; {ram.curBank}
72FB: F5              PUSH    AF                  
72FC: 3E 03           LD      A,$03               
72FE: CD B9 07        CALL    $07B9               
7301: CD D2 27        CALL    $27D2               
7304: F1              POP     AF                  
7305: EA AF DB        LD      ($DBAF),A           ; {ram.curBank}
7308: 3E 03           LD      A,$03               
...
7336: F5              PUSH    AF                  
7337: 3E 10           LD      A,$10               
7339: E0 99           LD      ($FF00+$99),A       
733B: 7B              LD      A,E                 
733C: CD 97 21        CALL    $2197               
733F: F1              POP     AF                  
7340: E0 99           LD      ($FF00+$99),A       
...
74F6: F0 98           LD      A,($98)             
74F8: C6 08           ADD     $08                 
74FA: E0 D7           LD      ($FF00+$D7),A       
74FC: F0 99           LD      A,($99)             
74FE: C6 08           ADD     $08                 
7500: E0 D9           LD      ($FF00+$D9),A       
...
756C: F0 D7           LD      A,($D7)             
756E: E0 9B           LD      ($FF00+$9B),A       
7570: F0 D8           LD      A,($D8)             
7572: E0 9A           LD      ($FF00+$9A),A       
7574: C9              RET                         
...
758D: 3E D0           LD      A,$D0               
758F: E0 9A           LD      ($FF00+$9A),A       
7591: AF              XOR     A                   
7592: E0 9B           LD      ($FF00+$9B),A       
7594: 3E 30           LD      A,$30               
7596: E0 A3           LD      ($FF00+$A3),A       
7598: 3E 0B           LD      A,$0B               
759A: E0 F2           LD      ($FF00+$F2),A       
759C: C9              RET                         
759D: 3E 20           LD      A,$20               
...
76A1: 36 10           LD      (HL),$10            
76A3: 3E 03           LD      A,$03               
76A5: EA AF DB        LD      ($DBAF),A           ; {ram.curBank}
76A8: CD D2 27        CALL    $27D2               
76AB: 3E 18           LD      A,$18               
76AD: EA AF DB        LD      ($DBAF),A           ; {ram.curBank}
...
7839: C9              RET                         
783A: E0 D7           LD      ($FF00+$D7),A       
783C: F0 98           LD      A,($98)             
783E: F5              PUSH    AF                  
783F: 21 00 C2        LD      HL,$C200            
7842: 19              ADD     HL,DE               
7843: 7E              LD      A,(HL)              
7844: E0 98           LD      ($FF00+$98),A       
7846: F0 99           LD      A,($99)             
7848: F5              PUSH    AF                  
...
7856: D1              POP     DE                  
7857: F1              POP     AF                  
7858: E0 99           LD      ($FF00+$99),A       
785A: F1              POP     AF                  
785B: E0 98           LD      ($FF00+$98),A       
785D: C9              RET                         
785E: 0D              DEC     C                   
785F: 02              LD      (BC),A              
7860: 08 08 0A        LD      ($0A08),SP          
7863: 06 08           LD      B,$08               
7865: 08 10 FF        LD      ($FF10),SP          ; {hard.SNDREG10}
...
7895: 09              ADD     HL,BC               
7896: 7E              LD      A,(HL)              
7897: E0 D7           LD      ($FF00+$D7),A       
7899: AF              XOR     A                   
789A: 77              LD      (HL),A              
789B: E0 D8           LD      ($FF00+$D8),A       
...
795E: 09              ADD     HL,BC               
795F: 7E              LD      A,(HL)              
7960: E0 D7           LD      ($FF00+$D7),A       
7962: 21 10 C2        LD      HL,$C210            
7965: 09              ADD     HL,BC               
7966: 7E              LD      A,(HL)              
7967: E0 D8           LD      ($FF00+$D8),A       
7969: 3E 0E           LD      A,$0E               
796B: E0 F2           LD      ($FF00+$F2),A       
796D: 3E 01           LD      A,$01               
...
7ADD: 19              ADD     HL,DE               
7ADE: 86              ADD     A,(HL)              
7ADF: E0 DB           LD      ($FF00+$DB),A       
7AE1: CB 37           SWAP    1,E                 
7AE3: E6 0F           AND     $0F                 
7AE5: E0 D8           LD      ($FF00+$D8),A       
7AE7: C1              POP     BC                  
7AE8: C5              PUSH    BC                  
7AE9: 7B              LD      A,E                 
7AEA: FE 03           CP      $03                 
...
7CB1: 09              ADD     HL,BC               
7CB2: 7E              LD      A,(HL)              
7CB3: E0 DB           LD      ($FF00+$DB),A       
7CB5: E6 F0           AND     $F0                 
7CB7: E0 CE           LD      ($FF00+$CE),A       
7CB9: CB 37           SWAP    1,E                 
...
7CC0: 7E              LD      A,(HL)              
7CC1: D6 08           SUB     $08                 
7CC3: E0 DC           LD      ($FF00+$DC),A       
7CC5: E6 F0           AND     $F0                 
7CC7: E0 CD           LD      ($FF00+$CD),A       
7CC9: B1              OR      C                   
7CCA: 4F              LD      C,A                 
7CCB: E0 E9           LD      ($FF00+$E9),A       
7CCD: 06 00           LD      B,$00               
...
7D46: E0 D8           LD      ($FF00+$D8),A       
7D48: A7              AND     A                   
7D49: CA D5 7D        JP      Z,$7DD5             ; {}
7D4C: E0 DA           LD      ($FF00+$DA),A       
7D4E: FE FF           CP      $FF                 
...
7DE5: 7E              LD      A,(HL)              
7DE6: D6 01           SUB     $01                 
7DE8: E0 DB           LD      ($FF00+$DB),A       
7DEA: E6 F0           AND     $F0                 
7DEC: E0 CE           LD      ($FF00+$CE),A       
7DEE: CB 37           SWAP    1,E                 
...
7DF5: 7E              LD      A,(HL)              
7DF6: D6 07           SUB     $07                 
7DF8: E0 DC           LD      ($FF00+$DC),A       
7DFA: E6 F0           AND     $F0                 
7DFC: E0 CD           LD      ($FF00+$CD),A       
7DFE: B1              OR      C                   
7DFF: 4F              LD      C,A                 
7E00: 06 00           LD      B,$00               
...
7E08: C1              POP     BC                  
7E09: 7E              LD      A,(HL)              
7E0A: E0 AF           LD      ($FF00+$AF),A       
7E0C: 5F              LD      E,A                 
7E0D: FA A5 DB        LD      A,($DBA5)           
7E10: 57              LD      D,A                 
7E11: CD E8 29        CALL    $29E8               
7E14: E0 DA           LD      ($FF00+$DA),A       
7E16: C9              RET                         
7E17: E0 D8           LD      ($FF00+$D8),A       
7E19: A7              AND     A                   
...
7E21: 1D              DEC     E                   
7E22: 7B              LD      A,E                 
7E23: E0 D9           LD      ($FF00+$D9),A       
7E25: 7A              LD      A,D                 
7E26: CB 7F           BIT     1,E                 
7E28: 28 02           JR      Z,$7E2C             ; {}
7E2A: 2F              CPL                         
7E2B: 3C              INC     A                   
7E2C: E0 E3           LD      ($FF00+$E3),A       
7E2E: CD AB 7E        CALL    $7EAB               ; {}
7E31: 7B              LD      A,E                 
7E32: E0 DA           LD      ($FF00+$DA),A       
7E34: 7A              LD      A,D                 
7E35: CB 7F           BIT     1,E                 
7E37: 28 02           JR      Z,$7E3B             ; {}
7E39: 2F              CPL                         
7E3A: 3C              INC     A                   
7E3B: E0 E4           LD      ($FF00+$E4),A       
7E3D: 1E 00           LD      E,$00               
...
7E48: F5              PUSH    AF                  
7E49: F0 E3           LD      A,($E3)             
7E4B: E0 E4           LD      ($FF00+$E4),A       
7E4D: F1              POP     AF                  
7E4E: E0 E3           LD      ($FF00+$E3),A       
7E50: AF              XOR     A                   
7E51: E0 E2           LD      ($FF00+$E2),A       
...
7E76: F5              PUSH    AF                  
7E77: F0 D8           LD      A,($D8)             
7E79: E0 D7           LD      ($FF00+$D7),A       
7E7B: F1              POP     AF                  
7E7C: E0 D8           LD      ($FF00+$D8),A       
7E7E: F0 D9           LD      A,($D9)             
7E80: A7              AND     A                   
7E81: F0 D7           LD      A,($D7)             
...
7E90: 2F              CPL                         
7E91: 3C              INC     A                   
7E92: E0 D8           LD      ($FF00+$D8),A       
7E94: C9              RET                         
7E95: AF              XOR     A                   
7E96: E0 D7           LD      ($FF00+$D7),A       
7E98: C9              RET                         
