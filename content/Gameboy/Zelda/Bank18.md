...
>>> binary 4000:roms/zelda.gb[60000:64000]
...
408B: F5              PUSH    AF                  
408C: 3E 10           LD      A,$10               
408E: E0 99           LD      ($FF00+$99),A       
4090: 7B              LD      A,E                 
4091: CD 97 21        CALL    $2197               
4094: F1              POP     AF                  
4095: E0 99           LD      ($FF00+$99),A       
4097: C9              RET                         
...
40F2: C9              RET                         
40F3: 3E 30           LD      A,$30               
40F5: E0 CD           LD      ($FF00+$CD),A       
40F7: 3E 18           LD      A,$18               
40F9: E0 CE           LD      ($FF00+$CE),A       
40FB: C3 B5 44        JP      $44B5               ; {}
40FE: 3E 30           LD      A,$30               
4100: E0 CD           LD      ($FF00+$CD),A       
4102: 3E 68           LD      A,$68               
4104: E0 CE           LD      ($FF00+$CE),A       
4106: C3 B5 44        JP      $44B5               ; {}
4109: 3E 38           LD      A,$38               
410B: E0 CE           LD      ($FF00+$CE),A       
410D: 3E 08           LD      A,$08               
410F: E0 CD           LD      ($FF00+$CD),A       
4111: C3 09 44        JP      $4409               ; {}
4114: 3E 38           LD      A,$38               
4116: E0 CE           LD      ($FF00+$CE),A       
4118: 3E 08           LD      A,$08               
411A: E0 CD           LD      ($FF00+$CD),A       
...
428B: 3E 6C           LD      A,$6C               
428D: E0 9D           LD      ($FF00+$9D),A       
428F: 3E 02           LD      A,$02               
4291: E0 A1           LD      ($FF00+$A1),A       
4293: F0 98           LD      A,($98)             
4295: E0 EE           LD      ($FF00+$EE),A       
4297: F0 99           LD      A,($99)             
4299: D6 0C           SUB     $0C                 
429B: E0 EC           LD      ($FF00+$EC),A       
429D: 11 6C 47        LD      DE,$476C            
42A0: AF              XOR     A                   
42A1: E0 F1           LD      ($FF00+$F1),A       
...
478F: 3E 6C           LD      A,$6C               
4791: E0 9D           LD      ($FF00+$9D),A       
4793: 3E 02           LD      A,$02               
4795: E0 A1           LD      ($FF00+$A1),A       
4797: F0 98           LD      A,($98)             
4799: E0 EE           LD      ($FF00+$EE),A       
479B: F0 99           LD      A,($99)             
479D: D6 0C           SUB     $0C                 
479F: E0 EC           LD      ($FF00+$EC),A       
47A1: 11 6C 47        LD      DE,$476C            
47A4: AF              XOR     A                   
47A5: E0 F1           LD      ($FF00+$F1),A       
...
4854: E0 F1           LD      ($FF00+$F1),A       
4856: F0 EC           LD      A,($EC)             
4858: C6 03           ADD     $03                 
485A: E0 EC           LD      ($FF00+$EC),A       
...
4897: F0 EE           LD      A,($EE)             
4899: D6 18           SUB     $18                 
489B: E0 EE           LD      ($FF00+$EE),A       
489D: F0 EC           LD      A,($EC)             
489F: D6 10           SUB     $10                 
48A1: E0 EC           LD      ($FF00+$EC),A       
...
4903: F0 EE           LD      A,($EE)             
4905: D6 18           SUB     $18                 
4907: E0 EE           LD      ($FF00+$EE),A       
4909: F0 EC           LD      A,($EC)             
490B: D6 10           SUB     $10                 
490D: E0 EC           LD      ($FF00+$EC),A       
...
4A9E: 3E 0E           LD      A,$0E               
4AA0: E0 F2           LD      ($FF00+$F2),A       
4AA2: F0 EE           LD      A,($EE)             
4AA4: E0 D7           LD      ($FF00+$D7),A       
4AA6: F0 EC           LD      A,($EC)             
4AA8: C6 00           ADD     $00                 
4AAA: E0 D8           LD      ($FF00+$D8),A       
4AAC: 3E 01           LD      A,$01               
...
4B86: AF              XOR     A                   
4B87: E0 F1           LD      ($FF00+$F1),A       
4B89: F0 EE           LD      A,($EE)             
4B8B: C6 18           ADD     $18                 
4B8D: E0 EE           LD      ($FF00+$EE),A       
4B8F: F0 EC           LD      A,($EC)             
4B91: C6 08           ADD     $08                 
4B93: E0 EC           LD      ($FF00+$EC),A       
...
4D5F: 3E 0D           LD      A,$0D               
4D61: E0 A5           LD      ($FF00+$A5),A       
4D63: 3E 5D           LD      A,$5D               
4D65: CD 85 21        CALL    $2185               
4D68: C3 8D 3B        JP      $3B8D               
4D6B: 3E 02           LD      A,$02               
4D6D: E0 A1           LD      ($FF00+$A1),A       
4D6F: EA 67 C1        LD      ($C167),A           
4D72: AF              XOR     A                   
4D73: E0 F1           LD      ($FF00+$F1),A       
4D75: F0 EC           LD      A,($EC)             
4D77: D6 0E           SUB     $0E                 
4D79: E0 EC           LD      ($FF00+$EC),A       
4D7B: F0 EE           LD      A,($EE)             
4D7D: D6 04           SUB     $04                 
4D7F: E0 EE           LD      ($FF00+$EE),A       
...
4E84: 36 90           LD      (HL),$90            
4E86: F0 EE           LD      A,($EE)             
4E88: E0 D7           LD      ($FF00+$D7),A       
4E8A: F0 EC           LD      A,($EC)             
4E8C: E0 D8           LD      ($FF00+$D8),A       
4E8E: 3E 02           LD      A,$02               
4E90: CD 53 09        CALL    $0953               
4E93: 3E 06           LD      A,$06               
4E95: E0 F2           LD      ($FF00+$F2),A       
...
4FF1: F5              PUSH    AF                  
4FF2: 3E 20           LD      A,$20               
4FF4: E0 99           LD      ($FF00+$99),A       
4FF6: 7B              LD      A,E                 
4FF7: CD 97 21        CALL    $2197               
4FFA: F1              POP     AF                  
4FFB: E0 99           LD      ($FF00+$99),A       
4FFD: C9              RET                         
4FFE: 00              NOP                         
4FFF: FC                              
5000: 70              LD      (HL),B              
...
5410: 3E 02           LD      A,$02               
5412: E0 BA           LD      ($FF00+$BA),A       
5414: 3E 3A           LD      A,$3A               
5416: E0 9D           LD      ($FF00+$9D),A       
5418: 3E 02           LD      A,$02               
541A: E0 9E           LD      ($FF00+$9E),A       
541C: 3E 01           LD      A,$01               
541E: E0 A1           LD      ($FF00+$A1),A       
5420: CD 3B 09        CALL    $093B               
5423: F0 EE           LD      A,($EE)             
5425: E0 98           LD      ($FF00+$98),A       
5427: F0 EC           LD      A,($EC)             
5429: C6 08           ADD     $08                 
542B: E0 99           LD      ($FF00+$99),A       
542D: FE 50           CP      $50                 
...
5714: 77              LD      (HL),A              
5715: 3E 08           LD      A,$08               
5717: E0 F2           LD      ($FF00+$F2),A       
5719: CD 8D 3B        CALL    $3B8D               
571C: C9              RET                         
571D: 3E 02           LD      A,$02               
571F: E0 A1           LD      ($FF00+$A1),A       
...
572F: 36 08           LD      (HL),$08            
5731: 3E 24           LD      A,$24               
5733: E0 F4           LD      ($FF00+$F4),A       
5735: F0 EE           LD      A,($EE)             
5737: E0 D7           LD      ($FF00+$D7),A       
5739: F0 EC           LD      A,($EC)             
573B: C6 10           ADD     $10                 
573D: E0 D8           LD      ($FF00+$D8),A       
573F: 3E 01           LD      A,$01               
5741: CD 53 09        CALL    $0953               
5744: F0 EE           LD      A,($EE)             
5746: C6 10           ADD     $10                 
5748: E0 D7           LD      ($FF00+$D7),A       
574A: F0 EC           LD      A,($EC)             
574C: C6 10           ADD     $10                 
574E: E0 D8           LD      ($FF00+$D8),A       
5750: 3E 01           LD      A,$01               
...
5A04: F5              PUSH    AF                  
5A05: 3E 28           LD      A,$28               
5A07: E0 99           LD      ($FF00+$99),A       
5A09: 3E 1F           LD      A,$1F               
5A0B: CD 97 21        CALL    $2197               
5A0E: F1              POP     AF                  
5A0F: E0 99           LD      ($FF00+$99),A       
5A11: 3E 0F           LD      A,$0F               
5A13: FE 01           CP      $01                 
...
5A20: 3E 05           LD      A,$05               
5A22: E0 B0           LD      ($FF00+$B0),A       
5A24: AF              XOR     A                   
5A25: EA B0 C3        LD      ($C3B0),A           
5A28: 11 C4 59        LD      DE,$59C4            
5A2B: CD 3B 3C        CALL    $3C3B               
5A2E: 3E 6C           LD      A,$6C               
5A30: E0 9D           LD      ($FF00+$9D),A       
5A32: 3E 02           LD      A,$02               
5A34: E0 A1           LD      ($FF00+$A1),A       
5A36: 3E 03           LD      A,$03               
5A38: E0 9E           LD      ($FF00+$9E),A       
5A3A: F0 98           LD      A,($98)             
...
5B61: 3E 02           LD      A,$02               
5B63: E0 A1           LD      ($FF00+$A1),A       
5B65: 3E 6A           LD      A,$6A               
5B67: E0 9D           LD      ($FF00+$9D),A       
5B69: C9              RET                         
...
5D5F: 3E 07           LD      A,$07               
5D61: E0 F4           LD      ($FF00+$F4),A       
5D63: C9              RET                         
5D64: F0 EC           LD      A,($EC)             
5D66: E0 D8           LD      ($FF00+$D8),A       
5D68: F0 EE           LD      A,($EE)             
5D6A: E0 D7           LD      ($FF00+$D7),A       
5D6C: 3E 0E           LD      A,$0E               
5D6E: E0 F2           LD      ($FF00+$F2),A       
5D70: 3E 0C           LD      A,$0C               
...
5D8E: 3E 01           LD      A,$01               
5D90: E0 A4           LD      ($FF00+$A4),A       
5D92: 3C              INC     A                   
5D93: E0 A1           LD      ($FF00+$A1),A       
...
5FB3: 3E 02           LD      A,$02               
5FB5: E0 A1           LD      ($FF00+$A1),A       
5FB7: EA 67 C1        LD      ($C167),A           
5FBA: 3E 00           LD      A,$00               
5FBC: E0 9E           LD      ($FF00+$9E),A       
5FBE: C5              PUSH    BC                  
...
6038: 3E 02           LD      A,$02               
603A: E0 A1           LD      ($FF00+$A1),A       
603C: C9              RET                         
603D: 3E 02           LD      A,$02               
603F: E0 A1           LD      ($FF00+$A1),A       
6041: F0 EC           LD      A,($EC)             
6043: FE 3E           CP      $3E                 
...
60A7: CB E6           SET     1,E                 
60A9: 7E              LD      A,(HL)              
60AA: E0 F8           LD      ($FF00+$F8),A       
60AC: C3 76 7E        JP      $7E76               ; {}
60AF: CD 20 7E        CALL    $7E20               ; {}
60B2: 7B              LD      A,E                 
60B3: EE 01           XOR     $01                 
60B5: E0 9E           LD      ($FF00+$9E),A       
60B7: C5              PUSH    BC                  
...
61B6: E0 B0           LD      ($FF00+$B0),A       
61B8: E0 BD           LD      ($FF00+$BD),A       
...
62EA: 3E 20           LD      A,$20               
62EC: E0 CD           LD      ($FF00+$CD),A       
62EE: C6 10           ADD     $10                 
62F0: E0 D8           LD      ($FF00+$D8),A       
62F2: 3E 80           LD      A,$80               
62F4: E0 CE           LD      ($FF00+$CE),A       
62F6: C6 08           ADD     $08                 
62F8: E0 D7           LD      ($FF00+$D7),A       
62FA: 3E 02           LD      A,$02               
...
6330: 36 00           LD      (HL),$00            
6332: 3E 01           LD      A,$01               
6334: E0 AC           LD      ($FF00+$AC),A       
6336: F0 CD           LD      A,($CD)             
6338: E6 F0           AND     $F0                 
633A: C6 10           ADD     $10                 
633C: E0 AE           LD      ($FF00+$AE),A       
633E: F0 CE           LD      A,($CE)             
6340: E6 F0           AND     $F0                 
6342: C6 08           ADD     $08                 
6344: E0 AD           LD      ($FF00+$AD),A       
6346: F0 F6           LD      A,($F6)             
6348: 5F              LD      E,A                 
6349: 16 00           LD      D,$00               
...
6473: 7E              LD      A,(HL)              
6474: D6 01           SUB     $01                 
6476: E0 DB           LD      ($FF00+$DB),A       
6478: E6 F0           AND     $F0                 
647A: E0 CE           LD      ($FF00+$CE),A       
647C: CB 37           SWAP    1,E                 
...
6483: 7E              LD      A,(HL)              
6484: D6 07           SUB     $07                 
6486: E0 DC           LD      ($FF00+$DC),A       
6488: E6 F0           AND     $F0                 
648A: E0 CD           LD      ($FF00+$CD),A       
648C: B1              OR      C                   
648D: 4F              LD      C,A                 
648E: 06 00           LD      B,$00               
...
6496: C1              POP     BC                  
6497: 7E              LD      A,(HL)              
6498: E0 AF           LD      ($FF00+$AF),A       
649A: 5F              LD      E,A                 
649B: FA A5 DB        LD      A,($DBA5)           
649E: 57              LD      D,A                 
649F: CD DB 29        CALL    $29DB               
64A2: E0 DA           LD      ($FF00+$DA),A       
64A4: C9              RET                         
64A5: EC                              
64A6: 14              INC     D                   
...
64DA: 3E 02           LD      A,$02               
64DC: E0 A1           LD      ($FF00+$A1),A       
64DE: 3E 6A           LD      A,$6A               
64E0: E0 9D           LD      ($FF00+$9D),A       
...
6611: 00              NOP                         
6612: FC                              
6613: F8 F0           LD      HL,SP+$F0           
6615: F8 E0           LD      HL,SP+$E0           
6617: 90              SUB     B                   
6618: A0              AND     B                   
6619: 00              NOP                         
661A: 00              NOP                         
...
6726: FD                              
6727: F8 6E           LD      HL,SP+$6E           
6729: 20 FD           JR      NZ,$6728            ; {}
672B: 00              NOP                         
672C: 6C              LD      L,H                 
672D: 20 FF           JR      NZ,$672E            ; {}
672F: F8 6C           LD      HL,SP+$6C           
6731: 00              NOP                         
6732: FF              RST     0X38                
6733: 00              NOP                         
6734: 6E              LD      L,(HL)              
...
673E: FD                              
673F: F8 6E           LD      HL,SP+$6E           
6741: 20 FD           JR      NZ,$6740            ; {}
6743: 00              NOP                         
6744: 6C              LD      L,H                 
6745: 20 00           JR      NZ,$6747            ; {}
6747: F8 6E           LD      HL,SP+$6E           
...
6761: 00              NOP                         
6762: FD                              
6763: F8 6E           LD      HL,SP+$6E           
6765: 00              NOP                         
6766: 00              NOP                         
6767: F8 6E           LD      HL,SP+$6E           
...
679E: FD                              
679F: F8 6E           LD      HL,SP+$6E           
67A1: 20 FD           JR      NZ,$67A0            ; {}
67A3: 00              NOP                         
67A4: 6C              LD      L,H                 
67A5: 20 00           JR      NZ,$67A7            ; {}
67A7: F8 6C           LD      HL,SP+$6C           
67A9: 00              NOP                         
67AA: 00              NOP                         
67AB: 00              NOP                         
67AC: 6E              LD      L,(HL)              
...
67EC: FF              RST     0X38                
67ED: 00              NOP                         
67EE: F8 10           LD      HL,SP+$10           
67F0: 6C              LD      L,H                 
67F1: 00              NOP                         
67F2: F8 18           LD      HL,SP+$18           
67F4: 6E              LD      L,(HL)              
67F5: 00              NOP                         
67F6: 00              NOP                         
67F7: 00              NOP                         
...
69DB: F0 EE           LD      A,($EE)             
69DD: E0 D7           LD      ($FF00+$D7),A       
69DF: F0 EC           LD      A,($EC)             
69E1: E0 D8           LD      ($FF00+$D8),A       
69E3: 3E 02           LD      A,$02               
69E5: CD 53 09        CALL    $0953               
69E8: 3E 0C           LD      A,$0C               
69EA: E0 E8           LD      ($FF00+$E8),A       
69EC: CD FC 69        CALL    $69FC               ; {}
69EF: 3E F4           LD      A,$F4               
69F1: E0 E8           LD      ($FF00+$E8),A       
...
6B74: F5              PUSH    AF                  
6B75: D6 14           SUB     $14                 
6B77: E0 99           LD      ($FF00+$99),A       
6B79: 3E 20           LD      A,$20               
6B7B: CD 25 3C        CALL    $3C25               
6B7E: F1              POP     AF                  
6B7F: E0 99           LD      ($FF00+$99),A       
...
6CB4: 78              LD      A,B                 
6CB5: F8 A8           LD      HL,SP+$A8           
6CB7: F8 A8           LD      HL,SP+$A8           
...
6D65: 3E 0D           LD      A,$0D               
6D67: E0 F4           LD      ($FF00+$F4),A       
6D69: F0 99           LD      A,($99)             
6D6B: F5              PUSH    AF                  
6D6C: D6 08           SUB     $08                 
6D6E: E0 99           LD      ($FF00+$99),A       
6D70: 3E 1F           LD      A,$1F               
6D72: CD 30 3C        CALL    $3C30               
6D75: F1              POP     AF                  
6D76: E0 99           LD      ($FF00+$99),A       
6D78: CD 1B 7B        CALL    $7B1B               ; {}
6D7B: E6 0F           AND     $0F                 
6D7D: E0 E8           LD      ($FF00+$E8),A       
6D7F: 1E 00           LD      E,$00               
...
6E61: F5              PUSH    AF                  
6E62: 7E              LD      A,(HL)              
6E63: E0 99           LD      ($FF00+$99),A       
6E65: 21 00 C2        LD      HL,$C200            
6E68: 19              ADD     HL,DE               
6E69: 7E              LD      A,(HL)              
6E6A: E0 98           LD      ($FF00+$98),A       
6E6C: D5              PUSH    DE                  
6E6D: 3E 20           LD      A,$20               
...
6E8C: 77              LD      (HL),A              
6E8D: F1              POP     AF                  
6E8E: E0 98           LD      ($FF00+$98),A       
6E90: F1              POP     AF                  
6E91: E0 99           LD      ($FF00+$99),A       
...
6F12: F0 EE           LD      A,($EE)             
6F14: E0 D7           LD      ($FF00+$D7),A       
6F16: F0 EC           LD      A,($EC)             
6F18: E0 D8           LD      ($FF00+$D8),A       
6F1A: 3E 02           LD      A,$02               
...
71FA: 19              ADD     HL,DE               
71FB: 7E              LD      A,(HL)              
71FC: E0 98           LD      ($FF00+$98),A       
71FE: 21 AF 71        LD      HL,$71AF            
7201: 19              ADD     HL,DE               
7202: 7E              LD      A,(HL)              
7203: E0 99           LD      ($FF00+$99),A       
7205: F0 E7           LD      A,($E7)             
7207: A9              XOR     C                   
7208: E6 03           AND     $03                 
...
7230: F1              POP     AF                  
7231: E0 99           LD      ($FF00+$99),A       
7233: F1              POP     AF                  
7234: E0 98           LD      ($FF00+$98),A       
...
7380: E0 B0           LD      ($FF00+$B0),A       
7382: E0 BD           LD      ($FF00+$BD),A       
7384: E0 BF           LD      ($FF00+$BF),A       
...
73B4: C9              RET                         
73B5: F8 08           LD      HL,SP+$08           
73B7: 10 00           ;;STOP    $00                 
73B9: 00              NOP                         
73BA: 08 F0 00        LD      ($00F0),SP          
73BD: F0 00           LD      A,($00)             
73BF: F0 F0           LD      A,($F0)             
73C1: F8 08           LD      HL,SP+$08           
...
7525: E0 98           LD      ($FF00+$98),A       
7527: FA 02 D2        LD      A,($D202)           
752A: E0 99           LD      ($FF00+$99),A       
752C: 3E 08           LD      A,$08               
...
7553: 36 20           LD      (HL),$20            
7555: F1              POP     AF                  
7556: E0 99           LD      ($FF00+$99),A       
7558: F1              POP     AF                  
7559: E0 98           LD      ($FF00+$98),A       
...
7665: 09              ADD     HL,BC               
7666: 7E              LD      A,(HL)              
7667: E0 E8           LD      ($FF00+$E8),A       
7669: F0 EE           LD      A,($EE)             
766B: 96              SUB     (HL)                
766C: CB 2F           SRA     1,E                 
766E: E0 E1           LD      ($FF00+$E1),A       
7670: CB 2F           SRA     1,E                 
7672: E0 E2           LD      ($FF00+$E2),A       
7674: CB 2F           SRA     1,E                 
7676: E0 E3           LD      ($FF00+$E3),A       
7678: CB 2F           SRA     1,E                 
767A: E0 E4           LD      ($FF00+$E4),A       
767C: CB 2F           SRA     1,E                 
767E: E0 E5           LD      ($FF00+$E5),A       
7680: CB 2F           SRA     1,E                 
7682: E0 E6           LD      ($FF00+$E6),A       
7684: 21 D0 C2        LD      HL,$C2D0            
7687: 09              ADD     HL,BC               
7688: 7E              LD      A,(HL)              
7689: E0 E9           LD      ($FF00+$E9),A       
768B: F0 EC           LD      A,($EC)             
768D: D6 20           SUB     $20                 
768F: BE              CP      (HL)                
7690: 38 65           JR      C,$76F7             ; {}
7692: E0 EC           LD      ($FF00+$EC),A       
7694: AF              XOR     A                   
7695: E0 F1           LD      ($FF00+$F1),A       
7697: 21 E1 FF        LD      HL,$FFE1            
769A: F0 E8           LD      A,($E8)             
769C: 86              ADD     A,(HL)              
769D: E0 EE           LD      ($FF00+$EE),A       
769F: 23              INC     HL                  
76A0: E5              PUSH    HL                  
...
76CD: 1E E0           LD      E,$E0               
76CF: 7B              LD      A,E                 
76D0: E0 9A           LD      ($FF00+$9A),A       
76D2: AF              XOR     A                   
76D3: E0 9B           LD      ($FF00+$9B),A       
76D5: 3E 18           LD      A,$18               
...
76E4: 3E 03           LD      A,$03               
76E6: E0 F3           LD      ($FF00+$F3),A       
76E8: E1              POP     HL                  
76E9: F0 E9           LD      A,($E9)             
76EB: 5F              LD      E,A                 
76EC: F0 EC           LD      A,($EC)             
76EE: D6 10           SUB     $10                 
76F0: E0 EC           LD      ($FF00+$EC),A       
76F2: 93              SUB     E                   
76F3: E6 80           AND     $80                 
...
7986: F0 EE           LD      A,($EE)             
7988: E0 D7           LD      ($FF00+$D7),A       
798A: F0 EC           LD      A,($EC)             
798C: E0 D8           LD      ($FF00+$D8),A       
798E: 3E 02           LD      A,$02               
7990: CD 53 09        CALL    $0953               
7993: 3E 2F           LD      A,$2F               
7995: E0 F2           LD      ($FF00+$F2),A       
7997: 18 52           JR      $79EB               ; {}
...
7A0A: 09              ADD     HL,BC               
7A0B: 7E              LD      A,(HL)              
7A0C: E0 CE           LD      ($FF00+$CE),A       
7A0E: 21 10 C2        LD      HL,$C210            
7A11: 09              ADD     HL,BC               
7A12: 7E              LD      A,(HL)              
7A13: E0 CD           LD      ($FF00+$CD),A       
...
7B9F: 2F              CPL                         
7BA0: 3C              INC     A                   
7BA1: E0 9B           LD      ($FF00+$9B),A       
7BA3: F0 D8           LD      A,($D8)             
7BA5: 2F              CPL                         
7BA6: 3C              INC     A                   
7BA7: E0 9A           LD      ($FF00+$9A),A       
7BA9: C5              PUSH    BC                  
...
7C29: 70              LD      (HL),B              
7C2A: 3E 07           LD      A,$07               
7C2C: E0 F2           LD      ($FF00+$F2),A       
7C2E: F0 EE           LD      A,($EE)             
7C30: E0 D7           LD      ($FF00+$D7),A       
7C32: F0 EC           LD      A,($EC)             
7C34: E0 D8           LD      ($FF00+$D8),A       
7C36: 3E 05           LD      A,$05               
...
7C4C: CB 2F           SRA     1,E                 
7C4E: CB 2F           SRA     1,E                 
7C50: E0 D7           LD      ($FF00+$D7),A       
7C52: E0 D9           LD      ($FF00+$D9),A       
7C54: F0 EF           LD      A,($EF)             
7C56: 21 99 FF        LD      HL,$FF99            
7C59: 96              SUB     (HL)                
7C5A: CB 2F           SRA     1,E                 
7C5C: CB 2F           SRA     1,E                 
7C5E: E0 D8           LD      ($FF00+$D8),A       
7C60: E0 DA           LD      ($FF00+$DA),A       
...
7C99: 86              ADD     A,(HL)              
7C9A: E0 D7           LD      ($FF00+$D7),A       
7C9C: F0 D8           LD      A,($D8)             
7C9E: 21 DA FF        LD      HL,$FFDA            
7CA1: 86              ADD     A,(HL)              
7CA2: E0 D8           LD      ($FF00+$D8),A       
7CA4: F0 DB           LD      A,($DB)             
7CA6: 3D              DEC     A                   
...
7EE4: F0 EE           LD      A,($EE)             
7EE6: E0 D7           LD      ($FF00+$D7),A       
7EE8: F0 EC           LD      A,($EC)             
7EEA: E0 D8           LD      ($FF00+$D8),A       
7EEC: 3E 02           LD      A,$02               
7EEE: CD 53 09        CALL    $0953               
7EF1: 3E 13           LD      A,$13               
7EF3: E0 F4           LD      ($FF00+$F4),A       
7EF5: C9              RET                         
7EF6: 3E 36           LD      A,$36               
