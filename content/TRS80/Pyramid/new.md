...
45F6: CD 2B 00        CALL    $002B               ; Keyboard scanning
45F9: A7              AND     A                   
...
46D3: 4F 57 20 54 48 41 54 20 57 4F ; OW_TH
...
; The stack pointer is initialized to 47BF. The Z80 SP decrements-before-store.
; Thus stack is 8 bytes:
47B7: 00 01 F9 47 09 7E C1 E1
...
4A8B: 0A 0B     ; D
4A8D: 07 07     ;    SubScriptAbortIfPass
...
4AAD: 09 0A     ; U
4AAF: 07 06     ;    SubScriptAbortIfPass
...
4AB8: 02 0A     ; E
4ABA: 07 06     ;    SubScriptAbortIfPass
...
4AD5: 10 0C     ; JUMP
4AD7: 07 06     ;    SubScriptAbortIfPass
...
4AE2: 04 0A     ; W
4AE4: 07 05     ;    SubScriptAbortIfPass
...
4AF7: 07 0C     ;    SubScriptAbortIfPass
...
4B15: 03 0A     ; S
4B17: 07 06     ;    SubScriptAbortIfPass
...
4B20: 01 0A     ; N
4B22: 07 06     ;    SubScriptAbortIfPass
...
4B2B: 04 0A     ; W
4B2D: 07 06     ;    SubScriptAbortIfPass
...
;
4B51: 10 0C     ; JUMP
4B53: 07 06     ;    SubScriptAbortIfPass
...
4B5E: 02 0A     ; E
4B60: 07 05     ;    SubScriptAbortIfPass
...
4B7A: 07 0C     ;    SubScriptAbortIfPass
...
4D86: 27 0B     ; FILL
4D88: 07 06     ;    SubScriptAbortIfPass
...
;
4DBE: 01 07     ; N
4DC0: 07 03     ;    SubScriptAbortIfPass
4DC2: 0A F0     ;        AssertRandomIsGreaterThan(240)
4DC4: 01 3B     ;    MoveToRoom(room_59)
4DC6: 02 07     ; E
4DC8: 07 03     ;    SubScriptAbortIfPass
4DCA: 0A F0     ;        AssertRandomIsGreaterThan(240)
4DCC: 01 3B     ;    MoveToRoom(room_59)
4DCE: 03 07     ; S
4DD0: 07 03     ;    SubScriptAbortIfPass
4DD2: 0A F0     ;        AssertRandomIsGreaterThan(240)
4DD4: 01 3B     ;    MoveToRoom(room_59)
4DD6: 05 07     ; NE
4DD8: 07 03     ;    SubScriptAbortIfPass
4DDA: 0A F0     ;        AssertRandomIsGreaterThan(240)
4DDC: 01 3B     ;    MoveToRoom(room_59)
4DDE: 06 07     ; SE
4DE0: 07 03     ;    SubScriptAbortIfPass
4DE2: 0A F0     ;        AssertRandomIsGreaterThan(240)
4DE4: 01 3B     ;    MoveToRoom(room_59)
4DE6: 07 07     ; SW
4DE8: 07 03     ;    SubScriptAbortIfPass
4DEA: 0A F0     ;        AssertRandomIsGreaterThan(240)
4DEC: 01 3B     ;    MoveToRoom(room_59)
4DEE: 08 07     ; NW
4DF0: 07 03     ;    SubScriptAbortIfPass
4DF2: 0A F0     ;        AssertRandomIsGreaterThan(240)
4DF4: 01 3B     ;    MoveToRoom(room_59)
4DF6: 09 07     ; U
4DF8: 07 03     ;    SubScriptAbortIfPass
4DFA: 0A F0     ;        AssertRandomIsGreaterThan(240)
...
;
4E06: 03 11     ; S
4E08: 07 06     ;    SubScriptAbortIfPass
...
4E0F: 07 06     ;    SubScriptAbortIfPass
...
4E44: 09 07     ; U
4E46: 07 03     ;    SubScriptAbortIfPass
4E48: 0A CC     ;        AssertRandomIsGreaterThan(204)
4E4A: 01 48     ;    MoveToRoom(room_72)
4E4C: 01 07     ; N
4E4E: 07 03     ;    SubScriptAbortIfPass
4E50: 0A CC     ;        AssertRandomIsGreaterThan(204)
4E52: 01 49     ;    MoveToRoom(room_73)
4E54: 03 07     ; S
4E56: 07 03     ;    SubScriptAbortIfPass
4E58: 0A CC     ;        AssertRandomIsGreaterThan(204)
4E5A: 01 42     ;    MoveToRoom(room_66)
4E5C: 0A 07     ; D
4E5E: 07 03     ;    SubScriptAbortIfPass
4E60: 0A CC     ;        AssertRandomIsGreaterThan(204)
...
;
4E77: 04 09     ; W
4E79: 07 04     ;    SubScriptAbortIfPass
...
;
4E86: 02 09     ; E
4E88: 07 04     ;    SubScriptAbortIfPass
...
;                                 YOU'D_BEST_TAKE_INVENTORY_AND_DROP_SOMETHING.[CR]")
4E90: 0C 09     ; OUT
4E92: 07 04     ;    SubScriptAbortIfPass
...
4EC6: 11 16     ; CLIMB
4EC8: 07 08     ;    SubScriptAbortIfPass
...
4ED1: 07 06     ;    SubScriptAbortIfPass
...
4EE4: 07 0E     ;    SubScriptAbortIfPass
...
4EF3: 07 0E     ;    SubScriptAbortIfPass
...
5081:   C0 47   ; 30 obj_STREAM_56        Stream in room 56
...
509F: 8A 51   ;   1     1    d   MoveToRoom
50A1: C8 52   ;   2     1    c   AssertObjectIsInPack
50A3: D7 52   ;   3     1    c   AssertObjectIsInCurrentRoomOrPack
50A5: 5E 53   ;   4     2    b   Print
50A7: 49 54   ;   5     0        PrintScoreAndStop
50A9: 00 00   ;   6     -
50AB: C2 43   ;   7     1    *   SubScriptAbortIfPass
50AD: C7 54   ;   8     0        PrintScore
50AF: EF 55   ;   9     0        PrintScoreAndStop
50B1: 18 53   ;  10     1        AssertRandomIsGreaterThan
50B3: 6B 53   ;  11     1    c   DropObjectX ?? Command B -- Never used? seems same as MoveObjectToRoom
50B5: 32 53   ;  12     1    d   MoveToRoomIfItWasLastRoom
...
50BF: E1 53   ;  17     1    c   AssertObjectMatchesUserInput
50C1: EF 53   ;  18     1    c   GetObjectFromRoom
50C3: 00 00   ;  19     -
50C5: 2B 54   ;  20     0        PrintOK
50C7: 34 54   ;  21     2    f   MoveObjectToRoom
50C9: 43 53   ;  22     0        GetUserInputObject
50CB: 24 54   ;  23     0        DropUserInputObject
50CD: A5 52   ;  24     1    c   MoveObjectToCurrentRoom
50CF: B3 52   ;  25     2    e   MoveObjectIntoContainer
50D1: EA 52   ;  26     1    c   AssertObjectIsInCurrentRoom
...
533E: 2B              DEC     HL                  
533F: E5              PUSH    HL                  
5340: C3 8A 51        JP      $518A               ; {code.MoveToRoom}
...
5A03: 17 18     ; ON
5A05: 07 0C     ;    SubScriptAbortIfPass
...
5A12: 07 06     ;    SubScriptAbortIfPass
...
5A1C: 18 18     ; OFF
5A1E: 07 0C     ;    SubScriptAbortIfPass
...
5A2B: 07 06     ;    SubScriptAbortIfPass
...
5A4B: 28 47     ; TAKE
5A4D: 07 06     ;    SubScriptAbortIfPass
...
;                                     FREE.[CR]")
5A54: 07 17     ;    SubScriptAbortIfPass
5A56: 11 13     ;        AssertObjectMatchesUserInput(obj_BIRD)
5A58: 07 06     ;        SubScriptAbortIfPass
...
5A5F: 07 09     ;        SubScriptAbortIfPass
...
5A6C: 07 0A     ;    SubScriptAbortIfPass
...
5A77: 07 0D     ;    SubScriptAbortIfPass
5A79: 11 1E     ;        AssertObjectMatchesUserInput(obj_STREAM_56)
5A7B: 07 06     ;        SubScriptAbortIfPass
...
5A85: 07 0C     ;    SubScriptAbortIfPass
...
5AAB: 26 0E     ; THROW
5AAD: 07 0B     ;    SubScriptAbortIfPass
...
5ABA: 29 36     ; OPEN
5ABC: 07 1C     ;    SubScriptAbortIfPass
5ABE: 11 17     ;        AssertObjectMatchesUserInput(obj_SARCOPH_full)
5AC0: 07 06     ;        SubScriptAbortIfPass
...
5AC7: 07 0E     ;        SubScriptAbortIfPass
...
5AD9: 07 14     ;    SubScriptAbortIfPass
5ADB: 11 18     ;        AssertObjectMatchesUserInput(obj_SARCOPH_empty)
5ADD: 07 06     ;        SubScriptAbortIfPass
...
5AE4: 07 06     ;        SubScriptAbortIfPass
...
5AF6: 24 0E     ; POUR
5AF8: 07 09     ;    SubScriptAbortIfPass
...
5B05: 25 12     ; RUB
5B07: 07 06     ;    SubScriptAbortIfPass
...
5B0E: 07 06     ;    SubScriptAbortIfPass
...
5B18: 27 12     ; FILL
5B1A: 07 06     ;    SubScriptAbortIfPass
...
5B21: 07 06     ;    SubScriptAbortIfPass
...
5B2B: 2C 2D     ; ATTACK
5B2D: 07 09     ;    SubScriptAbortIfPass
...
5B37: 07 09     ;    SubScriptAbortIfPass
...
5B41: 07 06     ;    SubScriptAbortIfPass
...
5B48: 07 06     ;    SubScriptAbortIfPass
...
5B4F: 07 06     ;    SubScriptAbortIfPass
...
5B5E: 2E 23     ; EAT
5B60: 07 09     ;    SubScriptAbortIfPass
...
5B82: 2F 15     ; DRINK
5B84: 07 09     ;    SubScriptAbortIfPass
...
5B8E: 07 06     ;    SubScriptAbortIfPass
...
5B98: 2D 38     ; FEED
5B9A: 07 06     ;    SubScriptAbortIfPass
...
5BA1: 07 06     ;    SubScriptAbortIfPass
...
5BA8: 07 10     ;    SubScriptAbortIfPass
5BAA: 11 0B     ;        AssertObjectMatchesUserInput(obj_SERPENT)
5BAC: 07 09     ;        SubScriptAbortIfPass
...
5BB9: 07 06     ;    SubScriptAbortIfPass
...
5BC0: 07 06     ;    SubScriptAbortIfPass
...
5BC7: 07 06     ;    SubScriptAbortIfPass
