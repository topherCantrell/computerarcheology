...
5203: 98 1D 00                           ; ----- Room RM_5_DESERT1, Length: 0x001D, Data: 0x00
;
...
5212:                30 97               ;           COM_30_set_current_room(room=RM_6_DESERT_CANYON)
5214:                2F 06               ;           COM_2F_load_section_from_disk(section=6)
5216:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5217:          02                        ;       ELSE goto=0x521A
5218:             00 BB                  ;         COM_00_move_and_look(room=RM_5_DESERT7)
521A:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
521B:          02                        ;       ELSE goto=0x521E
521C:             00 99                  ;         COM_00_move_and_look(room=RM_5_DESERT_CANYON)
521E:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
521F:          02                        ;       ELSE goto=0x5222
5220:             00 BA                  ;         COM_00_move_and_look(room=RM_5_DESERT6)

5222: 99 1A 00                           ; ----- Room RM_5_DESERT_CANYON, Length: 0x001A, Data: 0x00
;
...
5235:             00 9A                  ;         COM_00_move_and_look(room=RM_5_DESERT_CANYON)
...
523C:             00 98                  ;         COM_00_move_and_look(room=RM_5_DESERT1)

523E: 9A 1A 00                           ; ----- Room RM_5_DESERT_CANYON, Length: 0x001A, Data: 0x00
;
...
524E:             00 99                  ;         COM_00_move_and_look(room=RM_5_DESERT_CANYON)
...
5258:             00 BB                  ;         COM_00_move_and_look(room=RM_5_DESERT7)

525A: 9B 62 00                           ; ----- Room RM_5_NARROW_PATH, Length: 0x0062, Data: 0x00
;
...
52BC:             00 BC                  ;         COM_00_move_and_look(room=RM_5_DESERT8)

52BE: 9C 68 00                           ; ----- Room RM_5_CANYON_FLOOR, Length: 0x0068, Data: 0x00
;
...
5328: 9D 80 B3 00                        ; ----- Room RM_5_UFO_CRATER, Length: 0x00B3, Data: 0x00
;
...
5392:                   30 80            ;             COM_30_set_current_room(room=RM_7_??80??)
...
53CD:                   30 80            ;             COM_30_set_current_room(room=RM_7_??80??)
...
53DE: 9E 59 00                           ; ----- Room RM_5_STRANGE_FOOTPRINTS1, Length: 0x0059, Data: 0x00
;
...
542C:             00 BC                  ;         COM_00_move_and_look(room=RM_5_DESERT8)
542E:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
542F:          02                        ;       ELSE goto=0x5432
5430:             00 9F                  ;         COM_00_move_and_look(room=RM_5_DESERT_CANYON)
...
5437:             00 BD                  ;         COM_00_move_and_look(room=RM_5_FOOTPRINTS_LEAD)

5439: 9F 1A 00                           ; ----- Room RM_5_DESERT_CANYON, Length: 0x001A, Data: 0x00
;
...
5453:             00 BE                  ;         COM_00_move_and_look(room=RM_5_STRANGE_FOOTPRINTS3)

5455: A0 44 00                           ; ----- Room RM_5_ERRATIC_FOOTPRINTS, Length: 0x0044, Data: 0x00
;
...
548F:             00 BE                  ;         COM_00_move_and_look(room=RM_5_STRANGE_FOOTPRINTS3)
...
5499:             00 BF                  ;         COM_00_move_and_look(room=RM_5_WEARY_FOOTPRINTS)

549B: A1 3F 00                           ; ----- Room RM_5_WEAVING_FOOTPRINTS, Length: 0x003F, Data: 0x00
;
...
54CF:             00 BF                  ;         COM_00_move_and_look(room=RM_5_WEARY_FOOTPRINTS)
54D1:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
54D2:          02                        ;       ELSE goto=0x54D5
54D3:             00 A3                  ;         COM_00_move_and_look(room=RM_5_DESERT2)
...
54DC: A2 40 00                           ; ----- Room RM_5_STRANGE_FOOTPRINTS2, Length: 0x0040, Data: 0x00
;
...
5510:             00 C0                  ;         COM_00_move_and_look(room=RM_5_STAGGERING_FOOTPRINTS)
5512:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5513:          02                        ;       ELSE goto=0x5516
5514:             00 A4                  ;         COM_00_move_and_look(room=RM_5_DESERT3)
...
551C:             00 A3                  ;         COM_00_move_and_look(room=RM_5_DESERT2)

551E: A3 19 00                           ; ----- Room RM_5_DESERT2, Length: 0x0019, Data: 0x00
;
...
552B:             00 C1                  ;         COM_00_move_and_look(room=RM_5_CRAWL_MARKS)
552D:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
552E:          02                        ;       ELSE goto=0x5531
552F:             00 C3                  ;         COM_00_move_and_look(room=RM_5_DESERT10)
...
5537:             00 A4                  ;         COM_00_move_and_look(room=RM_5_DESERT3)

5539: A4 19 00                           ; ----- Room RM_5_DESERT3, Length: 0x0019, Data: 0x00
;
...
5546:             00 C2                  ;         COM_00_move_and_look(room=RM_5_DESERT9)
5548:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5549:          02                        ;       ELSE goto=0x554C
554A:             00 C4                  ;         COM_00_move_and_look(room=RM_5_DESERT11)
554C:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
554D:          02                        ;       ELSE goto=0x5550
554E:             00 A3                  ;         COM_00_move_and_look(room=RM_5_DESERT2)
5550:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5551:          02                        ;       ELSE goto=0x5554
5552:             00 A5                  ;         COM_00_move_and_look(room=RM_5_DESERT4)

5554: A5 19 00                           ; ----- Room RM_5_DESERT4, Length: 0x0019, Data: 0x00
;
...
5561:             00 C3                  ;         COM_00_move_and_look(room=RM_5_DESERT10)
5563:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5564:          02                        ;       ELSE goto=0x5567
5565:             00 C2                  ;         COM_00_move_and_look(room=RM_5_DESERT9)
5567:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
5568:          02                        ;       ELSE goto=0x556B
5569:             00 A4                  ;         COM_00_move_and_look(room=RM_5_DESERT3)
556B:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
556C:          02                        ;       ELSE goto=0x556F
556D:             00 A6                  ;         COM_00_move_and_look(room=RM_5_DESERT5)

556F: A6 1D 00                           ; ----- Room RM_5_DESERT5, Length: 0x001D, Data: 0x00
;
...
559D:                30 B9               ;           COM_30_set_current_room(room=RM_6_DESERT_LAKE)
559F:                2F 06               ;           COM_2F_load_section_from_disk(section=6)
55A1:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
55A2:          02                        ;       ELSE goto=0x55A5
55A3:             00 D5                  ;         COM_00_move_and_look(room=RM_5_DESERT13)
55A5:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
55A6:          02                        ;       ELSE goto=0x55A9
55A7:             00 98                  ;         COM_00_move_and_look(room=RM_5_DESERT1)
55A9:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
55AA:          02                        ;       ELSE goto=0x55AD
55AB:             00 D3                  ;         COM_00_move_and_look(room=RM_5_DESERT12)

55AD: BB 19 00                           ; ----- Room RM_5_DESERT7, Length: 0x0019, Data: 0x00
;
...
55BA:             00 98                  ;         COM_00_move_and_look(room=RM_5_DESERT1)
55BC:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
55BD:          02                        ;       ELSE goto=0x55C0
55BE:             00 BC                  ;         COM_00_move_and_look(room=RM_5_DESERT8)
55C0:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
55C1:          02                        ;       ELSE goto=0x55C4
55C2:             00 9A                  ;         COM_00_move_and_look(room=RM_5_DESERT_CANYON)
55C4:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
55C5:          02                        ;       ELSE goto=0x55C8
55C6:             00 D5                  ;         COM_00_move_and_look(room=RM_5_DESERT13)

55C8: BC 19 00                           ; ----- Room RM_5_DESERT8, Length: 0x0019, Data: 0x00
;
...
55D5:             00 BB                  ;         COM_00_move_and_look(room=RM_5_DESERT7)
...
55E3: BD 35 00                           ; ----- Room RM_5_FOOTPRINTS_LEAD, Length: 0x0035, Data: 0x00
;
...
5610:             00 BE                  ;         COM_00_move_and_look(room=RM_5_STRANGE_FOOTPRINTS3)
...
561A: BE 3F 00                           ; ----- Room RM_5_STRANGE_FOOTPRINTS3, Length: 0x003F, Data: 0x00
;
...
564D:             00 BD                  ;         COM_00_move_and_look(room=RM_5_FOOTPRINTS_LEAD)
...
5655:             00 9F                  ;         COM_00_move_and_look(room=RM_5_DESERT_CANYON)
5657:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5658:          02                        ;       ELSE goto=0x565B
5659:             00 D9                  ;         COM_00_move_and_look(room=RM_5_DESERT16)

565B: BF 3D 00                           ; ----- Room RM_5_WEARY_FOOTPRINTS, Length: 0x003D, Data: 0x00
;
...
5698:             00 C0                  ;         COM_00_move_and_look(room=RM_5_STAGGERING_FOOTPRINTS)

569A: C0 41 00                           ; ----- Room RM_5_STAGGERING_FOOTPRINTS, Length: 0x0041, Data: 0x00
;
...
56D7:             00 BF                  ;         COM_00_move_and_look(room=RM_5_WEARY_FOOTPRINTS)
56D9:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
56DA:          02                        ;       ELSE goto=0x56DD
56DB:             00 C1                  ;         COM_00_move_and_look(room=RM_5_CRAWL_MARKS)

56DD: C1 47 00                           ; ----- Room RM_5_CRAWL_MARKS, Length: 0x0047, Data: 0x00
;
...
571C:             00 A3                  ;         COM_00_move_and_look(room=RM_5_DESERT2)
571E:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
571F:          02                        ;       ELSE goto=0x5722
5720:             00 C0                  ;         COM_00_move_and_look(room=RM_5_STAGGERING_FOOTPRINTS)
5722:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5723:          02                        ;       ELSE goto=0x5726
5724:             00 C2                  ;         COM_00_move_and_look(room=RM_5_DESERT9)

5726: C2 19 00                           ; ----- Room RM_5_DESERT9, Length: 0x0019, Data: 0x00
;
...
5737:             00 A4                  ;         COM_00_move_and_look(room=RM_5_DESERT3)
5739:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
573A:          02                        ;       ELSE goto=0x573D
573B:             00 C1                  ;         COM_00_move_and_look(room=RM_5_CRAWL_MARKS)
573D:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
573E:          02                        ;       ELSE goto=0x5741
573F:             00 C3                  ;         COM_00_move_and_look(room=RM_5_DESERT10)

5741: C3 19 00                           ; ----- Room RM_5_DESERT10, Length: 0x0019, Data: 0x00
;
...
574E:             00 DD                  ;         COM_00_move_and_look(room=RM_5_HIGHWAY_CURVES)
5750:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5751:          02                        ;       ELSE goto=0x5754
5752:             00 A5                  ;         COM_00_move_and_look(room=RM_5_DESERT4)
5754:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
5755:          02                        ;       ELSE goto=0x5758
5756:             00 C2                  ;         COM_00_move_and_look(room=RM_5_DESERT9)
5758:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5759:          02                        ;       ELSE goto=0x575C
575A:             00 C4                  ;         COM_00_move_and_look(room=RM_5_DESERT11)

575C: C4 1D 00                           ; ----- Room RM_5_DESERT11, Length: 0x001D, Data: 0x00
;
...
578A:                30 D2               ;           COM_30_set_current_room(room=RM_6_DESERT)
...
5794:             00 BA                  ;         COM_00_move_and_look(room=RM_5_DESERT6)
5796:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5797:          02                        ;       ELSE goto=0x579A
5798:             00 E8                  ;         COM_00_move_and_look(room=RM_5_DESERT24)

579A: D4 1C 00                           ; ----- Room RM_5_DESERT_TRAIL1, Length: 0x001C, Data: 0x00
;
...
57B6:             00 BA                  ;         COM_00_move_and_look(room=RM_5_DESERT6)

57B8: D5 19 00                           ; ----- Room RM_5_DESERT13, Length: 0x0019, Data: 0x00
;
...
57C5:             00 BA                  ;         COM_00_move_and_look(room=RM_5_DESERT6)
...
580C: D8 1C 00                           ; ----- Room RM_5_DESERT_TRAIL3, Length: 0x001C, Data: 0x00
;
...
5828:             00 BE                  ;         COM_00_move_and_look(room=RM_5_STRANGE_FOOTPRINTS3)

582A: D9 19 00                           ; ----- Room RM_5_DESERT16, Length: 0x0019, Data: 0x00
;
...
583B:             00 BF                  ;         COM_00_move_and_look(room=RM_5_WEARY_FOOTPRINTS)
583D:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
583E:          02                        ;       ELSE goto=0x5841
583F:             00 BE                  ;         COM_00_move_and_look(room=RM_5_STRANGE_FOOTPRINTS3)
5841:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5842:          02                        ;       ELSE goto=0x5845
5843:             00 DA                  ;         COM_00_move_and_look(room=RM_5_DESERT17)

5845: DA 19 00                           ; ----- Room RM_5_DESERT17, Length: 0x0019, Data: 0x00
;
...
5856:             00 C0                  ;         COM_00_move_and_look(room=RM_5_STAGGERING_FOOTPRINTS)
...
5860: DB 19 00                           ; ----- Room RM_5_DESERT18, Length: 0x0019, Data: 0x00
;
...
5871:             00 C1                  ;         COM_00_move_and_look(room=RM_5_CRAWL_MARKS)
...
587B: DC 19 00                           ; ----- Room RM_5_DESERT19, Length: 0x0019, Data: 0x00
;
...
588C:             00 C2                  ;         COM_00_move_and_look(room=RM_5_DESERT9)
...
5894:             00 DD                  ;         COM_00_move_and_look(room=RM_5_HIGHWAY_CURVES)

5896: DD 40 00                           ; ----- Room RM_5_HIGHWAY_CURVES, Length: 0x0040, Data: 0x00
;
...
58CE:             00 C3                  ;         COM_00_move_and_look(room=RM_5_DESERT10)
...
58D6:             00 DE                  ;         COM_00_move_and_look(room=RM_5_HIGHWAY_LEADS)

58D8: DE 38 00                           ; ----- Room RM_5_HIGHWAY_LEADS, Length: 0x0038, Data: 0x00
;
...
5904:             00 C4                  ;         COM_00_move_and_look(room=RM_5_DESERT11)
5906:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
5907:          02                        ;       ELSE goto=0x590A
5908:             00 DD                  ;         COM_00_move_and_look(room=RM_5_HIGHWAY_CURVES)
...
5912: DF 1D 00                           ; ----- Room RM_5_DESERT20, Length: 0x001D, Data: 0x00
;
...
5923:             00 DE                  ;         COM_00_move_and_look(room=RM_5_HIGHWAY_LEADS)
...
592D:                30 C7               ;           COM_30_set_current_room(room=RM_6_DESERT)
592F:                2F 06               ;           COM_2F_load_section_from_disk(section=6)

5931: E0 1D 00                           ; ----- Room RM_5_DESERT21, Length: 0x001D, Data: 0x00
;
...
594C:                30 C8               ;           COM_30_set_current_room(room=RM_6_DESERT)
594E:                2F 06               ;           COM_2F_load_section_from_disk(section=6)

5950: E1 25 00                           ; ----- Room RM_5_DESERT22, Length: 0x0025, Data: 0x00
;
...
5968:                30 B3               ;           COM_30_set_current_room(room=RM_3_DESERT)
...
5973:                30 C9               ;           COM_30_set_current_room(room=RM_6_DESERT)
5975:                2F 06               ;           COM_2F_load_section_from_disk(section=6)

5977: E2 21 00                           ; ----- Room RM_5_DESERT23, Length: 0x0021, Data: 0x00
;
...
5986:                30 E3               ;           COM_30_set_current_room(room=RM_6_DESERT)
...
5996:                30 CA               ;           COM_30_set_current_room(room=RM_6_DESERT)
5998:                2F 06               ;           COM_2F_load_section_from_disk(section=6)

599A: E8 1D 00                           ; ----- Room RM_5_DESERT24, Length: 0x001D, Data: 0x00
;
...
59A9:                30 E7               ;           COM_30_set_current_room(room=RM_6_DESERT)
...
59B3:             00 D3                  ;         COM_00_move_and_look(room=RM_5_DESERT12)
59B5:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
59B6:          02                        ;       ELSE goto=0x59B9
59B7:             00 F2                  ;         COM_00_move_and_look(room=RM_5_TWISTY_TRAIL)

59B9: E9 1C 00                           ; ----- Room RM_5_DESERT_TRAIL4, Length: 0x001C, Data: 0x00
;
...
59CD:             00 F3                  ;         COM_00_move_and_look(room=RM_5_TRAIL_ALSO_FORKS)
...
59D7: EA 19 00                           ; ----- Room RM_5_DESERT25, Length: 0x0019, Data: 0x00
;
...
59F2: EB 1C 00                           ; ----- Room RM_5_DESERT_TRAIL5, Length: 0x001C, Data: 0x00
;
...
5A10: EC 1C 00                           ; ----- Room RM_5_DESERT_TRAIL6, Length: 0x001C, Data: 0x00
;
...
5A2E: ED 19 00                           ; ----- Room RM_5_DESERT26, Length: 0x0019, Data: 0x00
;
...
5A49: EE 1C 00                           ; ----- Room RM_5_DESERT_EMPTY_HIGHWAY1, Length: 0x001C, Data: 0x00
;
...
5A5D:             00 DD                  ;         COM_00_move_and_look(room=RM_5_HIGHWAY_CURVES)
...
5A67: EF 24 00                           ; ----- Room RM_5_DESERT_EMPTY_HIGHWAY2, Length: 0x0024, Data: 0x00
;
...
5A8D: F0 28 00                           ; ----- Room RM_5_EMPTY_HIGHWAY_DESERT, Length: 0x0028, Data: 0x00
;
...
5A9F:                30 E4               ;           COM_30_set_current_room(room=RM_6_DESERT_EMPTY_HIGHWAY)
...
5AB1:             00 F1                  ;         COM_00_move_and_look(room=RM_5_SMALL_TRAIL1)
5AB3:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5AB4:          02                        ;       ELSE goto=0x5AB7
5AB5:             00 E2                  ;         COM_00_move_and_look(room=RM_5_DESERT23)

5AB7: F1 3F 00                           ; ----- Room RM_5_SMALL_TRAIL1, Length: 0x003F, Data: 0x00
;
...
5AE8:                30 E5               ;           COM_30_set_current_room(room=RM_6_DESERT)
...
5AF2:             00 F2                  ;         COM_00_move_and_look(room=RM_5_TWISTY_TRAIL)
...
5AF8: F2 41 00                           ; ----- Room RM_5_TWISTY_TRAIL, Length: 0x0041, Data: 0x00
;
...
5B2B:                30 E6               ;           COM_30_set_current_room(room=RM_6_DESERT)
5B2D:                2F 06               ;           COM_2F_load_section_from_disk(section=6)
5B2F:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5B30:          02                        ;       ELSE goto=0x5B33
5B31:             00 F3                  ;         COM_00_move_and_look(room=RM_5_TRAIL_ALSO_FORKS)
...
5B39:             00 F1                  ;         COM_00_move_and_look(room=RM_5_SMALL_TRAIL1)

5B3B: F3 35 00                           ; ----- Room RM_5_TRAIL_ALSO_FORKS, Length: 0x0035, Data: 0x00
;
...
5B70:             00 F1                  ;         COM_00_move_and_look(room=RM_5_SMALL_TRAIL1)

5B72: F4 1C 00                           ; ----- Room RM_5_DESERT_TRAIL7, Length: 0x001C, Data: 0x00
;
...
5B82:             00 F3                  ;         COM_00_move_and_look(room=RM_5_TRAIL_ALSO_FORKS)
...
5B90: F5 19 00                           ; ----- Room RM_5_DESERT27, Length: 0x0019, Data: 0x00
;
...
5BAB: F6 45 00                           ; ----- Room RM_5_DESERT_SMALL_TRAIL2, Length: 0x0045, Data: 0x00
;
...
5BDC:             00 F1                  ;         COM_00_move_and_look(room=RM_5_SMALL_TRAIL1)
...
5BE4:             00 F3                  ;         COM_00_move_and_look(room=RM_5_TRAIL_ALSO_FORKS)
...
5BF2: F7 19 00                           ; ----- Room RM_5_DESERT28, Length: 0x0019, Data: 0x00
;
...
5C0D: F8 19 00                           ; ----- Room RM_5_DESERT29, Length: 0x0019, Data: 0x00
;
...
5C28: F9 21 00                           ; ----- Room RM_5_DESERT30, Length: 0x0021, Data: 0x00
;
...
5C4B: FA 19 00                           ; ----- Room RM_5_DESERT31, Length: 0x0019, Data: 0x00
;
