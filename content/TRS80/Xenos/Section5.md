...
52A9:          03                   ;       Phrase 0x03: "EAST     *          *           *"
52AA:          01                   ;       ELSE go to: 0x52AC
52AB:             99                ;         ROUTINE 0x99
52AC:          04                   ;       Phrase 0x04: "WEST     *          *           *"
52AD:          01                   ;       ELSE go to: 0x52AF
52AE:             99                ;         ROUTINE 0x99
52AF:          01                   ;       Phrase 0x01: "NORTH    *          *           *"
...
52B9:                99             ;           ROUTINE 0x99
52BA:          02                   ;       Phrase 0x02: "SOUTH    *          *           *"
...
531A:          03                   ;       Phrase 0x03: "EAST     *          *           *"
531B:          01                   ;       ELSE go to: 0x531D
531C:             9A                ;         ROUTINE 0x9A
531D:          04                   ;       Phrase 0x04: "WEST     *          *           *"
531E:          02                   ;       ELSE go to: 0x5321
531F:             00 9D             ;         MOVE AND LOOK, room=9D_5_UFO_CRATER
5321:          01                   ;       Phrase 0x01: "NORTH    *          *           *"
5322:          01                   ;       ELSE go to: 0x5324
5323:             9A                ;         ROUTINE 0x9A
5324:          02                   ;       Phrase 0x02: "SOUTH    *          *           *"
...
5394:                   17 9D 00    ;             MOVE TO, obj=9D_THIRST_TRACKER, room=00_nowhere
5397:                   2F 07       ;             LOAD SECTION FROM DISK, Section: 0x07
5399:          36                   ;       Phrase 0x36: "ENTER    *          *           *"
...
53A5:                   01 4E       ;             IS IN PACK OR CURRENT ROOM, obj=??4E??
...
53CF:                   17 9D 00    ;             MOVE TO, obj=9D_THIRST_TRACKER, room=00_nowhere
53D2:                   2F 07       ;             LOAD SECTION FROM DISK, Section: 0x07
53D4:          01                   ;       Phrase 0x01: "NORTH    *          *           *"
53D5:          01                   ;       ELSE go to: 0x53D7
53D6:             9A                ;         ROUTINE 0x9A
53D7:          02                   ;       Phrase 0x02: "SOUTH    *          *           *"
53D8:          01                   ;       ELSE go to: 0x53DA
53D9:             9A                ;         ROUTINE 0x9A
53DA:          03                   ;       Phrase 0x03: "EAST     *          *           *"
...
53E5:          AB                   ;       ROUTINE 0xAB
53E6:          96                   ;       ROUTINE 0x96
...
545C:          AB                   ;       ROUTINE 0xAB
545D:          96                   ;       ROUTINE 0x96
...
548D:          03                   ;       Phrase 0x03: "EAST     *          *           *"
548E:          02                   ;       ELSE go to: 0x5491
548F:             00 BE             ;         MOVE AND LOOK, room=BE_5_STRANGE_FOOTPRINTS2
5491:          04                   ;       Phrase 0x04: "WEST     *          *           *"
5492:          01                   ;       ELSE go to: 0x5494
5493:             97                ;         ROUTINE 0x97
5494:          01                   ;       Phrase 0x01: "NORTH    *          *           *"
5495:          01                   ;       ELSE go to: 0x5497
5496:             97                ;         ROUTINE 0x97
5497:          02                   ;       Phrase 0x02: "SOUTH    *          *           *"
...
54A2:          AB                   ;       ROUTINE 0xAB
54A3:          96                   ;       ROUTINE 0x96
...
5B42:          AB                   ;       ROUTINE 0xAB
5B43:          95                   ;       ROUTINE 0x95
