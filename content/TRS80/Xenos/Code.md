...
5D77: 47              LD      B,A                 
5D78: CD 57 70        CALL    $7057               ; {code.GetObjectScriptByIndex}
5D7B: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd}
5D7E: 7E              LD      A,(HL)              
5D7F: A7              AND     A                   
5D80: F2 77 5D        JP      P,$5D77             ; {}
5D83: 32 21 72        LD      ($7221),A           ; {code.currentRoom}
5D86: 47              LD      B,A                 
...
5D97: CD 57 63        CALL    $6357               ; {code.ExecuteCommand}
...
6FF4: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd}
6FF7: CD DC 61        CALL    $61DC               ; {code.CompareHLandDE}
6FFA: D2 E9 6F        JP      NC,$6FE9            ; {}
6FFD: D5              PUSH    DE                  
6FFE: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd}
7001: 7E              LD      A,(HL)              
7002: FE 01           CP      $01                 
...
```code
ObjectData:
887A: 00 AB 32  ; ID: 0x00, Length: 0x00
;
; Object 01
...
B467: F9              LD      SP,HL               
B468: 6C              LD      L,H                 
B469: 22 6D 62        LD      ($626D),HL          ; {}
B46C: 73              LD      (HL),E              
B46D: C3 06 3C        JP      $3C06               
B470: 49              LD      C,C                 
B471: FA 6C AB        JP      M,$AB6C             ; {}
B474: 70              LD      (HL),B              
B475: 94              SUB     H                   
B476: 14              INC     D                   
B477: BA              CP      D                   
...
B4A3: AB              XOR     E                   
B4A4: 70              LD      (HL),B              
B4A5: 20 01           JR      NZ,$B4A8            ; {}
B4A7: 1C              INC     E                   
B4A8: 01 1D 64        LD      BC,$641D            
B4AB: 9A              SBC     D                   
B4AC: 31 04 2F        LD      SP,$2F04            
B4AF: 5F              LD      E,A                 
B4B0: BE              CP      (HL)                
B4B1: D3 14           OUT     ($14),A             
B4B3: 91              SUB     C                   
...
B590: DB 63           IN      A,($63)             
B592: 0D              DEC     C                   
B593: 22 14 15        LD      ($1514),HL          
B596: 20 14           JR      NZ,$B5AC            ; {}
B598: 2D              DEC     L                   
B599: 5C              LD      E,H                 
B59A: 04              INC     B                   
B59B: 18 C7           JR      $B564               ; {}
...
B63A: 06 0D           LD      B,$0D               
B63C: 04              INC     B                   
B63D: 30 80           JR      NC,$B5BF            ; {}
B63F: 2F              CPL                         
B640: 01 A3 36        LD      BC,$36A3            
B643: 0D              DEC     C                   
B644: 34              INC     (HL)                
B645: 3A 2C 01        LD      A,($012C)           
B648: 30 80           JR      NC,$B5CA            ; {}
B64A: 17              RLA                         
B64B: 01 80 1F        LD      BC,$1F80            
B64E: 1A              LD      A,(DE)              
B64F: DF              RST     0X18                
B650: 2C              INC     L                   
B651: DF              RST     0X18                
...
B699: 09              ADD     HL,BC               
B69A: 9A              SBC     D                   
B69B: C2 16 A7        JP      NZ,$A716            ; {}
B69E: 61              LD      H,C                 
B69F: 0C              INC     C                   
B6A0: 0D              DEC     C                   
B6A1: 11 1A 15        LD      DE,$151A            
B6A4: 02              LD      (BC),A              
B6A5: 14              INC     D                   
B6A6: 2E 80           LD      L,$80               
B6A8: 14              INC     D                   
...
B6BA: 0E 06           LD      C,$06               
B6BC: 15              DEC     D                   
B6BD: 10 1F           DJNZ    $B6DE               ; {}
B6BF: 02              LD      (BC),A              
B6C0: 5F              LD      E,A                 
B6C1: BE              CP      (HL)                
B6C2: 11 A9 0C        LD      DE,$0CA9            
B6C5: 0D              DEC     C                   
B6C6: 0A              LD      A,(BC)              
B6C7: 1B              DEC     DE                  
B6C8: 0E 06           LD      C,$06               
B6CA: 15              DEC     D                   
B6CB: 10 1F           DJNZ    $B6EC               ; {}
B6CD: 02              LD      (BC),A              
B6CE: 5F              LD      E,A                 
B6CF: BE              CP      (HL)                
B6D0: 12              LD      (DE),A              
...
B6E7: B9              CP      C                   
B6E8: 0E 08           LD      C,$08               
B6EA: C3 04 05        JP      $0504               
B6ED: D4 47 75        CALL    NC,$7547            ; {}
B6F0: 8D              ADC     A,L                 
B6F1: 4B              LD      C,E                 
B6F2: 8B              ADC     A,E                 
B6F3: 04              INC     B                   
...
B717: 91              SUB     C                   
B718: 17              RLA                         
B719: C4 9C 8E        CALL    NZ,$8E9C            ; {}
B71C: C6 1D           ADD     $1D                 
B71E: A0              AND     B                   
B71F: 11 EE 5B        LD      DE,$5BEE            
B722: 98              SBC     B                   
B723: 4B              LD      C,E                 
B724: 7B              LD      A,E                 
B725: 66              LD      H,(HL)              
...
B73C: B9              CP      C                   
B73D: 0E 08           LD      C,$08               
B73F: C3 04 05        JP      $0504               
B742: D4 47 75        CALL    NC,$7547            ; {}
B745: 8D              ADC     A,L                 
B746: 4B              LD      C,E                 
B747: 8B              ADC     A,E                 
B748: 04              INC     B                   
...
B777: 16 4B           LD      D,$4B               
B779: 5E              LD      E,(HL)              
B77A: D4 B5 16        CALL    NC,$16B5            
B77D: 60              LD      H,B                 
B77E: C0              RET     NZ                  
B77F: 16 4B           LD      D,$4B               
B781: 5E              LD      E,(HL)              
B782: C4 B5 67        CALL    NZ,$67B5            ; {}
B785: 8E              ADC     A,(HL)              
B786: 03              INC     BC                  
B787: EE 33           XOR     $33                 
B789: 98              SBC     B                   
...
B79A: 89              ADC     A,C                 
B79B: 4E              LD      C,(HL)              
B79C: E2 87 41        JP      PO,$4187            
B79F: 0E 06           LD      C,$06               
B7A1: C3 04 03        JP      $0304               
B7A4: 23              INC     HL                  
B7A5: 63              LD      H,E                 
B7A6: 54              LD      D,H                 
B7A7: 8B              ADC     A,E                 
...
B7E4: 0E D0           LD      C,$D0               
B7E6: 16 8A           LD      D,$8A               
B7E8: F4 72 4B        CALL    P,$4B72             
B7EB: 5E              LD      E,(HL)              
B7EC: C3 B5 5F        JP      $5FB5               ; {}
B7EF: 17              RLA                         
B7F0: 46              LD      B,(HL)              
B7F1: 48              LD      C,B                 
B7F2: 63              LD      H,E                 
...
B8B5: C5              PUSH    BC                  
B8B6: EB              EX      DE,HL               
B8B7: DA AF 13        JP      C,$13AF             
B8BA: 0D              DEC     C                   
B8BB: 11 0A 12        LD      DE,$120A            
B8BE: 04              INC     B                   
B8BF: 06 55           LD      B,$55               
B8C1: 77              LD      (HL),A              
B8C2: 1B              DEC     DE                  
...
B8C4: EB              EX      DE,HL               
B8C5: 99              SBC     C                   
B8C6: 11 04 04        LD      DE,$0404            
B8C9: F4 72 DB        CALL    P,$DB72             
B8CC: 63              LD      H,E                 
B8CD: B1              OR      C                   
B8CE: 0E 0D           LD      C,$0D               
B8D0: 0C              INC     C                   
B8D1: 04              INC     B                   
B8D2: 01 20 AA        LD      BC,$AA20            
B8D5: 04              INC     B                   
B8D6: 06 40           LD      B,$40               
B8D8: 55              LD      D,L                 
B8D9: 4B              LD      C,E                 
...
B96A: 24              INC     H                   
B96B: 04              INC     B                   
B96C: 22 C7 DE        LD      ($DEC7),HL          
B96F: 20 16           JR      NZ,$B987            ; {}
B971: 6B              LD      L,E                 
B972: A1              AND     C                   
B973: C7              RST     0X00                
B974: DE D3           SBC     $D3                 
...
B9A3: 8D              ADC     A,L                 
B9A4: 48              LD      C,B                 
B9A5: 30 79           JR      NC,$BA20            ; {}
B9A7: 14              INC     D                   
B9A8: BC              CP      H                   
B9A9: 03              INC     BC                  
B9AA: 47              LD      B,A                 
B9AB: C3 9C 07        JP      $079C               
B9AE: 4F              LD      C,A                 
B9AF: 16 BC           LD      D,$BC               
B9B1: DB 72           IN      A,($72)             
B9B3: 5C              LD      E,H                 
...
B9C3: 0E 04           LD      C,$04               
B9C5: 0A              LD      A,(BC)              
B9C6: 3A 0A 42        LD      A,($420A)           
B9C9: 0E 5B           LD      C,$5B               
B9CB: 0D              DEC     C                   
B9CC: 28 09           JR      Z,$B9D7             ; {}
B9CE: 24              INC     H                   
B9CF: 1A              LD      A,(DE)              
B9D0: 14              INC     D                   
B9D1: 2E 40           LD      L,$40               
...
BA20: 89              ADC     A,C                 
BA21: 17              RLA                         
BA22: 01 18 6F        LD      BC,$6F18            
BA25: B2              OR      D                   
BA26: BB              CP      E                   
BA27: 23              INC     HL                  
BA28: 0D              DEC     C                   
BA29: 21 0E 04        LD      HL,$040E            
BA2C: 0A              LD      A,(BC)              
BA2D: 10 0A           DJNZ    $BA39               ; {}
BA2F: 0B              DEC     BC                  
BA30: 04              INC     B                   
BA31: 19              ADD     HL,DE               
BA32: 8D              ADC     A,L                 
...
BB04: A8              XOR     B                   
BB05: 8B              ADC     A,E                 
BB06: C3 04 14        JP      $1404               
BB09: 03              INC     BC                  
BB0A: 01 80 C4        LD      BC,$C480            
BB0D: 1C              INC     E                   
BB0E: 0E 1A           LD      C,$1A               
BB10: 0A              LD      A,(BC)              
BB11: 11 0A 3A        LD      DE,$3A0A            
BB14: 0A              LD      A,(BC)              
BB15: 05              DEC     B                   
BB16: 0A              LD      A,(BC)              
BB17: 43              LD      B,E                 
...
BBA5: 46              LD      B,(HL)              
BBA6: 62              LD      H,D                 
BBA7: FA 17 83        JP      M,$8317             ; {}
BBAA: 61              LD      H,C                 
BBAB: 5B              LD      E,E                 
BBAC: BE              CP      (HL)                
BBAD: 10 BC           DJNZ    $BB6B               ; {}
BBAF: 66              LD      H,(HL)              
BBB0: 49              LD      C,C                 
BBB1: 45              LD      B,L                 
BBB2: DB 63           IN      A,($63)             
...
BC0F: 04              INC     B                   
BC10: 80              ADD     A,B                 
BC11: E2 C7 DE        JP      PO,$DEC7            
BC14: 9B              SBC     E                   
BC15: 15              DEC     D                   
BC16: 5B              LD      E,E                 
BC17: CA 86 91        JP      Z,$9186             ; {}
BC1A: 4B              LD      C,E                 
BC1B: 5E              LD      E,(HL)              
BC1C: 04              INC     B                   
BC1D: BC              CP      H                   
BC1E: DD 46 89        LD      B,(IX+$89)          
BC21: 17              RLA                         
BC22: 89              ADC     A,C                 
BC23: 17              RLA                         
BC24: 01 D2 82        LD      BC,$82D2            
BC27: 17              RLA                         
BC28: 56              LD      D,(HL)              
BC29: 5E              LD      E,(HL)              
BC2A: 80              ADD     A,B                 
...
BC31: 15              DEC     D                   
BC32: 5B              LD      E,E                 
BC33: CA 76 B1        JP      Z,$B176             ; {}
BC36: 38 C6           JR      C,$BBFE             ; {}
BC38: F3              DI                          
BC39: 5F              LD      E,A                 
BC3A: 8E              ADC     A,(HL)              
BC3B: 48              LD      C,B                 
...
BC47: AF              XOR     A                   
BC48: D5              PUSH    DE                  
BC49: C3 65 62        JP      $6265               ; {}
BC4C: 43              LD      B,E                 
BC4D: F4 B3 14        CALL    P,$14B3             
BC50: C5              PUSH    BC                  
BC51: 6A              LD      L,D                 
BC52: 3F              CCF                         
BC53: 61              LD      H,C                 
...
BCF8: 23              INC     HL                  
BCF9: 0D              DEC     C                   
BCFA: 21 1F 0C        LD      HL,$0C1F            
BCFD: C7              RST     0X00                
BCFE: DE 9B           SBC     $9B                 
BD00: 15              DEC     D                   
BD01: 5B              LD      E,E                 
BD02: CA 3F 55        JP      Z,$553F             
BD05: FF              RST     0X38                
BD06: A5              AND     L                   
BD07: E6 BD           AND     $BD                 
BD09: 26 1F           LD      H,$1F               
BD0B: 10 F4           DJNZ    $BD01               ; {}
BD0D: A4              AND     H                   
BD0E: B0              OR      B                   
BD0F: 53              LD      D,E                 
BD10: 11 BC 9B        LD      DE,$9BBC            
BD13: 64              LD      H,H                 
BD14: 34              INC     (HL)                
BD15: A1              AND     C                   
BD16: 6B              LD      L,E                 
...
BD3A: 90              SUB     B                   
BD3B: 14              INC     D                   
BD3C: 30 15           JR      NC,$BD53            ; {}
BD3E: 31 62 44        LD      SP,$4462            
BD41: DB 8F           IN      A,($8F)             
BD43: 5F              LD      E,A                 
BD44: 30 15           JR      NC,$BD5B            ; {}
BD46: 6E              LD      L,(HL)              
BD47: CA 5F A0        JP      Z,$A05F             ; {}
BD4A: DB B5           IN      A,($B5)             
BD4C: 19              ADD     HL,DE               
BD4D: A1              AND     C                   
BD4E: 51              LD      D,C                 
