...
5D0B: 32 FA 71        LD      ($71FA),A           ; {code.currentLoadedSection} ... SECTION1.DAT
...
5D1F: 3A FA 71        LD      A,($71FA)           ; {code.currentLoadedSection} This is the currently loaded section
...
5D3B: CD 52 62        CALL    $6252               ; {code.GetInputLine} Get the user input
5D3E: 97              SUB     A                   ; A zero to initialize the decoded pieces:
5D3F: 32 03 72        LD      ($7203),A           ; {code.adjWord}
5D42: 32 06 72        LD      ($7206),A           ; {code.lsbAdj1}
5D45: 32 08 72        LD      ($7208),A           ; {code.lsbVerb}
5D48: 32 FE 71        LD      ($71FE),A           ; {code.tmp1}
5D4B: 32 FF 71        LD      ($71FF),A           ; {code.verbWord}
5D4E: 32 05 72        LD      ($7205),A           ; {}
5D51: 32 04 72        LD      ($7204),A           ; {code.commandTarg}
5D54: 32 00 72        LD      ($7200),A           ; {code.prepWord}
5D57: 32 01 72        LD      ($7201),A           ; {code.prepGiven}
5D5A: 32 0B 72        LD      ($720B),A           ; {code.varObject}
5D5D: 32 0F 72        LD      ($720F),A           ; {code.firstNoun}
5D60: 32 15 72        LD      ($7215),A           ; {code.secondNoun}
;
...
5DDB: 32 04 72        LD      ($7204),A           ; {code.commandTarg}
5DDE: 23              INC     HL                  
5DDF: 23              INC     HL                  
5DE0: 23              INC     HL                  
5DE1: 7E              LD      A,(HL)              
...
5E02: 3A FF 71        LD      A,($71FF)           ; {code.verbWord}
5E05: BE              CP      (HL)                
5E06: 23              INC     HL                  
5E07: 7E              LD      A,(HL)              
5E08: 23              INC     HL                  
...
5E0C: 47              LD      B,A                 
5E0D: 78              LD      A,B                 
5E0E: 32 FF 71        LD      ($71FF),A           ; {code.verbWord}
5E11: C3 67 5E        JP      $5E67               ; {}
5E14: 3D              DEC     A                   
5E15: C2 51 5E        JP      NZ,$5E51            ; {}
5E18: 3A 01 72        LD      A,($7201)           ; {code.prepGiven}
5E1B: A7              AND     A                   
5E1C: CA 3F 5E        JP      Z,$5E3F             ; {}
5E1F: 21 15 72        LD      HL,$7215            
5E22: 70              LD      (HL),B              
5E23: 23              INC     HL                  
5E24: 3A 03 72        LD      A,($7203)           ; {code.adjWord}
5E27: 77              LD      (HL),A              
5E28: 23              INC     HL                  
5E29: 3A 06 72        LD      A,($7206)           ; {code.lsbAdj1}
5E2C: 77              LD      (HL),A              
5E2D: A7              AND     A                   
5E2E: C2 32 5E        JP      NZ,$5E32            ; {}
5E31: 71              LD      (HL),C              
5E32: 97              SUB     A                   
5E33: 32 03 72        LD      ($7203),A           ; {code.adjWord}
5E36: 32 01 72        LD      ($7201),A           ; {code.prepGiven}
5E39: 32 06 72        LD      ($7206),A           ; {code.lsbAdj1}
5E3C: C3 67 5E        JP      $5E67               ; {}
5E3F: 2A 0F 72        LD      HL,($720F)          ; {code.firstNoun}
5E42: 22 15 72        LD      ($7215),HL          ; {code.secondNoun}
...
5E55: 78              LD      A,B                 
5E56: 32 03 72        LD      ($7203),A           ; {code.adjWord}
5E59: 79              LD      A,C                 
5E5A: 32 06 72        LD      ($7206),A           ; {code.lsbAdj1}
5E5D: C3 67 5E        JP      $5E67               ; {}
5E60: 78              LD      A,B                 
5E61: 32 00 72        LD      ($7200),A           ; {code.prepWord}
5E64: 32 01 72        LD      ($7201),A           ; {code.prepGiven}
5E67: E1              POP     HL                  
5E68: C3 E1 5D        JP      $5DE1               ; {}
5E6B: 3A FF 71        LD      A,($71FF)           ; {code.verbWord}
5E6E: A7              AND     A                   
5E6F: CA 3D 61        JP      Z,$613D             ; {}
5E72: 21 15 72        LD      HL,$7215            
5E75: CD 99 5F        CALL    $5F99               ; {}
5E78: 32 15 72        LD      ($7215),A           ; {code.secondNoun}
5E7B: 22 18 72        LD      ($7218),HL          ; {code.secondNounPtr}
5E7E: 21 0F 72        LD      HL,$720F            
5E81: CD 99 5F        CALL    $5F99               ; {}
5E84: 32 0F 72        LD      ($720F),A           ; {code.firstNoun}
5E87: 22 12 72        LD      ($7212),HL          ; {code.firstNounPtr}
5E8A: 97              SUB     A                   
5E8B: 32 01 72        LD      ($7201),A           ; {code.prepGiven}
5E8E: 2A 12 72        LD      HL,($7212)          ; {code.firstNounPtr}
5E91: 3A 0F 72        LD      A,($720F)           ; {code.firstNoun}
5E94: A7              AND     A                   
...
5EA1: 2A 18 72        LD      HL,($7218)          ; {code.secondNounPtr}
5EA4: 3A 15 72        LD      A,($7215)           ; {code.secondNoun}
5EA7: A7              AND     A                   
...
5EBC: 3A FF 71        LD      A,($71FF)           ; {code.verbWord}
5EBF: BE              CP      (HL)                
5EC0: 23              INC     HL                  
5EC1: C2 23 5F        JP      NZ,$5F23            ; {}
5EC4: 7E              LD      A,(HL)              
5EC5: 32 02 72        LD      ($7202),A           ; {}
5EC8: 3A 00 72        LD      A,($7200)           ; {code.prepWord}
5ECB: A7              AND     A                   
...
5F2A: 32 1D 72        LD      ($721D),A           ; {code.inputPhrase}
5F2D: 21 FF 3F        LD      HL,$3FFF            
5F30: 22 20 40        LD      ($4020),HL          ; {hard.CursorPointer}
5F33: 3A 0F 72        LD      A,($720F)           ; {code.firstNoun}
5F36: A7              AND     A                   
5F37: C2 46 5F        JP      NZ,$5F46            ; {}
5F3A: 2A 18 72        LD      HL,($7218)          ; {code.secondNounPtr}
5F3D: 22 12 72        LD      ($7212),HL          ; {code.firstNounPtr}
5F40: 3A 15 72        LD      A,($7215)           ; {code.secondNoun}
5F43: 32 0F 72        LD      ($720F),A           ; {code.firstNoun}
5F46: 3A 04 72        LD      A,($7204)           ; {code.commandTarg}
5F49: A7              AND     A                   
...
5F7F: CD EB 70        CALL    $70EB               ; {code.PrintCharCullSpaces} ... line feed
5F82: 21 4E 7D        LD      HL,$7D4E            ; {+code.GeneralScript} Run the ...
5F85: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} ... general script ...
5F88: CD 57 63        CALL    $6357               ; {code.ExecuteCommand} ... to handle input
5F8B: CD B2 6C        CALL    $6CB2               ; {} Execute TURN scripts for all objects
5F8E: 3E 0D           LD      A,$0D               ; Print a ...
5F90: CD EB 70        CALL    $70EB               ; {code.PrintCharCullSpaces} line feed
5F93: 3A 1D 72        LD      A,($721D)           ; {code.inputPhrase} !! Why? the game loop clobbers the accumulator
5F96: C3 38 5D        JP      $5D38               ; {code.GameLoop} Back for next command

5F99: 97              SUB     A                   
5F9A: 32 0B 72        LD      ($720B),A           ; {code.varObject}
5F9D: 7E              LD      A,(HL)              
5F9E: 32 FE 71        LD      ($71FE),A           ; {code.tmp1}
5FA1: 47              LD      B,A                 
5FA2: A7              AND     A                   
5FA3: C8              RET     Z                   
5FA4: 23              INC     HL                  
5FA5: 7E              LD      A,(HL)              
5FA6: 32 03 72        LD      ($7203),A           ; {code.adjWord}
5FA9: 23              INC     HL                  
5FAA: 7E              LD      A,(HL)              
...
5FC5: 3A 03 72        LD      A,($7203)           ; {code.adjWord}
5FC8: A7              AND     A                   
...
5FE6: 3A 03 72        LD      A,($7203)           ; {code.adjWord}
5FE9: BE              CP      (HL)                
5FEA: 23              INC     HL                  
...
6002: EB              EX      DE,HL               
6003: D1              POP     DE                  
6004: 3A FE 71        LD      A,($71FE)           ; {code.tmp1}
6007: 47              LD      B,A                 
...
6070: E5              PUSH    HL                  
6071: 97              SUB     A                   
6072: 32 FE 71        LD      ($71FE),A           ; {code.tmp1}
...
60A5: 3A FE 71        LD      A,($71FE)           ; {code.tmp1}
60A8: A7              AND     A                   
60A9: C2 FC 60        JP      NZ,$60FC            ; {}
60AC: 78              LD      A,B                 
60AD: 32 FE 71        LD      ($71FE),A           ; {code.tmp1}
60B0: 3A F1 71        LD      A,($71F1)           ; {}
60B3: 32 F2 71        LD      ($71F2),A           ; {}
60B6: 7E              LD      A,(HL)              
60B7: 32 03 72        LD      ($7203),A           ; {code.adjWord}
...
60CB: 3A FE 71        LD      A,($71FE)           ; {code.tmp1}
60CE: A7              AND     A                   
...
60E1: 12              LD      (DE),A              
60E2: 13              INC     DE                  
60E3: 3A 03 72        LD      A,($7203)           ; {code.adjWord}
60E6: 12              LD      (DE),A              
60E7: E1              POP     HL                  
60E8: 97              SUB     A                   
60E9: C9              RET                         
...
60F0: C3 42 61        JP      $6142               ; {code.FlashError}
60F3: 11 3E 72        LD      DE,$723E            
60F6: 3A 07 72        LD      A,($7207)           ; {}
60F9: C3 42 61        JP      $6142               ; {code.FlashError}
60FC: 3A 01 72        LD      A,($7201)           ; {code.prepGiven}
60FF: A7              AND     A                   
6100: CA 2B 61        JP      Z,$612B             ; {}
6103: 3A 00 72        LD      A,($7200)           ; {code.prepWord}
6106: A7              AND     A                   
...
6131: C3 42 61        JP      $6142               ; {code.FlashError}
6134: 11 36 72        LD      DE,$7236            
6137: 3A 1B 72        LD      A,($721B)           ; {}
613A: C3 42 61        JP      $6142               ; {code.FlashError}
...
61E8: CD 99 62        CALL    $6299               ; {code.GetKey} Get a key from the keyboard
...
6201: CA 52 62        JP      Z,$6252             ; {code.GetInputLine} Yes, handle clear
...
625E: C3 E2 61        JP      $61E2               ; {code.GetUserInput} Go get another key
;
...
62AF: CA A4 62        JP      Z,$62A4             ; {code.DecodeBuffer}
62B2: FE 41           CP      $41                 
62B4: DA A4 62        JP      C,$62A4             ; {code.DecodeBuffer}
62B7: 11 2C 76        LD      DE,$762C            
62BA: CD F1 62        CALL    $62F1               ; {code.DecodeWord}
62BD: CA A5 62        JP      Z,$62A5             ; {}
62C0: 06 01           LD      B,$01               
62C2: 13              INC     DE                  
62C3: CD F1 62        CALL    $62F1               ; {code.DecodeWord}
...
62EC: 32 08 72        LD      ($7208),A           ; {code.lsbVerb}
...
6354: C3 F1 62        JP      $62F1               ; {code.DecodeWord} Keep trying
...
6394: CD 57 63        CALL    $6357               ; {code.ExecuteCommand} Execute the command
...
63AA: CD 57 63        CALL    $6357               ; {code.ExecuteCommand} Execute the command
...
63CC: CD C9 61        CALL    $61C9               ; {code.GetMultiByteLength} Jump to the end ...
...
63EC: CD C1 64        CALL    $64C1               ; {code.PrintRoomDescription} Print room description
...
640B: 3A 21 72        LD      A,($7221)           ; {code.currentRoom} Set the var ...
...
6433: 3A 0F 72        LD      A,($720F)           ; {code.firstNoun} Copy first noun number ...
6436: 32 0B 72        LD      ($720B),A           ; {code.varObject} ... to var object
...
6443: 3A 15 72        LD      A,($7215)           ; {code.secondNoun} Copy second noun ...
6446: 32 0B 72        LD      ($720B),A           ; {code.varObject} ... to var object
6449: E1              POP     HL                  
...
6464: E5              PUSH    HL                  
6465: 2A 18 72        LD      HL,($7218)          ; {code.secondNounPtr}
6468: E5              PUSH    HL                  
6469: 3A 0F 72        LD      A,($720F)           ; {code.firstNoun}
646C: 47              LD      B,A                 
646D: 3A 15 72        LD      A,($7215)           ; {code.secondNoun}
6470: 4F              LD      C,A                 
6471: C5              PUSH    BC                  
6472: 3A 1D 72        LD      A,($721D)           ; {code.inputPhrase}
6475: 47              LD      B,A                 
6476: C5              PUSH    BC                  
6477: EB              EX      DE,HL               
6478: 7E              LD      A,(HL)              
6479: 32 1D 72        LD      ($721D),A           ; {code.inputPhrase}
647C: 23              INC     HL                  
647D: 46              LD      B,(HL)              
647E: 23              INC     HL                  
647F: 4E              LD      C,(HL)              
...
64A9: C1              POP     BC                  
64AA: 78              LD      A,B                 
64AB: 32 1D 72        LD      ($721D),A           ; {code.inputPhrase}
64AE: C1              POP     BC                  
64AF: 78              LD      A,B                 
64B0: 32 0F 72        LD      ($720F),A           ; {code.firstNoun}
64B3: 79              LD      A,C                 
64B4: 32 15 72        LD      ($7215),A           ; {code.secondNoun}
64B7: E1              POP     HL                  
64B8: 22 18 72        LD      ($7218),HL          ; {code.secondNounPtr}
64BB: E1              POP     HL                  
64BC: 22 12 72        LD      ($7212),HL          ; {code.firstNounPtr}
64BF: EB              EX      DE,HL               
64C0: C9              RET                         
...
64F0: 21 7B 65        LD      HL,$657B            ; {+code.printPeriodScript} Print a period ...
64F3: CD 57 63        CALL    $6357               ; {code.ExecuteCommand} ... after the short name
;
; Now the room description
64F6: 2A 22 72        LD      HL,($7222)          ; {code.currentRoomPtr} Point to ...
64F9: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} ... the current room struct
...
6582: 32 FB 66        LD      ($66FB),A           ; {code.printedSomethingOn??} ... something-was-printed flag ...
6585: 32 FA 66        LD      ($66FA),A           ; {} ... and the ??
6588: 3C              INC     A                   
6589: 32 FC 66        LD      ($66FC),A           ; {}
;
658C: 2A 0C 72        LD      HL,($720C)          ; {code.varObjectPtr} Look up the VAR object
658F: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} Skip to the data
...
65A6: 3A FB 66        LD      A,($66FB)           ; {code.printedSomethingOn??} Did we print ...
...
660E: 32 FB 66        LD      ($66FB),A           ; {code.printedSomethingOn??}
6611: E5              PUSH    HL                  
6612: 3A F9 66        LD      A,($66F9)           ; {}
6615: FE 01           CP      $01                 
6617: CA 25 66        JP      Z,$6625             ; {}
661A: 21 7B 65        LD      HL,$657B            ; {+code.printPeriodScript} "."
661D: CD 57 63        CALL    $6357               ; {code.ExecuteCommand}
6620: 3E 01           LD      A,$01               
6622: 32 FD 66        LD      ($66FD),A           ; {}
6625: 21 7A 65        LD      HL,$657A            ; {+code.printSpaceScript} SPACE
...
;
6634: E5              PUSH    HL                  
6635: 21 7C 65        LD      HL,$657C            ; {+code.printAndScript} " AND "
...
6657: 21 7B 65        LD      HL,$657B            ; {+code.printPeriodScript} "."
...
669C: 32 FB 66        LD      ($66FB),A           ; {code.printedSomethingOn??}
669F: E5              PUSH    HL                  
66A0: 3A F9 66        LD      A,($66F9)           ; {}
66A3: FE 01           CP      $01                 
66A5: CA B3 66        JP      Z,$66B3             ; {}
66A8: 21 7B 65        LD      HL,$657B            ; {+code.printPeriodScript} "."
66AB: CD 57 63        CALL    $6357               ; {code.ExecuteCommand}
66AE: 3E 01           LD      A,$01               
66B0: 32 FD 66        LD      ($66FD),A           ; {}
66B3: 21 7D 65        LD      HL,$657D            ; {+code.printOnVarSeenScript} " ON <the var> CAN BE SEEN
...
66C2: E5              PUSH    HL                  
66C3: 21 7C 65        LD      HL,$657C            ; {+code.printAndScript} " AND "
...
66E5: 21 7B 65        LD      HL,$657B            ; {+code.printPeriodScript} "."
...
6704: CD AD 61        CALL    $61AD               ; {code.FindObjectField} Look up the short name
6707: D2 7C 67        JP      NC,$677C            ; {} No short name, done here
670A: 23              INC     HL                  ; Skip section number (0x02)
670B: 3E 41           LD      A,$41               ; Print ...
670D: CD EB 70        CALL    $70EB               ; {code.PrintCharCullSpaces} ... "A"
6710: 3E 20           LD      A,$20               ; Print ...
6712: CD EB 70        CALL    $70EB               ; {code.PrintCharCullSpaces} ... SPACE
6715: CD 6F 70        CALL    $706F               ; {code.PrintPackedAutoWrap} Print the object short name
6718: D1              POP     DE                  
6719: 3A FB 66        LD      A,($66FB)           ; {code.printedSomethingOn??}
671C: F5              PUSH    AF                  
...
674E: 97              SUB     A                   
674F: 32 FB 66        LD      ($66FB),A           ; {code.printedSomethingOn??}
...
676C: 3A FB 66        LD      A,($66FB)           ; {code.printedSomethingOn??}
676F: A7              AND     A                   
6770: CA 77 67        JP      Z,$6777             ; {}
6773: 97              SUB     A                   
6774: 32 F7 71        LD      ($71F7),A           ; {}
6777: F1              POP     AF                  
6778: 32 FB 66        LD      ($66FB),A           ; {code.printedSomethingOn??}
677B: C9              RET                         
;
...
68D2: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} Skip to data
...
68E2: C9              RET                         
;
68E3: 3A 1E 72        LD      A,($721E)           ; {code.activeObject} Get active object's number
...
6920: 3A 15 72        LD      A,($7215)           ; {code.secondNoun}
6923: A7              AND     A                   
6924: CA 41 69        JP      Z,$6941             ; {}
6927: 2A 18 72        LD      HL,($7218)          ; {code.secondNounPtr}
...
6941: 3A 0F 72        LD      A,($720F)           ; {code.firstNoun}
6944: A7              AND     A                   
...
694C: 2A 12 72        LD      HL,($7212)          ; {code.firstNounPtr}
...
69F3: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} Skip to data
...
6A95: 47              LD      B,A                 ; To B
6A96: 3A FA 71        LD      A,($71FA)           ; {code.currentLoadedSection} Add the current disk section ...
6A99: B0              OR      B                   ; ... to the player's object data
6A9A: 77              LD      (HL),A              ; Set the player to the currently loaded disk section
6A9B: CD C1 64        CALL    $64C1               ; {code.PrintRoomDescription} Print the description
6A9E: 97              SUB     A                   ; Reset the "stop ...
6A9F: 32 F0 71        LD      ($71F0),A           ; {code.stopAtPeriod} ... at period" print flag
...
6AB6: 11 06 6B        LD      DE,$6B06            ; {+code.diskFileControlBlock}
6AB9: E5              PUSH    HL                  
6ABA: C5              PUSH    BC                  
...
6AD6: 11 06 6B        LD      DE,$6B06            ; {+code.diskFileControlBlock}
...
6C58: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} ... second noun object
6C5B: 3A 0B 72        LD      A,($720B)           ; {code.varObject} Now owned ...
...
6C83: 47              LD      B,A                 ; ... disk ...
6C84: 3A FA 71        LD      A,($71FA)           ; {code.currentLoadedSection} ... section ...
6C87: B0              OR      B                   ; ... to ...
...
6C98: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} Skip to object data
...
6CA2: 3A 1E 72        LD      A,($721E)           ; {code.activeObject} Get the active object
...
6CB9: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} Skip the list header
6CBC: CD DC 61        CALL    $61DC               ; {code.CompareHLandDE} Have we checked all objects?
6CBF: D0              RET     NC                  ; Yes, done
6CC0: 3A 1C 72        LD      A,($721C)           ; {} Bump ...
6CC3: 3C              INC     A                   ; ... ?? ...
6CC4: 32 1C 72        LD      ($721C),A           ; {} ... count
6CC7: D5              PUSH    DE                  ; Hold end of all objects
6CC8: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} Get start and end of this object
6CCB: 4E              LD      C,(HL)              
6CCC: D5              PUSH    DE                  
...
6ED1: 32 4F 6F        LD      ($6F4F),A           ; {code.objectSaveName} ... the "SSVDOBJS/DAT" file
6ED4: E5              PUSH    HL                  ; Hold script pointer
6ED5: 3E 30           LD      A,$30               ; Drive number "0" for the end ...
6ED7: 32 A2 6F        LD      ($6FA2),A           ; {code.selectedDiskDrive} ... of the filespec. SSVDOBJS always goes to "0".
;
...
6EF4: 3A A2 6F        LD      A,($6FA2)           ; {code.selectedDiskDrive} Copy drive spec ...
6EF7: 32 73 6F        LD      ($6F73),A           ; {} ... to filename
6EFA: 21 6E BD        LD      HL,$BD6E            ; {+code.diskAccessBuffer} 256 byte buffer needed by DOS
6EFD: 11 62 6F        LD      DE,$6F62            ; {+code.objectSaveFCB} The FCB
...
;
6F02: CD 20 44        CALL    $4420               ; {hard.OPEN_NEW_EXISTING} LSB CHANGED BY CODE ABOVE
...
6F0F: CD C8 61        CALL    $61C8               ; {code.SkipIDCalcEnd} Pointer to object's 3 data bytes
...
;
6F1A: 11 62 6F        LD      DE,$6F62            ; {+code.objectSaveFCB} The FCB
6F1D: CD 39 44        CALL    $4439               ; {hard.WRITE_RECORD} LSB CHANGED BY CODE ABOVE read/write the 3 bytes
...
6F28: CD AD 61        CALL    $61AD               ; {code.FindObjectField} Look for any hit points
...
6F35: CD DC 61        CALL    $61DC               ; {code.CompareHLandDE} All objects done?
6F38: DA 0E 6F        JP      C,$6F0E             ; {} No, continue with next object
;
6F3B: 11 62 6F        LD      DE,$6F62            ; {+code.objectSaveFCB} FCB for save file
6F3E: CD 28 44        CALL    $4428               ; {hard.CLOSE_FILE} Close the disk file
...
704E: 32 A2 6F        LD      ($6FA2),A           ; {code.selectedDiskDrive} Hold the player's choice
