...
5203: 99 81 1C 00                   ; room=99_4_MAIN_STREET_EAST, Length: 0x011C, Data: 0x00
;
...
53F3:                2F 03          ;           LOAD SECTION FROM DISK, Section: 0x03

53F5: 9C 81 92 00                   ; room=9C_4_EAST_OF_TOWN, Length: 0x0192, Data: 0x00
;
...
558A: 9D 80 88 00                   ; room=9D_4_EAST_OF_BANK, Length: 0x0088, Data: 0x00
;
...
5615: 9E 80 98 00                   ; room=9E_4_SOUTHEAST_OF_BANK, Length: 0x0098, Data: 0x00
;
...
56B0: A9 80 B9 00                   ; room=A9_4_NORTH_OF_HOTEL, Length: 0x00B9, Data: 0x00
;
...
576A:                2F 03          ;           LOAD SECTION FROM DISK, Section: 0x03

576C: AA 80 A8 00                   ; room=AA_4_HOTEL_LOBBY, Length: 0x00A8, Data: 0x00
;
...
5817: AB 80 D4 00                   ; room=AB_4_NORTHEAST_OF_HOTEL, Length: 0x00D4, Data: 0x00
;
...
58EE: AC 80 87 00                   ; room=AC_4_EAST_OF_HOTEL, Length: 0x0087, Data: 0x00
;
...
5978: B2 4D 00                      ; room=B2_4_DESERT_SOUTH3, Length: 0x004D, Data: 0x00
;
...
59C5:                2F 03          ;           LOAD SECTION FROM DISK, Section: 0x03

59C7: B4 80 BB 00                   ; room=B4_4_HIGHWAY_EAST, Length: 0x00BB, Data: 0x00
;
...
5A85: B5 6F 00                      ; room=B5_4_SOUTH_OF_HIGHWAY, Length: 0x006F, Data: 0x00
;
...
5AF6: B9 75 00                      ; room=B9_4_NORTH_OF_HIGHWAY, Length: 0x0075, Data: 0x00
;
...
5B6D: DD 44 00                      ; room=DD_4_HALLWAY, Length: 0x0044, Data: 0x00
;
...
5BB3: DE 4E 00                      ; room=DE_4_NORTH_ROOM, Length: 0x004E, Data: 0x00
;
