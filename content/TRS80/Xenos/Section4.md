...
520A:       04 80 F0                     ;     COM_04_print_message length=0x00F0
...
5304:             00 9C                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_TOWN)
...
5316:                00 AA               ;           COM_00_move_ACTIVE_and_look(room=RM_4_HOTEL_LOBBY)
...
5320:                00 9A               ;           COM_00_move_ACTIVE_and_look(room=RM_4_BANK)
...
5327:       04 14                        ;     COM_04_print_message length=0x0014
...
534A:                00 99               ;           COM_00_move_ACTIVE_and_look(room=RM_4_MAIN_STREET_EAST)
...
5353:       04 80 8A                     ;     COM_04_print_message length=0x008A
...
53E7:             00 B2                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_DESERT_SOUTH3)
53E9:          03                        ;       COM_0A_is_input_phrase("EAST * * *")
53EA:          02                        ;       ELSE goto=0x53ED
53EB:             00 9E                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_SOUTHEAST_OF_BANK)
...
53FC:       04 81 76                     ;     COM_04_print_message length=0x0176
...
557C:             00 AC                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_HOTEL)
557E:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
557F:          02                        ;       ELSE goto=0x5582
5580:             00 9D                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_BANK)
5582:          03                        ;       COM_0A_is_input_phrase("EAST * * *")
5583:          02                        ;       ELSE goto=0x5586
5584:             00 B4                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_HIGHWAY_EAST)
5586:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5587:          02                        ;       ELSE goto=0x558A
5588:             00 99                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_MAIN_STREET_EAST)
...
5590:       04 72                        ;     COM_04_print_message length=0x0072
...
560B:             00 9C                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_TOWN)
560D:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
560E:          02                        ;       ELSE goto=0x5611
560F:             00 9E                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_SOUTHEAST_OF_BANK)
5611:          03                        ;       COM_0A_is_input_phrase("EAST * * *")
5612:          02                        ;       ELSE goto=0x5615
5613:             00 B5                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_SOUTH_OF_HIGHWAY)
...
561B:       04 77                        ;     COM_04_print_message length=0x0077
...
569B:             00 9D                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_BANK)
569D:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
569E:          02                        ;       ELSE goto=0x56A1
569F:             00 B2                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_DESERT_SOUTH3)
...
56A7:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
56AA:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
56AC:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
56AD:          02                        ;       ELSE goto=0x56B0
56AE:             00 9B                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_SOUTH_OF_BANK)
...
56B7:       04 80 99                     ;     COM_04_print_message length=0x0099
...
5762:             00 AB                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_NORTHEAST_OF_HOTEL)
...
5773:       04 80 8A                     ;     COM_04_print_message length=0x008A
...
580D:                00 99               ;           COM_00_move_ACTIVE_and_look(room=RM_4_MAIN_STREET_EAST)
580F:          03                        ;       COM_0A_is_input_phrase("EAST * * *")
5810:          02                        ;       ELSE goto=0x5813
5811:             00 DD                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_HALLWAY)
5813:          54                        ;       COM_0A_is_input_phrase("CLIMB * UP *")
5814:          02                        ;       ELSE goto=0x5817
5815:             00 DD                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_HALLWAY)
...
581E:       04 80 AD                     ;     COM_04_print_message length=0x00AD
...
58DD:             00 AC                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_HOTEL)
...
58E5:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
58E8:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
58EA:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
58EB:          02                        ;       ELSE goto=0x58EE
58EC:             00 A9                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_NORTH_OF_HOTEL)
...
58F4:       04 71                        ;     COM_04_print_message length=0x0071
...
596E:             00 AB                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_NORTHEAST_OF_HOTEL)
5970:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5971:          02                        ;       ELSE goto=0x5974
5972:             00 9C                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_TOWN)
5974:          03                        ;       COM_0A_is_input_phrase("EAST * * *")
5975:          02                        ;       ELSE goto=0x5978
5976:             00 B9                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_NORTH_OF_HIGHWAY4)
...
597D:       04 24                        ;     COM_04_print_message length=0x0024
...
59AA:             00 9B                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_SOUTH_OF_BANK)
...
59BA:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
...
59CE:       04 80 98                     ;     COM_04_print_message length=0x0098
...
5A74:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5A77:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
5A79:          01                        ;       COM_0A_is_input_phrase("NORTH * * *")
5A7A:          02                        ;       ELSE goto=0x5A7D
5A7B:             00 B9                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_NORTH_OF_HIGHWAY4)
5A7D:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5A7E:          02                        ;       ELSE goto=0x5A81
5A7F:             00 B5                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_SOUTH_OF_HIGHWAY)
5A81:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5A82:          02                        ;       ELSE goto=0x5A85
5A83:             00 9C                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_TOWN)
...
5A8A:       04 47                        ;     COM_04_print_message length=0x0047
...
5ADA:             00 B4                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_HIGHWAY_EAST)
...
5AE2:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
...
5AED:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5AF0:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
5AF2:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5AF3:          02                        ;       ELSE goto=0x5AF6
5AF4:             00 9D                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_BANK)
...
5AFB:       04 4D                        ;     COM_04_print_message length=0x004D
...
5B55:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B58:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
5B5A:          02                        ;       COM_0A_is_input_phrase("SOUTH * * *")
5B5B:          02                        ;       ELSE goto=0x5B5E
5B5C:             00 B4                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_HIGHWAY_EAST)
...
5B64:                17 9D 01            ;           COM_17_move_object_to_destination(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B67:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
5B69:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5B6A:          02                        ;       ELSE goto=0x5B6D
5B6B:             00 AC                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_EAST_OF_HOTEL)
...
5B72:       04 1E                        ;     COM_04_print_message length=0x001E
...
5B9F:                00 DE               ;           COM_00_move_ACTIVE_and_look(room=RM_4_NORTH_ROOM)
...
5BA9:                00 DF               ;           COM_00_move_ACTIVE_and_look(room=RM_4_SOUTH_ROOM)
5BAB:          04                        ;       COM_0A_is_input_phrase("WEST * * *")
5BAC:          02                        ;       ELSE goto=0x5BAF
5BAD:             00 AA                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_HOTEL_LOBBY)
5BAF:          55                        ;       COM_0A_is_input_phrase("CLIMB * DOWN *")
5BB0:          02                        ;       ELSE goto=0x5BB3
5BB1:             00 AA                  ;         COM_00_move_ACTIVE_and_look(room=RM_4_HOTEL_LOBBY)
...
5BB8:       04 3A                        ;     COM_04_print_message length=0x003A
...
5C01:                00 DD               ;           COM_00_move_ACTIVE_and_look(room=RM_4_HALLWAY)
...
5C08:       04 3A                        ;     COM_04_print_message length=0x003A
...
5C51:                00 DD               ;           COM_00_move_ACTIVE_and_look(room=RM_4_HALLWAY)
```
