...
```code
5200: 00 8A 50                           ; List_ID=0x00, length=0x0A50 (to 0x5C53)

; --------------------------------------------------------------------------------------------------------------------
;
5203: 99 81 1C 00                        ; ----- Room 0x99 RM_4_MAIN_STREET_EAST, Length: 0x011C, Data: 0x00
;
5207:    03 80 F3                        ;   ---- Section SECTION_03_DESCRIPTION length=0x00F3 (to 0x52FD)
520A:       04 80 F0                     ;     COM_04_print_message length=0x00F0 (to 0x52FD)
...
;
;
52FD:    04 23                           ;   ---- Section SECTION_04_COMMANDS length=0x0023 (to 0x5322)
52FF:       0B 21 0A                     ;     COM_0B_switch length=0x0021 (to 0x5323), function=COM_0A_is_input_phrase(phrase_num)
5302:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
5304:             00 9C                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_TOWN)
;                                        ;       end case
5306:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
5308:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x530E)
530A:                30 96               ;           COM_30_set_current_room(room=RM_3_EAST_ALLEY_INTERSECTION)
530C:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x5308
;                                        ;       end case
530E:          01 08                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0008
5310:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5318)
5312:                14                  ;           COM_14_reverse_status next command
5313:                1C 0E               ;           COM_1C_set_var_object(obj=OBJ_0E_DOOR_MAIN_STREET_EAST_HOTEL)
5315:                8D                  ;           FN_8D_IS_CLOSED
5316:                00 AA               ;           COM_00_move_and_look(room=RM_4_HOTEL_LOBBY)
;                                        ;         end group_OR at 0x5310
;                                        ;       end case
5318:          02 08                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0008
531A:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5322)
531C:                14                  ;           COM_14_reverse_status next command
531D:                1C 10               ;           COM_1C_set_var_object(obj=OBJ_10_DOOR_MAIN_STREET_EAST_BANK)
531F:                8D                  ;           FN_8D_IS_CLOSED
5320:                00 9A               ;           COM_00_move_and_look(room=RM_4_BANK)
;                                        ;         end group_OR at 0x531A
;                                        ;       end case
;                                        ;     end decode_switch at 0x52FF

; --------------------------------------------------------------------------------------------------------------------
;
5322: 9A 28 00                           ; ----- Room 0x9A RM_4_BANK, Length: 0x0028, Data: 0x00
;
5325:    03 16                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0016 (to 0x533D)
5327:       04 14                        ;     COM_04_print_message length=0x0014 (to 0x533D)
...
;
;
533D:    04 0D                           ;   ---- Section SECTION_04_COMMANDS length=0x000D (to 0x534C)
533F:       0B 0B 0A                     ;     COM_0B_switch length=0x000B (to 0x534D), function=COM_0A_is_input_phrase(phrase_num)
5342:          01 08                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0008
5344:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x534C)
5346:                14                  ;           COM_14_reverse_status next command
5347:                1C 11               ;           COM_1C_set_var_object(obj=OBJ_11_DOOR_BANK)
5349:                8D                  ;           FN_8D_IS_CLOSED
534A:                00 99               ;           COM_00_move_and_look(room=RM_4_MAIN_STREET_EAST)
;                                        ;         end group_OR at 0x5344
;                                        ;       end case
;                                        ;     end decode_switch at 0x533F

; --------------------------------------------------------------------------------------------------------------------
;
534C: 9B 80 A6 00                        ; ----- Room 0x9B RM_4_SOUTH_OF_BANK, Length: 0x00A6, Data: 0x00
;
5350:    03 80 8D                        ;   ---- Section SECTION_03_DESCRIPTION length=0x008D (to 0x53E0)
5353:       04 80 8A                     ;     COM_04_print_message length=0x008A (to 0x53E0)
...
;
;
53E0:    04 13                           ;   ---- Section SECTION_04_COMMANDS length=0x0013 (to 0x53F5)
53E2:       0B 11 0A                     ;     COM_0B_switch length=0x0011 (to 0x53F6), function=COM_0A_is_input_phrase(phrase_num)
53E5:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
53E7:             00 B2                  ;         COM_00_move_and_look(room=RM_4_DESERT_SOUTH3)
;                                        ;       end case
53E9:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
53EB:             00 9E                  ;         COM_00_move_and_look(room=RM_4_SOUTHEAST_OF_BANK)
;                                        ;       end case
53ED:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
53EF:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x53F5)
53F1:                30 98               ;           COM_30_set_current_room(room=RM_3_SOUTH_OF_EAST_ALLEY)
53F3:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x53EF
;                                        ;       end case
;                                        ;     end decode_switch at 0x53E2

; --------------------------------------------------------------------------------------------------------------------
;
53F5: 9C 81 92 00                        ; ----- Room 0x9C RM_4_EAST_OF_TOWN, Length: 0x0192, Data: 0x00
;
53F9:    03 81 79                        ;   ---- Section SECTION_03_DESCRIPTION length=0x0179 (to 0x5575)
53FC:       04 81 76                     ;     COM_04_print_message length=0x0176 (to 0x5575)
...
;
;
5575:    04 13                           ;   ---- Section SECTION_04_COMMANDS length=0x0013 (to 0x558A)
5577:       0B 11 0A                     ;     COM_0B_switch length=0x0011 (to 0x558B), function=COM_0A_is_input_phrase(phrase_num)
557A:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
557C:             00 AC                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_HOTEL)
;                                        ;       end case
557E:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
5580:             00 9D                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_BANK)
;                                        ;       end case
5582:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
5584:             00 B4                  ;         COM_00_move_and_look(room=RM_4_HIGHWAY_EAST)
;                                        ;       end case
5586:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
...
;
558E:    03 74                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0074 (to 0x5604)
5590:       04 72                        ;     COM_04_print_message length=0x0072 (to 0x5604)
...
;
;
5604:    04 0F                           ;   ---- Section SECTION_04_COMMANDS length=0x000F (to 0x5615)
5606:       0B 0D 0A                     ;     COM_0B_switch length=0x000D (to 0x5616), function=COM_0A_is_input_phrase(phrase_num)
5609:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
560B:             00 9C                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_TOWN)
;                                        ;       end case
560D:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
560F:             00 9E                  ;         COM_00_move_and_look(room=RM_4_SOUTHEAST_OF_BANK)
;                                        ;       end case
5611:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
5613:             00 B5                  ;         COM_00_move_and_look(room=RM_4_SOUTH_OF_HIGHWAY)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5606

; --------------------------------------------------------------------------------------------------------------------
;
5615: 9E 80 98 00                        ; ----- Room 0x9E RM_4_SOUTHEAST_OF_BANK, Length: 0x0098, Data: 0x00
;
5619:    03 79                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0079 (to 0x5694)
561B:       04 77                        ;     COM_04_print_message length=0x0077 (to 0x5694)
...
;
;
5694:    04 1A                           ;   ---- Section SECTION_04_COMMANDS length=0x001A (to 0x56B0)
5696:       0B 18 0A                     ;     COM_0B_switch length=0x0018 (to 0x56B1), function=COM_0A_is_input_phrase(phrase_num)
5699:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
569B:             00 9D                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_BANK)
;                                        ;       end case
569D:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
569F:             00 B2                  ;         COM_00_move_and_look(room=RM_4_DESERT_SOUTH3)
;                                        ;       end case
56A1:          03 09                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0009
56A3:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x56AC)
56A5:                30 E2               ;           COM_30_set_current_room(room=RM_5_DESERT23)
56A7:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
56AA:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x56A3
;                                        ;       end case
56AC:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
56AE:             00 9B                  ;         COM_00_move_and_look(room=RM_4_SOUTH_OF_BANK)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5696

; --------------------------------------------------------------------------------------------------------------------
;
56B0: A9 80 B9 00                        ; ----- Room 0xA9 RM_4_NORTH_OF_HOTEL, Length: 0x00B9, Data: 0x00
;
56B4:    03 80 9C                        ;   ---- Section SECTION_03_DESCRIPTION length=0x009C (to 0x5753)
56B7:       04 80 99                     ;     COM_04_print_message length=0x0099 (to 0x5753)
...
;
;
5753:    04 17                           ;   ---- Section SECTION_04_COMMANDS length=0x0017 (to 0x576C)
5755:       0B 15 0A                     ;     COM_0B_switch length=0x0015 (to 0x576D), function=COM_0A_is_input_phrase(phrase_num)
5758:          01 06                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0006
575A:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5760)
575C:                30 B8               ;           COM_30_set_current_room(room=RM_3_DESERT_NORTH2)
575E:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x575A
;                                        ;       end case
5760:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
5762:             00 AB                  ;         COM_00_move_and_look(room=RM_4_NORTHEAST_OF_HOTEL)
;                                        ;       end case
5764:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
5766:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x576C)
...
;                                        ;       end case
;                                        ;     end decode_switch at 0x5755

; --------------------------------------------------------------------------------------------------------------------
;
576C: AA 80 A8 00                        ; ----- Room 0xAA RM_4_HOTEL_LOBBY, Length: 0x00A8, Data: 0x00
;
5770:    03 80 8D                        ;   ---- Section SECTION_03_DESCRIPTION length=0x008D (to 0x5800)
5773:       04 80 8A                     ;     COM_04_print_message length=0x008A (to 0x5800)
...
;
;
5800:    04 15                           ;   ---- Section SECTION_04_COMMANDS length=0x0015 (to 0x5817)
5802:       0B 13 0A                     ;     COM_0B_switch length=0x0013 (to 0x5818), function=COM_0A_is_input_phrase(phrase_num)
5805:          02 08                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0008
5807:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x580F)
5809:                14                  ;           COM_14_reverse_status next command
580A:                1C 0F               ;           COM_1C_set_var_object(obj=OBJ_0F_DOOR_HOTEL_LOBBY)
580C:                8D                  ;           FN_8D_IS_CLOSED
580D:                00 99               ;           COM_00_move_and_look(room=RM_4_MAIN_STREET_EAST)
;                                        ;         end group_OR at 0x5807
;                                        ;       end case
580F:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
5811:             00 DD                  ;         COM_00_move_and_look(room=RM_4_HALLWAY)
;                                        ;       end case
5813:          54 02                     ;       case COM_0A_is_input_phrase("CLIMB * UP *"), length=0x0002
5815:             00 DD                  ;         COM_00_move_and_look(room=RM_4_HALLWAY)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5802

; --------------------------------------------------------------------------------------------------------------------
;
5817: AB 80 D4 00                        ; ----- Room 0xAB RM_4_NORTHEAST_OF_HOTEL, Length: 0x00D4, Data: 0x00
;
581B:    03 80 B0                        ;   ---- Section SECTION_03_DESCRIPTION length=0x00B0 (to 0x58CE)
581E:       04 80 AD                     ;     COM_04_print_message length=0x00AD (to 0x58CE)
...
;
;
58CE:    04 1E                           ;   ---- Section SECTION_04_COMMANDS length=0x001E (to 0x58EE)
58D0:       0B 1C 0A                     ;     COM_0B_switch length=0x001C (to 0x58EF), function=COM_0A_is_input_phrase(phrase_num)
58D3:          01 06                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0006
58D5:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x58DB)
58D7:                30 B8               ;           COM_30_set_current_room(room=RM_3_DESERT_NORTH2)
58D9:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x58D5
;                                        ;       end case
58DB:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
58DD:             00 AC                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_HOTEL)
;                                        ;       end case
58DF:          03 09                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0009
58E1:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x58EA)
58E3:                30 F1               ;           COM_30_set_current_room(room=RM_5_DESERT_SMALL_TRAIL1)
58E5:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
58E8:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x58E1
;                                        ;       end case
58EA:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
...
;
58F2:    03 73                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0073 (to 0x5967)
58F4:       04 71                        ;     COM_04_print_message length=0x0071 (to 0x5967)
...
;
;
5967:    04 0F                           ;   ---- Section SECTION_04_COMMANDS length=0x000F (to 0x5978)
5969:       0B 0D 0A                     ;     COM_0B_switch length=0x000D (to 0x5979), function=COM_0A_is_input_phrase(phrase_num)
596C:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
596E:             00 AB                  ;         COM_00_move_and_look(room=RM_4_NORTHEAST_OF_HOTEL)
;                                        ;       end case
5970:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
5972:             00 9C                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_TOWN)
;                                        ;       end case
5974:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
5976:             00 B9                  ;         COM_00_move_and_look(room=RM_4_NORTH_OF_HIGHWAY4)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5969

; --------------------------------------------------------------------------------------------------------------------
;
5978: B2 4D 00                           ; ----- Room 0xB2 RM_4_DESERT_SOUTH3, Length: 0x004D, Data: 0x00
;
597B:    03 26                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0026 (to 0x59A3)
597D:       04 24                        ;     COM_04_print_message length=0x0024 (to 0x59A3)
...
;
;
59A3:    04 22                           ;   ---- Section SECTION_04_COMMANDS length=0x0022 (to 0x59C7)
59A5:       0B 20 0A                     ;     COM_0B_switch length=0x0020 (to 0x59C8), function=COM_0A_is_input_phrase(phrase_num)
59A8:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
59AA:             00 9B                  ;         COM_00_move_and_look(room=RM_4_SOUTH_OF_BANK)
;                                        ;       end case
59AC:          02 06                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0006
59AE:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x59B4)
59B0:                30 B3               ;           COM_30_set_current_room(room=RM_3_DESERT1)
59B2:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x59AE
;                                        ;       end case
59B4:          03 09                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0009
59B6:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x59BF)
59B8:                30 E2               ;           COM_30_set_current_room(room=RM_5_DESERT23)
59BA:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
59BD:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x59B6
;                                        ;       end case
59BF:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
59C1:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x59C7)
59C3:                30 B1               ;           COM_30_set_current_room(room=RM_3_DESERT_SOUTH2)
59C5:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x59C1
;                                        ;       end case
;                                        ;     end decode_switch at 0x59A5

; --------------------------------------------------------------------------------------------------------------------
;
59C7: B4 80 BB 00                        ; ----- Room 0xB4 RM_4_HIGHWAY_EAST, Length: 0x00BB, Data: 0x00
;
59CB:    03 80 9B                        ;   ---- Section SECTION_03_DESCRIPTION length=0x009B (to 0x5A69)
59CE:       04 80 98                     ;     COM_04_print_message length=0x0098 (to 0x5A69)
...
;
;
5A69:    04 1A                           ;   ---- Section SECTION_04_COMMANDS length=0x001A (to 0x5A85)
5A6B:       0B 18 0A                     ;     COM_0B_switch length=0x0018 (to 0x5A86), function=COM_0A_is_input_phrase(phrase_num)
5A6E:          03 09                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0009
5A70:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5A79)
5A72:                30 F0               ;           COM_30_set_current_room(room=RM_5_EMPTY_HIGHWAY_DESERT)
5A74:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5A77:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5A70
;                                        ;       end case
5A79:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
5A7B:             00 B9                  ;         COM_00_move_and_look(room=RM_4_NORTH_OF_HIGHWAY4)
;                                        ;       end case
5A7D:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
...
;                                        ;       end case
;                                        ;     end decode_switch at 0x5A6B

; --------------------------------------------------------------------------------------------------------------------
;
5A85: B5 6F 00                           ; ----- Room 0xB5 RM_4_SOUTH_OF_HIGHWAY, Length: 0x006F, Data: 0x00
;
5A88:    03 49                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0049 (to 0x5AD3)
5A8A:       04 47                        ;     COM_04_print_message length=0x0047 (to 0x5AD3)
...
;
;
5AD3:    04 21                           ;   ---- Section SECTION_04_COMMANDS length=0x0021 (to 0x5AF6)
5AD5:       0B 1F 0A                     ;     COM_0B_switch length=0x001F (to 0x5AF7), function=COM_0A_is_input_phrase(phrase_num)
5AD8:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
5ADA:             00 B4                  ;         COM_00_move_and_look(room=RM_4_HIGHWAY_EAST)
;                                        ;       end case
5ADC:          02 09                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0009
5ADE:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5AE7)
5AE0:                30 E2               ;           COM_30_set_current_room(room=RM_5_DESERT23)
5AE2:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5AE5:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5ADE
;                                        ;       end case
5AE7:          03 09                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0009
5AE9:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5AF2)
5AEB:                30 F0               ;           COM_30_set_current_room(room=RM_5_EMPTY_HIGHWAY_DESERT)
5AED:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5AF0:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5AE9
;                                        ;       end case
5AF2:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
5AF4:             00 9D                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_BANK)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5AD5

; --------------------------------------------------------------------------------------------------------------------
;
5AF6: B9 75 00                           ; ----- Room 0xB9 RM_4_NORTH_OF_HIGHWAY4, Length: 0x0075, Data: 0x00
;
5AF9:    03 4F                           ;   ---- Section SECTION_03_DESCRIPTION length=0x004F (to 0x5B4A)
5AFB:       04 4D                        ;     COM_04_print_message length=0x004D (to 0x5B4A)
...
;
;
5B4A:    04 21                           ;   ---- Section SECTION_04_COMMANDS length=0x0021 (to 0x5B6D)
5B4C:       0B 1F 0A                     ;     COM_0B_switch length=0x001F (to 0x5B6E), function=COM_0A_is_input_phrase(phrase_num)
5B4F:          01 09                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0009
5B51:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5B5A)
5B53:                30 F1               ;           COM_30_set_current_room(room=RM_5_DESERT_SMALL_TRAIL1)
5B55:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B58:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5B51
;                                        ;       end case
5B5A:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
5B5C:             00 B4                  ;         COM_00_move_and_look(room=RM_4_HIGHWAY_EAST)
;                                        ;       end case
5B5E:          03 09                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0009
5B60:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5B69)
5B62:                30 F0               ;           COM_30_set_current_room(room=RM_5_EMPTY_HIGHWAY_DESERT)
5B64:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B67:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5B60
;                                        ;       end case
5B69:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
5B6B:             00 AC                  ;         COM_00_move_and_look(room=RM_4_EAST_OF_HOTEL)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5B4C

; --------------------------------------------------------------------------------------------------------------------
;
5B6D: DD 44 00                           ; ----- Room 0xDD RM_4_HALLWAY, Length: 0x0044, Data: 0x00
;
5B70:    03 20                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0020 (to 0x5B92)
5B72:       04 1E                        ;     COM_04_print_message length=0x001E (to 0x5B92)
...
;
;
5B92:    04 1F                           ;   ---- Section SECTION_04_COMMANDS length=0x001F (to 0x5BB3)
5B94:       0B 1D 0A                     ;     COM_0B_switch length=0x001D (to 0x5BB4), function=COM_0A_is_input_phrase(phrase_num)
5B97:          01 08                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0008
5B99:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5BA1)
5B9B:                14                  ;           COM_14_reverse_status next command
5B9C:                1C 16               ;           COM_1C_set_var_object(obj=OBJ_16_RED_DOOR_HALLWAY)
5B9E:                8D                  ;           FN_8D_IS_CLOSED
5B9F:                00 DE               ;           COM_00_move_and_look(room=RM_4_NORTH_ROOM)
;                                        ;         end group_OR at 0x5B99
;                                        ;       end case
5BA1:          02 08                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0008
5BA3:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5BAB)
5BA5:                14                  ;           COM_14_reverse_status next command
5BA6:                1C 18               ;           COM_1C_set_var_object(obj=OBJ_18_BLUE_DOOR_HALLWAY)
5BA8:                8D                  ;           FN_8D_IS_CLOSED
5BA9:                00 DF               ;           COM_00_move_and_look(room=RM_4_SOUTH_ROOM)
;                                        ;         end group_OR at 0x5BA3
;                                        ;       end case
5BAB:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
5BAD:             00 AA                  ;         COM_00_move_and_look(room=RM_4_HOTEL_LOBBY)
;                                        ;       end case
5BAF:          55 02                     ;       case COM_0A_is_input_phrase("CLIMB * DOWN *"), length=0x0002
5BB1:             00 AA                  ;         COM_00_move_and_look(room=RM_4_HOTEL_LOBBY)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5B94

; --------------------------------------------------------------------------------------------------------------------
;
5BB3: DE 4E 00                           ; ----- Room 0xDE RM_4_NORTH_ROOM, Length: 0x004E, Data: 0x00
;
5BB6:    03 3C                           ;   ---- Section SECTION_03_DESCRIPTION length=0x003C (to 0x5BF4)
5BB8:       04 3A                        ;     COM_04_print_message length=0x003A (to 0x5BF4)
...
;
;
5BF4:    04 0D                           ;   ---- Section SECTION_04_COMMANDS length=0x000D (to 0x5C03)
5BF6:       0B 0B 0A                     ;     COM_0B_switch length=0x000B (to 0x5C04), function=COM_0A_is_input_phrase(phrase_num)
5BF9:          02 08                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0008
5BFB:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5C03)
5BFD:                14                  ;           COM_14_reverse_status next command
5BFE:                1C 17               ;           COM_1C_set_var_object(obj=OBJ_17_DOOR_NORTH_ROOM)
5C00:                8D                  ;           FN_8D_IS_CLOSED
5C01:                00 DD               ;           COM_00_move_and_look(room=RM_4_HALLWAY)
;                                        ;         end group_OR at 0x5BFB
;                                        ;       end case
;                                        ;     end decode_switch at 0x5BF6

; --------------------------------------------------------------------------------------------------------------------
;
5C03: DF 4E 00                           ; ----- Room 0xDF RM_4_SOUTH_ROOM, Length: 0x004E, Data: 0x00
;
5C06:    03 3C                           ;   ---- Section SECTION_03_DESCRIPTION length=0x003C (to 0x5C44)
5C08:       04 3A                        ;     COM_04_print_message length=0x003A (to 0x5C44)
...
;
;
5C44:    04 0D                           ;   ---- Section SECTION_04_COMMANDS length=0x000D (to 0x5C53)
5C46:       0B 0B 0A                     ;     COM_0B_switch length=0x000B (to 0x5C54), function=COM_0A_is_input_phrase(phrase_num)
5C49:          01 08                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0008
5C4B:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5C53)
5C4D:                14                  ;           COM_14_reverse_status next command
5C4E:                1C 19               ;           COM_1C_set_var_object(obj=OBJ_19_DOOR_SOUTH_ROOM)
5C50:                8D                  ;           FN_8D_IS_CLOSED
5C51:                00 DD               ;           COM_00_move_and_look(room=RM_4_HALLWAY)
;                                        ;         end group_OR at 0x5C4B
;                                        ;       end case
;                                        ;     end decode_switch at 0x5C46
```
