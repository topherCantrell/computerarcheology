...
```code
5200: 00 8A 1D                           ; List_ID=0x00, length=0x0A1D (to 0x5C20)

; --------------------------------------------------------------------------------------------------------------------
;
5203: 8A 81 48 00                        ; ----- Room 0x8A RM_2_WEST_OF_TOWN, Length: 0x0148, Data: 0x00
;
5207:    03 81 2B                        ;   ---- Section SECTION_03_DESCRIPTION length=0x012B (to 0x5335)
520A:       04 81 28                     ;     COM_04_print_message length=0x0128 (to 0x5335)
...
;
;
5335:    04 17                           ;   ---- Section SECTION_04_COMMANDS length=0x0017 (to 0x534E)
5337:       0B 15 0A                     ;     COM_0B_switch length=0x0015 (to 0x534F), function=COM_0A_is_input_phrase(phrase_num)
533A:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
533C:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5342)
533E:                30 89               ;           COM_30_set_current_room(room=RM_1_CITY_LIMIT)
5340:                2F 01               ;           COM_2F_load_section_from_disk(section=1)
;                                        ;         end group_AND at 0x533C
;                                        ;       end case
5342:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
5344:             00 8D                  ;         COM_00_move_and_look(room=RM_2_MAIN_STREET_WEST)
;                                        ;       end case
5346:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
5348:             00 A0                  ;         COM_00_move_and_look(room=RM_2_WEST_SIDE_OF_SALOON)
;                                        ;       end case
534A:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
534C:             00 8B                  ;         COM_00_move_and_look(room=RM_2_WEST_OF_SHERIFF)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5337

; --------------------------------------------------------------------------------------------------------------------
;
534E: 8B 80 C2 00                        ; ----- Room 0x8B RM_2_WEST_OF_SHERIFF, Length: 0x00C2, Data: 0x00
;
5352:    03 80 A5                        ;   ---- Section SECTION_03_DESCRIPTION length=0x00A5 (to 0x53FA)
5355:       04 80 A2                     ;     COM_04_print_message length=0x00A2 (to 0x53FA)
...
;
;
53FA:    04 17                           ;   ---- Section SECTION_04_COMMANDS length=0x0017 (to 0x5413)
53FC:       0B 15 0A                     ;     COM_0B_switch length=0x0015 (to 0x5414), function=COM_0A_is_input_phrase(phrase_num)
53FF:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
5401:             00 8A                  ;         COM_00_move_and_look(room=RM_2_WEST_OF_TOWN)
;                                        ;       end case
5403:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
5405:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x540B)
...
;                                        ;       end case
540B:          02 06                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0006
540D:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5413)
540F:                30 8C               ;           COM_30_set_current_room(room=RM_1_SOUTHWEST_OF_SHERIFF)
5411:                2F 01               ;           COM_2F_load_section_from_disk(section=1)
;                                        ;         end group_AND at 0x540D
;                                        ;       end case
;                                        ;     end decode_switch at 0x53FC

; --------------------------------------------------------------------------------------------------------------------
;
5413: 8D 81 62 00                        ; ----- Room 0x8D RM_2_MAIN_STREET_WEST, Length: 0x0162, Data: 0x00
;
5417:    03 81 39                        ;   ---- Section SECTION_03_DESCRIPTION length=0x0139 (to 0x5553)
541A:       04 81 36                     ;     COM_04_print_message length=0x0136 (to 0x5553)
...
;
;
5553:    04 23                           ;   ---- Section SECTION_04_COMMANDS length=0x0023 (to 0x5578)
5555:       0B 21 0A                     ;     COM_0B_switch length=0x0021 (to 0x5579), function=COM_0A_is_input_phrase(phrase_num)
5558:          01 08                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0008
555A:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5562)
555C:                14                  ;           COM_14_reverse_status next command
555D:                1C 06               ;           COM_1C_set_var_object(obj=OBJ_06_DOOR_MAIN_STREET_WEST)
555F:                8D                  ;           FN_8D_IS_CLOSED
5560:                00 A2               ;           COM_00_move_and_look(room=RM_2_SALOON)
;                                        ;         end group_OR at 0x555A
;                                        ;       end case
5562:          03 06                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0006
5564:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x556A)
5566:                30 90               ;           COM_30_set_current_room(room=RM_3_WEST_ALLEY_INTERSECTION)
5568:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x5564
;                                        ;       end case
556A:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
556C:             00 8A                  ;         COM_00_move_and_look(room=RM_2_WEST_OF_TOWN)
;                                        ;       end case
556E:          02 08                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0008
5570:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5578)
5572:                14                  ;           COM_14_reverse_status next command
5573:                1C 08               ;           COM_1C_set_var_object(obj=OBJ_08_DOOR_MAIN_STREET_WEST)
5575:                8D                  ;           FN_8D_IS_CLOSED
5576:                00 8E               ;           COM_00_move_and_look(room=RM_2_SHERIFFS_OFFICE)
;                                        ;         end group_OR at 0x5570
;                                        ;       end case
;                                        ;     end decode_switch at 0x5555

; --------------------------------------------------------------------------------------------------------------------
;
5578: 8E 80 8D 00                        ; ----- Room 0x8E RM_2_SHERIFFS_OFFICE, Length: 0x008D, Data: 0x00
;
557C:    03 7B                           ;   ---- Section SECTION_03_DESCRIPTION length=0x007B (to 0x55F9)
557E:       04 79                        ;     COM_04_print_message length=0x0079 (to 0x55F9)
...
;
;
55F9:    04 0D                           ;   ---- Section SECTION_04_COMMANDS length=0x000D (to 0x5608)
55FB:       0B 0B 0A                     ;     COM_0B_switch length=0x000B (to 0x5609), function=COM_0A_is_input_phrase(phrase_num)
55FE:          01 08                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0008
5600:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5608)
5602:                14                  ;           COM_14_reverse_status next command
5603:                1C 09               ;           COM_1C_set_var_object(obj=OBJ_09_DOOR_SHERIFFS_OFFICE)
5605:                8D                  ;           FN_8D_IS_CLOSED
5606:                00 8D               ;           COM_00_move_and_look(room=RM_2_MAIN_STREET_WEST)
;                                        ;         end group_OR at 0x5600
;                                        ;       end case
;                                        ;     end decode_switch at 0x55FB

; --------------------------------------------------------------------------------------------------------------------
;
5608: 8F 66 00                           ; ----- Room 0x8F RM_2_SOUTH_OF_SHERIFF, Length: 0x0066, Data: 0x00
;
560B:    03 4A                           ;   ---- Section SECTION_03_DESCRIPTION length=0x004A (to 0x5657)
560D:       04 48                        ;     COM_04_print_message length=0x0048 (to 0x5657)
...
;
;
5657:    04 17                           ;   ---- Section SECTION_04_COMMANDS length=0x0017 (to 0x5670)
5659:       0B 15 0A                     ;     COM_0B_switch length=0x0015 (to 0x5671), function=COM_0A_is_input_phrase(phrase_num)
565C:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
565E:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5664)
5660:                30 8C               ;           COM_30_set_current_room(room=RM_1_SOUTHWEST_OF_SHERIFF)
5662:                2F 01               ;           COM_2F_load_section_from_disk(section=1)
;                                        ;         end group_AND at 0x565E
;                                        ;       end case
5664:          02 06                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0006
5666:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x566C)
...
;                                        ;       end case
566C:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
566E:             00 92                  ;         COM_00_move_and_look(room=RM_2_SOUTH_OF_WEST_ALLEY)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5659

; --------------------------------------------------------------------------------------------------------------------
;
5670: 92 80 8C 00                        ; ----- Room 0x92 RM_2_SOUTH_OF_WEST_ALLEY, Length: 0x008C, Data: 0x00
;
5674:    03 68                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0068 (to 0x56DE)
5676:       04 66                        ;     COM_04_print_message length=0x0066 (to 0x56DE)
...
;
;
56DE:    04 1F                           ;   ---- Section SECTION_04_COMMANDS length=0x001F (to 0x56FF)
56E0:       0B 1D 0A                     ;     COM_0B_switch length=0x001D (to 0x5700), function=COM_0A_is_input_phrase(phrase_num)
56E3:          03 06                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0006
56E5:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x56EB)
56E7:                30 95               ;           COM_30_set_current_room(room=RM_3_SOUTH_OF_SLIMS)
56E9:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x56E5
;                                        ;       end case
56EB:          01 06                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0006
56ED:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x56F3)
56EF:                30 91               ;           COM_30_set_current_room(room=RM_3_WEST_ALLEY_SOUTH)
56F1:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x56ED
;                                        ;       end case
56F3:          02 06                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0006
56F5:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x56FB)
56F7:                30 B1               ;           COM_30_set_current_room(room=RM_3_DESERT_SOUTH2)
56F9:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x56F5
;                                        ;       end case
56FB:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
56FD:             00 8F                  ;         COM_00_move_and_look(room=RM_2_SOUTH_OF_SHERIFF)
;                                        ;       end case
;                                        ;     end decode_switch at 0x56E0

; --------------------------------------------------------------------------------------------------------------------
;
56FF: 9F 80 D3 00                        ; ----- Room 0x9F RM_2_NORTHWEST_OF_SALOON, Length: 0x00D3, Data: 0x00
;
5703:    03 80 B3                        ;   ---- Section SECTION_03_DESCRIPTION length=0x00B3 (to 0x57B9)
5706:       04 80 B0                     ;     COM_04_print_message length=0x00B0 (to 0x57B9)
...
;
;
57B9:    04 1A                           ;   ---- Section SECTION_04_COMMANDS length=0x001A (to 0x57D5)
57BB:       0B 18 0A                     ;     COM_0B_switch length=0x0018 (to 0x57D6), function=COM_0A_is_input_phrase(phrase_num)
57BE:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
57C0:             00 B6                  ;         COM_00_move_and_look(room=RM_2_DESERT_NORTH1)
;                                        ;       end case
57C2:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
57C4:             00 A0                  ;         COM_00_move_and_look(room=RM_2_WEST_SIDE_OF_SALOON)
;                                        ;       end case
57C6:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
57C8:             00 A1                  ;         COM_00_move_and_look(room=RM_2_NORTH_OF_SALOON)
;                                        ;       end case
57CA:          04 09                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0009
57CC:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x57D5)
57CE:                30 F5               ;           COM_30_set_current_room(room=RM_5_DESERT27)
57D0:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
57D3:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x57CC
;                                        ;       end case
;                                        ;     end decode_switch at 0x57BB

; --------------------------------------------------------------------------------------------------------------------
;
57D5: A0 80 F5 00                        ; ----- Room 0xA0 RM_2_WEST_SIDE_OF_SALOON, Length: 0x00F5, Data: 0x00
;
57D9:    03 80 C0                        ;   ---- Section SECTION_03_DESCRIPTION length=0x00C0 (to 0x589C)
57DC:       04 80 BD                     ;     COM_04_print_message length=0x00BD (to 0x589C)
...
;
;
589C:    04 2F                           ;   ---- Section SECTION_04_COMMANDS length=0x002F (to 0x58CD)
589E:       0B 2D 0A                     ;     COM_0B_switch length=0x002D (to 0x58CE), function=COM_0A_is_input_phrase(phrase_num)
58A1:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
58A3:             00 9F                  ;         COM_00_move_and_look(room=RM_2_NORTHWEST_OF_SALOON)
;                                        ;       end case
58A5:          55 08                     ;       case COM_0A_is_input_phrase("CLIMB * DOWN *"), length=0x0008
58A7:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x58AF)
58A9:                14                  ;           COM_14_reverse_status next command
58AA:                1C 14               ;           COM_1C_set_var_object(obj=OBJ_14_DOOR_COVERED_SHELTER)
58AC:                8D                  ;           FN_8D_IS_CLOSED
58AD:                00 DB               ;           COM_00_move_and_look(room=RM_2_STORM_SHELTER)
;                                        ;         end group_OR at 0x58A7
;                                        ;       end case
58AF:          36 10                     ;       case COM_0A_is_input_phrase("ENTER * * *"), length=0x0010
58B1:             0D 0E                  ;         COM_0D_group_AND length=0x000E (to 0x58C1)
58B3:                0E 04               ;           COM_0E_group_OR length=0x0004 (to 0x58B9)
58B5:                   09 00            ;             COM_09_is_noun2(obj=nothing)
58B7:                   09 5F            ;             COM_09_is_noun2(obj=OBJ_5F_SHELTER)
;                                        ;           end group_OR at 0x58B3
58B9:                0E 06               ;           COM_0E_group_OR length=0x0006 (to 0x58C1)
58BB:                   14               ;             COM_14_reverse_status next command
58BC:                   1C 14            ;             COM_1C_set_var_object(obj=OBJ_14_DOOR_COVERED_SHELTER)
58BE:                   8D               ;             FN_8D_IS_CLOSED
58BF:                   00 DB            ;             COM_00_move_and_look(room=RM_2_STORM_SHELTER)
;                                        ;           end group_OR at 0x58B9
;                                        ;         end group_AND at 0x58B1
;                                        ;       end case
58C1:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
58C3:             00 8A                  ;         COM_00_move_and_look(room=RM_2_WEST_OF_TOWN)
;                                        ;       end case
58C5:          04 06                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0006
58C7:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x58CD)
58C9:                30 AF               ;           COM_30_set_current_room(room=RM_1_NORTH_OF_HIGHWAY3)
58CB:                2F 01               ;           COM_2F_load_section_from_disk(section=1)
;                                        ;         end group_AND at 0x58C7
;                                        ;       end case
;                                        ;     end decode_switch at 0x589E

; --------------------------------------------------------------------------------------------------------------------
;
58CD: A1 80 82 00                        ; ----- Room 0xA1 RM_2_NORTH_OF_SALOON, Length: 0x0082, Data: 0x00
;
58D1:    03 6E                           ;   ---- Section SECTION_03_DESCRIPTION length=0x006E (to 0x5941)
58D3:       04 6C                        ;     COM_04_print_message length=0x006C (to 0x5941)
...
;
;
5941:    04 0F                           ;   ---- Section SECTION_04_COMMANDS length=0x000F (to 0x5952)
5943:       0B 0D 0A                     ;     COM_0B_switch length=0x000D (to 0x5953), function=COM_0A_is_input_phrase(phrase_num)
5946:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
5948:             00 B6                  ;         COM_00_move_and_look(room=RM_2_DESERT_NORTH1)
;                                        ;       end case
594A:          03 02                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0002
594C:             00 A3                  ;         COM_00_move_and_look(room=RM_2_NORTH_OF_WEST_ALLEY)
;                                        ;       end case
594E:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
5950:             00 9F                  ;         COM_00_move_and_look(room=RM_2_NORTHWEST_OF_SALOON)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5943

; --------------------------------------------------------------------------------------------------------------------
;
5952: A2 6E 00                           ; ----- Room 0xA2 RM_2_SALOON, Length: 0x006E, Data: 0x00
;
5955:    03 5C                           ;   ---- Section SECTION_03_DESCRIPTION length=0x005C (to 0x59B3)
5957:       04 5A                        ;     COM_04_print_message length=0x005A (to 0x59B3)
...
;
;
59B3:    04 0D                           ;   ---- Section SECTION_04_COMMANDS length=0x000D (to 0x59C2)
59B5:       0B 0B 0A                     ;     COM_0B_switch length=0x000B (to 0x59C3), function=COM_0A_is_input_phrase(phrase_num)
59B8:          02 08                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0008
59BA:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x59C2)
59BC:                14                  ;           COM_14_reverse_status next command
59BD:                1C 07               ;           COM_1C_set_var_object(obj=OBJ_07_DOOR_SALOON)
59BF:                8D                  ;           FN_8D_IS_CLOSED
59C0:                00 8D               ;           COM_00_move_and_look(room=RM_2_MAIN_STREET_WEST)
;                                        ;         end group_OR at 0x59BA
;                                        ;       end case
;                                        ;     end decode_switch at 0x59B5

; --------------------------------------------------------------------------------------------------------------------
;
59C2: A3 80 C8 00                        ; ----- Room 0xA3 RM_2_NORTH_OF_WEST_ALLEY, Length: 0x00C8, Data: 0x00
;
59C6:    03 80 AB                        ;   ---- Section SECTION_03_DESCRIPTION length=0x00AB (to 0x5A74)
59C9:       04 80 A8                     ;     COM_04_print_message length=0x00A8 (to 0x5A74)
...
;
;
5A74:    04 17                           ;   ---- Section SECTION_04_COMMANDS length=0x0017 (to 0x5A8D)
5A76:       0B 15 0A                     ;     COM_0B_switch length=0x0015 (to 0x5A8E), function=COM_0A_is_input_phrase(phrase_num)
...
;                                        ;       end case
5A81:          03 06                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0006
5A83:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5A89)
5A85:                30 A5               ;           COM_30_set_current_room(room=RM_3_NORTH_OF_BOBS)
5A87:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x5A83
;                                        ;       end case
5A89:          04 02                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0002
5A8B:             00 A1                  ;         COM_00_move_and_look(room=RM_2_NORTH_OF_SALOON)
;                                        ;       end case
;                                        ;     end decode_switch at 0x5A76

; --------------------------------------------------------------------------------------------------------------------
;
5A8D: A4 44 00                           ; ----- Room 0xA4 RM_2_WEST_ALLEY_NORTH, Length: 0x0044, Data: 0x00
;
5A90:    03 30                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0030 (to 0x5AC2)
5A92:       04 2E                        ;     COM_04_print_message length=0x002E (to 0x5AC2)
...
;
;
5AC2:    04 0F                           ;   ---- Section SECTION_04_COMMANDS length=0x000F (to 0x5AD3)
5AC4:       0B 0D 0A                     ;     COM_0B_switch length=0x000D (to 0x5AD4), function=COM_0A_is_input_phrase(phrase_num)
5AC7:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
5AC9:             00 A3                  ;         COM_00_move_and_look(room=RM_2_NORTH_OF_WEST_ALLEY)
;                                        ;       end case
5ACB:          02 06                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0006
5ACD:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5AD3)
5ACF:                30 90               ;           COM_30_set_current_room(room=RM_3_WEST_ALLEY_INTERSECTION)
5AD1:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x5ACD
;                                        ;       end case
;                                        ;     end decode_switch at 0x5AC4

; --------------------------------------------------------------------------------------------------------------------
;
5AD3: B6 51 00                           ; ----- Room 0xB6 RM_2_DESERT_NORTH1, Length: 0x0051, Data: 0x00
;
5AD6:    03 2E                           ;   ---- Section SECTION_03_DESCRIPTION length=0x002E (to 0x5B06)
5AD8:       04 2C                        ;     COM_04_print_message length=0x002C (to 0x5B06)
...
;
;
5B06:    04 1E                           ;   ---- Section SECTION_04_COMMANDS length=0x001E (to 0x5B26)
5B08:       0B 1C 0A                     ;     COM_0B_switch length=0x001C (to 0x5B27), function=COM_0A_is_input_phrase(phrase_num)
5B0B:          01 02                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0002
5B0D:             00 B7                  ;         COM_00_move_and_look(room=RM_2_DESERT_PATH)
;                                        ;       end case
5B0F:          02 02                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0002
5B11:             00 A3                  ;         COM_00_move_and_look(room=RM_2_NORTH_OF_WEST_ALLEY)
;                                        ;       end case
5B13:          04 09                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0009
5B15:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5B1E)
5B17:                30 F5               ;           COM_30_set_current_room(room=RM_5_DESERT27)
5B19:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B1C:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5B15
;                                        ;       end case
5B1E:          03 06                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0006
5B20:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5B26)
5B22:                30 B8               ;           COM_30_set_current_room(room=RM_3_DESERT_NORTH2)
5B24:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x5B20
;                                        ;       end case
;                                        ;     end decode_switch at 0x5B08

; --------------------------------------------------------------------------------------------------------------------
;
5B26: B7 80 80 00                        ; ----- Room 0xB7 RM_2_DESERT_PATH, Length: 0x0080, Data: 0x00
;
5B2A:    03 4F                           ;   ---- Section SECTION_03_DESCRIPTION length=0x004F (to 0x5B7B)
5B2C:       04 4D                        ;     COM_04_print_message length=0x004D (to 0x5B7B)
...
;
;
5B7B:    04 2C                           ;   ---- Section SECTION_04_COMMANDS length=0x002C (to 0x5BA9)
5B7D:       0B 2A 0A                     ;     COM_0B_switch length=0x002A (to 0x5BAA), function=COM_0A_is_input_phrase(phrase_num)
5B80:          01 09                     ;       case COM_0A_is_input_phrase("NORTH * * *"), length=0x0009
5B82:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5B8B)
5B84:                30 F6               ;           COM_30_set_current_room(room=RM_5_DESERT_SMALL_TRAIL2)
5B86:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B89:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5B82
;                                        ;       end case
5B8B:          03 09                     ;       case COM_0A_is_input_phrase("EAST * * *"), length=0x0009
5B8D:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5B96)
5B8F:                30 F1               ;           COM_30_set_current_room(room=RM_5_DESERT_SMALL_TRAIL1)
5B91:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B94:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5B8D
;                                        ;       end case
5B96:          04 09                     ;       case COM_0A_is_input_phrase("WEST * * *"), length=0x0009
5B98:             0D 07                  ;         COM_0D_group_AND length=0x0007 (to 0x5BA1)
5B9A:                30 F5               ;           COM_30_set_current_room(room=RM_5_DESERT27)
5B9C:                17 9D 01            ;           COM_17_move_object_to(obj=OBJ_9D_THIRST_TRACKER, destination=OBJ_01_PLAYER)
5B9F:                2F 05               ;           COM_2F_load_section_from_disk(section=5)
;                                        ;         end group_AND at 0x5B98
;                                        ;       end case
5BA1:          02 06                     ;       case COM_0A_is_input_phrase("SOUTH * * *"), length=0x0006
5BA3:             0D 04                  ;         COM_0D_group_AND length=0x0004 (to 0x5BA9)
5BA5:                30 B8               ;           COM_30_set_current_room(room=RM_3_DESERT_NORTH2)
5BA7:                2F 03               ;           COM_2F_load_section_from_disk(section=3)
;                                        ;         end group_AND at 0x5BA3
;                                        ;       end case
...
;
5BAC:    03 51                           ;   ---- Section SECTION_03_DESCRIPTION length=0x0051 (to 0x5BFF)
5BAE:       04 4F                        ;     COM_04_print_message length=0x004F (to 0x5BFF)
...
;
;
5BFF:    04 1F                           ;   ---- Section SECTION_04_COMMANDS length=0x001F (to 0x5C20)
5C01:       0B 1D 0A                     ;     COM_0B_switch length=0x001D (to 0x5C21), function=COM_0A_is_input_phrase(phrase_num)
5C04:          37 10                     ;       case COM_0A_is_input_phrase("CLIMB * OUT *"), length=0x0010
5C06:             0D 0E                  ;         COM_0D_group_AND length=0x000E (to 0x5C16)
5C08:                0E 04               ;           COM_0E_group_OR length=0x0004 (to 0x5C0E)
5C0A:                   09 00            ;             COM_09_is_noun2(obj=nothing)
5C0C:                   09 60            ;             COM_09_is_noun2(obj=OBJ_60_SHELTER)
;                                        ;           end group_OR at 0x5C08
5C0E:                0E 06               ;           COM_0E_group_OR length=0x0006 (to 0x5C16)
5C10:                   14               ;             COM_14_reverse_status next command
5C11:                   1C 15            ;             COM_1C_set_var_object(obj=OBJ_15_DOOR_SHELTER)
5C13:                   8D               ;             FN_8D_IS_CLOSED
5C14:                   00 A0            ;             COM_00_move_and_look(room=RM_2_WEST_SIDE_OF_SALOON)
;                                        ;           end group_OR at 0x5C0E
;                                        ;         end group_AND at 0x5C06
;                                        ;       end case
5C16:          54 08                     ;       case COM_0A_is_input_phrase("CLIMB * UP *"), length=0x0008
5C18:             0E 06                  ;         COM_0E_group_OR length=0x0006 (to 0x5C20)
5C1A:                14                  ;           COM_14_reverse_status next command
5C1B:                1C 15               ;           COM_1C_set_var_object(obj=OBJ_15_DOOR_SHELTER)
5C1D:                8D                  ;           FN_8D_IS_CLOSED
5C1E:                00 A0               ;           COM_00_move_and_look(room=RM_2_WEST_SIDE_OF_SALOON)
;                                        ;         end group_OR at 0x5C18
;                                        ;       end case
;                                        ;     end decode_switch at 0x5C01
```
