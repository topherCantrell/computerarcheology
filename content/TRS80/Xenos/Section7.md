...
5203: 80 49 00                      ; Room Number: 0x80, Length: 0x0049, Data: 0x00
;
5206:    03 01                      ;   Section DESCRIPTION, Length: 0x0001
5208:       9D                      ;     COMMAND 0x9D
;
5209:    04 43                      ;   Section COMMANDS, Length: 0x0043
520B:       0B 41 0A                ;     SWITCH, Length: 0x0041, Function to call: 0x0A
520E:          37                   ;       Phrase number: 0x37
520F:          09                   ;       ELSE go to: 0x5219
5210:             0D 07             ;         WHILE PASS, Length: 0x0007
5212:                30 9D          ;           UNKNOWN1, Data: 0x9D
5214:                17 9D 01       ;           MOVE TO, Object number: 0x9D, Destination room: 0x01
5217:                2F 05          ;           UNKNOWN2 Data: 0x05
5219:          03                   ;       Phrase number: 0x03
521A:          09                   ;       ELSE go to: 0x5224
521B:             0D 07             ;         WHILE PASS, Length: 0x0007
521D:                30 9D          ;           UNKNOWN1, Data: 0x9D
521F:                17 9D 01       ;           MOVE TO, Object number: 0x9D, Destination room: 0x01
5222:                2F 05          ;           UNKNOWN2 Data: 0x05
5224:          12                   ;       Phrase number: 0x12
...
522B:                   03 67 81    ;             IS LOCATED, Room number: 0x67, Object number: 0x81
522E:                   04 0B       ;             PRINT, Length: 0x000B
;
; NOTHING HAPPENS.
;
5230:                      06 9A 90 73 CA 6A EA 48 9D 61 2E ; 
523B:                9F             ;           COMMAND 0x9F
523C:          36                   ;       Phrase number: 0x36
523D:          10                   ;       ELSE go to: 0x524E
523E:             0D 0E             ;         WHILE PASS, Length: 0x000E
5240:                C0             ;           COMMAND 0xC0
5241:                0E 0B          ;           WHILE FAIL, Length: 0x000B
5243:                   AE          ;             COMMAND 0xAE
5244:                   14          ;             EXECUTE AND REVERSE STATUS
5245:                   0B 06 03    ;             SWITCH, Length: 0x0006, Function to call: 0x03
5248:                      3F       ;               Phrase number: 0x3F
5249:                      3E       ;               ELSE go to: 0x5288
524A:                         02 00 82 ;                 IS OWNED BY, A=0x82, Object number: 0x00
524D:                   9E          ;             COMMAND 0x9E

524E: 82 80 E0 00                   ; Room Number: 0x82, Length: 0x00E0, Data: 0x00
;
...
5263:             C3                ;         COMMAND 0xC3
5264:             04 04             ;         PRINT, Length: 0x0004
;
; LOUNGE
;
5266:                87 8D B7 98    ; 
526A:          8B                   ;       COMMAND 0x8B
526B:          04 80 96             ;       PRINT, Length: 0x0096
;
;  YOU ARE NOW IN A LARGE RECTANGULAR ROOM. AN EERIE MOVING PICTURE FACES YOU. ON THE WALL BEHIND YOU THERE ARE THREE BUTTONS, ONE RED, ONE BLUE, AND ONE YELLOW. THEY ARE ARRANGED HORIZONTALLY, WITH THE RED BUTTON ON THE RIGHT.
;
...
5309:          12                   ;       Phrase number: 0x12
530A:          05                   ;       ELSE go to: 0x5310
530B:             0E 03             ;         WHILE FAIL, Length: 0x0003
530D:                A0             ;           COMMAND 0xA0
530E:                A1             ;           COMMAND 0xA1
530F:                9F             ;           COMMAND 0x9F
5310:          36                   ;       Phrase number: 0x36
5311:          1F                   ;       ELSE go to: 0x5331
5312:             0D 1D             ;         WHILE PASS, Length: 0x001D
5314:                C0             ;           COMMAND 0xC0
5315:                0E 1A          ;           WHILE FAIL, Length: 0x001A
5317:                   AE          ;             COMMAND 0xAE
5318:                   14          ;             EXECUTE AND REVERSE STATUS
5319:                   0B 15 03    ;             SWITCH, Length: 0x0015, Function to call: 0x03
531C:                      3F       ;               Phrase number: 0x3F
531D:                      3E       ;               ELSE go to: 0x535C
531E:                         02 00 80 ;                 IS OWNED BY, A=0x80, Object number: 0x00
5321:                      40       ;               Phrase number: 0x40
5322:                      3E       ;               ELSE go to: 0x5361
5323:                         02 00 83 ;                 IS OWNED BY, A=0x83, Object number: 0x00
5326:                      41       ;               Phrase number: 0x41
5327:                      3E       ;               ELSE go to: 0x5366
5328:                         07    ;                 PRINT ROOM DESCRIPTION
5329:                      0D       ;               Phrase number: 0x0D
532A:                      05       ;               ELSE go to: 0x5330
532B:                         9E    ;                 COMMAND 0x9E
532C:                      30       ;               Phrase number: 0x30
532D:                      84 2F    ;               ELSE go to: 0x575E
532F:                         08 9E ;                 IS FIRST NOUN, Word number: 0x9E

5331: 83 2C 00                      ; Room Number: 0x83, Length: 0x002C, Data: 0x00
;
5334:    03 01                      ;   Section DESCRIPTION, Length: 0x0001
5336:       B0                      ;     COMMAND 0xB0
;
5337:    04 26                      ;   Section COMMANDS, Length: 0x0026
5339:       0B 24 0A                ;     SWITCH, Length: 0x0024, Function to call: 0x0A
533C:          12                   ;       Phrase number: 0x12
533D:          05                   ;       ELSE go to: 0x5343
533E:             0E 03             ;         WHILE FAIL, Length: 0x0003
5340:                9F             ;           COMMAND 0x9F
5341:                A0             ;           COMMAND 0xA0
5342:                A1             ;           COMMAND 0xA1
5343:          36                   ;       Phrase number: 0x36
5344:          1A                   ;       ELSE go to: 0x535F
5345:             0D 18             ;         WHILE PASS, Length: 0x0018
5347:                C0             ;           COMMAND 0xC0
5348:                0E 15          ;           WHILE FAIL, Length: 0x0015
534A:                   AE          ;             COMMAND 0xAE
534B:                   14          ;             EXECUTE AND REVERSE STATUS
534C:                   0B 10 03    ;             SWITCH, Length: 0x0010, Function to call: 0x03
534F:                      3F       ;               Phrase number: 0x3F
5350:                      3E       ;               ELSE go to: 0x538F
5351:                         02 00 93 ;                 IS OWNED BY, A=0x93, Object number: 0x00
5354:                      40       ;               Phrase number: 0x40
5355:                      3E       ;               ELSE go to: 0x5394
5356:                         02 00 85 ;                 IS OWNED BY, A=0x85, Object number: 0x00
5359:                      41       ;               Phrase number: 0x41
535A:                      3E       ;               ELSE go to: 0x5399
535B:                         02 00 82 ;                 IS OWNED BY, A=0x82, Object number: 0x00
535E:                   9E          ;             COMMAND 0x9E

535F: 85 80 D2 00                   ; Room Number: 0x85, Length: 0x00D2, Data: 0x00
;
...
5374:             C3                ;         COMMAND 0xC3
5375:             04 06             ;         PRINT, Length: 0x0006
;
; SLEEPING 
;
5377:                BF B8 E3 61 AB 98 ; 
537D:          8B                   ;       COMMAND 0x8B
537E:          04 80 91             ;       PRINT, Length: 0x0091
;
; YOU NOW FIND YOURSELF IN A DIMLY LIT CUBICLE. THERE IS A CYLINDER WITH A GLASS LID AGAINST ONE WALL. BEHIND YOU YOU DISCOVER THE WALL HAS TWO BUTTONS ON IT, A RED BUTTON AND A BLUE BUTTON, ARRANGED FROM LEFT TO RIGHT.
;
...
5417:          12                   ;       Phrase number: 0x12
5418:          04                   ;       ELSE go to: 0x541D
5419:             0E 02             ;         WHILE FAIL, Length: 0x0002
541B:                A0             ;           COMMAND 0xA0
541C:                A1             ;           COMMAND 0xA1
541D:          36                   ;       Phrase number: 0x36
541E:          15                   ;       ELSE go to: 0x5434
541F:             0D 13             ;         WHILE PASS, Length: 0x0013
5421:                C0             ;           COMMAND 0xC0
5422:                0E 10          ;           WHILE FAIL, Length: 0x0010
5424:                   AE          ;             COMMAND 0xAE
5425:                   14          ;             EXECUTE AND REVERSE STATUS
5426:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
5429:                      40       ;               Phrase number: 0x40
542A:                      3E       ;               ELSE go to: 0x5469
542B:                         02 00 87 ;                 IS OWNED BY, A=0x87, Object number: 0x00
542E:                      41       ;               Phrase number: 0x41
542F:                      3E       ;               ELSE go to: 0x546E
5430:                         02 00 83 ;                 IS OWNED BY, A=0x83, Object number: 0x00
5433:                   9E          ;             COMMAND 0x9E

5434: 87 26 00                      ; Room Number: 0x87, Length: 0x0026, Data: 0x00
;
5437:    03 01                      ;   Section DESCRIPTION, Length: 0x0001
5439:       9C                      ;     COMMAND 0x9C
;
543A:    04 20                      ;   Section COMMANDS, Length: 0x0020
543C:       0B 1E 0A                ;     SWITCH, Length: 0x001E, Function to call: 0x0A
543F:          12                   ;       Phrase number: 0x12
5440:          04                   ;       ELSE go to: 0x5445
5441:             0E 02             ;         WHILE FAIL, Length: 0x0002
5443:                A0             ;           COMMAND 0xA0
5444:                A1             ;           COMMAND 0xA1
5445:          36                   ;       Phrase number: 0x36
5446:          15                   ;       ELSE go to: 0x545C
5447:             0D 13             ;         WHILE PASS, Length: 0x0013
5449:                C0             ;           COMMAND 0xC0
544A:                0E 10          ;           WHILE FAIL, Length: 0x0010
544C:                   AE          ;             COMMAND 0xAE
544D:                   14          ;             EXECUTE AND REVERSE STATUS
544E:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
5451:                      40       ;               Phrase number: 0x40
5452:                      3E       ;               ELSE go to: 0x5491
5453:                         02 00 89 ;                 IS OWNED BY, A=0x89, Object number: 0x00
5456:                      41       ;               Phrase number: 0x41
5457:                      3E       ;               ELSE go to: 0x5496
5458:                         02 00 85 ;                 IS OWNED BY, A=0x85, Object number: 0x00
545B:                   9E          ;             COMMAND 0x9E

545C: 89 80 C9 00                   ; Room Number: 0x89, Length: 0x00C9, Data: 0x00
;
...
546E:             C3                ;         COMMAND 0xC3
546F:             04 05             ;         PRINT, Length: 0x0005
;
; CONTROL
;
5471:                40 55 F9 BF 4C ; 
5476:          8B                   ;       COMMAND 0x8B
5477:          04 80 8C             ;       PRINT, Length: 0x008C
;
; YOU ARE IN A SMALL ROOM WITH BLACK WALLS. IN THE CENTER OF THE ROOM IS A SMALL CHAIR FACING A SMALL CONTROL PANEL. THE WALL BEHIND THE CHAIR HAS UPON IT A PAIR OF TELEPORTAL BUTTONS, ONE IS RED AND ONE IS BLUE.
;
...
550B:          12                   ;       Phrase number: 0x12
550C:          04                   ;       ELSE go to: 0x5511
550D:             0E 02             ;         WHILE FAIL, Length: 0x0002
550F:                A0             ;           COMMAND 0xA0
5510:                A1             ;           COMMAND 0xA1
5511:          36                   ;       Phrase number: 0x36
5512:          15                   ;       ELSE go to: 0x5528
5513:             0D 13             ;         WHILE PASS, Length: 0x0013
5515:                C0             ;           COMMAND 0xC0
5516:                0E 10          ;           WHILE FAIL, Length: 0x0010
5518:                   AE          ;             COMMAND 0xAE
5519:                   14          ;             EXECUTE AND REVERSE STATUS
551A:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
551D:                      40       ;               Phrase number: 0x40
551E:                      3E       ;               ELSE go to: 0x555D
551F:                         02 00 8B ;                 IS OWNED BY, A=0x8B, Object number: 0x00
5522:                      41       ;               Phrase number: 0x41
5523:                      3E       ;               ELSE go to: 0x5562
5524:                         02 00 87 ;                 IS OWNED BY, A=0x87, Object number: 0x00
5527:                   9E          ;             COMMAND 0x9E

5528: 8B 26 00                      ; Room Number: 0x8B, Length: 0x0026, Data: 0x00
;
552B:    03 01                      ;   Section DESCRIPTION, Length: 0x0001
552D:       9C                      ;     COMMAND 0x9C
;
552E:    04 20                      ;   Section COMMANDS, Length: 0x0020
5530:       0B 1E 0A                ;     SWITCH, Length: 0x001E, Function to call: 0x0A
5533:          12                   ;       Phrase number: 0x12
5534:          04                   ;       ELSE go to: 0x5539
5535:             0E 02             ;         WHILE FAIL, Length: 0x0002
5537:                A0             ;           COMMAND 0xA0
5538:                A1             ;           COMMAND 0xA1
5539:          36                   ;       Phrase number: 0x36
553A:          15                   ;       ELSE go to: 0x5550
553B:             0D 13             ;         WHILE PASS, Length: 0x0013
553D:                C0             ;           COMMAND 0xC0
553E:                0E 10          ;           WHILE FAIL, Length: 0x0010
5540:                   AE          ;             COMMAND 0xAE
5541:                   14          ;             EXECUTE AND REVERSE STATUS
5542:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
5545:                      40       ;               Phrase number: 0x40
5546:                      3E       ;               ELSE go to: 0x5585
5547:                         02 00 8D ;                 IS OWNED BY, A=0x8D, Object number: 0x00
554A:                      41       ;               Phrase number: 0x41
554B:                      3E       ;               ELSE go to: 0x558A
554C:                         02 00 89 ;                 IS OWNED BY, A=0x89, Object number: 0x00
554F:                   9E          ;             COMMAND 0x9E

5550: 8D 80 DE 00                   ; Room Number: 0x8D, Length: 0x00DE, Data: 0x00
;
...
5563:             C3                ;         COMMAND 0xC3
5564:             04 05             ;         PRINT, Length: 0x0005
;
; LIBRARY
;
5566:                84 8C D4 B0 59 ; 
556B:          8B                   ;       COMMAND 0x8B
556C:          04 80 A8             ;       PRINT, Length: 0x00A8
;
; YOU ARE IN A SMALL RECTANGULAR ROOM. IN THE CENTER OF THE ROOM IS A CHAIR, WHICH FACES A LARGE CUBE. THERE IS A SMALL SQUARE HOLE ABOUT TWO INCHES DEEP IN THE TOP OF THE CUBE. A CURSORY INSPECTION OF THE ROOM REVEALS A BLUE BUTTON ON ONE OF THE WALLS. 
;
...
561C:          12                   ;       Phrase number: 0x12
561D:          01                   ;       ELSE go to: 0x561F
561E:             A1                ;         COMMAND 0xA1
561F:          36                   ;       Phrase number: 0x36
5620:          10                   ;       ELSE go to: 0x5631
5621:             0D 0E             ;         WHILE PASS, Length: 0x000E
5623:                C0             ;           COMMAND 0xC0
5624:                0E 0B          ;           WHILE FAIL, Length: 0x000B
5626:                   AE          ;             COMMAND 0xAE
5627:                   14          ;             EXECUTE AND REVERSE STATUS
5628:                   0B 06 03    ;             SWITCH, Length: 0x0006, Function to call: 0x03
562B:                      41       ;               Phrase number: 0x41
562C:                      3E       ;               ELSE go to: 0x566B
562D:                         02 00 8B ;                 IS OWNED BY, A=0x8B, Object number: 0x00
5630:                   9E          ;             COMMAND 0x9E

5631: 93 2C 00                      ; Room Number: 0x93, Length: 0x002C, Data: 0x00
;
5634:    03 01                      ;   Section DESCRIPTION, Length: 0x0001
5636:       B0                      ;     COMMAND 0xB0
;
5637:    04 26                      ;   Section COMMANDS, Length: 0x0026
5639:       0B 24 0A                ;     SWITCH, Length: 0x0024, Function to call: 0x0A
563C:          12                   ;       Phrase number: 0x12
563D:          05                   ;       ELSE go to: 0x5643
563E:             0E 03             ;         WHILE FAIL, Length: 0x0003
5640:                A0             ;           COMMAND 0xA0
5641:                A1             ;           COMMAND 0xA1
5642:                9F             ;           COMMAND 0x9F
5643:          36                   ;       Phrase number: 0x36
5644:          1A                   ;       ELSE go to: 0x565F
5645:             0D 18             ;         WHILE PASS, Length: 0x0018
5647:                C0             ;           COMMAND 0xC0
5648:                0E 15          ;           WHILE FAIL, Length: 0x0015
564A:                   AE          ;             COMMAND 0xAE
564B:                   14          ;             EXECUTE AND REVERSE STATUS
564C:                   0B 10 03    ;             SWITCH, Length: 0x0010, Function to call: 0x03
564F:                      40       ;               Phrase number: 0x40
5650:                      3E       ;               ELSE go to: 0x568F
5651:                         02 00 95 ;                 IS OWNED BY, A=0x95, Object number: 0x00
5654:                      41       ;               Phrase number: 0x41
5655:                      3E       ;               ELSE go to: 0x5694
5656:                         02 00 94 ;                 IS OWNED BY, A=0x94, Object number: 0x00
5659:                      3F       ;               Phrase number: 0x3F
565A:                      3E       ;               ELSE go to: 0x5699
565B:                         02 00 83 ;                 IS OWNED BY, A=0x83, Object number: 0x00
565E:                   9E          ;             COMMAND 0x9E

565F: 94 80 A9 00                   ; Room Number: 0x94, Length: 0x00A9, Data: 0x00
;
...
5672:             C3                ;         COMMAND 0xC3
5673:             04 04             ;         PRINT, Length: 0x0004
;
; BOMBS 
;
5675:                FF 4E 8B 4F    ; 
5679:          8B                   ;       COMMAND 0x8B
567A:          04 75                ;       PRINT, Length: 0x0075
;
; YOU ARE IN A LONG, NARROW ROOM THAT IS FULL OF CYLINDERS THAT ARE IN A SERIES OF STACKS THAT LINE THE LONGER WALLS. ON THE SHORT WALL BEHIND YOU, YOU FIND A SINGLE RED BUTTON.
;
...
56F6:          12                   ;       Phrase number: 0x12
56F7:          01                   ;       ELSE go to: 0x56F9
56F8:             A0                ;         COMMAND 0xA0
56F9:          36                   ;       Phrase number: 0x36
56FA:          10                   ;       ELSE go to: 0x570B
56FB:             0D 0E             ;         WHILE PASS, Length: 0x000E
56FD:                C0             ;           COMMAND 0xC0
56FE:                0E 0B          ;           WHILE FAIL, Length: 0x000B
5700:                   AE          ;             COMMAND 0xAE
5701:                   14          ;             EXECUTE AND REVERSE STATUS
5702:                   0B 06 03    ;             SWITCH, Length: 0x0006, Function to call: 0x03
5705:                      40       ;               Phrase number: 0x40
5706:                      3E       ;               ELSE go to: 0x5745
5707:                         02 00 93 ;                 IS OWNED BY, A=0x93, Object number: 0x00
570A:                   9E          ;             COMMAND 0x9E

570B: 95 80 D9 00                   ; Room Number: 0x95, Length: 0x00D9, Data: 0x00
;
...
571F:             C3                ;         COMMAND 0xC3
5720:             04 02             ;         PRINT, Length: 0x0002
;
; GAS
;
5722:                15 6C          ; 
5724:          8B                   ;       COMMAND 0x8B
5725:          04 80 9D             ;       PRINT, Length: 0x009D
;
; YOU ARE IN A LONG, NARROW ROOM THAT IS FULL OF CYLINDERS THAT ARE IN A SERIES OF STACKS THAT LINE THE LONGER WALLS. ON THE SHORT WALL BEHIND YOU, THERE ARE A BLUE AND A RED BUTTON ARRANGED HORIZONTALLY GOING FROM THE RIGHT TO THE LEFT.
;
...
57CA:          12                   ;       Phrase number: 0x12
57CB:          04                   ;       ELSE go to: 0x57D0
57CC:             0E 02             ;         WHILE FAIL, Length: 0x0002
57CE:                A0             ;           COMMAND 0xA0
57CF:                A1             ;           COMMAND 0xA1
57D0:          36                   ;       Phrase number: 0x36
57D1:          15                   ;       ELSE go to: 0x57E7
57D2:             0D 13             ;         WHILE PASS, Length: 0x0013
57D4:                C0             ;           COMMAND 0xC0
57D5:                0E 10          ;           WHILE FAIL, Length: 0x0010
57D7:                   AE          ;             COMMAND 0xAE
57D8:                   14          ;             EXECUTE AND REVERSE STATUS
57D9:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
57DC:                      40       ;               Phrase number: 0x40
57DD:                      3E       ;               ELSE go to: 0x581C
57DE:                         02 00 96 ;                 IS OWNED BY, A=0x96, Object number: 0x00
57E1:                      41       ;               Phrase number: 0x41
57E2:                      3E       ;               ELSE go to: 0x5821
57E3:                         02 00 93 ;                 IS OWNED BY, A=0x93, Object number: 0x00
57E6:                   9E          ;             COMMAND 0x9E

57E7: 96 26 00                      ; Room Number: 0x96, Length: 0x0026, Data: 0x00
;
57EA:    03 01                      ;   Section DESCRIPTION, Length: 0x0001
57EC:       9C                      ;     COMMAND 0x9C
;
57ED:    04 20                      ;   Section COMMANDS, Length: 0x0020
57EF:       0B 1E 0A                ;     SWITCH, Length: 0x001E, Function to call: 0x0A
57F2:          12                   ;       Phrase number: 0x12
57F3:          04                   ;       ELSE go to: 0x57F8
57F4:             0E 02             ;         WHILE FAIL, Length: 0x0002
57F6:                A0             ;           COMMAND 0xA0
57F7:                A1             ;           COMMAND 0xA1
57F8:          36                   ;       Phrase number: 0x36
57F9:          15                   ;       ELSE go to: 0x580F
57FA:             0D 13             ;         WHILE PASS, Length: 0x0013
57FC:                C0             ;           COMMAND 0xC0
57FD:                0E 10          ;           WHILE FAIL, Length: 0x0010
57FF:                   AE          ;             COMMAND 0xAE
5800:                   14          ;             EXECUTE AND REVERSE STATUS
5801:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
5804:                      40       ;               Phrase number: 0x40
5805:                      3E       ;               ELSE go to: 0x5844
5806:                         02 00 97 ;                 IS OWNED BY, A=0x97, Object number: 0x00
5809:                      41       ;               Phrase number: 0x41
580A:                      3E       ;               ELSE go to: 0x5849
580B:                         02 00 95 ;                 IS OWNED BY, A=0x95, Object number: 0x00
580E:                   9E          ;             COMMAND 0x9E

580F: 97 80 AD 00                   ; Room Number: 0x97, Length: 0x00AD, Data: 0x00
;
...
5823:             C3                ;         COMMAND 0xC3
5824:             04 02             ;         PRINT, Length: 0x0002
;
; BIO
;
5826:                11 4E          ; 
5828:          8B                   ;       COMMAND 0x8B
5829:          04 72                ;       PRINT, Length: 0x0072
;
; YOU ARE IN A SMALL ROOM, THERE ARE SEVERAL BLACK GLOBES IN STACKS AGAINST THE WALLS. ON THE WALL BEHIND YOU, THERE IS A RED AND A BLUE BUTTON ARRANGED FROM LEFT TO RIGHT. 
;
...
58A2:          12                   ;       Phrase number: 0x12
58A3:          04                   ;       ELSE go to: 0x58A8
58A4:             0E 02             ;         WHILE FAIL, Length: 0x0002
58A6:                A0             ;           COMMAND 0xA0
58A7:                A1             ;           COMMAND 0xA1
58A8:          36                   ;       Phrase number: 0x36
58A9:          15                   ;       ELSE go to: 0x58BF
58AA:             0D 13             ;         WHILE PASS, Length: 0x0013
58AC:                C0             ;           COMMAND 0xC0
58AD:                0E 10          ;           WHILE FAIL, Length: 0x0010
58AF:                   AE          ;             COMMAND 0xAE
58B0:                   14          ;             EXECUTE AND REVERSE STATUS
58B1:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
58B4:                      40       ;               Phrase number: 0x40
58B5:                      3E       ;               ELSE go to: 0x58F4
58B6:                         02 00 98 ;                 IS OWNED BY, A=0x98, Object number: 0x00
58B9:                      41       ;               Phrase number: 0x41
58BA:                      3E       ;               ELSE go to: 0x58F9
58BB:                         02 00 96 ;                 IS OWNED BY, A=0x96, Object number: 0x00
58BE:                   9E          ;             COMMAND 0x9E

58BF: 98 26 00                      ; Room Number: 0x98, Length: 0x0026, Data: 0x00
;
58C2:    03 01                      ;   Section DESCRIPTION, Length: 0x0001
58C4:       9C                      ;     COMMAND 0x9C
;
58C5:    04 20                      ;   Section COMMANDS, Length: 0x0020
58C7:       0B 1E 0A                ;     SWITCH, Length: 0x001E, Function to call: 0x0A
58CA:          12                   ;       Phrase number: 0x12
58CB:          04                   ;       ELSE go to: 0x58D0
58CC:             0E 02             ;         WHILE FAIL, Length: 0x0002
58CE:                A0             ;           COMMAND 0xA0
58CF:                A1             ;           COMMAND 0xA1
58D0:          36                   ;       Phrase number: 0x36
58D1:          15                   ;       ELSE go to: 0x58E7
58D2:             0D 13             ;         WHILE PASS, Length: 0x0013
58D4:                C0             ;           COMMAND 0xC0
58D5:                0E 10          ;           WHILE FAIL, Length: 0x0010
58D7:                   AE          ;             COMMAND 0xAE
58D8:                   14          ;             EXECUTE AND REVERSE STATUS
58D9:                   0B 0B 03    ;             SWITCH, Length: 0x000B, Function to call: 0x03
58DC:                      40       ;               Phrase number: 0x40
58DD:                      3E       ;               ELSE go to: 0x591C
58DE:                         02 00 99 ;                 IS OWNED BY, A=0x99, Object number: 0x00
58E1:                      41       ;               Phrase number: 0x41
58E2:                      3E       ;               ELSE go to: 0x5921
58E3:                         02 00 97 ;                 IS OWNED BY, A=0x97, Object number: 0x00
58E6:                   9E          ;             COMMAND 0x9E

58E7: 99 80 95 00                   ; Room Number: 0x99, Length: 0x0095, Data: 0x00
;
...
58F9:             C3                ;         COMMAND 0xC3
58FA:             04 05             ;         PRINT, Length: 0x0005
;
; STORAGE
;
58FC:                09 BA C9 B0 45 ; 
5901:          8B                   ;       COMMAND 0x8B
5902:          04 61                ;       PRINT, Length: 0x0061
;
; YOU ARE IN A SMALL ROOM, THERE ARE SEVERAL CYLINDERS STORED IN A STACK OPPOSITE YOU. TO THE SIDE, YOU CAN SEE A SOLITARY BLUE BUTTON ON THE WALL.
;
...
5CFF: 03 05 02 02 00 72 02 02 00 F8 F8 19 00 03 01 AB ; .....r..........
5D0F: 04 13 0B 11 0A 03 02 00 F8 04 02 00 F9 01 02 00 ; ................
5D1F: F8 02 02 00 F8 F9 21 00 03 01 AB 04 1B 0B 19 0A ; ......!.........
5D2F: 03 0A 0E 08 0D 04 05 3E 00 86 00 F9 04 02 00 F8 ; .......>........
5D3F: 01 02 00 FA 02 02 00 F9 FA 19 00 03 01 AB 04 13 ; ................
5D4F: 0B 11 0A 03 02 00 FA 04 02 00 F7 01 02 00 FA 02 ; ................
5D5F: 02 00 F9 4C 41 54 22 05 53 50 41 52 45 23 04 42 ; ...LAT".SPARE#.B
5D6F: 4C 55 45 0D 06 4D 41 53 53 49 56 3F 04 42 41 4E ; LUE..MASSIV?.BAN
5D7F: 4B 40 06 53 41 4C 4F 4F 4E 41 06 53 48 45 52 49 ; K@.SALOONA.SHERI
5D8F: 46 42 06 4F 46 46 49 43 45 42 06 53 4C 49 4D 27 ; FB.OFFICEB.SLIM'
5D9F: 53 43 05 53 4C 49 4D 53 43 05 42 4F 42 27 53 44 ; SC.SLIMSC.BOB'SD
5DAF: 04 42 4F 42 53 44 06 44 4F 55 42 4C 45 45 05 48 ; .BOBSD.DOUBLEE.H
5DBF: 4F 54 45 4C 47 06 53 57 49 4E 47 49 46 04 54 53 ; OTELG.SWINGIF.TS
5DCF: 4F                                              ; O
```
