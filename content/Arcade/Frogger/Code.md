...
0339: 32 02 D0       LD      ($D002),A       ; {-hard_PPI8255}
033C: 3E FF          LD      A,$FF           
...
104B: 3A 00 88       LD      A,($8800)       ; {-hard_watchdog}
104E: 0B             DEC     BC              
104F: 78             LD      A,B             
1050: A7             AND     A               
...
1417: D0             RET     NC              
1418: D1             POP     DE              
1419: D2 D3 CC       JP      NC,$CCD3        ; {-hard_PPI8255}
141C: CD CE CF       CALL    $CFCE           ; {-hard_PPI8255}
141F: C8             RET     Z               
1420: C9             RET                     
...
1B30: 3A 04 E0       LD      A,($E004)       ; {-hard_PPI8255}
1B33: CB 5F          BIT     3,A             
1B35: 28 07          JR      Z,$1B3E         
1B37: 3A FD 83       LD      A,($83FD)       
1B3A: 3D             DEC     A               
1B3B: C2 83 1B       JP      NZ,$1B83        
1B3E: 3A 04 E0       LD      A,($E004)       ; {-hard_PPI8255}
1B41: CB 67          BIT     4,A             
...
1B73: C9             RET                     
1B74: 3A 02 E0       LD      A,($E002)       ; {-hard_PPI8255}
1B77: 4F             LD      C,A             
1B78: C3 FB 1A       JP      $1AFB           
1B7B: 3A 04 E0       LD      A,($E004)       ; {-hard_PPI8255}
1B7E: CB 47          BIT     0,A             
1B80: C3 15 1B       JP      $1B15           
1B83: 3A 00 E0       LD      A,($E000)       ; {-hard_PPI8255}
1B86: CB 47          BIT     0,A             
...
279F: 00             NOP                     
27A0: EE EC          XOR     $EC             
27A2: EA E8 E6       JP      PE,$E6E8        ; {-hard_PPI8255}
27A5: E4 E2 E0       CALL    PO,$E0E2        ; {-hard_PPI8255}
27A8: 01 DE DC       LD      BC,$DCDE        
27AB: DA D8 D6       JP      C,$D6D8         ; {-hard_PPI8255}
27AE: D4 D2 D0       CALL    NC,$D0D2        ; {-hard_PPI8255}
27B1: 00             NOP                     
27B2: D0             RET     NC              
...
2CF3: 7E             LD      A,(HL)          
2CF4: B7             OR      A               
2CF5: 3A 00 E0       LD      A,($E000)       ; {-hard_PPI8255}
2CF8: 2F             CPL                     
...
2D15: 3C             INC     A               
2D16: 32 18 B8       LD      ($B818),A       ; {-hard_COINCNT0}
2D19: 3E 04          LD      A,$04           
...
2D2B: 77             LD      (HL),A          
2D2C: 3C             INC     A               
2D2D: 32 1C B8       LD      ($B81C),A       ; {-hard_COINCNT1}
2D30: 3E 04          LD      A,$04           
