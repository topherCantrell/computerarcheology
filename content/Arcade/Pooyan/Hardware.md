...
Three things matter when reading the map. (1) A **read and a write at one address can be different devices**:
 `0xA000` **reads DSW1**, but a **write** there **kicks the watchdog**.
