[Dig Dug 2 Main Board](digdug2.jpg)

# DigDug2 Main Board

>>> cpu 6809

>>> binary 8000:roms/d23_3.1d + roms/d23_1.1b
...
8643: 86 0E           LDA     #$0E                
8645: C6 06           LDB     #$06                
8647: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
...
8827: 86 20           LDA     #$20                
8829: C6 0A           LDB     #$0A                
882B: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
882E: 8E 07 9C        LDX     #$079C              
8831: 86 20           LDA     #$20                
8833: C6 0A           LDB     #$0A                
8835: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8838: 8E 0F BC        LDX     #$0FBC              
883B: 86 00           LDA     #$00                
883D: C6 0A           LDB     #$0A                
883F: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8842: 8E 0F 9C        LDX     #$0F9C              
8845: 86 00           LDA     #$00                
8847: C6 0A           LDB     #$0A                
8849: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
...
8AB5: 86 00           LDA     #$00                
8AB7: C6 07           LDB     #$07                
8AB9: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8ABC: 8E 0F F4        LDX     #$0FF4              
8ABF: 86 00           LDA     #$00                
8AC1: C6 0A           LDB     #$0A                
8AC3: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8AC6: 8E 0F E1        LDX     #$0FE1              
8AC9: 86 00           LDA     #$00                
8ACB: C6 02           LDB     #$02                
8ACD: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8AD0: 8E 0F EA        LDX     #$0FEA              
8AD3: 86 00           LDA     #$00                
8AD5: C6 07           LDB     #$07                
8AD7: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8ADA: 39              RTS                         
...
; new additions.
8AE1: 7D 17 26        TST     $1726               ; {ram.scoreOverflow} Have we already overflowed into the upper digit?
8AE4: 27 01           BEQ     $8AE7               ; {} No ... we can add more to it
8AE6: 39              RTS                         ; Yes ... just ignore
;
8AE7: 1E 89           EXG     A,B                 ; Start with the low part
8AE9: BB 17 02        ADDA    $1702               ; {ram.playerScore+2} Add in the lower 2 digits
8AEC: 19              DAA                         ; Correct binary math to BCD result
8AED: B7 17 02        STA     $1702               ; {ram.playerScore+2} New lower 2 digits
8AF0: 1F 98           TFR     B,A                 ; Now for the middle 2 digits
8AF2: B9 17 01        ADCA    $1701               ; {ram.playerScore+1} Add the upper 2 digits
8AF5: 19              DAA                         ; Correct binary math to BCD result
8AF6: B7 17 01        STA     $1701               ; {ram.playerScore+1} New upper 2 digits
8AF9: B6 17 00        LDA     $1700               ; {ram.playerScore} Upper most 2 digits
8AFC: 89 00           ADCA    #$00                ; Any carry from the last addition
8AFE: 19              DAA                         ; Correct binary math to BCD result
8AFF: B7 17 00        STA     $1700               ; {ram.playerScore} Update the upper 2 digits
8B02: 84 F0           ANDA    #$F0                ; Did anything carry into the upper most digit?
8B04: 27 22           BEQ     $8B28               ; {} Upper digit is 0 ... continue normally.
8B06: B7 17 26        STA     $1726               ; {ram.scoreOverflow} Upper digit is not 0. Note the overflow.
8B09: 7F 17 01        CLR     $1701               ; {ram.playerScore+1} Set middle digits to 00
8B0C: 7F 17 02        CLR     $1702               ; {ram.playerScore+2} Set lower digits to 00
8B0F: 8E 0F F4        LDX     #$0FF4              
8B12: 86 0B           LDA     #$0B                
8B14: C6 0A           LDB     #$0A                
8B16: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8B19: 8E 0F E1        LDX     #$0FE1              
8B1C: 86 0B           LDA     #$0B                
8B1E: C6 02           LDB     #$02                
8B20: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
...
8BE2: 86 0D           LDA     #$0D                
8BE4: C6 0A           LDB     #$0A                
8BE6: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
8BE9: 8E 0F C1        LDX     #$0FC1              
8BEC: 86 0D           LDA     #$0D                
8BEE: C6 02           LDB     #$02                
8BF0: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
...
9031: 86 0D           LDA     #$0D                
9033: C6 03           LDB     #$03                
9035: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
9038: 8E 0F DA        LDX     #$0FDA              
903B: 86 0D           LDA     #$0D                
903D: C6 03           LDB     #$03                
903F: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
9042: 8D 02           BSR     $9046               ; {}
9044: 20 E5           BRA     $902B               ; {}
...
9D3A: 86 20           LDA     #$20                
9D3C: C6 0A           LDB     #$0A                
9D3E: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
9D41: 8E 07 9C        LDX     #$079C              
9D44: 86 20           LDA     #$20                
9D46: C6 0A           LDB     #$0A                
9D48: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
9D4B: 8E 0F BC        LDX     #$0FBC              
9D4E: 86 00           LDA     #$00                
9D50: C6 0A           LDB     #$0A                
9D52: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
9D55: 8E 0F 9C        LDX     #$0F9C              
9D58: 86 00           LDA     #$00                
9D5A: C6 0A           LDB     #$0A                
9D5C: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
...
D798: A8 3B           EORA    -5,Y                
D79A: 68 8B           ASL     D,X                 
D79C: A8 2B           EORA    11,Y                
D79E: A8 8B           EORA    D,X                 
D7A0: A8 5B           EORA    -5,U                
D7A2: A8 3B           EORA    -5,Y                
D7A4: A8 4B           EORA    11,U                
D7A6: 78 2B A6        ASL     $2BA6               
D7A9: 88 88           EORA    #$88                
...
DC0F: 78 F8 00        ASL     $F800               ; {}
DC12: 00 00           NEG     $00                 
DC14: 00 00           NEG     $00                 
DC16: 00 00           NEG     $00                 
DC18: 00 88           NEG     $88                 
DC1A: 70 70 00        NEG     $7000               
DC1D: 90 00           SUBA    $00                 
DC1F: 00 00           NEG     $00                 
DC21: 00 00           NEG     $00                 
DC23: 00 40           NEG     $40                 
...
DC39: 18 ; ????
DC3A: 08 00           LSL     $00                 
DC3C: F8 F8 F8        EORB    $F8F8               ; {}
DC3F: 00 00           NEG     $00                 
DC41: 00 00           NEG     $00                 
DC43: 00 00           NEG     $00                 
DC45: F8 F8 F8        EORB    $F8F8               ; {}
DC48: F8 E0 C0        EORB    $E0C0               ; {}
DC4B: 08 18           LSL     $18                 
DC4D: 98 40           EORA    $40                 
DC4F: 40              NEGA                        
DC50: C0 98           SUBB    #$98                
...
DFB4: 78 70 80        ASL     $7080               
DFB7: 78 3C 9E        ASL     $3C9E               
DFBA: 2E B2           BGT     $DF6E               ; {}
...
E902: 86 20           LDA     #$20                
E904: C6 80           LDB     #$80                
E906: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
E909: 20 C4           BRA     $E8CF               ; {}
...
E948: 86 20           LDA     #$20                
E94A: C6 80           LDB     #$80                
E94C: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
E94F: 20 BF           BRA     $E910               ; {}
E951: 1C FF           ANDCC   #$FF                
...
E965: 86 20           LDA     #$20                
E967: C6 80           LDB     #$80                
E969: BD 85 BD        JSR     $85BD               ; {code.FillMemory}
