...
0006: DB 09           IN      A,($09)             ; {hard.WDOG} Feed watchdog
0008: 3E FF           LD      A,$FF               ; LEDs, screen reverse, meters ...
000A: D3 13           OUT     ($13),A             ; {hard.OUTPUTA} ... all off
;
...
0030: ED B0           LDIR                        
;                        
0032: C3 E8 04        JP      $04E8               ; {code.Diagnostics} Diagnostics OR startup
...
0040: DB 11           IN      A,($11)             ; {hard.INPUTA}
0042: CB 67           BIT     4,A                 
0044: 20 36           JR      NZ,$7C              ; {}
0046: 3A 82 40        LD      A,($4082)           ; {ram.m4082}
0049: B7              OR      A                   
004A: 20 30           JR      NZ,$7C              ; {}
004C: 3E 13           LD      A,$13               
004E: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD}
0050: 32 82 40        LD      ($4082),A           ; {ram.m4082}
0053: 3E 00           LD      A,$00               
0055: 32 25 40        LD      ($4025),A           ; {ram.m4025}
0058: 32 26 40        LD      ($4026),A           ; {ram.m4026}
005B: 18 0B           JR      $68                 ; {}
...
0068: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
006B: B7              OR      A                   
006C: 28 0A           JR      Z,$78               ; {}
006E: D6 01           SUB     $01                 
0070: 27              DAA                         
0071: 32 2D 40        LD      ($402D),A           ; {ram.m402D}
0074: FD CB AE F6     SET     6,(IY+$AE)          
0078: FD 36 A1 03     LD      (IY+$A1),$03        
007C: DB 11           IN      A,($11)             ; {hard.INPUTA}
007E: E6 03           AND     $03                 
0080: 32 35 40        LD      ($4035),A           ; {ram.m4035}
0083: 47              LD      B,A                 
0084: A9              XOR     C                   
0085: 28 10           JR      Z,$97               ; {}
0087: CB 47           BIT     0,A                 
...
0097: 3A 1B 40        LD      A,($401B)           ; {ram.m401B}
009A: B7              OR      A                   
009B: 28 4D           JR      Z,$EA               ; {}
...
00A2: CB 40           BIT     0,B                 
00A4: 20 44           JR      NZ,$EA              ; {}
00A6: DB 11           IN      A,($11)             ; {hard.INPUTA}
00A8: CB 7F           BIT     7,A                 
00AA: 28 08           JR      Z,$B4               ; {}
00AC: 3E 00           LD      A,$00               
...
00B4: 3E 12           LD      A,$12               
00B6: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD}
00B8: FD 34 A5        INC     (IY+$A5)            ; 
00BB: 3A 25 40        LD      A,($4025)           ; {ram.m4025}
00BE: E5              PUSH    HL                  
00BF: 2A 27 40        LD      HL,($4027)          ; {ram.m4027}
00C2: BE              CP      (HL)                
00C3: 38 24           JR      C,$E9               ; {}
00C5: FD 36 A5 00     LD      (IY+$A5),$00        
00C9: 23              INC     HL                  
00CA: DB 11           IN      A,($11)             ; {hard.INPUTA}
00CC: CB 7F           BIT     7,A                 
00CE: 20 05           JR      NZ,$D5              ; {}
00D0: 3E 02           LD      A,$02               
00D2: CD 21 15        CALL    $1521               ; {}
00D5: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
00D8: 86              ADD     A,(HL)              
00D9: 27              DAA                         
00DA: 32 2D 40        LD      ($402D),A           ; {ram.m402D}
00DD: FD CB AE F6     SET     6,(IY+$AE)          
00E1: FE 21           CP      $21                 
00E3: 38 04           JR      C,$E9               ; {}
00E5: FD 36 AD 20     LD      (IY+$AD),$20        
00E9: E1              POP     HL                  
00EA: 3A 1C 40        LD      A,($401C)           ; {ram.m401C}
00ED: B7              OR      A                   
00EE: 28 4D           JR      Z,$13D              ; {}
...
00F9: DB 11           IN      A,($11)             ; {hard.INPUTA}
00FB: CB 7F           BIT     7,A                 
00FD: 28 08           JR      Z,$107              ; {}
00FF: 3E 01           LD      A,$01               
...
0107: 3E 12           LD      A,$12               
0109: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD}
010B: FD 34 A6        INC     (IY+$A6)            ; 
010E: 3A 26 40        LD      A,($4026)           ; {ram.m4026}
0111: E5              PUSH    HL                  
0112: 2A 29 40        LD      HL,($4029)          ; {ram.m4029}
0115: BE              CP      (HL)                
0116: 38 24           JR      C,$13C              ; {}
0118: FD 36 A6 00     LD      (IY+$A6),$00        
011C: 23              INC     HL                  
011D: DB 11           IN      A,($11)             ; {hard.INPUTA}
011F: CB 7F           BIT     7,A                 
0121: 20 05           JR      NZ,$128             ; {}
0123: 3E 02           LD      A,$02               
0125: CD 21 15        CALL    $1521               ; {}
0128: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
012B: 86              ADD     A,(HL)              
012C: 27              DAA                         
012D: 32 2D 40        LD      ($402D),A           ; {ram.m402D}
0130: FD CB AE F6     SET     6,(IY+$AE)          
0134: FE 21           CP      $21                 
0136: 38 04           JR      C,$13C              ; {}
0138: FD 36 AD 20     LD      (IY+$AD),$20        
013C: E1              POP     HL                  
013D: 3A 1F 40        LD      A,($401F)           ; {ram.m401F}
0140: B7              OR      A                   
0141: 28 16           JR      Z,$159              ; {}
0143: 3D              DEC     A                   
0144: 32 1F 40        LD      ($401F),A           ; {ram.m401F}
0147: 28 10           JR      Z,$159              ; {}
0149: FE 19           CP      $19                 
014B: 20 4E           JR      NZ,$19B             ; {}
014D: 3A 72 40        LD      A,($4072)           ; {ram.m4072}
0150: F6 03           OR      $03                 
0152: D3 13           OUT     ($13),A             ; {hard.OUTPUTA}
0154: 32 72 40        LD      ($4072),A           ; {ram.m4072}
0157: 18 42           JR      $19B                ; {}
0159: 3A 1D 40        LD      A,($401D)           ; {ram.m401D}
015C: B7              OR      A                   
015D: 28 0B           JR      Z,$16A              ; {}
015F: FD 35 9D        DEC     (IY+$9D)            
0162: FD CB F2 86     RES     0,(IY+$F2)          
0166: FD 36 9F 32     LD      (IY+$9F),$32        
016A: 3A 1E 40        LD      A,($401E)           ; {ram.m401E}
016D: B7              OR      A                   
016E: 28 1F           JR      Z,$18F              ; {}
0170: 3A 2B 40        LD      A,($402B)           ; {ram.m402B}
...
018F: 3A 1F 40        LD      A,($401F)           ; {ram.m401F}
0192: FE 32           CP      $32                 
0194: 20 05           JR      NZ,$19B             ; {}
0196: 3A 72 40        LD      A,($4072)           ; {ram.m4072}
0199: D3 13           OUT     ($13),A             ; {hard.OUTPUTA}
019B: C1              POP     BC                  
019C: F1              POP     AF                  
019D: FB              EI                          
019E: ED 4D           RETI                        
...
02E0: 53              LD      D,E                 
02E1: 2E 50           LD      L,$50               
02E3: 32 20 46        LD      ($4620),A           ; {ram.m4620}
02E6: 49              LD      C,C                 
02E7: 52              LD      D,D                 
02E8: 45              LD      B,L                 
...
04EA: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD} ... off
04EC: DB 09           IN      A,($09)             ; {hard.WDOG} Feed watchdog
...
0507: C3 C8 08        JP      $08C8               ; {code.PrintString} Print the test string
050A: DB 11           IN      A,($11)             ; {hard.INPUTA} Is test ...
050C: CB 7F           BIT     7,A                 ; ... switch set?
050E: C2 55 09        JP      NZ,$0955            ; {} No ... skip it
0511: 01 00 00        LD      BC,$0000            
0514: DB 11           IN      A,($11)             ; {hard.INPUTA}
0516: 57              LD      D,A                 
0517: 1E 00           LD      E,$00               
0519: D9              EXX                         
...
0527: DB 09           IN      A,($09)             ; {hard.WDOG} Feed watchdog
...
0534: ED B0           LDIR                        ; ... FFs
0536: DB 09           IN      A,($09)             ; {hard.WDOG} Feed watchdog
;
...
0545: C3 E9 07        JP      $07E9               ; {code.TestROM} Test the ROM chip
...
055D: C3 E9 07        JP      $07E9               ; {code.TestROM} Check it
;
...
0575: C3 E9 07        JP      $07E9               ; {code.TestROM} Check it
;
...
058D: C3 E9 07        JP      $07E9               ; {code.TestROM} Check it
; 
...
05AA: C3 1D 08        JP      $081D               ; {code.TestRAM} Check it
;
...
05C2: C3 1D 08        JP      $081D               ; {code.TestRAM} Check it
;
...
05DA: C3 1D 08        JP      $081D               ; {code.TestRAM} Check it
;
...
05F7: C3 63 08        JP      $0863               ; {code.TestNONVOL} Check it
;
...
0614: C3 1D 08        JP      $081D               ; {code.TestRAM} Check it
;
...
062C: C3 1D 08        JP      $081D               ; {code.TestRAM} Check it
;
...
0644: C3 1D 08        JP      $081D               ; {code.TestRAM} Check it
;
...
065C: C3 1D 08        JP      $081D               ; {code.TestRAM} Check it
;
...
0679: C3 E9 07        JP      $07E9               ; {code.TestROM} Check it
;
...
0691: C3 E9 07        JP      $07E9               ; {code.TestROM} Check it
;
...
06B9: ED B0           LDIR                        
06BB: DB 09           IN      A,($09)             ; {hard.WDOG}
06BD: 01 95 01        LD      BC,$0195            
06C0: DD 21 C7 06     LD      IX,$06C7            
06C4: C3 C8 08        JP      $08C8               ; {code.PrintString}
06C7: DD 21 CE 06     LD      IX,$06CE            
06CB: C3 DD 07        JP      $07DD               ; {}
06CE: 11 3C 80        LD      DE,$803C            
06D1: DB 11           IN      A,($11)             ; {hard.INPUTA}
06D3: E6 03           AND     $03                 
06D5: 4F              LD      C,A                 
06D6: DB 11           IN      A,($11)             ; {hard.INPUTA}
06D8: E6 F0           AND     $F0                 
06DA: 0F              RRCA                        
06DB: 0F              RRCA                        
06DC: B1              OR      C                   
...
06E6: DB 12           IN      A,($12)             ; {hard.INPUTB}
06E8: E6 0F           AND     $0F                 
06EA: 4F              LD      C,A                 
06EB: DB 12           IN      A,($12)             ; {hard.INPUTB}
06ED: E6 C0           AND     $C0                 
06EF: 0F              RRCA                        
06F0: 0F              RRCA                        
06F1: B1              OR      C                   
...
06FB: DB 15           IN      A,($15)             ; {hard.ENCODER1}
06FD: 0F              RRCA                        
06FE: 0F              RRCA                        
06FF: E6 3F           AND     $3F                 
0701: 06 06           LD      B,$06               
...
074C: C3 CF 07        JP      $07CF               ; {code.DogAndDVG}
...
076E: C3 CF 07        JP      $07CF               ; {code.DogAndDVG}
...
0781: 3E 16           LD      A,$16               
0783: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD}
0785: AF              XOR     A                   
...
0797: 28 ED           JR      Z,$786              ; {}
0799: 3E 00           LD      A,$00               
079B: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD}
079D: C3 EC 04        JP      $04EC               ; {}

07A0: D9              EXX                         
07A1: 08              EX      AF,AF'              
07A2: 21 00 30        LD      HL,$3000            
07A5: DB 09           IN      A,($09)             ; {hard.WDOG}
07A7: DB 0B           IN      A,($0B)             ; {hard.RDSTOP}
07A9: CB 7F           BIT     7,A                 
07AB: 28 05           JR      Z,$7B2              ; {}
07AD: 2B              DEC     HL                  
07AE: 7C              LD      A,H                 
...
07D0: DB 09           IN      A,($09)             ; {hard.WDOG} Bump watchdog
07D2: DB 0B           IN      A,($0B)             ; {hard.RDSTOP} Is DVG running
07D4: CB 7F           BIT     7,A                 ; Test run bit
07D6: 20 02           JR      NZ,$7DA             ; {} Yes ... leave it running
07D8: DB 08           IN      A,($08)             ; {hard.VGSTART} Start it up
07DA: 08              EX      AF,AF'              ; Restore A
07DB: FD E9           JP      (IY)                ; Continue routine

07DD: D9              
07DE: DB 11           IN      A,($11)             ; {hard.INPUTA}
07E0: 5F              LD      E,A                 
07E1: A2              AND     D                   
07E2: AA              XOR     D                   
07E3: 53              LD      D,E                 
...
07F7: C3 CF 07        JP      $07CF               ; {code.DogAndDVG} Feed the watchdog
...
0825: C3 CF 07        JP      $07CF               ; {code.DogAndDVG} Feed the watchdog and DVG
0828: DB 09           IN      A,($09)             ; {hard.WDOG} Feed the watchdog
...
0841: 78              LD      A,B                 ; Jump ...
0842: B1              OR      C                   ; ... and ...
0843: 20 D8           JR      NZ,$81D             ; {code.TestRAM} ... do all
;
...
0867: C3 CF 07        JP      $07CF               ; {code.DogAndDVG} Feed watchdog and make sure DVG is running
...
087E: 78              LD      A,B                 ; Jump ...
087F: B1              OR      C                   ; ... back ...
0880: 20 E1           JR      NZ,$863             ; {code.TestNONVOL} ... for all
;
...
08C3: C3 CF 07        JP      $07CF               ; {code.DogAndDVG}
08C6: DD E9           JP      (IX)                
```
...
08C8: DB 09           IN      A,($09)             ; {hard.WDOG} Feed watchdog
...
0911: 78              LD      A,B                 ; If ...
0912: B1              OR      C                   ; ... not ...
0913: 20 B3           JR      NZ,$8C8             ; {code.PrintString} ... keep printing
...
091E: D3 13           OUT     ($13),A             ; {hard.OUTPUTA} Turn on all 4 LEDs
0920: 3E 07           LD      A,$07               ; Play ...
0922: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD} ... beeping sound
0924: 21 00 30        LD      HL,$3000            ; Delay
0927: FD 21 2E 09     LD      IY,$092E            ; Next code is lights off
092B: C3 CF 07        JP      $07CF               ; {code.DogAndDVG} Watch dog and DVG
...
0935: D3 13           OUT     ($13),A             ; {hard.OUTPUTA} ... off
0937: 3E 00           LD      A,$00               ; Sound ...
0939: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD} ... off
093B: 21 00 30        LD      HL,$3000            ; Delay
093E: FD 21 45 09     LD      IY,$0945            ; Next code is ??
0942: C3 CF 07        JP      $07CF               ; {code.DogAndDVG} Watch dog and DVG
...
0970: DB 11           IN      A,($11)             ; {hard.INPUTA}
0972: E6 03           AND     $03                 
0974: 32 35 40        LD      ($4035),A           ; {ram.m4035}
0977: DB 17           IN      A,($17)             ; {hard.DIPSWC6}
0979: E6 07           AND     $07                 
097B: 07              RLCA                        
097C: 32 2B 40        LD      ($402B),A           ; {ram.m402B}
097F: 6F              LD      L,A                 
0980: 26 00           LD      H,$00               
0982: 11 C3 2F        LD      DE,$2FC3            
0985: 19              ADD     HL,DE               
0986: 22 27 40        LD      ($4027),HL          ; {ram.m4027}
0989: DB 17           IN      A,($17)             ; {hard.DIPSWC6}
098B: E6 38           AND     $38                 
098D: 0F              RRCA                        
098E: 0F              RRCA                        
098F: 32 2C 40        LD      ($402C),A           ; {ram.m402C}
0992: 6F              LD      L,A                 
0993: 26 00           LD      H,$00               
0995: 11 C3 2F        LD      DE,$2FC3            
0998: 19              ADD     HL,DE               
0999: 22 29 40        LD      ($4029),HL          ; {ram.m4029}
...
0A3A: C9              RET                         
0A3B: AF              XOR     A                   
0A3C: 32 2D 40        LD      ($402D),A           ; {ram.m402D}
...
0AC2: DB 17           IN      A,($17)             ; {hard.DIPSWC6}
0AC4: CB 77           BIT     6,A                 
0AC6: 28 04           JR      Z,$ACC              ; {}
0AC8: FD 36 AD 04     LD      (IY+$AD),$04        
0ACC: 3A 41 40        LD      A,($4041)           ; {ram.m4041}
0ACF: E6 40           AND     $40                 
0AD1: 32 41 40        LD      ($4041),A           ; {ram.m4041}
...
0B03: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
0B06: B7              OR      A                   
0B07: CA 76 0B        JP      Z,$0B76             ; {}
0B0A: FD 36 A1 3C     LD      (IY+$A1),$3C        
0B0E: DB 10           IN      A,($10)             ; {hard.DIPSWC4}
0B10: E6 03           AND     $03                 
0B12: 07              RLCA                        
0B13: 5F              LD      E,A                 
0B14: 16 00           LD      D,$00               
...
0B1B: 23              INC     HL                  
0B1C: 56              LD      D,(HL)              
0B1D: ED 53 60 40     LD      ($4060),DE          ; {ram.m4060}
0B21: DB 10           IN      A,($10)             ; {hard.DIPSWC4}
0B23: E6 0C           AND     $0C                 
0B25: 0F              RRCA                        
0B26: 5F              LD      E,A                 
0B27: 16 00           LD      D,$00               
...
0B2F: 56              LD      D,(HL)              
0B30: 23              INC     HL                  
0B31: ED 53 62 40     LD      ($4062),DE          ; {ram.m4062}
0B35: 5E              LD      E,(HL)              
0B36: 23              INC     HL                  
0B37: 56              LD      D,(HL)              
0B38: ED 53 64 40     LD      ($4064),DE          ; {ram.m4064}
0B3C: FD 36 04 04     LD      (IY+$04),$04        
0B40: CD F3 2A        CALL    $2AF3               ; {}
0B43: DB 10           IN      A,($10)             ; {hard.DIPSWC4}
0B45: E6 30           AND     $30                 
0B47: 0F              RRCA                        
0B48: 0F              RRCA                        
0B49: 0F              RRCA                        
...
0BA6: 3A 83 40        LD      A,($4083)           ; {ram.m4083}
0BA9: FE 07           CP      $07                 
0BAB: 28 06           JR      Z,$BB3              ; {}
0BAD: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
0BB0: B7              OR      A                   
...
0BC5: DB 17           IN      A,($17)             ; {hard.DIPSWC6}
0BC7: CB 7F           BIT     7,A                 
0BC9: 28 53           JR      Z,$C1E              ; {}
...
0BD9: DB 17           IN      A,($17)             ; {hard.DIPSWC6}
0BDB: CB 77           BIT     6,A                 
0BDD: 20 0C           JR      NZ,$BEB             ; {}
0BDF: F3              DI                          
0BE0: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
0BE3: FD 96 C0        SUB     (IY+$C0)            
0BE6: 27              DAA                         
0BE7: 32 2D 40        LD      ($402D),A           ; {ram.m402D}
0BEA: FB              EI                          
0BEB: FD CB AE FE     SET     7,(IY+$AE)          
0BEF: 2A 36 40        LD      HL,($4036)          ; {ram.m4036}
0BF2: 22 42 40        LD      ($4042),HL          ; {ram.m4042}
0BF5: 2A 38 40        LD      HL,($4038)          ; {ram.m4038}
0BF8: 22 44 40        LD      ($4044),HL          ; {ram.m4044}
0BFB: 21 00 00        LD      HL,$0000            
0BFE: 22 36 40        LD      ($4036),HL          ; {ram.m4036}
0C01: 22 38 40        LD      ($4038),HL          ; {ram.m4038}
0C04: 22 3A 40        LD      ($403A),HL          ; {ram.m403A}
0C07: 22 3C 40        LD      ($403C),HL          ; {ram.m403C}
...
0C1C: ED B0           LDIR                        
0C1E: DB 10           IN      A,($10)             ; {hard.DIPSWC4}
0C20: E6 30           AND     $30                 
0C22: 0F              RRCA                        
0C23: 0F              RRCA                        
0C24: 0F              RRCA                        
...
0C32: 19              ADD     HL,DE               
0C33: 7E              LD      A,(HL)              
0C34: 32 66 40        LD      ($4066),A           ; {ram.m4066}
...
0CA4: 3A 6C 40        LD      A,($406C)           ; {ram.m406C}
0CA7: E6 03           AND     $03                 
0CA9: 20 70           JR      NZ,$D1B             ; {}
0CAB: 3A 6C 40        LD      A,($406C)           ; {ram.m406C}
0CAE: CB 2F           SRA     A                   
0CB0: CB 2F           SRA     A                   
0CB2: FE 06           CP      $06                 
0CB4: 38 02           JR      C,$CB8              ; {}
0CB6: 3E 06           LD      A,$06               
0CB8: C6 16           ADD     A,$16               
0CBA: 32 84 40        LD      ($4084),A           ; {ram.m4084}
...
0CD4: DB 09           IN      A,($09)             ; {hard.WDOG}
0CD6: CD D5 17        CALL    $17D5               ; {}
0CD9: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
0CDC: 47              LD      B,A                 
...
0CF1: 3A 21 40        LD      A,($4021)           ; {ram.m4021}
0CF4: B7              OR      A                   
0CF5: 28 13           JR      Z,$D0A              ; {}
0CF7: FE 02           CP      $02                 
...
0D2F: 3A 6D 40        LD      A,($406D)           ; {ram.m406D}
0D32: B7              OR      A                   
0D33: 28 1C           JR      Z,$D51              ; {}
...
0D51: 3A 3E 40        LD      A,($403E)           ; {ram.m403E}
0D54: FE 01           CP      $01                 
0D56: 28 32           JR      Z,$D8A              ; {}
...
0E3D: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
0E40: 06 15           LD      B,$15               
0E42: FE 06           CP      $06                 
...
0E54: 10 FB           DJNZ    $E51                ; {}
0E56: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
0E59: FE 06           CP      $06                 
...
0EA4: 3A 24 40        LD      A,($4024)           ; {ram.m4024}
0EA7: FE 02           CP      $02                 
...
0F30: 3E 00           LD      A,$00               
0F32: 32 17 40        LD      ($4017),A           ; {ram.m4017}
0F35: 32 18 40        LD      ($4018),A           ; {ram.m4018}
0F38: FB              EI                          
0F39: FD 21 80 40     LD      IY,$4080            
0F3D: DB 09           IN      A,($09)             ; {hard.WDOG}
0F3F: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
0F42: FD 96 98        SUB     (IY+$98)            
0F45: 32 19 40        LD      ($4019),A           ; {ram.m4019}
0F48: 47              LD      B,A                 
0F49: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
0F4C: 32 18 40        LD      ($4018),A           ; {ram.m4018}
0F4F: 30 7B           JR      NC,$FCC             ; {}
0F51: FD 34 A0        INC     (IY+$A0)            ; 
0F54: 11 3A 40        LD      DE,$403A            
0F57: 21 F7 3F        LD      HL,$3FF7            
0F5A: CD D5 16        CALL    $16D5               ; {}
0F5D: 3A 21 40        LD      A,($4021)           ; {ram.m4021}
0F60: B7              OR      A                   
0F61: 28 30           JR      Z,$F93              ; {}
0F63: FD 35 A1        DEC     (IY+$A1)            
0F66: 20 2B           JR      NZ,$F93             ; {}
0F68: 3A 82 40        LD      A,($4082)           ; {ram.m4082}
0F6B: B7              OR      A                   
...
0F7E: 3A 68 40        LD      A,($4068)           ; {ram.m4068}
...
10D8: 18 BF           JR      $1099               ; {}
10DA: 18 D9           JR      $10B5               ; {}
10DC: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
10DF: B7              OR      A                   
...
10F1: 2A 27 40        LD      HL,($4027)          ; {ram.m4027}
10F4: 4E              LD      C,(HL)              
10F5: 23              INC     HL                  
10F6: 46              LD      B,(HL)              
...
1192: 18 E8           JR      $117C               ; {}
1194: 3A 8B 40        LD      A,($408B)           ; {ram.m408B}
...
11AA: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
11AD: B7              OR      A                   
...
11CC: D3 13           OUT     ($13),A             ; {hard.OUTPUTA} Write the LED values
11CE: 32 72 40        LD      ($4072),A           ; {ram.m4072} Remember what we wrote
11D1: FB              EI                          ; Done ... interrupts back on

11D2: 18 03           JR      $11D7               ; {}
11D4: CD 48 12        CALL    $1248               ; {}
11D7: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
11DA: FE 02           CP      $02                 
...
1210: DB 17           IN      A,($17)             ; {hard.DIPSWC6}
1212: CB 7F           BIT     7,A                 
...
1247: C9              RET                         
1248: F3              DI                          
1249: 3A 72 40        LD      A,($4072)           ; {ram.m4072}
124C: F6 3C           OR      $3C                 
124E: D3 13           OUT     ($13),A             ; {hard.OUTPUTA}
1250: 32 72 40        LD      ($4072),A           ; {ram.m4072}
1253: FB              EI                          
1254: C9              RET                         
1255: FD CB C1 56     BIT     2,(IY+$C1)          
1259: 28 1C           JR      Z,$1277             ; {}
125B: F3              DI                          
125C: 3A 3E 40        LD      A,($403E)           ; {ram.m403E}
...
1271: 3A 72 40        LD      A,($4072)           ; {ram.m4072}
1274: D3 13           OUT     ($13),A             ; {hard.OUTPUTA}
1276: FB              EI                          
1277: C9              RET                         
...
1287: 3A 24 40        LD      A,($4024)           ; {ram.m4024}
128A: FE 04           CP      $04                 
...
12E1: EE 3F           XOR     $3F                 
12E3: 47              LD      B,A                 
12E4: 3A 24 40        LD      A,($4024)           ; {ram.m4024}
12E7: FE 03           CP      $03                 
...
12F5: 78              LD      A,B                 
12F6: 32 BC 40        LD      ($40BC),A           ; {ram.m40BC}
...
130F: 3A 70 40        LD      A,($4070)           ; {ram.m4070}
1312: B7              OR      A                   
...
1329: 3A 77 40        LD      A,($4077)           ; {ram.m4077}
132C: B7              OR      A                   
...
1396: 3A 23 40        LD      A,($4023)           ; {ram.m4023}
1399: FE 03           CP      $03                 
...
13B2: 3A 66 40        LD      A,($4066)           ; {ram.m4066}
13B5: FE 01           CP      $01                 
...
13D2: 3A 3E 40        LD      A,($403E)           ; {ram.m403E}
13D5: FE 02           CP      $02                 
...
1417: 3A 8B 40        LD      A,($408B)           ; {ram.m408B}
141A: FD BE 09        CP      (IY+$09)            
141D: 38 05           JR      C,$1424             ; {}
141F: CD 6D 2B        CALL    $2B6D               ; {}
1422: 18 70           JR      $1494               ; {}
1424: 3A 22 40        LD      A,($4022)           ; {ram.m4022}
1427: B7              OR      A                   
...
1446: 3A 3E 40        LD      A,($403E)           ; {ram.m403E}
1449: FE 02           CP      $02                 
...
147E: 3A 24 40        LD      A,($4024)           ; {ram.m4024}
1481: FE 04           CP      $04                 
...
14B8: 3A B9 40        LD      A,($40B9)           ; {ram.m40B9}
14BB: FE D0           CP      $D0                 
14BD: 30 32           JR      NC,$14F1            ; {}
14BF: FE 30           CP      $30                 
14C1: 38 2E           JR      C,$14F1             ; {}
14C3: FD CB EB E6     SET     4,(IY+$EB)          
14C7: 3A BB 40        LD      A,($40BB)           ; {ram.m40BB}
14CA: FE 80           CP      $80                 
14CC: 38 23           JR      C,$14F1             ; {}
14CE: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
14D1: CB 2F           SRA     A                   
14D3: 47              LD      B,A                 
14D4: C6 01           ADD     A,$01               
14D6: CB 27           SLA     A                   
...
14FA: 32 2F 40        LD      ($402F),A           ; {ram.m402F}
14FD: 5F              LD      E,A                 
14FE: A2              AND     D                   
14FF: AA              XOR     D                   
1500: 32 30 40        LD      ($4030),A           ; {ram.m4030}
1503: 7B              LD      A,E                 
1504: B2              OR      D                   
1505: AA              XOR     D                   
1506: 32 31 40        LD      ($4031),A           ; {ram.m4031}
1509: FD 56 B2        LD      D,(IY+$B2)          
150C: DB 12           IN      A,($12)             ; {hard.INPUTB}
150E: 32 32 40        LD      ($4032),A           ; {ram.m4032}
1511: 5F              LD      E,A                 
1512: A2              AND     D                   
1513: AA              XOR     D                   
1514: 32 33 40        LD      ($4033),A           ; {ram.m4033}
1517: C9              RET                         
1518: E5              PUSH    HL                  
...
155A: ED 53 67 44     LD      ($4467),DE          ; {ram.m4467}
...
15E4: 2A 67 44        LD      HL,($4467)          ; {ram.m4467}
15E7: 7E              LD      A,(HL)              
15E8: C6 01           ADD     A,$01               
15EA: 27              DAA                         
...
1655: 0B              DEC     BC                  
1656: 0A              LD      A,(BC)              
1657: 32 93 40        LD      ($4093),A           ; {ram.m4093}
...
1688: 36 00           LD      (HL),$00            
168A: ED B0           LDIR                        
168C: 3A 93 40        LD      A,($4093)           ; {ram.m4093}
168F: B7              OR      A                   
1690: 28 33           JR      Z,$16C5             ; {}
1692: DB 09           IN      A,($09)             ; {hard.WDOG}
...
16E1: C1              POP     BC                  
16E2: C9              RET                         
16E3: 3A 2D 40        LD      A,($402D)           ; {ram.m402D}
...
1717: DB 11           IN      A,($11)             ; {hard.INPUTA}
1719: 18 1B           JR      $1736               ; {}
171B: 3A 3E 40        LD      A,($403E)           ; {ram.m403E}
171E: FD AE EE        XOR     (IY+$EE)            
1721: CB 47           BIT     0,A                 
1723: 28 F2           JR      Z,$1717             ; {}
1725: DB 12           IN      A,($12)             ; {hard.INPUTB}
1727: E6 03           AND     $03                 
1729: 0F              RRCA                        
172A: 0F              RRCA                        
172B: 0F              RRCA                        
172C: 32 34 40        LD      ($4034),A           ; {ram.m4034}
172F: DB 11           IN      A,($11)             ; {hard.INPUTA}
1731: E6 9F           AND     $9F                 
1733: FD B6 B4        OR      (IY+$B4)            
1736: C9              RET                         
1737: FD CB C1 56     BIT     2,(IY+$C1)          
173B: 20 06           JR      NZ,$1743            ; {}
173D: DB 15           IN      A,($15)             ; {hard.ENCODER1}
173F: 0F              RRCA                        
1740: 0F              RRCA                        
1741: 18 0C           JR      $174F               ; {}
1743: 3A 3E 40        LD      A,($403E)           ; {ram.m403E}
1746: FD AE EE        XOR     (IY+$EE)            
1749: CB 47           BIT     0,A                 
174B: 28 F0           JR      Z,$173D             ; {}
174D: DB 16           IN      A,($16)             ; {hard.ENCODER2}
174F: C9              RET                         
1750: DB 09           IN      A,($09)             ; {hard.WDOG}
1752: DB 0B           IN      A,($0B)             ; {hard.RDSTOP}
1754: CB 7F           BIT     7,A                 
...
17B7: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
...
17C3: 00              NOP                         
17C4: 00              NOP                         
17C5: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
17C8: 32 1A 40        LD      ($401A),A           ; {ram.m401A}
17CB: FD CB 1A 7E     BIT     7,(IY+$1A)          
17CF: C4 68 18        CALL    NZ,$1868            ; {}
17D2: DB 08           IN      A,($08)             ; {hard.VGSTART}
17D4: C9              RET                         
17D5: DB 09           IN      A,($09)             ; {hard.WDOG}
17D7: DB 0B           IN      A,($0B)             ; {hard.RDSTOP}
17D9: CB 7F           BIT     7,A                 
17DB: 20 2F           JR      NZ,$180C            ; {}
17DD: 3A 24 40        LD      A,($4024)           ; {ram.m4024}
17E0: FE 01           CP      $01                 
17E2: 20 26           JR      NZ,$180A            ; {}
17E4: 3A 84 40        LD      A,($4084)           ; {ram.m4084}
17E7: FE 02           CP      $02                 
17E9: 20 1F           JR      NZ,$180A            ; {}
17EB: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
17EE: E6 0C           AND     $0C                 
17F0: 0F              RRCA                        
17F1: 5F              LD      E,A                 
17F2: 16 00           LD      D,$00               
...
180A: DB 08           IN      A,($08)             ; {hard.VGSTART}
180C: C9              RET                         
180D: DB 09           IN      A,($09)             ; {hard.WDOG}
180F: DB 0B           IN      A,($0B)             ; {hard.RDSTOP}
1811: CB 7F           BIT     7,A                 
...
184F: ED B0           LDIR                        
1851: DB 09           IN      A,($09)             ; {hard.WDOG}
1853: C9              RET                         
1854: DB 0B           IN      A,($0B)             ; {hard.RDSTOP}
1856: CB 7F           BIT     7,A                 
1858: 20 FA           JR      NZ,$1854            ; {}
185A: DB 09           IN      A,($09)             ; {hard.WDOG}
185C: C9              RET                         
185D: F5              PUSH    AF                  
185E: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
...
1A02: 3A 75 40        LD      A,($4075)           ; {ram.m4075}
1A05: DD 96 07        SUB     (IX+$07)            
1A08: 30 02           JR      NC,$1A0C            ; {}
1A0A: ED 44           NEG                         
1A0C: 67              LD      H,A                 
1A0D: 3A 76 40        LD      A,($4076)           ; {ram.m4076}
...
1A2F: 32 75 40        LD      ($4075),A           ; {ram.m4075}
1A32: DD 7E 09        LD      A,(IX+$09)          
1A35: 32 76 40        LD      ($4076),A           ; {ram.m4076}
1A38: DD E1           POP     IX                  
1A3A: DD E1           POP     IX                  
1A3C: DD 74 07        LD      (IX+$07),H          
1A3F: 18 10           JR      $1A51               ; {}
1A41: DD 7E 07        LD      A,(IX+$07)          
1A44: 32 75 40        LD      ($4075),A           ; {ram.m4075}
1A47: DD 7E 09        LD      A,(IX+$09)          
1A4A: 32 76 40        LD      ($4076),A           ; {ram.m4076}
1A4D: DD E1           POP     IX                  
1A4F: DD E1           POP     IX                  
1A51: 05              DEC     B                   
...
1A57: FB              EI                          
1A58: C9              RET                         
1A59: DB 09           IN      A,($09)             ; {hard.WDOG}
1A5B: DB 0B           IN      A,($0B)             ; {hard.RDSTOP}
1A5D: CB 7F           BIT     7,A                 
1A5F: CC 50 17        CALL    Z,$1750             ; {}
1A62: 3A 17 40        LD      A,($4017)           ; {ram.m4017}
1A65: FD 96 98        SUB     (IY+$98)            
1A68: FD 86 92        ADD     A,(IY+$92)          
1A6B: 32 13 40        LD      ($4013),A           ; {ram.m4013}
1A6E: FD CB 81 6E     BIT     5,(IY+$81)          
1A72: C2 F9 1A        JP      NZ,$1AF9            ; {}
1A75: 3A 7D 40        LD      A,($407D)           ; {ram.m407D}
1A78: FE 01           CP      $01                 
...
1AA2: 18 50           JR      $1AF4               ; {}
1AA4: 3A 7A 40        LD      A,($407A)           ; {ram.m407A}
1AA7: B7              OR      A                   
1AA8: 20 20           JR      NZ,$1ACA            ; {}
1AAA: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
1AAD: FE 06           CP      $06                 
1AAF: 20 08           JR      NZ,$1AB9            ; {}
1AB1: 3A 22 40        LD      A,($4022)           ; {ram.m4022}
1AB4: B7              OR      A                   
...
1B29: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
1B2C: CB 67           BIT     4,A                 
...
1B3D: 23              INC     HL                  
1B3E: 56              LD      D,(HL)              
1B3F: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
1B42: E6 30           AND     $30                 
...
1B4B: ED 44           NEG                         
1B4D: 57              LD      D,A                 
1B4E: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
1B51: CB 6F           BIT     5,A                 
1B53: 28 04           JR      Z,$1B59             ; {}
1B55: 7B              LD      A,E                 
1B56: ED 44           NEG                         
1B58: 5F              LD      E,A                 
1B59: 2A 02 40        LD      HL,($4002)          ; {ram.m4002}
1B5C: 4A              LD      C,D                 
1B5D: 06 00           LD      B,$00               
1B5F: CB 7A           BIT     7,D                 
...
1B6B: 22 02 40        LD      ($4002),HL          ; {ram.m4002}
1B6E: 2A 04 40        LD      HL,($4004)          ; {ram.m4004}
1B71: 4B              LD      C,E                 
1B72: 06 00           LD      B,$00               
1B74: CB 7B           BIT     7,E                 
...
1B80: 22 04 40        LD      ($4004),HL          ; {ram.m4004}
...
1BA3: 2A 02 40        LD      HL,($4002)          ; {ram.m4002}
1BA6: CD 48 21        CALL    $2148               ; {}
1BA9: 22 02 40        LD      ($4002),HL          ; {ram.m4002}
1BAC: 2A 04 40        LD      HL,($4004)          ; {ram.m4004}
1BAF: CD 48 21        CALL    $2148               ; {}
1BB2: 22 04 40        LD      ($4004),HL          ; {ram.m4004}
...
1BCA: 3A 7D 40        LD      A,($407D)           ; {ram.m407D}
1BCD: 32 7E 40        LD      ($407E),A           ; {ram.m407E}
1BD0: CD BF 27        CALL    $27BF               ; {}
1BD3: 18 16           JR      $1BEB               ; {}
1BD5: ED 5B 02 40     LD      DE,($4002)          ; {ram.m4002}
1BD9: 2A 06 40        LD      HL,($4006)          ; {ram.m4006}
1BDC: 19              ADD     HL,DE               
1BDD: 22 06 40        LD      ($4006),HL          ; {ram.m4006}
1BE0: ED 5B 04 40     LD      DE,($4004)          ; {ram.m4004}
1BE4: 2A 08 40        LD      HL,($4008)          ; {ram.m4008}
1BE7: 19              ADD     HL,DE               
1BE8: 22 08 40        LD      ($4008),HL          ; {ram.m4008}
1BEB: 3A 7B 40        LD      A,($407B)           ; {ram.m407B}
...
1C3D: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
1C40: 32 0F 40        LD      ($400F),A           ; {ram.m400F}
1C43: CD 2F 25        CALL    $252F               ; {}
1C46: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
1C49: FE 06           CP      $06                 
...
1C57: E6 07           AND     $07                 
1C59: F6 04           OR      $04                 
1C5B: 32 7F 40        LD      ($407F),A           ; {ram.m407F}
...
1C7B: 3A 68 40        LD      A,($4068)           ; {ram.m4068}
1C7E: FE 0F           CP      $0F                 
1C80: 28 22           JR      Z,$1CA4             ; {}
1C82: 3A 22 40        LD      A,($4022)           ; {ram.m4022}
1C85: FE 0A           CP      $0A                 
...
1CA4: 3A 77 40        LD      A,($4077)           ; {ram.m4077}
1CA7: FE 01           CP      $01                 
1CA9: 28 0A           JR      Z,$1CB5             ; {}
1CAB: 3A 22 40        LD      A,($4022)           ; {ram.m4022}
1CAE: B7              OR      A                   
...
1CC0: 3A 22 40        LD      A,($4022)           ; {ram.m4022}
1CC3: FE 0C           CP      $0C                 
...
1CE3: 32 22 40        LD      ($4022),A           ; {ram.m4022}
1CE6: CD 06 29        CALL    $2906               ; {}
1CE9: E6 0F           AND     $0F                 
1CEB: F6 10           OR      $10                 
1CED: 32 0E 40        LD      ($400E),A           ; {ram.m400E}
...
1D15: 32 12 40        LD      ($4012),A           ; {ram.m4012}
1D18: FD 36 FF FA     LD      (IY+$FF),$FA        
1D1C: 3E 05           LD      A,$05               
1D1E: CD F6 2D        CALL    $2DF6               ; {}
1D21: 3A 3B 40        LD      A,($403B)           ; {ram.m403B}
1D24: B7              OR      A                   
1D25: 20 58           JR      NZ,$1D7F            ; {}
1D27: 3A 3A 40        LD      A,($403A)           ; {ram.m403A}
1D2A: FE 35           CP      $35                 
...
1D42: 3A 77 40        LD      A,($4077)           ; {ram.m4077}
1D45: FE 01           CP      $01                 
1D47: 20 22           JR      NZ,$1D6B            ; {}
1D49: 3A 7C 40        LD      A,($407C)           ; {ram.m407C}
1D4C: FE 14           CP      $14                 
1D4E: 38 04           JR      C,$1D54             ; {}
1D50: FD 36 FC 14     LD      (IY+$FC),$14        
1D54: 3A B9 40        LD      A,($40B9)           ; {ram.m40B9}
1D57: FD AE 87        XOR     (IY+$87)            
1D5A: 4F              LD      C,A                 
1D5B: 3A BB 40        LD      A,($40BB)           ; {ram.m40BB}
...
1D69: 18 26           JR      $1D91               ; {}
1D6B: 3A 0F 40        LD      A,($400F)           ; {ram.m400F}
1D6E: 32 0A 40        LD      ($400A),A           ; {ram.m400A}
1D71: 3A 22 40        LD      A,($4022)           ; {ram.m4022}
1D74: B7              OR      A                   
1D75: CA D6 1C        JP      Z,$1CD6             ; {}
1D78: E6 07           AND     $07                 
1D7A: 20 15           JR      NZ,$1D91            ; {}
1D7C: FD 35 A2        DEC     (IY+$A2)            
1D7F: 3A 0F 40        LD      A,($400F)           ; {ram.m400F}
1D82: C6 20           ADD     A,$20               
1D84: 32 0F 40        LD      ($400F),A           ; {ram.m400F}
1D87: CD 06 29        CALL    $2906               ; {}
1D8A: CB 47           BIT     0,A                 
1D8C: 28 03           JR      Z,$1D91             ; {}
1D8E: FD 35 8F        DEC     (IY+$8F)            
1D91: CD 2F 25        CALL    $252F               ; {}
1D94: 3A 7F 40        LD      A,($407F)           ; {ram.m407F}
1D97: B7              OR      A                   
1D98: 28 13           JR      Z,$1DAD             ; {}
1D9A: 3A 7A 40        LD      A,($407A)           ; {ram.m407A}
1D9D: B7              OR      A                   
...
1DBA: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
1DBD: E6 03           AND     $03                 
1DBF: 07              RLCA                        
...
1DE1: 3A 14 40        LD      A,($4014)           ; {ram.m4014}
1DE4: 07              RLCA                        
1DE5: E6 06           AND     $06                 
1DE7: 20 1A           JR      NZ,$1E03            ; {}
1DE9: 3A 0E 40        LD      A,($400E)           ; {ram.m400E}
1DEC: B7              OR      A                   
1DED: 3E 00           LD      A,$00               
...
1E15: EB              EX      DE,HL               
1E16: 18 43           JR      $1E5B               ; {}
1E18: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
1E1B: 32 0F 40        LD      ($400F),A           ; {ram.m400F}
1E1E: E6 30           AND     $30                 
1E20: 0F              RRCA                        
1E21: 0F              RRCA                        
1E22: 0F              RRCA                        
...
1E2B: 23              INC     HL                  
1E2C: 56              LD      D,(HL)              
1E2D: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
1E30: CB 67           BIT     4,A                 
...
1EBB: 2A 06 40        LD      HL,($4006)          ; {ram.m4006}
1EBE: 7C              LD      A,H                 
1EBF: CB 04           RLC     H                   
1EC1: CB 04           RLC     H                   
1EC3: CB 05           RLC     L                   
...
1ECD: E6 03           AND     $03                 
1ECF: 67              LD      H,A                 
1ED0: 3A 0B 40        LD      A,($400B)           ; {ram.m400B}
1ED3: E6 F0           AND     $F0                 
1ED5: B4              OR      H                   
...
1EE5: 3A 75 40        LD      A,($4075)           ; {ram.m4075}
1EE8: FD 96 87        SUB     (IY+$87)            
1EEB: 30 02           JR      NC,$1EEF            ; {}
1EED: ED 44           NEG                         
1EEF: 57              LD      D,A                 
1EF0: 3A 76 40        LD      A,($4076)           ; {ram.m4076}
...
1F11: 3A 07 40        LD      A,($4007)           ; {ram.m4007}
1F14: 32 75 40        LD      ($4075),A           ; {ram.m4075}
1F17: 3A 09 40        LD      A,($4009)           ; {ram.m4009}
1F1A: 32 76 40        LD      ($4076),A           ; {ram.m4076}
1F1D: DB 0B           IN      A,($0B)             ; {hard.RDSTOP}
1F1F: CB FF           SET     7,A                 
...
1F30: ED 5B 08 40     LD      DE,($4008)          ; {ram.m4008}
1F34: 2A 04 40        LD      HL,($4004)          ; {ram.m4004}
1F37: 19              ADD     HL,DE               
1F38: CB 7A           BIT     7,D                 
...
1F5D: ED 44           NEG                         
1F5F: 5F              LD      E,A                 
1F60: ED 4B 06 40     LD      BC,($4006)          ; {ram.m4006}
1F64: 2A 02 40        LD      HL,($4002)          ; {ram.m4002}
1F67: 09              ADD     HL,BC               
1F68: 7C              LD      A,H                 
1F69: D6 80           SUB     $80                 
...
1FDC: 18 52           JR      $2030               ; {}
1FDE: 3A 07 40        LD      A,($4007)           ; {ram.m4007}
1FE1: FD AE 83        XOR     (IY+$83)            
1FE4: CB 7F           BIT     7,A                 
1FE6: 20 2F           JR      NZ,$2017            ; {}
1FE8: 3A 09 40        LD      A,($4009)           ; {ram.m4009}
1FEB: FD AE 85        XOR     (IY+$85)            
1FEE: CB 7F           BIT     7,A                 
1FF0: 20 3E           JR      NZ,$2030            ; {}
1FF2: FD CB 81 46     BIT     0,(IY+$81)          
1FF6: 20 56           JR      NZ,$204E            ; {}
1FF8: ED 5B 02 40     LD      DE,($4002)          ; {ram.m4002}
1FFC: 2A 04 40        LD      HL,($4004)          ; {ram.m4004}
1FFF: 7A              LD      A,D                 
2000: 2F              CPL                         
2001: 57              LD      D,A                 
2002: 7B              LD      A,E                 
...
200B: 6F              LD      L,A                 
200C: 23              INC     HL                  
200D: ED 53 04 40     LD      ($4004),DE          ; {ram.m4004}
2011: 22 02 40        LD      ($4002),HL          ; {ram.m4002}
2014: C3 74 20        JP      $2074               ; {}
2017: FD CB F8 EE     SET     5,(IY+$F8)          
201B: FD CB 81 46     BIT     0,(IY+$81)          
201F: 20 2D           JR      NZ,$204E            ; {}
2021: 2A 04 40        LD      HL,($4004)          ; {ram.m4004}
2024: 7C              LD      A,H                 
2025: 2F              CPL                         
2026: 67              LD      H,A                 
2027: 7D              LD      A,L                 
...
2029: 6F              LD      L,A                 
202A: 23              INC     HL                  
202B: 22 04 40        LD      ($4004),HL          ; {ram.m4004}
202E: 18 44           JR      $2074               ; {}
2030: FD CB 81 46     BIT     0,(IY+$81)          
2034: 20 0F           JR      NZ,$2045            ; {}
2036: 2A 02 40        LD      HL,($4002)          ; {ram.m4002}
2039: 7C              LD      A,H                 
203A: 2F              CPL                         
203B: 67              LD      H,A                 
203C: 7D              LD      A,L                 
...
203E: 6F              LD      L,A                 
203F: 23              INC     HL                  
2040: 22 02 40        LD      ($4002),HL          ; {ram.m4002}
2043: 18 2F           JR      $2074               ; {}
...
2055: 3A 07 40        LD      A,($4007)           ; {ram.m4007}
2058: FE 7E           CP      $7E                 
205A: 30 71           JR      NC,$20CD            ; {}
205C: 2A 06 40        LD      HL,($4006)          ; {ram.m4006}
205F: ED 5B 02 40     LD      DE,($4002)          ; {ram.m4002}
2063: 19              ADD     HL,DE               
2064: 22 06 40        LD      ($4006),HL          ; {ram.m4006}
2067: 2A 08 40        LD      HL,($4008)          ; {ram.m4008}
206A: ED 5B 04 40     LD      DE,($4004)          ; {ram.m4004}
206E: 19              ADD     HL,DE               
206F: 22 04 40        LD      ($4004),HL          ; {ram.m4004}
2072: 18 59           JR      $20CD               ; {}
...
20AD: 3A 02 40        LD      A,($4002)           ; {ram.m4002}
...
20DB: 3A 78 40        LD      A,($4078)           ; {ram.m4078}
20DE: CB 77           BIT     6,A                 
...
2184: F1              POP     AF                  
2185: C9              RET                         
2186: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
2189: 07              RLCA                        
218A: E6 1E           AND     $1E                 
218C: 47              LD      B,A                 
...
2192: CB EF           SET     5,A                 
2194: 90              SUB     B                   
2195: 32 7C 40        LD      ($407C),A           ; {ram.m407C}
2198: C9              RET                         
2199: DB 09           IN      A,($09)             ; {hard.WDOG}
...
2223: 3A 0E 40        LD      A,($400E)           ; {ram.m400E}
2226: B7              OR      A                   
...
225C: 3A 7D 40        LD      A,($407D)           ; {ram.m407D}
225F: FE 0E           CP      $0E                 
2261: 38 17           JR      C,$227A             ; {}
2263: 3A 7E 40        LD      A,($407E)           ; {ram.m407E}
...
22F9: 3A 7D 40        LD      A,($407D)           ; {ram.m407D}
22FC: FE 01           CP      $01                 
22FE: 28 04           JR      Z,$2304             ; {}
2300: FE 0E           CP      $0E                 
2302: 38 03           JR      C,$2307             ; {}
2304: 3A 7E 40        LD      A,($407E)           ; {ram.m407E}
...
236D: ED 5B 60 40     LD      DE,($4060)          ; {ram.m4060}
2371: 2A 38 40        LD      HL,($4038)          ; {ram.m4038}
2374: B7              OR      A                   
...
2397: 18 54           JR      $23ED               ; {}
2399: ED 5B 62 40     LD      DE,($4062)          ; {ram.m4062}
239D: 2A 38 40        LD      HL,($4038)          ; {ram.m4038}
23A0: B7              OR      A                   
...
23C2: 18 29           JR      $23ED               ; {}
23C4: ED 5B 64 40     LD      DE,($4064)          ; {ram.m4064}
23C8: 2A 38 40        LD      HL,($4038)          ; {ram.m4038}
23CB: B7              OR      A                   
...
2487: 3A 7B 40        LD      A,($407B)           ; {ram.m407B}
248A: B7              OR      A                   
248B: 20 20           JR      NZ,$24AD            ; {}
248D: 3A 77 40        LD      A,($4077)           ; {ram.m4077}
2490: FE 01           CP      $01                 
...
24A1: 32 7B 40        LD      ($407B),A           ; {ram.m407B}
24A4: D5              PUSH    DE                  
24A5: DD E1           POP     IX                  
...
24F0: EB              EX      DE,HL               
24F1: 2A 80 40        LD      HL,($4080)          ; {ram.m4080}
24F4: B7              OR      A                   
...
2503: 08              EX      AF,AF'              
2504: 3A 77 40        LD      A,($4077)           ; {ram.m4077}
2507: FE 02           CP      $02                 
2509: 30 22           JR      NC,$252D            ; {}
250B: 08              EX      AF,AF'              
250C: FD 36 FB 00     LD      (IY+$FB),$00        
2510: ED 53 80 40     LD      ($4080),DE          ; {ram.m4080}
2514: 32 7A 40        LD      ($407A),A           ; {ram.m407A}
2517: 3A 77 40        LD      A,($4077)           ; {ram.m4077}
251A: FE 01           CP      $01                 
...
252D: D1              POP     DE                  
252E: C9              RET                         
252F: 3A B9 40        LD      A,($40B9)           ; {ram.m40B9}
...
253B: 06 FF           LD      B,$FF               
253D: 57              LD      D,A                 
253E: 3A BB 40        LD      A,($40BB)           ; {ram.m40BB}
...
2585: C6 10           ADD     A,$10               
2587: 47              LD      B,A                 
2588: 3A 0F 40        LD      A,($400F)           ; {ram.m400F}
258B: E6 3F           AND     $3F                 
258D: 4F              LD      C,A                 
258E: 90              SUB     B                   
...
25A3: 18 01           JR      $25A6               ; {}
25A5: 79              LD      A,C                 
25A6: 32 0F 40        LD      ($400F),A           ; {ram.m400F}
25A9: C9              RET                         
25AA: C5              PUSH    BC                  
25AB: D5              PUSH    DE                  
25AC: 7A              LD      A,D                 
...
26B8: 3A 0F 40        LD      A,($400F)           ; {ram.m400F}
...
26EE: 29              ADD     HL,HL               
26EF: 18 12           JR      $2703               ; {}
26F1: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
...
2718: 29              ADD     HL,HL               
2719: 18 12           JR      $272D               ; {}
271B: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
...
2737: 3A 0F 40        LD      A,($400F)           ; {ram.m400F}
273A: E6 3F           AND     $3F                 
273C: 5F              LD      E,A                 
273D: 83              ADD     A,E                 
273E: 83              ADD     A,E                 
...
27B0: 3A 07 40        LD      A,($4007)           ; {ram.m4007}
27B3: DD 77 07        LD      (IX+$07),A          
27B6: 3A 09 40        LD      A,($4009)           ; {ram.m4009}
27B9: DD 77 09        LD      (IX+$09),A          
27BC: DD E1           POP     IX                  
27BE: C9              RET                         
27BF: F5              PUSH    AF                  
27C0: 3A 00 40        LD      A,($4000)           ; {ram.m4000}
...
27DC: 3A 7D 40        LD      A,($407D)           ; {ram.m407D}
27DF: FE 0E           CP      $0E                 
27E1: 38 07           JR      C,$27EA             ; {}
27E3: FE 16           CP      $16                 
27E5: 30 03           JR      NC,$27EA            ; {}
27E7: 3A 7E 40        LD      A,($407E)           ; {ram.m407E}
27EA: FE 16           CP      $16                 
...
27F6: 3A 66 40        LD      A,($4066)           ; {ram.m4066}
27F9: FE 01           CP      $01                 
...
2817: 18 24           JR      $283D               ; {}
2819: 3A 6F 40        LD      A,($406F)           ; {ram.m406F}
281C: FE 03           CP      $03                 
281E: 3E 02           LD      A,$02               
2820: 28 18           JR      Z,$283A             ; {}
2822: 3A 6F 40        LD      A,($406F)           ; {ram.m406F}
2825: FE 04           CP      $04                 
2827: 3E 10           LD      A,$10               
2829: 28 0F           JR      Z,$283A             ; {}
282B: 3E 15           LD      A,$15               
282D: 18 0B           JR      $283A               ; {}
282F: 3A 6F 40        LD      A,($406F)           ; {ram.m406F}
2832: FE 01           CP      $01                 
2834: 3E 03           LD      A,$03               
...
28E8: 65              LD      H,L                 
28E9: 3A 0A 40        LD      A,($400A)           ; {ram.m400A}
28EC: E6 3F           AND     $3F                 
28EE: 4F              LD      C,A                 
28EF: 94              SUB     H                   
...
2909: 32 73 40        LD      ($4073),A           ; {ram.m4073}
290C: DB 09           IN      A,($09)             ; {hard.WDOG}
290E: ED 5F           LD      A,R                 
...
2919: 32 73 40        LD      ($4073),A           ; {ram.m4073}
291C: C9              RET                         
291D: F5              PUSH    AF                  
291E: C5              PUSH    BC                  
291F: D5              PUSH    DE                  
...
2A17: ED B0           LDIR                        
2A19: ED 53 96 40     LD      ($4096),DE          ; {ram.m4096}
2A1D: ED 53 94 40     LD      ($4094),DE          ; {ram.m4094}
...
2A37: D5              PUSH    DE                  
2A38: E5              PUSH    HL                  
2A39: 3A BC 40        LD      A,($40BC)           ; {ram.m40BC}
2A3C: E6 3E           AND     $3E                 
2A3E: 0F              RRCA                        
2A3F: 32 99 40        LD      ($4099),A           ; {ram.m4099}
2A42: 57              LD      D,A                 
2A43: 1E 20           LD      E,$20               
...
2A4B: 19              ADD     HL,DE               
2A4C: 7C              LD      A,H                 
2A4D: 32 92 44        LD      ($4492),A           ; {ram.m4492}
2A50: 7D              LD      A,L                 
2A51: 32 91 44        LD      ($4491),A           ; {ram.m4491}
2A54: 2A 96 40        LD      HL,($4096)          ; {ram.m4096}
2A57: CD AA 11        CALL    $11AA               ; {}
2A5A: 20 32           JR      NZ,$2A8E            ; {}
2A5C: 3A 20 40        LD      A,($4020)           ; {ram.m4020}
2A5F: FE 14           CP      $14                 
2A61: 30 2B           JR      NC,$2A8E            ; {}
2A63: FD CB 32 56     BIT     2,(IY+$32)          
2A67: CA EE 2A        JP      Z,$2AEE             ; {}
2A6A: FD CB 32 96     RES     2,(IY+$32)          
2A6E: 3A 99 40        LD      A,($4099)           ; {ram.m4099}
2A71: FE 1A           CP      $1A                 
...
2A7D: 3A 98 40        LD      A,($4098)           ; {ram.m4098}
2A80: B7              OR      A                   
2A81: 28 6B           JR      Z,$2AEE             ; {}
2A83: FD 35 18        DEC     (IY+$18)            
2A86: 2B              DEC     HL                  
2A87: 22 96 40        LD      ($4096),HL          ; {ram.m4096}
2A8A: 36 20           LD      (HL),$20            
2A8C: 18 3D           JR      $2ACB               ; {}
2A8E: FD 36 A4 01     LD      (IY+$A4),$01        
2A92: 2A 94 40        LD      HL,($4094)          ; {ram.m4094}
2A95: 7E              LD      A,(HL)              
2A96: FE 46           CP      $46                 
...
2AB6: 18 36           JR      $2AEE               ; {}
2AB8: 47              LD      B,A                 
2AB9: 3A 98 40        LD      A,($4098)           ; {ram.m4098}
2ABC: FE 03           CP      $03                 
...
2B15: 23              INC     HL                  
2B16: 56              LD      D,(HL)              
2B17: ED 53 85 40     LD      ($4085),DE          ; {ram.m4085}
2B1B: 13              INC     DE                  
2B1C: EB              EX      DE,HL               
2B1D: 5E              LD      E,(HL)              
2B1E: 23              INC     HL                  
...
2B21: E5              PUSH    HL                  
2B22: EB              EX      DE,HL               
2B23: 22 87 40        LD      ($4087),HL          ; {ram.m4087}
2B26: B7              OR      A                   
...
2B38: 23              INC     HL                  
2B39: ED B0           LDIR                        
2B3B: 22 8D 40        LD      ($408D),HL          ; {ram.m408D}
2B3E: ED 53 8F 40     LD      ($408F),DE          ; {ram.m408F}
2B42: 2A 87 40        LD      HL,($4087)          ; {ram.m4087}
...
2B6F: D5              PUSH    DE                  
2B70: E5              PUSH    HL                  
2B71: DB 09           IN      A,($09)             ; {hard.WDOG}
2B73: 3A 70 40        LD      A,($4070)           ; {ram.m4070}
2B76: B7              OR      A                   
2B77: C2 0F 2C        JP      NZ,$2C0F            ; {}
2B7A: FD 36 F0 0A     LD      (IY+$F0),$0A        
2B7E: FD 34 0A        INC     (IY+$0A)            ; 
2B81: ED 5B 8D 40     LD      DE,($408D)          ; {ram.m408D}
2B85: 2A 8F 40        LD      HL,($408F)          ; {ram.m408F}
2B88: CB 7C           BIT     7,H                 
...
2BC4: ED 53 8D 40     LD      ($408D),DE          ; {ram.m408D}
2BC8: 22 8F 40        LD      ($408F),HL          ; {ram.m408F}
2BCB: 3A 8A 40        LD      A,($408A)           ; {ram.m408A}
2BCE: FD BE 0C        CP      (IY+$0C)            
2BD1: 38 3C           JR      C,$2C0F             ; {}
2BD3: FD 36 F0 19     LD      (IY+$F0),$19        
2BD7: FD 34 09        INC     (IY+$09)            ; 
2BDA: 3A 8B 40        LD      A,($408B)           ; {ram.m408B}
2BDD: FD BE 09        CP      (IY+$09)            
2BE0: 38 2D           JR      C,$2C0F             ; {}
2BE2: 2A 87 40        LD      HL,($4087)          ; {ram.m4087}
2BE5: 5E              LD      E,(HL)              
2BE6: 23              INC     HL                  
2BE7: 56              LD      D,(HL)              
2BE8: 23              INC     HL                  
2BE9: ED 53 87 40     LD      ($4087),DE          ; {ram.m4087}
2BED: E5              PUSH    HL                  
2BEE: EB              EX      DE,HL               
2BEF: B7              OR      A                   
...
2C02: ED B0           LDIR                        
2C04: 22 8D 40        LD      ($408D),HL          ; {ram.m408D}
2C07: ED 53 8F 40     LD      ($408F),DE          ; {ram.m408F}
...
2C8F: C5              PUSH    BC                  
2C90: D5              PUSH    DE                  
2C91: 3A 22 40        LD      A,($4022)           ; {ram.m4022}
2C94: 77              LD      (HL),A              
2C95: 23              INC     HL                  
2C96: 3A 66 40        LD      A,($4066)           ; {ram.m4066}
2C99: 77              LD      (HL),A              
2C9A: 23              INC     HL                  
2C9B: 3A 67 40        LD      A,($4067)           ; {ram.m4067}
2C9E: 77              LD      (HL),A              
2C9F: 23              INC     HL                  
2CA0: 3A 6A 40        LD      A,($406A)           ; {ram.m406A}
2CA3: 77              LD      (HL),A              
2CA4: 23              INC     HL                  
2CA5: 3A 6C 40        LD      A,($406C)           ; {ram.m406C}
2CA8: 77              LD      (HL),A              
2CA9: 23              INC     HL                  
...
2CC0: 7E              LD      A,(HL)              
2CC1: 23              INC     HL                  
2CC2: 32 22 40        LD      ($4022),A           ; {ram.m4022}
2CC5: 7E              LD      A,(HL)              
2CC6: 23              INC     HL                  
2CC7: 32 66 40        LD      ($4066),A           ; {ram.m4066}
2CCA: 7E              LD      A,(HL)              
2CCB: 23              INC     HL                  
2CCC: 32 67 40        LD      ($4067),A           ; {ram.m4067}
2CCF: 7E              LD      A,(HL)              
2CD0: 23              INC     HL                  
2CD1: 32 6A 40        LD      ($406A),A           ; {ram.m406A}
2CD4: 7E              LD      A,(HL)              
2CD5: 23              INC     HL                  
2CD6: 32 6C 40        LD      ($406C),A           ; {ram.m406C}
...
2CF7: F1              POP     AF                  
2CF8: C9              RET                         
2CF9: 3A 66 40        LD      A,($4066)           ; {ram.m4066}
...
2DFD: 32 68 40        LD      ($4068),A           ; {ram.m4068}
...
2E3B: F1              POP     AF                  
2E3C: F5              PUSH    AF                  
2E3D: D3 14           OUT     ($14),A             ; {hard.SOUNDCMD}
2E3F: 3E 00           LD      A,$00               
2E41: 00              NOP                         
2E42: 00              NOP                         
2E43: 00              NOP                         
...
3633: 32 20 43        LD      ($4320),A           ; {ram.m4320}
3636: 52              LD      D,D                 
3637: 45              LD      B,L                 
3638: 44              LD      B,H                 
3639: 49              LD      C,C                 
...
3908: 00              NOP                         
3909: 00              NOP                         
390A: 32 20 43        LD      ($4320),A           ; {ram.m4320}
390D: 52              LD      D,D                 
390E: 45              LD      B,L                 
390F: 44              LD      B,H                 
3910: 49              LD      C,C                 
...
3C06: 00              NOP                         
3C07: 00              NOP                         
3C08: 32 20 43        LD      ($4320),A           ; {ram.m4320}
3C0B: 4F              LD      C,A                 
3C0C: 49              LD      C,C                 
3C0D: 4E              LD      C,(HL)              
3C0E: 53              LD      D,E                 
