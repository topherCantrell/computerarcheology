...
003A: DB 00       IN    A,($00)            ; Get the command
...
006F: 20 FE       JR    NZ,$6F             ; 
0071: E1          POP   HL                 
0072: 3A 00 10    LD    A,($1000)          ; 
0075: 3C          INC   A                  
0076: 32 00 10    LD    ($1000),A          ; 
0079: F1          POP   AF                 
007A: ED 45       RETN                     
007C: 5E          LD    E,(HL)             
007D: 3E 00       LD    A,$00              
...
; Main loop
0090: 3A 00 10    LD    A,($1000)          ; 
0093: FD BE 01    CP    (IY+$01)           
0096: 28 F8       JR    Z,$90              ; 
0098: 32 01 10    LD    ($1001),A          ; 
009B: 06 17       LD    B,$17              
...
00CF: D3 00       OUT   ($00),A            ; Write the register address (chip 1)
00D1: DD 7E 20    LD    A,(IX+$20)         ; Write ...
00D4: D3 01       OUT   ($01),A            ; ... the value (chip 1)
00D6: 18 07       JR    $DF                ; Skip 2nd chip logic
;
00D8: D3 02       OUT   ($02),A            ; Write the register address (chip 2)
00DA: DD 7E 20    LD    A,(IX+$20)         ; Write ...
00DD: D3 03       OUT   ($03),A            ; ... the value (chip 2)
;
...
00E8: E5          PUSH  HL                 
00E9: F3          DI                       
00EA: 3A 02 10    LD    A,($1002)          ; 
00ED: 32 03 10    LD    ($1003),A          ; 
00F0: 2B          DEC   HL                 
00F1: 5E          LD    E,(HL)             
00F2: 23          INC   HL                 
00F3: 56          LD    D,(HL)             
