...
0CAF: 7E              LD      A,(HL)              
0CB0: 7E              LD      A,(HL)              
0CB1: C3 C3 E7        JP      $E7C3                   
0CB4: E7              RST     0X20                
0CB5: FF              RST     0X38                
0CB6: FF              RST     0X38                
0CB7: DB C3           IN      A,($C3)               
0CB9: C3 C3 66        JP      $66C3                   
0CBC: 66              LD      H,(HL)              
0CBD: 6E              LD      L,(HL)              
0CBE: 6E              LD      L,(HL)              
0CBF: 7E              LD      A,(HL)              
...
0D12: 3C              INC     A                   
0D13: 18 18           JR      $D2D                   
0D15: C3 C3 C3        JP      $C3C3                   
0D18: DB FF           IN      A,($FF)               
0D1A: FF              RST     0X38                
0D1B: E7              RST     0X20                
0D1C: E7              RST     0X20                
0D1D: C3 C3 66        JP      $66C3                   
0D20: 66              LD      H,(HL)              
0D21: 7E              LD      A,(HL)              
0D22: 3C              INC     A                   
0D23: 18 18           JR      $D3D                   
...
0D9F: FF              RST     0X38                
0DA0: 3F              CCF                         
0DA1: FC FF FF        CALL    M,$FFFF                 
0DA4: 1F              RRA                         
0DA5: FC FF FF        CALL    M,$FFFF                 
0DA8: 0F              RRCA                        
0DA9: F8              RET     M                   
0DAA: FF              RST     0X38                
0DAB: FF              RST     0X38                
...
0DCB: FF              RST     0X38                
0DCC: FF              RST     0X38                
0DCD: FC FF FF        CALL    M,$FFFF                 
0DD0: FF              RST     0X38                
0DD1: 3F              CCF                         
0DD2: FC FF FF        CALL    M,$FFFF                 
0DD5: FF              RST     0X38                
0DD6: 1F              RRA                         
0DD7: FC FF FF        CALL    M,$FFFF                 
0DDA: FF              RST     0X38                
0DDB: 0F              RRCA                        
0DDC: F8              RET     M                   
0DDD: FF              RST     0X38                
...
0DFF: 07              RLCA                        
0E00: 02              LD      (BC),A              
0E01: FC F0 07        CALL    M,$07F0                 
0E04: F8              RET     M                   
0E05: FC FF FF        CALL    M,$FFFF                 
0E08: 7F              LD      A,A                 
0E09: FC FF FF        CALL    M,$FFFF                 
0E0C: 3F              CCF                         
0E0D: F8              RET     M                   
0E0E: FF              RST     0X38                
0E0F: FF              RST     0X38                
...
0E20: 00              NOP                         
0E21: 00              NOP                         
0E22: 01 A0 01        LD      BC,$01A0                
0E25: 00              NOP                         
0E26: 01 A0 01        LD      BC,$01A0                
0E29: 00              NOP                         
0E2A: 01 F0 01        LD      BC,$01F0                
0E2D: 00              NOP                         
0E2E: 01 F8 01        LD      BC,$01F8                
0E31: 00              NOP                         
0E32: F9              LD      SP,HL               
0E33: F8              RET     M                   
0E34: FF              RST     0X38                
...
0E56: 0F              RRCA                        
0E57: 10 00           DJNZ    $E59                   
0E59: 30 02           JR      NC,$E5D                
0E5B: 70              LD      (HL),B              
0E5C: 01 FC 00        LD      BC,$00FC                
0E5F: F8              RET     M                   
0E60: 11 F0 3B        LD      DE,$3BF0                
0E63: E0              RET     PO                  
0E64: 7F              LD      A,A                 
0E65: C0              RET     NZ                  
0E66: 3F              CCF                         
...
0F02: 4C              LD      C,H                 
0F03: 46              LD      B,(HL)              
0F04: 3A 3B 3C        LD      A,($3C3B)               
0F07: 3B              DEC     SP                  
0F08: 3C              INC     A                   
0F09: 3A 3B 3C        LD      A,($3C3B)               
0F0C: 3A 3C 3B        LD      A,($3B3C)               
0F0F: 3C              INC     A                   
0F10: 3A 3B 3A        LD      A,($3A3B)               
0F13: 3C              INC     A                   
0F14: 3B              DEC     SP                  
0F15: 3A 3C 3A        LD      A,($3A3C)               
0F18: 3B              DEC     SP                  
0F19: 3C              INC     A                   
0F1A: 3A 3C 3B        LD      A,($3B3C)               
0F1D: 3C              INC     A                   
0F1E: 3A 3B 3C        LD      A,($3C3B)               
0F21: 3A 3B 3C        LD      A,($3C3B)               
0F24: 42              LD      B,D                 
0F25: 4F              LD      C,A                 
0F26: 4E              LD      C,(HL)              
0F27: 55              LD      D,L                 
...
0F42: 4C              LD      C,H                 
0F43: 0F              RRCA                        
0F44: 01 41 04        LD      BC,$0441                
0F47: 3D              DEC     A                   
0F48: 5A              LD      E,D                 
0F49: 2F              CPL                         
0F4A: 50              LD      D,B                 
0F4B: 3F              CCF                         
0F4C: 01 41 04        LD      BC,$0441                
0F4F: 3D              DEC     A                   
0F50: 57              LD      D,A                 
0F51: 2F              CPL                         
0F52: 4D              LD      C,L                 
...
0F59: 03              INC     BC                  
0F5A: 03              INC     BC                  
0F5B: 01 01 07        LD      BC,$0701                
0F5E: 00              NOP                         
0F5F: 08              EX      AF,AF'              
0F60: 18 10           JR      $F72                   
0F62: 38 30           JR      C,$F94                 
0F64: 20 28           JR      NZ,$F8E                
0F66: 78              LD      A,B                 
0F67: 70              LD      (HL),B              
0F68: 60              LD      H,B                 
0F69: 68              LD      L,B                 
...
0F96: 0D              DEC     C                   
0F97: EB              EX      DE,HL               
0F98: 20 15           JR      NZ,$FAF                
0F9A: 00              NOP                         
0F9B: E0              RET     PO                  
0F9C: 00              NOP                         
0F9D: 01 0E 19        LD      BC,$190E                
0FA0: 20 15           JR      NZ,$FB7                
0FA2: 00              NOP                         
0FA3: E0              RET     PO                  
0FA4: 00              NOP                         
0FA5: 01 0E 47        LD      BC,$470E                
0FA8: 20 1A           JR      NZ,$FC4                
0FAA: 00              NOP                         
0FAB: F0              RET     P                   
0FAC: 00              NOP                         
0FAD: 03              INC     BC                  
