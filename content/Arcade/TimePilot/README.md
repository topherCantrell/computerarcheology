...
This dig focuses on the sound board. Karl Stiefvater disassembled the main board too. Before we get to the
sound code below, here are the notes about his main board work:
...
with the **8-way joystick**; the whole sky scrolls and banks around it, and you **fire in the direction the ship is facing**. 
The parallax reads as forward flight, but mechanically
