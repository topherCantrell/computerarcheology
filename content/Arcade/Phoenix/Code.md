...
;*****************************************************************************
StarsScrollDown:
067A: 21 B9 43        LD      HL,$43B9            ; {+ram.B9Counter}
067D: 7E              LD      A,(HL)              ; 
...
06B3: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
06B6: 4F              LD      C,A                 ; 
06B7: BE              CP      (HL)                ; 
06B8: C0              RET     NZ                  ; 
;
...
;
L07F0:
07F0: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
...
0A93: 5F              LD      E,A                 ; 
0A94: FE 03           CP      $03                 ; 
0A96: C2 72 0A        JP      NZ,$0A72            ; {code.L0A72}
0A99: C9              RET                         ; 
;
...
;*****************************************************************************
L0AEA:
0AEA: 21 B9 43        LD      HL,$43B9            ; {+ram.B9Counter}
0AED: 7E              LD      A,(HL)              
0AEE: E6 F8           AND     $F8                 
0AF0: 77              LD      (HL),A              
...
0B9B: C3 F0 1D        JP      $1DF0               ; {code.L1DF0}
; 
0B9E: FF FF
; 
L0BA0:
...
0BEB: 11 48 0A        LD      DE,$0A48            ; T0A48 alien pilot shape
...
0C10: E1              POP     HL                  
0C11: FE 07           CP      $07                 
0C13: DA A4 0E        JP      C,$0EA4             ; {code.L0EA4}
0C16: FE 09           CP      $09                 
0C18: D2 A4 0E        JP      NC,$0EA4            ; {code.L0EA4}
...
0C48: CD 56 0C        CALL    $0C56               ; {code.L0C56}
0C4B: CD 6B 0C        CALL    $0C6B               ; {code.L0C6B}
0C4E: CD D8 0C        CALL    $0CD8               ; {code.L0CD8}
0C51: C9              RET                         

0C52: FF FF FF FF

L0C56:
0C56: 21 CC 43        LD      HL,$43CC            ; {+ram.AlienBullet0State}
L0C59:
0C59: E5              PUSH    HL                  
0C5A: CD 84 0C        CALL    $0C84               ; {code.L0C84}
0C5D: E1              POP     HL                  
0C5E: 7D              LD      A,L                 
0C5F: C6 04           ADD     $04                 
0C61: 6F              LD      L,A                 
0C62: FE E0           CP      $E0                 
0C64: C2 59 0C        JP      NZ,$0C59            ; {code.L0C59}
0C67: C9              RET                         
...
0C7A: 79              LD      A,C                 
0C7B: FE E2           CP      $E2                 
0C7D: C2 71 0C        JP      NZ,$0C71            ; {code.L0C71}
0C80: C9              RET                         
...
0C94: 77              LD      (HL),A              
0C95: FE F9           CP      $F9                 
0C97: D2 6E 09        JP      NC,$096E            ; {code.L096E}
0C9A: 2D              DEC     L                   
...
0CA9: 2C              INC     L                   
0CAA: FE E8           CP      $E8                 
0CAC: D2 6E 09        JP      NC,$096E            ; {code.L096E}
0CAF: C9              RET                         
;
0CB0: FF FF FF FF
;
...
0CD0: 32 63 43        LD      ($4363),A           ; {ram.PlayerWasHit}
0CD3: C9              RET                         ; 
; 
0CD4: FF FF FF FF
...
0CEC: C2 DE 0C        JP      NZ,$0CDE            ; {code.L0CDE}
0CEF: C9              RET                         
; 
0CF0: FF FF FF FF
;
...
0D28: 3E B0           LD      A,$B0               
0D2A: B9              CP      C                   
0D2B: C2 22 0D        JP      NZ,$0D22            ; {code.L0D22}
0D2E: C9              RET                         
...
0D38: 5E              LD      E,(HL)              
0D39: EB              EX      DE,HL               
0D3A: 7E              LD      A,(HL)              ; get T1000 (Closed loops pattern table for aliens)
0D3B: 07              RLCA                        ; Multiply by 2
0D3C: C6 00           ADD     $00                 ; reset all flags
0D3E: 6F              LD      L,A                 
0D3F: 26 17           LD      H,$17               ; get MSB for T1700
0D41: AF              XOR     A                   ; A=0
0D42: BE              CP      (HL)                
0D43: CA 4F 0D        JP      Z,$0D4F             ; {code.L0D4F}
0D46: 23              INC     HL                  
0D47: BE              CP      (HL)                
0D48: CA 5E 0D        JP      Z,$0D5E             ; {code.L0D5E}
0D4B: 2B              DEC     HL                  
0D4C: 0A              LD      A,(BC)              
0D4D: 86              ADD     A,(HL)              
0D4E: 02              LD      (BC),A              
...
0D7D: 3E B0           LD      A,$B0               
0D7F: B9              CP      C                   
0D80: C2 76 0D        JP      NZ,$0D76            ; {code.L0D76}
0D83: C9              RET                         
...
0D91: CC DE 0D        CALL    Z,$0DDE             ; {code.L0DDE}
0D94: 6F              LD      L,A                 
...
0DA6: 23              INC     HL                  
0DA7: 0F              RRCA                        
0DA8: DA BB 0D        JP      C,$0DBB             ; {code.L0DBB}
0DAB: 0F              RRCA                        
0DAC: DA CC 0D        JP      C,$0DCC             ; {code.L0DCC}
0DAF: 0A              LD      A,(BC)              
0DB0: 0F              RRCA                        
0DB1: E6 03           AND     $03                 
0DB3: 86              ADD     A,(HL)              
...
0E20: D2 39 0E        JP      NC,$0E39            ; {code.L0E39}
...
0F03: 7E              LD      A,(HL)              ; 
0F04: FE C0           CP      $C0                 ; 
0F06: D2 74 0F        JP      NC,$0F74            ; {code.L0F74}
0F09: 2E E2           LD      L,$E2               ; 
...
2043: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
2046: 4F              LD      C,A                 ; 
2047: BE              CP      (HL)                ; 
2048: C0              RET     NZ                  ; 
2049: 7E              LD      A,(HL)              ; 
...
; 
L211C:
211C: 21 B9 43        LD      HL,$43B9            ; {+ram.B9Counter}
211F: 7E              LD      A,(HL)              
2120: FE 10           CP      $10                 
2122: D8              RET     C                   
2123: FE 30           CP      $30                 
...
2163: CD 40 0C        CALL    $0C40               ; {code.L0C40}
2166: CD 1C 0D        CALL    $0D1C               ; {code.L0D1C}
...
; masked counter = 2
L2170:
2170: CD 70 0D        CALL    $0D70               ; {code.L0D70}
...
2183: CD 40 0C        CALL    $0C40               ; {code.L0C40}
...
219C: C3 40 0C        JP      $0C40               ; {code.L0C40}

219F: FF FF FF FF FF FF
; 
L21A5:
21A5: CD 1C 0D        CALL    $0D1C               ; {code.L0D1C}
21A8: CD 70 0D        CALL    $0D70               ; {code.L0D70}
...
21BF: CD 40 0C        CALL    $0C40               ; {code.L0C40}
...
22BB: 7E              LD      A,(HL)              ; 
22BC: FE 28           CP      $28                 ; 
22BE: C2 48 08        JP      NZ,$0848            ; {code.L0848}
22C1: 2E 67           LD      L,$67               ; 
22C3: 36 FF           LD      (HL),$FF            ; 
22C5: C9              RET                         ; 
; 
...
; 
L22E2:
22E2: 32 B9 43        LD      ($43B9),A           ; {ram.B9Counter} free running 8 bit backwards counter
...
2358: C6 08           ADD     $08                 
235A: 67              LD      H,A                 
235B: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
235E: 0F              RRCA                        
235F: 0F              RRCA                        
2360: 0F              RRCA                        
2361: 85              ADD     A,L                 
...
; 
L242C:
242C: 21 B9 43        LD      HL,$43B9            ; {+ram.B9Counter}
242F: 7E              LD      A,(HL)              
2430: E6 F8           AND     $F8                 
2432: 77              LD      (HL),A              
...
24E3: E6 0F           AND     $0F                 
24E5: C0              RET     NZ                  
24E6: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
24E9: FE A0           CP      $A0                 
24EB: D8              RET     C                   
...
250B: D6 04           SUB     $04                 
250D: 47              LD      B,A                 
250E: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
2511: 2F              CPL                         
2512: 3C              INC     A                   
2513: E6 F8           AND     $F8                 
2515: C6 48           ADD     $48                 
...
2524: D1              POP     DE                  ; 
2525: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter} get value from 8 bit backwards counter
...
2537: FE 90           CP      $90                 ; 
2539: D2 3D 25        JP      NC,$253D            ; {code.L253D}
253C: 47              LD      B,A                 ; 
L253D:
253D: AF              XOR     A                   ; A=0
253E: 78              LD      A,B                 ; 
...
25C8: 16 05           LD      D,$05               ; 
L25CA:
25CA: 21 CC 43        LD      HL,$43CC            ; {+ram.AlienBullet0State}
L25CD:
25CD: 7E              LD      A,(HL)              ; 
...
2603: 00              NOP                         ; ..
2604: 00              NOP                         ; ..
2605: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
2608: 2F              CPL                         
2609: 0F              RRCA                        
260A: 0F              RRCA                        
260B: 0F              RRCA                        
...
2633: 86              ADD     A,(HL)              
2634: 57              LD      D,A                 
2635: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
2638: 92              SUB     D                   
L2639:
2639: 32 B9 43        LD      ($43B9),A           ; {ram.B9Counter}
...
L2650:
2650: 2C              INC     L                   ; 
2651: 3A 9B 43        LD      A,($439B)           ; {ram.Counter16+1}
...
265B: 6F              LD      L,A                 
265C: 26 3E           LD      H,$3E               
265E: 3A B9 43        LD      A,($43B9)           ; {ram.B9Counter}
2661: 86              ADD     A,(HL)              
...
267F: FE 03           CP      $03                 
2681: D2 85 26        JP      NC,$2685            ; {code.L2685}
2684: 04              INC     B                   
L2685:
...
2697: FE 04           CP      $04                 
2699: D2 9D 26        JP      NC,$269D            ; {code.L269D}
269C: 14              INC     D                   
L269D:
269D: FE 02           CP      $02                 
269F: D2 A3 26        JP      NC,$26A3            ; {code.L26A3}
26A2: 14              INC     D                   
L26A3:
26A3: 7A              LD      A,D                 
...
; 
L27BD:
27BD: 21 63 43        LD      HL,$4363            ; {+ram.PlayerWasHit}
27C0: 7E              LD      A,(HL)              ; 
...
27C9: C8              RET     Z                   
27CA: FE 19           CP      $19                 
27CC: D2 D8 27        JP      NC,$27D8            ; {code.L27D8}
27CF: 35              DEC     (HL)                
27D0: 2E 8C           LD      L,$8C               
27D2: 7E              LD      A,(HL)              
27D3: F6 40           OR      $40                 
...
3416: FE 04           CP      $04                 ; 
3418: D2 38 34        JP      NC,$3438            ; {+code.L3438}
...
3434: C3 40 0C        JP      $0C40               ; {code.L0C40}
; 
3437: FF
; 
L3438:
...
344B: C3 40 0C        JP      $0C40               ; {code.L0C40}
; 
344E: FF FF FF FF
; 
L3452:
...
3465: 0F              RRCA                        
3466: D8              RET     C                   
3467: CD 40 0C        CALL    $0C40               ; {code.L0C40}
...
35E2: 7E              LD      A,(HL)              
35E3: FE 10           CP      $10                 
35E5: D2 28 36        JP      NC,$3628            ; {code.L3628}
35E8: 47              LD      B,A                 
35E9: 2D              DEC     L                   
35EA: 86              ADD     A,(HL)              
35EB: 77              LD      (HL),A              
...
3884: 7B              LD      A,E                 
3885: FE 0C           CP      $0C                 
3887: D2 FB 38        JP      NC,$38FB            ; {code.L38FB}
388A: 79              LD      A,C                 
388B: 0F              RRCA                        
388C: 4F              LD      C,A                 
...
38CD: FE 03           CP      $03                 
38CF: D2 E9 38        JP      NC,$38E9            ; {code.L38E9}
38D2: 47              LD      B,A                 
38D3: 62              LD      H,D                 
38D4: 7B              LD      A,E                 
38D5: C6 05           ADD     $05                 
...
391C: 78              LD      A,B                 
391D: FE 20           CP      $20                 
391F: D2 BC 38        JP      NC,$38BC            ; {code.L38BC}
3922: C9              RET                         
; 
L3923:
3923: C8              RET     Z                   
