...
015D: 36 10           LD      (HL),$10            ; 
015F: 2E BE           LD      L,$BE               ; 
0161: 3A 00 78        LD      A,($7800)           ; {hard.DSW0} 78xx DSW0
0164: E6 0C           AND     $0C                 ; Bonus lives
0166: 07              RLCA                        ; Multiply by 4 ..
0167: 07              RLCA                        ; ..
0168: C6 30           ADD     $30                 ; 
016A: 77              LD      (HL),A              ; 
...
0463: 11 20 43        LD      DE,$4320            ; {+ram.ForegroundScreen+320}
0466: 70              LD      (HL),B              
0467: 1A              LD      A,(DE)              
0468: 71              LD      (HL),C              
0469: 12              LD      (DE),A              
...
0518: 21 A4 43        LD      HL,$43A4            ; {+ram.GameState}
051B: 36 03           LD      (HL),$03            
...
0B74: 21 A4 43        LD      HL,$43A4            ; {+ram.GameState}
0B77: 36 00           LD      (HL),$00            
0B79: 2E 90           LD      L,$90               
0B7B: 7E              LD      A,(HL)              
0B7C: 2C              INC     L                   
...
21E4: 77              LD      (HL),A              ;
21E5: 2D              DEC     L                   ;
21E6: 36 EF           LD      (HL),$EF            ; {ram.M4B72} LSB of screen ram for the bird
21E8: 2D              DEC     L                   ;
21E9: 36 49           LD      (HL),$49            ; {ram.M4B71} MSB of screen ram for the bird
21EB: 2D              DEC     L                   ;
...
23C4: FE 70           CP      $70                 
23C6: C0              RET     NZ                  
23C7: 21 A4 43        LD      HL,$43A4            ; {+ram.GameState}
23CA: 36 06           LD      (HL),$06            
23CC: 2C              INC     L                   
23CD: 36 60           LD      (HL),$60            
23CF: 2E 63           LD      L,$63               
...
248D: E6 1E           AND     $1E                 
248F: 80              ADD     A,B                 
2490: 32 D1 4B        LD      ($4BD1),A           ; {ram.Stack+91}
2493: C9              RET                         
2494: 1F              RRA                         
2495: 80              ADD     A,B                 
2496: 0D              DEC     C                   
...
2611: 77              LD      (HL),A              
2612: 2C              INC     L                   
2613: 3A D1 4B        LD      A,($4BD1)           ; {ram.Stack+91}
2616: BE              CP      (HL)                
2617: DA 50 26        JP      C,$2650             ; {}
261A: 3A D5 4B        LD      A,($4BD5)           ; {ram.Stack+95}
261D: 57              LD      D,A                 
261E: E6 03           AND     $03                 
2620: 5F              LD      E,A                 
...
2684: 04              INC     B                   
2685: 3A D6 4B        LD      A,($4BD6)           ; {ram.Stack+96}
2688: C6 E0           ADD     $E0                 
268A: 6F              LD      L,A                 
268B: 26 3E           LD      H,$3E               
268D: 78              LD      A,B                 
...
26A2: 14              INC     D                   
26A3: 7A              LD      A,D                 
26A4: 32 D5 4B        LD      ($4BD5),A           ; {ram.Stack+95}
26A7: C9              RET                         
26A8: 00              NOP                         
26A9: 58              LD      E,B                 
...
26EE: 3A D2 4B        LD      A,($4BD2)           ; {ram.Stack+92}
26F1: 82              ADD     A,D                 
26F2: 83              ADD     A,E                 
26F3: E6 1F           AND     $1F                 
26F5: 32 D6 4B        LD      ($4BD6),A           ; {ram.Stack+96}
26F8: 7B              LD      A,E                 
26F9: 92              SUB     D                   
...
3809: C6 08           ADD     $08                 
380B: 57              LD      D,A                 
380C: 3A D2 4B        LD      A,($4BD2)           ; {ram.Stack+92}
380F: 5F              LD      E,A                 
...
396D: 2D              DEC     L                   
396E: 2D              DEC     L                   
396F: 3A D2 4B        LD      A,($4BD2)           ; {ram.Stack+92}
3972: 86              ADD     A,(HL)              
3973: E6 1F           AND     $1F                 
...
3AE9: 3A D6 4B        LD      A,($4BD6)           ; {ram.Stack+96}
3AEC: C6 E0           ADD     $E0                 
3AEE: 5F              LD      E,A                 
3AEF: 16 3D           LD      D,$3D               
3AF1: 1A              LD      A,(DE)              
