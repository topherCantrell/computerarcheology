...
8003: C9 10           CMP     #$10                ; 
8005: D0 05           BNE     $800C               ; {hard.MMC1_0+C}
8007: A9 02           LDA     #$02                ; 
8009: 8D 01 06        STA     $0601               ; {ram.??SND_601??}
800C: 60              RTS                         ; 
800D: BD 05 04        LDA     $0405,X             ; {ram.0405}
8010: F0 FA           BEQ     $800C               ; {hard.MMC1_0+C}
8012: 4C 10 B0        JMP     $B010               ; {hard.MMC1_1+1010}
8015: A9 C0           LDA     #$C0                ; 
8017: D0 02           BNE     $801B               ; {hard.MMC1_0+1B}
8019: A9 E0           LDA     #$E0                ; 
801B: 9D BC 03        STA     $03BC,X             ; {ram.03BC}
801E: 4C DA FE        JMP     $FEDA               ; {hard.MMC1_3+1EDA}
8021: A9 80           LDA     #$80                ; 
8023: 95 28           STA     $28,X               ; {ram.0028}
8025: B5 98           LDA     $98,X               ; {ram.0098}
8027: D0 25           BNE     $804E               ; {hard.MMC1_0+4E}
8029: A0 02           LDY     #$02                ; 
802B: A5 61           LDA     <$61                ; {ram.0061}
802D: 38              SEC                         ; 
802E: F5 70           SBC     $70,X               ; {ram.0070}
8030: B0 01           BCS     $8033               ; {hard.MMC1_0+33}
8032: 88              DEY                         ; 
...
8040: B0 02           BCS     $8044               ; {hard.MMC1_0+44}
8042: A0 08           LDY     #$08                ; 
8044: 94 98           STY     $98,X               ; {ram.0098}
8046: C5 00           CMP     <$00                ; {ram.GP_00}
8048: 90 04           BCC     $804E               ; {hard.MMC1_0+4E}
...
805B: 20 4F FA        JSR     $FA4F               ; {hard.MMC1_3+1A4F}
805E: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8061: C9 40           CMP     #$40                ; 
8063: F0 04           BEQ     $8069               ; {hard.MMC1_0+69}
8065: A9 00           LDA     #$00                ; 
...
8073: F0 03           BEQ     $8078               ; {hard.MMC1_0+78}
8075: 4C B8 EE        JMP     $EEB8               ; {hard.MMC1_2+2EB8}
8078: AD 6C 06        LDA     $066C               ; {ram.066C}
807B: 15 3D           ORA     $3D,X               ; {ram.003D}
807D: D0 24           BNE     $80A3               ; {hard.MMC1_0+A3}
807F: 4C 94 80        JMP     $8094               ; {hard.MMC1_0+94}
8082: A9 70           LDA     #$70                ; 
8084: BC 4F 03        LDY     $034F,X             ; {ram.034F}
8087: C0 05           CPY     #$05                ; 
8089: F0 02           BEQ     $808D               ; {hard.MMC1_0+8D}
808B: A9 A0           LDA     #$A0                ; 
808D: 9D 1F 04        STA     $041F,X             ; {ram.041F}
8090: B5 AC           LDA     $AC,X               ; {ram.00AC}
8092: 30 0F           BMI     $80A3               ; {hard.MMC1_0+A3}
8094: BD 78 04        LDA     $0478,X             ; 
8097: F0 03           BEQ     $809C               ; {hard.MMC1_0+9C}
8099: DE 78 04        DEC     $0478,X             ; 
809C: 20 D0 EF        JSR     $EFD0               ; {hard.MMC1_2+2FD0}
809F: B5 C0           LDA     $C0,X               ; {ram.00C0}
80A1: F0 01           BEQ     $80A4               ; {hard.MMC1_0+A4}
80A3: 60              RTS                         ; 
80A4: BD BC 03        LDA     $03BC,X             ; {ram.03BC}
80A7: F0 6D           BEQ     $8116               ; {hard.MMC1_0+116}
80A9: BD 94 03        LDA     $0394,X             ; {ram.0394}
80AC: 29 0F           AND     #$0F                ; 
80AE: D0 66           BNE     $8116               ; {hard.MMC1_0+116}
80B0: 9D 94 03        STA     $0394,X             ; {ram.0394}
80B3: BD 1F 04        LDA     $041F,X             ; {ram.041F}
80B6: D5 19           CMP     $19,X               ; {ram.0019}
80B8: 90 4A           BCC     $8104               ; {hard.MMC1_0+104}
80BA: A5 AC           LDA     <$AC                ; {ram.00AC}
80BC: C9 FF           CMP     #$FF                ; 
80BE: F0 44           BEQ     $8104               ; {hard.MMC1_0+104}
80C0: A5 61           LDA     <$61                ; {ram.0061}
80C2: 38              SEC                         ; 
80C3: F5 70           SBC     $70,X               ; {ram.0070}
80C5: 10 05           BPL     $80CC               ; {hard.MMC1_0+CC}
80C7: 49 FF           EOR     #$FF                ; 
80C9: 18              CLC                         ; 
80CA: 69 01           ADC     #$01                ; 
80CC: C9 09           CMP     #$09                ; 
80CE: B0 0C           BCS     $80DC               ; {hard.MMC1_0+DC}
80D0: A0 08           LDY     #$08                ; 
80D2: A5 62           LDA     <$62                ; {ram.0062}
80D4: D5 84           CMP     $84,X               ; {ram.0084}
80D6: 90 1D           BCC     $80F5               ; {hard.MMC1_0+F5}
80D8: A0 04           LDY     #$04                ; 
80DA: D0 19           BNE     $80F5               ; {hard.MMC1_0+F5}
80DC: A5 62           LDA     <$62                ; {ram.0062}
80DE: 38              SEC                         ; 
80DF: F5 84           SBC     $84,X               ; {ram.0084}
80E1: 10 05           BPL     $80E8               ; {hard.MMC1_0+E8}
80E3: 49 FF           EOR     #$FF                ; 
80E5: 18              CLC                         ; 
80E6: 69 01           ADC     #$01                ; 
80E8: C9 09           CMP     #$09                ; 
80EA: B0 18           BCS     $8104               ; {hard.MMC1_0+104}
80EC: A0 01           LDY     #$01                ; 
80EE: A5 61           LDA     <$61                ; {ram.0061}
80F0: D5 70           CMP     $70,X               ; {ram.0070}
80F2: B0 01           BCS     $80F5               ; {hard.MMC1_0+F5}
80F4: C8              INY                         ; 
...
8101: 4C 90 81        JMP     $8190               ; {hard.MMC1_0+190}
8104: A9 00           LDA     #$00                ; 
8106: 9D 12 04        STA     $0412,X             ; {ram.0412}
8109: BD 78 04        LDA     $0478,X             ; 
810C: D0 08           BNE     $8116               ; {hard.MMC1_0+116}
810E: B5 98           LDA     $98,X               ; {ram.0098}
8110: 29 0C           AND     #$0C                ; 
8112: D0 D8           BNE     $80EC               ; {hard.MMC1_0+EC}
8114: F0 BA           BEQ     $80D0               ; {hard.MMC1_0+D0}
8116: 4C 90 81        JMP     $8190               ; {hard.MMC1_0+190}
8119: BD 50 03        LDA     $0350,X             ; {ram.0350}
811C: C9 1E           CMP     #$1E                ; 
811E: F0 04           BEQ     $8124               ; {hard.MMC1_0+124}
8120: B5 AC           LDA     $AC,X               ; {ram.00AC}
8122: 30 07           BMI     $812B               ; {hard.MMC1_0+12B}
8124: 20 D0 EF        JSR     $EFD0               ; {hard.MMC1_2+2FD0}
8127: B5 C0           LDA     $C0,X               ; {ram.00C0}
8129: F0 01           BEQ     $812C               ; {hard.MMC1_0+12C}
812B: 60              RTS                         ; 
812C: BD BC 03        LDA     $03BC,X             ; {ram.03BC}
812F: F0 5F           BEQ     $8190               ; {hard.MMC1_0+190}
8131: BD 94 03        LDA     $0394,X             ; {ram.0394}
8134: 29 0F           AND     #$0F                ; 
8136: D0 58           BNE     $8190               ; {hard.MMC1_0+190}
8138: 9D 94 03        STA     $0394,X             ; {ram.0394}
813B: A5 AC           LDA     <$AC                ; {ram.00AC}
813D: C9 FF           CMP     #$FF                ; 
813F: F0 4F           BEQ     $8190               ; {hard.MMC1_0+190}
8141: A9 04           LDA     #$04                ; 
8143: 85 02           STA     <$02                ; {ram.GP_02}
8145: A5 62           LDA     <$62                ; {ram.0062}
8147: B4 84           LDY     $84,X               ; {ram.0084}
8149: D5 84           CMP     $84,X               ; {ram.0084}
814B: B0 06           BCS     $8153               ; {hard.MMC1_0+153}
...
8164: B0 06           BCS     $816C               ; {hard.MMC1_0+16C}
...
8179: B0 01           BCS     $817C               ; {hard.MMC1_0+17C}
817B: C8              INY                         ; 
817C: A9 00           LDA     #$00                ; 
817E: 9D 12 04        STA     $0412,X             ; {ram.0412}
8181: B9 00 00        LDA     $0000,Y             ; {ram.GP_00}
8184: C9 51           CMP     #$51                ; 
8186: B0 08           BCS     $8190               ; {hard.MMC1_0+190}
...
819A: C0 05           CPY     #$05                ; 
819C: F0 10           BEQ     $81AE               ; {hard.MMC1_0+1AE}
819E: C0 06           CPY     #$06                ; 
81A0: D0 50           BNE     $81F2               ; {hard.MMC1_0+1F2}
81A2: B5 18           LDA     $18,X               ; {ram.0018}
81A4: C9 23           CMP     #$23                ; 
81A6: F0 04           BEQ     $81AC               ; {hard.MMC1_0+1AC}
81A8: C9 77           CMP     #$77                ; 
81AA: D0 46           BNE     $81F2               ; {hard.MMC1_0+1F2}
81AC: A9 5C           LDA     #$5C                ; 
81AE: B4 28           LDY     $28,X               ; {ram.0028}
81B0: D0 40           BNE     $81F2               ; {hard.MMC1_0+1F2}
81B2: 85 00           STA     <$00                ; {ram.GP_00}
81B4: AD 6C 06        LDA     $066C               ; {ram.066C}
81B7: 15 3D           ORA     $3D,X               ; {ram.003D}
81B9: D0 37           BNE     $81F2               ; {hard.MMC1_0+1F2}
81BB: A5 00           LDA     <$00                ; {ram.GP_00}
81BD: 20 79 B1        JSR     $B179               ; {hard.MMC1_1+1179}
81C0: 90 30           BCC     $81F2               ; {hard.MMC1_0+1F2}
81C2: A9 80           LDA     #$80                ; 
...
81FB: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
81FE: 04                              ;
81FF: 82                              ;
8200: 63                              ;
8201: 82                              ;
...
8207: F0 54           BEQ     $825D               ; {hard.MMC1_0+25D}
8209: A5 70           LDA     <$70                ; {ram.0070}
820B: D5 70           CMP     $70,X               ; {ram.0070}
820D: D0 0D           BNE     $821C               ; {hard.MMC1_0+21C}
820F: A0 00           LDY     #$00                ; 
...
8219: 4C 2C 82        JMP     $822C               ; {hard.MMC1_0+22C}
821C: A5 84           LDA     <$84                ; {ram.0084}
821E: 18              CLC                         ; 
821F: 69 03           ADC     #$03                ; 
8221: D5 84           CMP     $84,X               ; {ram.0084}
8223: D0 38           BNE     $825D               ; {hard.MMC1_0+25D}
8225: A0 02           LDY     #$02                ; 
8227: A5 70           LDA     <$70                ; {ram.0070}
8229: 38              SEC                         ; 
822A: F5 70           SBC     $70,X               ; {ram.0070}
822C: 10 04           BPL     $8232               ; {hard.MMC1_0+232}
822E: C8              INY                         ; 
822F: 20 21 70        JSR     $7021               ; {ram.7021}
8232: C9 11           CMP     #$11                ; 
8234: B0 27           BCS     $825D               ; {hard.MMC1_0+25D}
8236: AD F8 03        LDA     $03F8               ; {ram.03F8}
8239: D9 F3 81        CMP     $81F3,Y             ; {hard.MMC1_0+1F3}
823C: D0 1F           BNE     $825D               ; {hard.MMC1_0+25D}
823E: FE 12 04        INC     $0412,X             ; {ram.0412}
8241: BC 12 04        LDY     $0412,X             ; {ram.0412}
8244: C0 10           CPY     #$10                ; 
8246: 90 1A           BCC     $8262               ; {hard.MMC1_0+262}
8248: 95 98           STA     $98,X               ; {ram.0098}
824A: F6 AC           INC     $AC,X               ; {ram.00AC}
824C: E6 F7           INC     <$F7                ; {ram.00F7}
824E: A9 74           LDA     #$74                ; 
8250: 20 62 E8        JSR     $E862               ; {hard.MMC1_2+2862}
8253: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
...
8267: 20 8D F0        JSR     $F08D               ; {hard.MMC1_3+108D}
826A: 20 53 82        JSR     $8253               ; {hard.MMC1_0+253}
826D: BD 94 03        LDA     $0394,X             ; {ram.0394}
8270: C9 10           CMP     #$10                ; 
8272: F0 04           BEQ     $8278               ; {hard.MMC1_0+278}
8274: C9 F0           CMP     #$F0                ; 
8276: D0 11           BNE     $8289               ; {hard.MMC1_0+289}
8278: A9 04           LDA     #$04                ; 
827A: 8D 02 06        STA     $0602               ; {ram.SND_ReqMusEff}
827D: E6 F7           INC     <$F7                ; {ram.00F7}
827F: A9 B0           LDA     #$B0                ; 
8281: 20 62 E8        JSR     $E862               ; {hard.MMC1_2+2862}
...
8292: 60              RTS                         ; 
8293: A0 00           LDY     #$00                ; 
8295: F0 02           BEQ     $8299               ; {hard.MMC1_0+299}
8297: A0 01           LDY     #$01                ; 
...
82B1: 20 BB FE        JSR     $FEBB               ; {hard.MMC1_3+1EBB}
82B4: F0 1A           BEQ     $82D0               ; {hard.MMC1_0+2D0}
82B6: 8A              TXA                         ; 
82B7: 48              PHA                         ; 
82B8: 98              TYA                         ; 
82B9: AA              TAX                         ; 
82BA: A5 00           LDA     <$00                ; {ram.GP_00}
82BC: 20 B3 FE        JSR     $FEB3               ; {hard.MMC1_3+1EB3}
82BF: 8A              TXA                         ; 
82C0: A8              TAY                         ; 
82C1: 68              PLA                         ; 
82C2: AA              TAX                         ; 
...
82D3: FE 02 FF        INC     $FF02,X             ; {hard.MMC1_3+1F02}
82D6: FF                              ;
...
82DD: 29 F0           AND     #$F0                ; 
82DF: C9 10           CMP     #$10                ; 
82E1: D0 69           BNE     $834C               ; {hard.MMC1_0+34C}
82E3: BD 4F 03        LDA     $034F,X             ; {ram.034F}
82E6: C9 55           CMP     #$55                ; 
82E8: B0 0C           BCS     $82F6               ; {hard.MMC1_0+2F6}
82EA: B5 28           LDA     $28,X               ; {ram.0028}
82EC: D0 10           BNE     $82FE               ; {hard.MMC1_0+2FE}
82EE: 20 FA ED        JSR     $EDFA               ; {hard.MMC1_2+2DFA}
82F1: CD 4A 03        CMP     $034A               ; {ram.034A}
82F4: B0 45           BCS     $833B               ; {hard.MMC1_0+33B}
82F6: 20 B8 6F        JSR     $6FB8               ; {ram.6FB8}
82F9: F0 40           BEQ     $833B               ; {hard.MMC1_0+33B}
82FB: 20 8D F0        JSR     $F08D               ; {hard.MMC1_3+108D}
82FE: 20 71 83        JSR     $8371               ; {hard.MMC1_0+371}
8301: A5 06           LDA     <$06                ; {ram.0006}
8303: D0 36           BNE     $833B               ; {hard.MMC1_0+33B}
8305: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8308: C9 5B           CMP     #$5B                ; 
830A: D0 03           BNE     $830F               ; {hard.MMC1_0+30F}
830C: 4C 7B F5        JMP     $F57B               ; {hard.MMC1_3+157B}
830F: C9 57           CMP     #$57                ; 
8311: 90 07           BCC     $831A               ; {hard.MMC1_0+31A}
8313: C9 5A           CMP     #$5A                ; 
8315: B0 03           BCS     $831A               ; {hard.MMC1_0+31A}
8317: 4C 91 F3        JMP     $F391               ; {hard.MMC1_3+1391}
831A: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
831D: 85 0D           STA     <$0D                ; {ram.000D}
831F: A5 15           LDA     <$15                ; {ram.0015}
8321: 29 03           AND     #$03                ; 
8323: BC 4F 03        LDY     $034F,X             ; {ram.034F}
8326: C0 55           CPY     #$55                ; 
8328: B0 09           BCS     $8333               ; {hard.MMC1_0+333}
832A: A0 03           LDY     #$03                ; 
832C: E6 00           INC     <$00                ; {ram.GP_00}
832E: 88              DEY                         ; 
832F: 10 FB           BPL     $832C               ; {hard.MMC1_0+32C}
8331: A9 00           LDA     #$00                ; 
...
833E: C9 55           CMP     #$55                ; 
8340: F0 07           BEQ     $8349               ; {hard.MMC1_0+349}
8342: C9 56           CMP     #$56                ; 
8344: F0 03           BEQ     $8349               ; {hard.MMC1_0+349}
8346: CE 4C 03        DEC     $034C               ; {ram.034C}
8349: 4C B1 FE        JMP     $FEB1               ; {hard.MMC1_3+1EB1}
834C: BD 80 03        LDA     $0380,X             ; 
834F: 20 13 70        JSR     $7013               ; {ram.7013}
8352: B5 84           LDA     $84,X               ; {ram.0084}
8354: 18              CLC                         ; 
8355: 79 D3 82        ADC     $82D3,Y             ; {hard.MMC1_0+2D3}
8358: 95 84           STA     $84,X               ; {ram.0084}
835A: B5 70           LDA     $70,X               ; {ram.0070}
835C: 18              CLC                         ; 
835D: 79 D1 82        ADC     $82D1,Y             ; {hard.MMC1_0+2D1}
...
836B: C9 20           CMP     #$20                ; 
836D: B0 CC           BCS     $833B               ; {hard.MMC1_0+33B}
836F: 90 94           BCC     $8305               ; {hard.MMC1_0+305}
8371: A9 00           LDA     #$00                ; 
8373: 9D 94 03        STA     $0394,X             ; {ram.0394}
8376: 20 A7 7A        JSR     $7AA7               ; {ram.7AA7}
8379: AD 4B 03        LDA     $034B               ; {ram.034B}
837C: F0 09           BEQ     $8387               ; {hard.MMC1_0+387}
837E: A5 98           LDA     <$98                ; {ram.0098}
8380: 9D 80 03        STA     $0380,X             ; 
8383: A9 30           LDA     #$30                ; 
8385: 95 AC           STA     $AC,X               ; {ram.00AC}
8387: 60              RTS                         ; 
8388: 70 68           BVS     $83F2               ; {hard.MMC1_0+3F2}
838A: 60              RTS                         ; 
838B: 58              CLI                         ; 
838C: 50 3C           BVC     $83CA               ; {hard.MMC1_0+3CA}
838E: 26 10           ROL     <$10                ; {ram.0010}
8390: 00              BRK                         ; 
8391: 10 26           BPL     $83B9               ; {hard.MMC1_0+3B9}
8393: 3C                              ;
8394: 50 58           BVC     $83EE               ; {hard.MMC1_0+3EE}
8396: 60              RTS                         ; 
8397: 68              PLA                         ; 
8398: 70 B5           BVS     $834F               ; {hard.MMC1_0+34F}
...
83B9: B9 88 83        LDA     $8388,Y             ; {hard.MMC1_0+388}
83BC: 9D 1F 04        STA     $041F,X             ; {ram.041F}
83BF: B9 90 83        LDA     $8390,Y             ; {hard.MMC1_0+390}
...
83F6: 20 07 84        JSR     $8407               ; {hard.MMC1_0+407}
83F9: 9D 5E 04        STA     $045E,X             ; 
83FC: 20 71 83        JSR     $8371               ; {hard.MMC1_0+371}
83FF: AD 4B 03        LDA     $034B               ; {ram.034B}
8402: D0 D3           BNE     $83D7               ; {hard.MMC1_0+3D7}
8404: 4C 05 83        JMP     $8305               ; {hard.MMC1_0+305}
8407: 9D BC 03        STA     $03BC,X             ; {ram.03BC}
840A: 98              TYA                         ; 
840B: 9D A8 03        STA     $03A8,X             ; {ram.03A8}
840E: 20 8D F0        JSR     $F08D               ; {hard.MMC1_3+108D}
8411: BD A8 03        LDA     $03A8,X             ; {ram.03A8}
8414: 60              RTS                         ; 
8415: A9 40           LDA     #$40                ; 
8417: 9D BC 03        STA     $03BC,X             ; {ram.03BC}
841A: 4C 25 80        JMP     $8025               ; {hard.MMC1_0+25}
841D: B5 18           LDA     $18,X               ; {ram.0018}
841F: 29 07           AND     #$07                ; 
8421: A8              TAY                         ; 
8422: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
8425: 95 98           STA     $98,X               ; {ram.0098}
8427: 20 0B B2        JSR     $B20B               ; {hard.MMC1_1+120B}
842A: A9 C0           LDA     #$C0                ; 
842C: 8D D1 04        STA     $04D1               ; {ram.04D1}
842F: A9 1F           LDA     #$1F                ; 
8431: 9D 1F 04        STA     $041F,X             ; {ram.041F}
8434: 60              RTS                         ; 
8435: 20 1D 84        JSR     $841D               ; {hard.MMC1_0+41D}
8438: A9 7F           LDA     #$7F                ; 
843A: 9D 1F 04        STA     $041F,X             ; {ram.041F}
843D: 60              RTS                         ; 
843E: A9 40           LDA     #$40                ; 
8440: 20 6E 80        JSR     $806E               ; {hard.MMC1_0+6E}
8443: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8446: C9 2B           CMP     #$2B                ; 
8448: F0 06           BEQ     $8450               ; {hard.MMC1_0+450}
844A: 38              SEC                         ; 
844B: E9 2B           SBC     #$2B                ; 
844D: 4C 54 84        JMP     $8454               ; {hard.MMC1_0+454}
8450: A5 15           LDA     <$15                ; {ram.0015}
8452: 29 03           AND     #$03                ; 
8454: 20 88 79        JSR     $7988               ; {ram.7988}
8457: A9 01           LDA     #$01                ; 
8459: 20 76 84        JSR     $8476               ; {hard.MMC1_0+476}
845C: 20 A7 7A        JSR     $7AA7               ; {ram.7AA7}
845F: A5 06           LDA     <$06                ; {ram.0006}
8461: F0 0B           BEQ     $846E               ; {hard.MMC1_0+46E}
8463: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8466: C9 2B           CMP     #$2B                ; 
8468: D0 05           BNE     $846F               ; {hard.MMC1_0+46F}
846A: A9 10           LDA     #$10                ; 
...
8475: 60              RTS                         ; 
8476: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
8479: 20 72 FA        JSR     $FA72               ; {hard.MMC1_3+1A72}
847C: A9 00           LDA     #$00                ; 
847E: 4C DF 77        JMP     $77DF               ; {ram.77DF}
8481: AD 6C 06        LDA     $066C               ; {ram.066C}
8484: 0D 06 05        ORA     $0506               ; {ram.0506}
8487: D0 06           BNE     $848F               ; {hard.MMC1_0+48F}
8489: 20 A1 84        JSR     $84A1               ; {hard.MMC1_0+4A1}
848C: 20 88 B2        JSR     $B288               ; {hard.MMC1_1+1288}
848F: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
8492: BD 37 04        LDA     $0437,X             ; {ram.0437}
8495: 29 02           AND     #$02                ; 
8497: 4A              LSR     A                   ; 
8498: 20 DB 77        JSR     $77DB               ; {ram.77DB}
849B: 20 D0 79        JSR     $79D0               ; {ram.79D0}
849E: 4C E4 EE        JMP     $EEE4               ; {hard.MMC1_2+2EE4}
84A1: BD 44 04        LDA     $0444,X             ; 
84A4: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
...
84B7: C9 A0           CMP     #$A0                ; 
84B9: B0 06           BCS     $84C1               ; {hard.MMC1_0+4C1}
84BB: C8              INY                         ; 
84BC: C9 20           CMP     #$20                ; 
84BE: B0 01           BCS     $84C1               ; {hard.MMC1_0+4C1}
84C0: C8              INY                         ; 
84C1: 98              TYA                         ; 
...
84CA: 60              RTS                         ; 
84CB: 20 E1 84        JSR     $84E1               ; {hard.MMC1_0+4E1}
84CE: 20 2C 85        JSR     $852C               ; {hard.MMC1_0+52C}
84D1: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
84D4: A0 00           LDY     #$00                ; 
84D6: A5 15           LDA     <$15                ; {ram.0015}
84D8: 29 08           AND     #$08                ; 
84DA: D0 01           BNE     $84DD               ; {hard.MMC1_0+4DD}
84DC: C8              INY                         ; 
84DD: 98              TYA                         ; 
84DE: 4C DB 77        JMP     $77DB               ; {ram.77DB}
84E1: B5 AC           LDA     $AC,X               ; {ram.00AC}
84E3: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
84E6: EC 84 F1        CPX     $F184               ; {hard.MMC1_3+1184}
84E9: 84 F9           STY     <$F9                ; {ram.00F9}
84EB: 84 A9           STY     <$A9                ; {ram.00A9}
84ED: 18              CLC                         ; 
84EE: 4C C8 85        JMP     $85C8               ; {hard.MMC1_0+5C8}
84F1: 20 FE 85        JSR     $85FE               ; {hard.MMC1_0+5FE}
84F4: 90 02           BCC     $84F8               ; {hard.MMC1_0+4F8}
84F6: F6 AC           INC     $AC,X               ; {ram.00AC}
84F8: 60              RTS                         ; 
84F9: EE 4E 03        INC     $034E               ; {ram.034E}
84FC: 20 B1 FE        JSR     $FEB1               ; {hard.MMC1_3+1EB1}
84FF: 20 19 85        JSR     $8519               ; {hard.MMC1_0+519}
8502: B5 98           LDA     $98,X               ; {ram.0098}
8504: C9 04           CMP     #$04                ; 
8506: A9 02           LDA     #$02                ; 
8508: B0 02           BCS     $850C               ; {hard.MMC1_0+50C}
850A: A9 08           LDA     #$08                ; 
850C: 99 98 00        STA     $0098,Y             ; {ram.0098}
850F: 48              PHA                         ; 
8510: 20 19 85        JSR     $8519               ; {hard.MMC1_0+519}
8513: 68              PLA                         ; 
8514: 4A              LSR     A                   ; 
...
851D: 20 80 B1        JSR     $B180               ; {hard.MMC1_1+1180}
8520: A9 00           LDA     #$00                ; 
...
852E: D0 30           BNE     $8560               ; {hard.MMC1_0+560}
8530: 20 29 86        JSR     $8629               ; {hard.MMC1_0+629}
8533: BD 05 04        LDA     $0405,X             ; {ram.0405}
8536: D0 28           BNE     $8560               ; {hard.MMC1_0+560}
8538: BD F0 04        LDA     $04F0,X             ; {ram.04F0}
853B: F0 23           BEQ     $8560               ; {hard.MMC1_0+560}
853D: A0 00           LDY     #$00                ; 
853F: B5 84           LDA     $84,X               ; {ram.0084}
8541: 29 0F           AND     #$0F                ; 
8543: C9 0D           CMP     #$0D                ; 
8545: D0 02           BNE     $8549               ; {hard.MMC1_0+549}
8547: A0 03           LDY     #$03                ; 
8549: 84 00           STY     <$00                ; {ram.GP_00}
854B: A0 00           LDY     #$00                ; 
854D: B5 70           LDA     $70,X               ; {ram.0070}
854F: 29 0F           AND     #$0F                ; 
8551: D0 02           BNE     $8555               ; {hard.MMC1_0+555}
8553: A0 0C           LDY     #$0C                ; 
8555: 98              TYA                         ; 
8556: 05 00           ORA     <$00                ; {ram.GP_00}
8558: 25 98           AND     <$98                ; {ram.0098}
855A: D0 02           BNE     $855E               ; {hard.MMC1_0+55E}
855C: F6 AC           INC     $AC,X               ; {ram.00AC}
855E: F6 AC           INC     $AC,X               ; {ram.00AC}
8560: 60              RTS                         ; 
8561: A9 02           LDA     #$02                ; 
8563: 95 AC           STA     $AC,X               ; {ram.00AC}
8565: 4C 25 80        JMP     $8025               ; {hard.MMC1_0+25}
8568: 20 8F 85        JSR     $858F               ; {hard.MMC1_0+58F}
856B: 20 29 86        JSR     $8629               ; {hard.MMC1_0+629}
856E: B5 70           LDA     $70,X               ; {ram.0070}
8570: 48              PHA                         ; 
8571: 18              CLC                         ; 
8572: 69 04           ADC     #$04                ; 
8574: 95 70           STA     $70,X               ; {ram.0070}
8576: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
8579: A0 00           LDY     #$00                ; 
857B: A5 15           LDA     <$15                ; {ram.0015}
857D: 29 02           AND     #$02                ; 
857F: D0 01           BNE     $8582               ; {hard.MMC1_0+582}
8581: C8              INY                         ; 
8582: A9 03           LDA     #$03                ; 
...
8591: F0 27           BEQ     $85BA               ; {hard.MMC1_0+5BA}
8593: 88              DEY                         ; 
8594: D0 30           BNE     $85C6               ; {hard.MMC1_0+5C6}
8596: B5 28           LDA     $28,X               ; {ram.0028}
8598: F0 05           BEQ     $859F               ; {hard.MMC1_0+59F}
859A: 20 FE 85        JSR     $85FE               ; {hard.MMC1_0+5FE}
859D: 90 1A           BCC     $85B9               ; {hard.MMC1_0+5B9}
...
85CD: C9 05           CMP     #$05                ; 
85CF: B0 24           BCS     $85F5               ; {hard.MMC1_0+5F5}
85D1: A9 20           LDA     #$20                ; 
85D3: 9D 1F 04        STA     $041F,X             ; {ram.041F}
85D6: 20 94 80        JSR     $8094               ; {hard.MMC1_0+94}
85D9: BD 94 03        LDA     $0394,X             ; {ram.0394}
85DC: 15 28           ORA     $28,X               ; {ram.0028}
85DE: D0 15           BNE     $85F5               ; {hard.MMC1_0+5F5}
85E0: B5 18           LDA     $18,X               ; {ram.0018}
85E2: 29 03           AND     #$03                ; 
85E4: A8              TAY                         ; 
85E5: BD 4F 03        LDA     $034F,X             ; {ram.034F}
85E8: C9 13           CMP     #$13                ; 
85EA: F0 04           BEQ     $85F0               ; {hard.MMC1_0+5F0}
85EC: C8              INY                         ; 
85ED: C8              INY                         ; 
85EE: C8              INY                         ; 
85EF: C8              INY                         ; 
85F0: B9 F6 85        LDA     $85F6,Y             ; {hard.MMC1_0+5F6}
...
860A: D0 08           BNE     $8614               ; {hard.MMC1_0+614}
860C: 20 FA ED        JSR     $EDFA               ; {hard.MMC1_2+2DFA}
860F: CD 4A 03        CMP     $034A               ; {ram.034A}
8612: B0 14           BCS     $8628               ; {hard.MMC1_0+628}
8614: 20 B8 6F        JSR     $6FB8               ; {ram.6FB8}
8617: 38              SEC                         ; 
8618: F0 0E           BEQ     $8628               ; {hard.MMC1_0+628}
861A: 20 8D F0        JSR     $F08D               ; {hard.MMC1_3+108D}
861D: BD 94 03        LDA     $0394,X             ; {ram.0394}
8620: 29 0F           AND     #$0F                ; 
8622: 18              CLC                         ; 
8623: D0 03           BNE     $8628               ; {hard.MMC1_0+628}
...
8639: 50 80           BVC     $85BB               ; {hard.MMC1_0+5BB}
863B: F0 60           BEQ     $869D               ; {hard.MMC1_0+69D}
863D: 00              BRK                         ; 
863E: 04                              ;
...
8655: D0 0E           BNE     $8665               ; {hard.MMC1_0+665}
8657: 20 5A E8        JSR     $E85A               ; {hard.MMC1_2+285A}
865A: A0 01           LDY     #$01                ; 
865C: D9 34 86        CMP     $8634,Y             ; {hard.MMC1_0+634}
865F: F0 04           BEQ     $8665               ; {hard.MMC1_0+665}
8661: 88              DEY                         ; 
8662: 10 F8           BPL     $865C               ; {hard.MMC1_0+65C}
8664: 60              RTS                         ; 
8665: 98              TYA                         ; 
8666: 48              PHA                         ; 
8667: 20 BB FE        JSR     $FEBB               ; {hard.MMC1_3+1EBB}
866A: C9 01           CMP     #$01                ; 
866C: 68              PLA                         ; 
866D: B0 6D           BCS     $86DC               ; {hard.MMC1_0+6DC}
866F: C0 06           CPY     #$06                ; 
8671: 90 69           BCC     $86DC               ; {hard.MMC1_0+6DC}
8673: 84 0A           STY     <$0A                ; {ram.000A}
8675: 85 0B           STA     <$0B                ; {ram.000B}
8677: A8              TAY                         ; 
8678: BE 36 86        LDX     $8636,Y             ; {hard.MMC1_0+636}
867B: BC E8 04        LDY     $04E8,X             ; 
867E: 88              DEY                         ; 
867F: 98              TYA                         ; 
8680: 9D E8 04        STA     $04E8,X             ; 
8683: C8              INY                         ; 
8684: D0 53           BNE     $86D9               ; {hard.MMC1_0+6D9}
8686: B5 18           LDA     $18,X               ; {ram.0018}
8688: C9 F0           CMP     #$F0                ; 
868A: B0 4D           BCS     $86D9               ; {hard.MMC1_0+6D9}
868C: 29 03           AND     #$03                ; 
868E: A8              TAY                         ; 
868F: B9 39 86        LDA     $8639,Y             ; {hard.MMC1_0+639}
8692: 9D E8 04        STA     $04E8,X             ; 
8695: A4 0B           LDY     <$0B                ; {ram.000B}
8697: 8A              TXA                         ; 
8698: 18              CLC                         ; 
8699: 79 3D 86        ADC     $863D,Y             ; {hard.MMC1_0+63D}
869C: A8              TAY                         ; 
869D: 8A              TXA                         ; 
869E: 48              PHA                         ; 
869F: A2 00           LDX     #$00                ; 
86A1: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
86A4: A6 0A           LDX     <$0A                ; {ram.000A}
86A6: B9 40 86        LDA     $8640,Y             ; {hard.MMC1_0+640}
86A9: 85 02           STA     <$02                ; {ram.GP_02}
86AB: 95 70           STA     $70,X               ; {ram.0070}
86AD: B9 48 86        LDA     $8648,Y             ; {hard.MMC1_0+648}
...
86C1: C9 18           CMP     #$18                ; 
86C3: 10 06           BPL     $86CB               ; {hard.MMC1_0+6CB}
86C5: C9 E8           CMP     #$E8                ; 
86C7: 30 02           BMI     $86CB               ; {hard.MMC1_0+6CB}
86C9: 46 04           LSR     <$04                ; {ram.0004}
86CB: 88              DEY                         ; 
86CC: 10 EC           BPL     $86BA               ; {hard.MMC1_0+6BA}
86CE: A5 04           LDA     <$04                ; {ram.0004}
86D0: F0 05           BEQ     $86D7               ; {hard.MMC1_0+6D7}
86D2: A9 55           LDA     #$55                ; 
86D4: 20 AF 82        JSR     $82AF               ; {hard.MMC1_0+2AF}
86D7: 68              PLA                         ; 
86D8: AA              TAX                         ; 
86D9: CA              DEX                         ; 
86DA: 10 9F           BPL     $867B               ; {hard.MMC1_0+67B}
86DC: 60              RTS                         ; 
86DD: FF                              ;
86DE: FF                              ;
86DF: FF                              ;
...
86E5: 29 08           AND     #$08                ; 
86E7: F0 49           BEQ     $8732               ; {hard.MMC1_0+732}
86E9: AD 14 05        LDA     $0514               ; {ram.0514}
86EC: D0 44           BNE     $8732               ; {hard.MMC1_0+732}
86EE: 20 BB FE        JSR     $FEBB               ; {hard.MMC1_3+1EBB}
86F1: F0 3F           BEQ     $8732               ; {hard.MMC1_0+732}
86F3: A9 0D           LDA     #$0D                ; 
...
8702: F0 2A           BEQ     $872E               ; {hard.MMC1_0+72E}
8704: C9 F0           CMP     #$F0                ; 
8706: F0 26           BEQ     $872E               ; {hard.MMC1_0+72E}
...
870E: 0A              ASL     A                   ; 
870F: C9 50           CMP     #$50                ; 
8711: 90 1B           BCC     $872E               ; {hard.MMC1_0+72E}
8713: C9 E0           CMP     #$E0                ; 
8715: B0 17           BCS     $872E               ; {hard.MMC1_0+72E}
8717: 09 0D           ORA     #$0D                ; 
8719: 95 84           STA     $84,X               ; {ram.0084}
871B: 20 F4 ED        JSR     $EDF4               ; {hard.MMC1_2+2DF4}
871E: C9 8D           CMP     #$8D                ; 
8720: 90 0C           BCC     $872E               ; {hard.MMC1_0+72E}
8722: C9 99           CMP     #$99                ; 
8724: B0 08           BCS     $872E               ; {hard.MMC1_0+72E}
8726: EE 14 05        INC     $0514               ; {ram.0514}
8729: A9 11           LDA     #$11                ; 
872B: 4C B3 FE        JMP     $FEB3               ; {hard.MMC1_3+1EB3}
872E: C6 0D           DEC     <$0D                ; {ram.000D}
8730: D0 C7           BNE     $86F9               ; {hard.MMC1_0+6F9}
8732: 60              RTS                         ; 
8733: 01 02           ORA     ($02,X)             ; {ram.GP_02}
8735: 05 0A           ORA     <$0A                ; {ram.000A}
8737: A9 00           LDA     #$00                ; 
8739: 8D 15 05        STA     $0515               ; {ram.0515}
873C: 20 D6 FE        JSR     $FED6               ; {hard.MMC1_3+1ED6}
873F: B5 19           LDA     $19,X               ; {ram.0019}
8741: 29 03           AND     #$03                ; 
8743: A8              TAY                         ; 
8744: B9 33 87        LDA     $8733,Y             ; {hard.MMC1_0+733}
...
8752: 20 D6 FE        JSR     $FED6               ; {hard.MMC1_3+1ED6}
8755: A9 20           LDA     #$20                ; 
8757: D0 02           BNE     $875B               ; {hard.MMC1_0+75B}
8759: A9 30           LDA     #$30                ; 
...
8767: 20 55 F8        JSR     $F855               ; {hard.MMC1_3+1855}
876A: 9D E4 03        STA     $03E4,X             ; {ram.03E4}
876D: A9 06           LDA     #$06                ; 
876F: 9D D0 03        STA     $03D0,X             ; {ram.03D0}
8772: 4C 25 80        JMP     $8025               ; {hard.MMC1_0+25}
8775: 20 D6 FE        JSR     $FED6               ; {hard.MMC1_3+1ED6}
8778: A9 08           LDA     #$08                ; 
877A: 95 98           STA     $98,X               ; {ram.0098}
877C: 20 0B B2        JSR     $B20B               ; {hard.MMC1_1+120B}
877F: A9 A0           LDA     #$A0                ; 
...
879B: D0 FA           BNE     $8797               ; {hard.MMC1_0+797}
879D: 20 6D 8A        JSR     $8A6D               ; {hard.MMC1_0+A6D}
87A0: B5 AC           LDA     $AC,X               ; {ram.00AC}
87A2: C9 03           CMP     #$03                ; 
87A4: D0 0F           BNE     $87B5               ; {hard.MMC1_0+7B5}
87A6: B5 28           LDA     $28,X               ; {ram.0028}
87A8: C9 FD           CMP     #$FD                ; 
87AA: D0 09           BNE     $87B5               ; {hard.MMC1_0+7B5}
87AC: A9 55           LDA     #$55                ; 
87AE: 20 AF 82        JSR     $82AF               ; {hard.MMC1_0+2AF}
87B1: A9 20           LDA     #$20                ; 
87B3: 95 28           STA     $28,X               ; {ram.0028}
87B5: B5 AC           LDA     $AC,X               ; {ram.00AC}
87B7: D0 DE           BNE     $8797               ; {hard.MMC1_0+797}
87B9: CE 14 05        DEC     $0514               ; {ram.0514}
87BC: 4C B1 FE        JMP     $FEB1               ; {hard.MMC1_3+1EB1}
87BF: A9 A0           LDA     #$A0                ; 
87C1: 9D 1F 04        STA     $041F,X             ; {ram.041F}
87C4: 20 94 80        JSR     $8094               ; {hard.MMC1_0+94}
87C7: A0 5B           LDY     #$5B                ; 
87C9: 4C D1 87        JMP     $87D1               ; {hard.MMC1_0+7D1}
87CC: 20 19 81        JSR     $8119               ; {hard.MMC1_0+119}
87CF: A0 57           LDY     #$57                ; 
87D1: A9 20           LDA     #$20                ; 
87D3: 85 01           STA     <$01                ; {ram.GP_01}
87D5: BD 4F 03        LDA     $034F,X             ; {ram.034F}
87D8: C9 03           CMP     #$03                ; 
87DA: F0 17           BEQ     $87F3               ; {hard.MMC1_0+7F3}
87DC: C9 01           CMP     #$01                ; 
87DE: F0 13           BEQ     $87F3               ; {hard.MMC1_0+7F3}
87E0: C9 09           CMP     #$09                ; 
87E2: F0 0F           BEQ     $87F3               ; {hard.MMC1_0+7F3}
87E4: C9 0A           CMP     #$0A                ; 
87E6: F0 0B           BEQ     $87F3               ; {hard.MMC1_0+7F3}
87E8: BD 51 04        LDA     $0451,X             ; 
87EB: D0 06           BNE     $87F3               ; {hard.MMC1_0+7F3}
87ED: B5 18           LDA     $18,X               ; {ram.0018}
87EF: C9 F8           CMP     #$F8                ; 
87F1: 90 3E           BCC     $8831               ; {hard.MMC1_0+831}
87F3: A5 01           LDA     <$01                ; {ram.GP_01}
87F5: 84 00           STY     <$00                ; {ram.GP_00}
87F7: 48              PHA                         ; 
87F8: A0 00           LDY     #$00                ; 
87FA: BD F0 04        LDA     $04F0,X             ; {ram.04F0}
87FD: D0 0D           BNE     $880C               ; {hard.MMC1_0+80C}
87FF: BC 51 04        LDY     $0451,X             ; 
8802: 88              DEY                         ; 
8803: 10 07           BPL     $880C               ; {hard.MMC1_0+80C}
8805: BD 12 04        LDA     $0412,X             ; {ram.0412}
8808: F0 23           BEQ     $882D               ; {hard.MMC1_0+82D}
880A: A0 30           LDY     #$30                ; 
880C: 98              TYA                         ; 
880D: 9D 51 04        STA     $0451,X             ; 
8810: F0 1B           BEQ     $882D               ; {hard.MMC1_0+82D}
8812: C0 10           CPY     #$10                ; 
8814: D0 13           BNE     $8829               ; {hard.MMC1_0+829}
8816: AD 6C 06        LDA     $066C               ; {ram.066C}
8819: 15 3D           ORA     $3D,X               ; {ram.003D}
881B: D0 0C           BNE     $8829               ; {hard.MMC1_0+829}
881D: A5 00           LDA     <$00                ; {ram.GP_00}
881F: 20 32 88        JSR     $8832               ; {hard.MMC1_0+832}
8822: 90 09           BCC     $882D               ; {hard.MMC1_0+82D}
8824: A9 00           LDA     #$00                ; 
...
8831: 60              RTS                         ; 
8832: 20 79 B1        JSR     $B179               ; {hard.MMC1_1+1179}
8835: 90 07           BCC     $883E               ; {hard.MMC1_0+83E}
8837: A9 80           LDA     #$80                ; 
...
8846: D0 14           BNE     $885C               ; {hard.MMC1_0+85C}
8848: BD AC 00        LDA     $00AC,X             ; {ram.00AC}
884B: 29 F0           AND     #$F0                ; 
884D: C9 20           CMP     #$20                ; 
884F: F0 18           BEQ     $8869               ; {hard.MMC1_0+869}
8851: C9 10           CMP     #$10                ; 
8853: D0 2A           BNE     $887F               ; {hard.MMC1_0+87F}
8855: B5 98           LDA     $98,X               ; {ram.0098}
8857: 85 0F           STA     <$0F                ; {ram.000F}
8859: 4C 69 88        JMP     $8869               ; {hard.MMC1_0+869}
885C: BC 2C 04        LDY     $042C,X             ; {ram.!SplashMode}
885F: B9 4F 03        LDA     $034F,Y             ; {ram.034F}
8862: D0 02           BNE     $8866               ; {hard.MMC1_0+866}
8864: 95 28           STA     $28,X               ; {ram.0028}
8866: 4C 7B F5        JMP     $F57B               ; {hard.MMC1_3+157B}
8869: 20 19 F5        JSR     $F519               ; {hard.MMC1_3+1519}
886C: BD AC 00        LDA     $00AC,X             ; {ram.00AC}
886F: 29 F0           AND     #$F0                ; 
8871: C9 10           CMP     #$10                ; 
8873: D0 0A           BNE     $887F               ; {hard.MMC1_0+87F}
8875: 20 71 83        JSR     $8371               ; {hard.MMC1_0+371}
8878: A5 06           LDA     <$06                ; {ram.0006}
887A: F0 C2           BEQ     $883E               ; {hard.MMC1_0+83E}
887C: 4C 46 83        JMP     $8346               ; {hard.MMC1_0+346}
887F: C9 30           CMP     #$30                ; 
8881: D0 BB           BNE     $883E               ; {hard.MMC1_0+83E}
8883: 4C 4C 83        JMP     $834C               ; {hard.MMC1_0+34C}
8886: B5 28           LDA     $28,X               ; {ram.0028}
8888: D0 3F           BNE     $88C9               ; {hard.MMC1_0+8C9}
888A: AD 15 05        LDA     $0515               ; {ram.0515}
888D: C9 03           CMP     #$03                ; 
888F: F0 31           BEQ     $88C2               ; {hard.MMC1_0+8C2}
8891: 20 BB FE        JSR     $FEBB               ; {hard.MMC1_3+1EBB}
8894: F0 33           BEQ     $88C9               ; {hard.MMC1_0+8C9}
8896: A6 59           LDX     <$59                ; {ram.0059}
8898: EE 15 05        INC     $0515               ; {ram.0515}
889B: A9 20           LDA     #$20                ; 
889D: 20 B3 FE        JSR     $FEB3               ; {hard.MMC1_3+1EB3}
88A0: B5 19           LDA     $19,X               ; {ram.0019}
88A2: A4 61           LDY     <$61                ; {ram.0061}
88A4: C0 80           CPY     #$80                ; 
88A6: B0 05           BCS     $88AD               ; {hard.MMC1_0+8AD}
88A8: 29 7F           AND     #$7F                ; 
88AA: 4C AF 88        JMP     $88AF               ; {hard.MMC1_0+8AF}
88AD: 09 80           ORA     #$80                ; 
...
88DC: 00              BRK                         ; 
88DD: 00              BRK                         ; 
88DE: 30 30           BMI     $8910               ; {hard.MMC1_0+910}
88E0: 00              BRK                         ; 
88E1: 80                              ;
88E2: 80                              ;
88E3: 00              BRK                         ; 
...
88E7: 00              BRK                         ; 
88E8: 00              BRK                         ; 
88E9: 50 50           BVC     $893B               ; {hard.MMC1_0+93B}
88EB: 60              RTS                         ; 
88EC: 60              RTS                         ; 
88ED: 60              RTS                         ; 
88EE: 60              RTS                         ; 
...
88F0: 60              RTS                         ; 
88F1: 60              RTS                         ; 
88F2: FD FC FE        SBC     $FEFC,X             ; {hard.MMC1_3+1EFC}
88F5: 00              BRK                         ; 
88F6: 0B                              ;
...
88FD: B8              CLV                         ; 
88FE: EE 4C CB        INC     $CB4C               ; {hard.MMC1_2+B4C}
8901: 89                              ;
8902: AD 6C 06        LDA     $066C               ; {ram.066C}
8905: 15 3D           ORA     $3D,X               ; {ram.003D}
8907: D0 F6           BNE     $88FF               ; {hard.MMC1_0+8FF}
8909: B5 AC           LDA     $AC,X               ; {ram.00AC}
890B: D0 4C           BNE     $8959               ; {hard.MMC1_0+959}
890D: B5 28           LDA     $28,X               ; {ram.0028}
890F: D0 45           BNE     $8956               ; {hard.MMC1_0+956}
8911: 20 1A B3        JSR     $B31A               ; {hard.MMC1_1+131A}
8914: B5 98           LDA     $98,X               ; {ram.0098}
8916: 29 03           AND     #$03                ; 
8918: D0 0E           BNE     $8928               ; {hard.MMC1_0+928}
891A: A0 02           LDY     #$02                ; 
891C: A5 61           LDA     <$61                ; {ram.0061}
891E: D5 70           CMP     $70,X               ; {ram.0070}
8920: 90 01           BCC     $8923               ; {hard.MMC1_0+923}
8922: 88              DEY                         ; 
8923: 98              TYA                         ; 
...
892D: C9 02           CMP     #$02                ; 
892F: 90 0B           BCC     $893C               ; {hard.MMC1_0+93C}
8931: B5 98           LDA     $98,X               ; {ram.0098}
8933: 49 03           EOR     #$03                ; 
8935: 95 98           STA     $98,X               ; {ram.0098}
8937: A9 00           LDA     #$00                ; 
8939: 9D 51 04        STA     $0451,X             ; 
893C: 20 11 8A        JSR     $8A11               ; {hard.MMC1_0+A11}
893F: B4 98           LDY     $98,X               ; {ram.0098}
8941: B5 84           LDA     $84,X               ; {ram.0084}
8943: 18              CLC                         ; 
8944: 79 CA 88        ADC     $88CA,Y             ; {hard.MMC1_0+8CA}
8947: 9D 44 04        STA     $0444,X             ; 
894A: 20 03 8A        JSR     $8A03               ; {hard.MMC1_0+A03}
894D: B9 F2 88        LDA     $88F2,Y             ; {hard.MMC1_0+8F2}
8950: 9D 12 04        STA     $0412,X             ; {ram.0412}
8953: 20 4D 8A        JSR     $8A4D               ; {hard.MMC1_0+A4D}
8956: 4C CB 89        JMP     $89CB               ; {hard.MMC1_0+9CB}
8959: 20 CD B2        JSR     $B2CD               ; {hard.MMC1_1+12CD}
895C: A5 0F           LDA     <$0F                ; {ram.000F}
895E: D0 06           BNE     $8966               ; {hard.MMC1_0+966}
8960: FE 51 04        INC     $0451,X             ; 
8963: 4C 2A 89        JMP     $892A               ; {hard.MMC1_0+92A}
8966: 20 11 8A        JSR     $8A11               ; {hard.MMC1_0+A11}
8969: A9 00           LDA     #$00                ; 
896B: 9D 51 04        STA     $0451,X             ; 
896E: 20 03 8A        JSR     $8A03               ; {hard.MMC1_0+A03}
8971: B9 F5 88        LDA     $88F5,Y             ; {hard.MMC1_0+8F5}
8974: 18              CLC                         ; 
8975: 75 98           ADC     <$98,X              ; {ram.0098}
8977: A8              TAY                         ; 
8978: B9 D5 88        LDA     $88D5,Y             ; {hard.MMC1_0+8D5}
897B: A0 02           LDY     #$02                ; 
897D: 20 21 8A        JSR     $8A21               ; {hard.MMC1_0+A21}
8980: A0 FF           LDY     #$FF                ; 
8982: B5 98           LDA     $98,X               ; {ram.0098}
8984: 29 02           AND     #$02                ; 
8986: D0 02           BNE     $898A               ; {hard.MMC1_0+98A}
8988: A0 01           LDY     #$01                ; 
898A: 98              TYA                         ; 
898B: 18              CLC                         ; 
...
8993: 30 36           BMI     $89CB               ; {hard.MMC1_0+9CB}
8995: B5 84           LDA     $84,X               ; {ram.0084}
8997: 38              SEC                         ; 
8998: FD 44 04        SBC     $0444,X             ; 
899B: 20 1F 70        JSR     $701F               ; {ram.701F}
899E: C9 03           CMP     #$03                ; 
89A0: B0 29           BCS     $89CB               ; {hard.MMC1_0+9CB}
89A2: 20 55 F8        JSR     $F855               ; {hard.MMC1_3+1855}
89A5: BC 4F 03        LDY     $034F,X             ; {ram.034F}
89A8: C0 20           CPY     #$20                ; 
89AA: F0 1D           BEQ     $89C9               ; {hard.MMC1_0+9C9}
89AC: A9 10           LDA     #$10                ; 
89AE: 18              CLC                         ; 
89AF: 75 19           ADC     <$19,X              ; {ram.0019}
89B1: C9 20           CMP     #$20                ; 
89B3: B0 03           BCS     $89B8               ; {hard.MMC1_0+9B8}
89B5: 38              SEC                         ; 
89B6: E9 40           SBC     #$40                ; 
89B8: BC 4F 03        LDY     $034F,X             ; {ram.034F}
89BB: C0 0D           CPY     #$0D                ; 
89BD: F0 0A           BEQ     $89C9               ; {hard.MMC1_0+9C9}
89BF: 29 7F           AND     #$7F                ; 
89C1: B4 19           LDY     $19,X               ; {ram.0019}
89C3: C0 A0           CPY     #$A0                ; 
89C5: 90 02           BCC     $89C9               ; {hard.MMC1_0+9C9}
89C7: 29 0F           AND     #$0F                ; 
89C9: 95 28           STA     $28,X               ; {ram.0028}
89CB: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
89CE: 85 0D           STA     <$0D                ; {ram.000D}
89D0: BD 4F 03        LDA     $034F,X             ; {ram.034F}
89D3: C9 20           CMP     #$20                ; 
89D5: F0 15           BEQ     $89EC               ; {hard.MMC1_0+9EC}
89D7: B5 AC           LDA     $AC,X               ; {ram.00AC}
89D9: D0 0E           BNE     $89E9               ; {hard.MMC1_0+9E9}
89DB: B4 28           LDY     $28,X               ; {ram.0028}
89DD: C0 21           CPY     #$21                ; 
89DF: 90 08           BCC     $89E9               ; {hard.MMC1_0+9E9}
89E1: A9 10           LDA     #$10                ; 
89E3: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
89E6: BD E4 03        LDA     $03E4,X             ; {ram.03E4}
89E9: 4C 65 8C        JMP     $8C65               ; {hard.MMC1_0+C65}
89EC: A9 06           LDA     #$06                ; 
89EE: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
89F1: BD E4 03        LDA     $03E4,X             ; {ram.03E4}
89F4: 20 AC 8C        JSR     $8CAC               ; {hard.MMC1_0+CAC}
89F7: B5 84           LDA     $84,X               ; {ram.0084}
89F9: C9 F0           CMP     #$F0                ; 
89FB: 90 13           BCC     $8A10               ; {hard.MMC1_0+A10}
89FD: CE 15 05        DEC     $0515               ; {ram.0515}
8A00: 4C B1 FE        JMP     $FEB1               ; {hard.MMC1_3+1EB1}
8A03: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8A06: 38              SEC                         ; 
8A07: E9 0D           SBC     #$0D                ; 
8A09: A8              TAY                         ; 
8A0A: C0 02           CPY     #$02                ; 
8A0C: 90 02           BCC     $8A10               ; {hard.MMC1_0+A10}
8A0E: A0 02           LDY     #$02                ; 
8A10: 60              RTS                         ; 
8A11: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8A14: C9 20           CMP     #$20                ; 
8A16: D0 08           BNE     $8A20               ; {hard.MMC1_0+A20}
...
8A3F: 30 11           BMI     $8A52               ; {hard.MMC1_0+A52}
8A41: BD 1F 04        LDA     $041F,X             ; {ram.041F}
8A44: C9 80           CMP     #$80                ; 
8A46: 90 0A           BCC     $8A52               ; {hard.MMC1_0+A52}
...
8A53: 08              PHP                         ; 
8A54: 0A              ASL     A                   ; 
8A55: 10 20           BPL     $8A77               ; {hard.MMC1_0+A77}
8A57: 10 0A           BPL     $8A63               ; {hard.MMC1_0+A63}
8A59: 80                              ;
8A5A: 20 0F FF        JSR     $FF0F               ; {hard.MMC1_3+1F0F}
8A5D: 10 60           BPL     $8ABF               ; {hard.MMC1_0+ABF}
8A5F: 10 0B           BPL     $8A6C               ; {hard.MMC1_0+A6C}
8A61: 01 05           ORA     ($05,X)             ; {ram.0005}
8A63: 01 0B           ORA     ($0B,X)             ; {ram.000B}
8A65: A9 A0           LDA     #$A0                ; 
8A67: 9D 1F 04        STA     $041F,X             ; {ram.041F}
8A6A: 20 94 80        JSR     $8094               ; {hard.MMC1_0+94}
8A6D: B5 28           LDA     $28,X               ; {ram.0028}
8A6F: D0 30           BNE     $8AA1               ; {hard.MMC1_0+AA1}
8A71: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8A74: C9 11           CMP     #$11                ; 
8A76: D0 10           BNE     $8A88               ; {hard.MMC1_0+A88}
8A78: B4 AC           LDY     $AC,X               ; {ram.00AC}
8A7A: 88              DEY                         ; 
8A7B: D0 0B           BNE     $8A88               ; {hard.MMC1_0+A88}
8A7D: A0 03           LDY     #$03                ; 
8A7F: B5 84           LDA     $84,X               ; {ram.0084}
8A81: C5 84           CMP     <$84                ; {ram.0084}
8A83: B0 01           BCS     $8A86               ; {hard.MMC1_0+A86}
8A85: 88              DEY                         ; 
...
8A8B: 69 01           ADC     #$01                ; 
8A8D: C9 06           CMP     #$06                ; 
8A8F: 90 02           BCC     $8A93               ; {hard.MMC1_0+A93}
8A91: A9 00           LDA     #$00                ; 
8A93: 95 AC           STA     $AC,X               ; {ram.00AC}
8A95: A8              TAY                         ; 
8A96: B9 53 8A        LDA     $8A53,Y             ; {hard.MMC1_0+A53}
8A99: 9D BC 03        STA     $03BC,X             ; {ram.03BC}
8A9C: B9 59 8A        LDA     $8A59,Y             ; {hard.MMC1_0+A59}
8A9F: 95 28           STA     $28,X               ; {ram.0028}
8AA1: B4 AC           LDY     $AC,X               ; {ram.00AC}
8AA3: B9 5F 8A        LDA     $8A5F,Y             ; {hard.MMC1_0+A5F}
8AA6: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
8AA9: B5 AC           LDA     $AC,X               ; {ram.00AC}
8AAB: F0 49           BEQ     $8AF6               ; {hard.MMC1_0+AF6}
8AAD: BC 4F 03        LDY     $034F,X             ; {ram.034F}
8AB0: C0 11           CPY     #$11                ; 
8AB2: D0 0E           BNE     $8AC2               ; {hard.MMC1_0+AC2}
8AB4: B4 AC           LDY     $AC,X               ; {ram.00AC}
8AB6: C0 02           CPY     #$02                ; 
8AB8: 90 08           BCC     $8AC2               ; {hard.MMC1_0+AC2}
8ABA: C0 05           CPY     #$05                ; 
8ABC: B0 04           BCS     $8AC2               ; {hard.MMC1_0+AC2}
8ABE: B5 98           LDA     $98,X               ; {ram.0098}
8AC0: D0 08           BNE     $8ACA               ; {hard.MMC1_0+ACA}
8AC2: 38              SEC                         ; 
8AC3: E9 01           SBC     #$01                ; 
8AC5: 0A              ASL     A                   ; 
8AC6: 18              CLC                         ; 
...
8AD0: C9 11           CMP     #$11                ; 
8AD2: D0 0A           BNE     $8ADE               ; {hard.MMC1_0+ADE}
8AD4: B5 AC           LDA     $AC,X               ; {ram.00AC}
8AD6: C9 02           CMP     #$02                ; 
8AD8: F0 0A           BEQ     $8AE4               ; {hard.MMC1_0+AE4}
8ADA: C9 04           CMP     #$04                ; 
8ADC: F0 06           BEQ     $8AE4               ; {hard.MMC1_0+AE4}
8ADE: B5 AC           LDA     $AC,X               ; {ram.00AC}
8AE0: C9 03           CMP     #$03                ; 
8AE2: D0 12           BNE     $8AF6               ; {hard.MMC1_0+AF6}
8AE4: 20 D0 79        JSR     $79D0               ; {ram.79D0}
8AE7: BD 05 04        LDA     $0405,X             ; {ram.0405}
8AEA: F0 0A           BEQ     $8AF6               ; {hard.MMC1_0+AF6}
8AEC: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8AEF: C9 10           CMP     #$10                ; 
8AF1: D0 03           BNE     $8AF6               ; {hard.MMC1_0+AF6}
...
8AFD: 00              BRK                         ; 
8AFE: 10 08           BPL     $8B08               ; {hard.MMC1_0+B08}
8B00: FF                              ;
8B01: 08              PHP                         ; 
8B02: 10 10           BPL     $8B14               ; {hard.MMC1_0+B14}
8B04: 08              PHP                         ; 
8B05: 08              PHP                         ; 
8B06: 05 08           ORA     <$08                ; {ram.0008}
8B08: 08              PHP                         ; 
8B09: B5 AC           LDA     $AC,X               ; {ram.00AC}
8B0B: F0 03           BEQ     $8B10               ; {hard.MMC1_0+B10}
8B0D: 4C 9D 8B        JMP     $8B9D               ; {hard.MMC1_0+B9D}
8B10: A5 4D           LDA     <$4D                ; {ram.004D}
8B12: D0 39           BNE     $8B4D               ; {hard.MMC1_0+B4D}
8B14: AD 10 05        LDA     $0510               ; {ram.0510}
8B17: C9 02           CMP     #$02                ; 
8B19: B0 32           BCS     $8B4D               ; {hard.MMC1_0+B4D}
8B1B: A5 98           LDA     <$98                ; {ram.0098}
8B1D: 95 98           STA     $98,X               ; {ram.0098}
8B1F: B5 19           LDA     $19,X               ; {ram.0019}
8B21: C9 C0           CMP     #$C0                ; 
8B23: 90 03           BCC     $8B28               ; {hard.MMC1_0+B28}
8B25: 20 D0 F1        JSR     $F1D0               ; {hard.MMC1_3+11D0}
8B28: B5 98           LDA     $98,X               ; {ram.0098}
8B2A: 29 0C           AND     #$0C                ; 
8B2C: F0 20           BEQ     $8B4E               ; {hard.MMC1_0+B4E}
8B2E: A5 70           LDA     <$70                ; {ram.0070}
8B30: 95 70           STA     $70,X               ; {ram.0070}
8B32: A0 28           LDY     #$28                ; 
8B34: B5 98           LDA     $98,X               ; {ram.0098}
8B36: 29 08           AND     #$08                ; 
8B38: F0 02           BEQ     $8B3C               ; {hard.MMC1_0+B3C}
8B3A: A0 D8           LDY     #$D8                ; 
...
8B49: C9 5D           CMP     #$5D                ; 
8B4B: B0 37           BCS     $8B84               ; {hard.MMC1_0+B84}
8B4D: 60              RTS                         ; 
8B4E: A5 84           LDA     <$84                ; {ram.0084}
8B50: 95 84           STA     $84,X               ; {ram.0084}
8B52: C9 5D           CMP     #$5D                ; 
8B54: 90 F7           BCC     $8B4D               ; {hard.MMC1_0+B4D}
8B56: A0 28           LDY     #$28                ; 
8B58: B5 98           LDA     $98,X               ; {ram.0098}
8B5A: 29 02           AND     #$02                ; 
8B5C: F0 02           BEQ     $8B60               ; {hard.MMC1_0+B60}
8B5E: A0 D8           LDY     #$D8                ; 
...
8B71: 90 08           BCC     $8B7B               ; {hard.MMC1_0+B7B}
8B73: 48              PHA                         ; 
...
8B80: C9 30           CMP     #$30                ; 
8B82: B0 C9           BCS     $8B4D               ; {hard.MMC1_0+B4D}
8B84: 20 F4 ED        JSR     $EDF4               ; {hard.MMC1_2+2DF4}
8B87: CD 4A 03        CMP     $034A               ; {ram.034A}
8B8A: B0 C1           BCS     $8B4D               ; {hard.MMC1_0+B4D}
8B8C: EE 10 05        INC     $0510               ; {ram.0510}
8B8F: A9 01           LDA     #$01                ; 
8B91: 9D D0 03        STA     $03D0,X             ; {ram.03D0}
8B94: 0A              ASL     A                   ; 
8B95: 85 4D           STA     <$4D                ; {ram.004D}
8B97: 20 DA 8B        JSR     $8BDA               ; {hard.MMC1_0+BDA}
8B9A: 20 D0 F1        JSR     $F1D0               ; {hard.MMC1_3+11D0}
8B9D: B5 AC           LDA     $AC,X               ; {ram.00AC}
8B9F: C9 03           CMP     #$03                ; 
8BA1: D0 33           BNE     $8BD6               ; {hard.MMC1_0+BD6}
8BA3: B5 C0           LDA     $C0,X               ; {ram.00C0}
8BA5: F0 06           BEQ     $8BAD               ; {hard.MMC1_0+BAD}
8BA7: 20 B8 EE        JSR     $EEB8               ; {hard.MMC1_2+2EB8}
8BAA: 4C F6 8B        JMP     $8BF6               ; {hard.MMC1_0+BF6}
8BAD: AD 6C 06        LDA     $066C               ; {ram.066C}
8BB0: 15 3D           ORA     $3D,X               ; {ram.003D}
8BB2: D0 42           BNE     $8BF6               ; {hard.MMC1_0+BF6}
8BB4: B5 98           LDA     $98,X               ; {ram.0098}
8BB6: 85 0F           STA     <$0F                ; {ram.000F}
8BB8: 20 FA ED        JSR     $EDFA               ; {hard.MMC1_2+2DFA}
8BBB: CD 4A 03        CMP     $034A               ; {ram.034A}
8BBE: B0 1A           BCS     $8BDA               ; {hard.MMC1_0+BDA}
8BC0: 20 B8 6F        JSR     $6FB8               ; {ram.6FB8}
8BC3: F0 15           BEQ     $8BDA               ; {hard.MMC1_0+BDA}
8BC5: 20 8D F0        JSR     $F08D               ; {hard.MMC1_3+108D}
8BC8: BD 94 03        LDA     $0394,X             ; {ram.0394}
8BCB: 29 0F           AND     #$0F                ; 
8BCD: D0 03           BNE     $8BD2               ; {hard.MMC1_0+BD2}
8BCF: 9D 94 03        STA     $0394,X             ; {ram.0394}
8BD2: A9 FF           LDA     #$FF                ; 
8BD4: 95 28           STA     $28,X               ; {ram.0028}
8BD6: B5 28           LDA     $28,X               ; {ram.0028}
8BD8: D0 1C           BNE     $8BF6               ; {hard.MMC1_0+BF6}
8BDA: B5 AC           LDA     $AC,X               ; {ram.00AC}
8BDC: 18              CLC                         ; 
8BDD: 69 01           ADC     #$01                ; 
8BDF: C9 06           CMP     #$06                ; 
8BE1: 90 05           BCC     $8BE8               ; {hard.MMC1_0+BE8}
8BE3: CE 10 05        DEC     $0510               ; {ram.0510}
8BE6: A9 00           LDA     #$00                ; 
8BE8: 95 AC           STA     $AC,X               ; {ram.00AC}
8BEA: A8              TAY                         ; 
8BEB: B9 F7 8A        LDA     $8AF7,Y             ; {hard.MMC1_0+AF7}
8BEE: 9D BC 03        STA     $03BC,X             ; {ram.03BC}
8BF1: B9 FD 8A        LDA     $8AFD,Y             ; {hard.MMC1_0+AFD}
8BF4: 95 28           STA     $28,X               ; {ram.0028}
8BF6: B4 AC           LDY     $AC,X               ; {ram.00AC}
8BF8: B9 03 8B        LDA     $8B03,Y             ; {hard.MMC1_0+B03}
8BFB: 4C A6 8A        JMP     $8AA6               ; {hard.MMC1_0+AA6}
8BFE: 60              RTS                         ; 
8BFF: A9 A0           LDA     #$A0                ; 
8C01: BC 4F 03        LDY     $034F,X             ; {ram.034F}
8C04: C0 09           CPY     #$09                ; 
8C06: B0 02           BCS     $8C0A               ; {hard.MMC1_0+C0A}
8C08: A9 70           LDA     #$70                ; 
8C0A: 9D 1F 04        STA     $041F,X             ; {ram.041F}
8C0D: 20 94 80        JSR     $8094               ; {hard.MMC1_0+94}
8C10: A9 20           LDA     #$20                ; 
8C12: BC 4F 03        LDY     $034F,X             ; {ram.034F}
8C15: C0 07           CPY     #$07                ; 
8C17: F0 05           BEQ     $8C1E               ; {hard.MMC1_0+C1E}
8C19: C0 09           CPY     #$09                ; 
8C1B: F0 01           BEQ     $8C1E               ; {hard.MMC1_0+C1E}
8C1D: 0A              ASL     A                   ; 
8C1E: A0 53           LDY     #$53                ; 
8C20: 20 D3 87        JSR     $87D3               ; {hard.MMC1_0+7D3}
8C23: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
8C26: B5 98           LDA     $98,X               ; {ram.0098}
8C28: A8              TAY                         ; 
8C29: 29 0C           AND     #$0C                ; 
8C2B: F0 0A           BEQ     $8C37               ; {hard.MMC1_0+C37}
8C2D: A9 02           LDA     #$02                ; 
8C2F: C0 08           CPY     #$08                ; 
8C31: D0 0C           BNE     $8C3F               ; {hard.MMC1_0+C3F}
8C33: A9 01           LDA     #$01                ; 
8C35: D0 08           BNE     $8C3F               ; {hard.MMC1_0+C3F}
8C37: C0 01           CPY     #$01                ; 
8C39: D0 02           BNE     $8C3D               ; {hard.MMC1_0+C3D}
8C3B: E6 0F           INC     <$0F                ; {ram.000F}
8C3D: A9 00           LDA     #$00                ; 
8C3F: 48              PHA                         ; 
8C40: DE D0 03        DEC     $03D0,X             ; {ram.03D0}
8C43: D0 0C           BNE     $8C51               ; {hard.MMC1_0+C51}
8C45: A9 06           LDA     #$06                ; 
...
8C59: 29 0C           AND     #$0C                ; 
8C5B: D0 07           BNE     $8C64               ; {hard.MMC1_0+C64}
8C5D: 68              PLA                         ; 
...
8C6B: A9 FF           LDA     #$FF                ; 
8C6D: 20 6E 80        JSR     $806E               ; {hard.MMC1_0+6E}
8C70: 20 8D 8C        JSR     $8C8D               ; {hard.MMC1_0+C8D}
8C73: 20 D0 79        JSR     $79D0               ; {ram.79D0}
8C76: BD 05 04        LDA     $0405,X             ; {ram.0405}
8C79: F0 11           BEQ     $8C8C               ; {hard.MMC1_0+C8C}
8C7B: A0 0B           LDY     #$0B                ; 
8C7D: B9 4F 03        LDA     $034F,Y             ; {ram.034F}
8C80: C9 22           CMP     #$22                ; 
8C82: D0 05           BNE     $8C89               ; {hard.MMC1_0+C89}
8C84: A9 11           LDA     #$11                ; 
8C86: 99 05 04        STA     $0405,Y             ; {ram.0405}
8C89: 88              DEY                         ; 
8C8A: D0 F1           BNE     $8C7D               ; {hard.MMC1_0+C7D}
8C8C: 60              RTS                         ; 
8C8D: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
8C90: 85 0D           STA     <$0D                ; {ram.000D}
8C92: B5 98           LDA     $98,X               ; {ram.0098}
8C94: 29 08           AND     #$08                ; 
8C96: D0 0A           BNE     $8CA2               ; {hard.MMC1_0+CA2}
8C98: E6 0D           INC     <$0D                ; {ram.000D}
8C9A: B5 98           LDA     $98,X               ; {ram.0098}
8C9C: 29 01           AND     #$01                ; 
8C9E: F0 0A           BEQ     $8CAA               ; {hard.MMC1_0+CAA}
8CA0: D0 06           BNE     $8CA8               ; {hard.MMC1_0+CA8}
8CA2: B5 98           LDA     $98,X               ; {ram.0098}
8CA4: 29 02           AND     #$02                ; 
8CA6: F0 02           BEQ     $8CAA               ; {hard.MMC1_0+CAA}
...
8CB5: 22                              ;
8CB6: 34                              ;
8CB7: 3D 4E E0        AND     $E04E,X             ; {hard.MMC1_2+204E}
8CBA: B0 B0           BCS     $8C6C               ; {hard.MMC1_0+C6C}
8CBC: 30 40           BMI     $8CFE               ; {hard.MMC1_0+CFE}
8CBE: 90 A0           BCC     $8C60               ; {hard.MMC1_0+C60}
8CC0: B5 28           LDA     $28,X               ; {ram.0028}
8CC2: 9D 92 04        STA     $0492,X             ; 
8CC5: D0 64           BNE     $8D2B               ; {hard.MMC1_0+D2B}
8CC7: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8CCA: C9 22           CMP     #$22                ; 
8CCC: F0 5D           BEQ     $8D2B               ; {hard.MMC1_0+D2B}
8CCE: A9 70           LDA     #$70                ; 
8CD0: 85 00           STA     <$00                ; {ram.GP_00}
8CD2: A0 06           LDY     #$06                ; 
8CD4: A5 EB           LDA     <$EB                ; {ram.00EB}
8CD6: D9 B2 8C        CMP     $8CB2,Y             ; {hard.MMC1_0+CB2}
8CD9: D0 27           BNE     $8D02               ; {hard.MMC1_0+D02}
8CDB: B5 70           LDA     $70,X               ; {ram.0070}
8CDD: D9 B9 8C        CMP     $8CB9,Y             ; {hard.MMC1_0+CB9}
8CE0: D0 20           BNE     $8D02               ; {hard.MMC1_0+D02}
8CE2: B5 84           LDA     $84,X               ; {ram.0084}
8CE4: C9 80           CMP     #$80                ; 
8CE6: D0 1A           BNE     $8D02               ; {hard.MMC1_0+D02}
8CE8: C0 00           CPY     #$00                ; 
8CEA: D0 1D           BNE     $8D09               ; {hard.MMC1_0+D09}
...
8CFB: D0 08           BNE     $8D05               ; {hard.MMC1_0+D05}
8CFD: 20 81 90        JSR     $9081               ; {hard.MMC1_0+1081}
8D00: D0 03           BNE     $8D05               ; {hard.MMC1_0+D05}
8D02: 88              DEY                         ; 
8D03: 10 CF           BPL     $8CD4               ; {hard.MMC1_0+CD4}
8D05: A9 26           LDA     #$26                ; 
8D07: 85 00           STA     <$00                ; {ram.GP_00}
8D09: A5 00           LDA     <$00                ; {ram.GP_00}
8D0B: 48              PHA                         ; 
8D0C: C9 70           CMP     #$70                ; 
8D0E: D0 03           BNE     $8D13               ; {hard.MMC1_0+D13}
8D10: 20 81 90        JSR     $9081               ; {hard.MMC1_0+1081}
8D13: E6 F7           INC     <$F7                ; {ram.00F7}
8D15: 68              PLA                         ; 
8D16: 20 62 E8        JSR     $E862               ; {hard.MMC1_2+2862}
8D19: A9 03           LDA     #$03                ; 
8D1B: 9D 94 03        STA     $0394,X             ; {ram.0394}
8D1E: A9 20           LDA     #$20                ; 
8D20: B4 19           LDY     $19,X               ; {ram.0019}
8D22: C0 80           CPY     #$80                ; 
8D24: 90 02           BCC     $8D28               ; {hard.MMC1_0+D28}
8D26: A9 60           LDA     #$60                ; 
...
8D34: 4A              LSR     A                   ; 
8D35: B0 0A           BCS     $8D41               ; {hard.MMC1_0+D41}
8D37: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8D3A: C9 22           CMP     #$22                ; 
8D3C: F0 04           BEQ     $8D42               ; {hard.MMC1_0+D42}
8D3E: 20 69 8D        JSR     $8D69               ; {hard.MMC1_0+D69}
8D41: 60              RTS                         ; 
8D42: 20 8D 8C        JSR     $8C8D               ; {hard.MMC1_0+C8D}
8D45: BD 92 04        LDA     $0492,X             ; 
8D48: D0 F7           BNE     $8D41               ; {hard.MMC1_0+D41}
8D4A: 20 D6 FE        JSR     $FED6               ; {hard.MMC1_3+1ED6}
8D4D: 4C 7C 87        JMP     $877C               ; {hard.MMC1_0+77C}
8D50: 20 19 81        JSR     $8119               ; {hard.MMC1_0+119}
8D53: B5 C0           LDA     $C0,X               ; {ram.00C0}
8D55: D0 12           BNE     $8D69               ; {hard.MMC1_0+D69}
8D57: DE D0 03        DEC     $03D0,X             ; {ram.03D0}
8D5A: D0 0D           BNE     $8D69               ; {hard.MMC1_0+D69}
8D5C: A9 06           LDA     #$06                ; 
8D5E: 9D D0 03        STA     $03D0,X             ; {ram.03D0}
8D61: BD E4 03        LDA     $03E4,X             ; {ram.03E4}
8D64: 49 02           EOR     #$02                ; 
8D66: 9D E4 03        STA     $03E4,X             ; {ram.03E4}
8D69: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
8D6C: B4 98           LDY     $98,X               ; {ram.0098}
8D6E: C0 08           CPY     #$08                ; 
8D70: D0 02           BNE     $8D74               ; {hard.MMC1_0+D74}
8D72: A9 01           LDA     #$01                ; 
8D74: 18              CLC                         ; 
8D75: 7D E4 03        ADC     $03E4,X             ; {ram.03E4}
8D78: 20 DF 77        JSR     $77DF               ; {ram.77DF}
8D7B: B5 28           LDA     $28,X               ; {ram.0028}
8D7D: D0 0E           BNE     $8D8D               ; {hard.MMC1_0+D8D}
8D7F: 20 D0 79        JSR     $79D0               ; {ram.79D0}
8D82: BD 05 04        LDA     $0405,X             ; {ram.0405}
8D85: F0 05           BEQ     $8D8C               ; {hard.MMC1_0+D8C}
8D87: A9 5D           LDA     #$5D                ; 
8D89: 9D 4F 03        STA     $034F,X             ; {ram.034F}
8D8C: 60              RTS                         ; 
8D8D: 4C A7 7A        JMP     $7AA7               ; {ram.7AA7}
8D90: 20 23 B2        JSR     $B223               ; {hard.MMC1_1+1223}
8D93: A5 AD           LDA     <$AD                ; {ram.00AD}
8D95: D0 19           BNE     $8DB0               ; {hard.MMC1_0+DB0}
8D97: A5 84           LDA     <$84                ; {ram.0084}
8D99: C9 AD           CMP     #$AD                ; 
8D9B: D0 12           BNE     $8DAF               ; {hard.MMC1_0+DAF}
8D9D: A5 70           LDA     <$70                ; {ram.0070}
8D9F: C9 70           CMP     #$70                ; 
8DA1: 90 0C           BCC     $8DAF               ; {hard.MMC1_0+DAF}
8DA3: C9 81           CMP     #$81                ; 
8DA5: B0 08           BCS     $8DAF               ; {hard.MMC1_0+DAF}
...
8DAF: 60              RTS                         ; 
8DB0: C9 01           CMP     #$01                ; 
8DB2: D0 0A           BNE     $8DBE               ; {hard.MMC1_0+DBE}
8DB4: A5 63           LDA     <$63                ; {ram.0063}
8DB6: D0 14           BNE     $8DCC               ; {hard.MMC1_0+DCC}
8DB8: E6 AD           INC     <$AD                ; {ram.00AD}
8DBA: A9 50           LDA     #$50                ; 
8DBC: 85 29           STA     <$29                ; {ram.0029}
8DBE: C9 02           CMP     #$02                ; 
8DC0: D0 20           BNE     $8DE2               ; {hard.MMC1_0+DE2}
8DC2: A5 29           LDA     <$29                ; {ram.0029}
8DC4: D0 06           BNE     $8DCC               ; {hard.MMC1_0+DCC}
...
8DD6: 20 13 F2        JSR     $F213               ; {hard.MMC1_3+1213}
8DD9: 68              PLA                         ; 
8DDA: 85 AC           STA     <$AC                ; {ram.00AC}
8DDC: 20 EA 8D        JSR     $8DEA               ; {hard.MMC1_0+DEA}
8DDF: AE 40 03        LDX     $0340               ; {ram.0340}
8DE2: 60              RTS                         ; 
8DE3: 14                              ;
8DE4: 10 0C           BPL     $8DF2               ; {hard.MMC1_0+DF2}
8DE6: 08              PHP                         ; 
8DE7: 04                              ;
8DE8: 00              BRK                         ; 
8DE9: 1C                              ;
...
8DEE: D0 2B           BNE     $8E1B               ; {hard.MMC1_0+E1B}
8DF0: E0 02           CPX     #$02                ; 
8DF2: F0 11           BEQ     $8E05               ; {hard.MMC1_0+E05}
8DF4: A5 AE           LDA     <$AE                ; {ram.00AE}
8DF6: F0 F4           BEQ     $8DEC               ; {hard.MMC1_0+DEC}
8DF8: 8A              TXA                         ; 
8DF9: 38              SEC                         ; 
8DFA: E9 03           SBC     #$03                ; 
8DFC: A8              TAY                         ; 
8DFD: AD 96 03        LDA     $0396               ; {ram.0396}
8E00: D9 E3 8D        CMP     $8DE3,Y             ; {hard.MMC1_0+DE3}
8E03: D0 37           BNE     $8E3C               ; {hard.MMC1_0+E3C}
...
8E1F: A9 60           LDA     #$60                ; 
8E21: 20 59 B4        JSR     $B459               ; {hard.MMC1_1+1459}
8E24: A9 06           LDA     #$06                ; 
8E26: A8              TAY                         ; 
8E27: 20 BD B3        JSR     $B3BD               ; {hard.MMC1_1+13BD}
8E2A: 95 84           STA     $84,X               ; {ram.0084}
8E2C: 8A              TXA                         ; 
8E2D: 48              PHA                         ; 
8E2E: 20 86 79        JSR     $7986               ; {ram.7986}
8E31: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
...
8E3C: E8              INX                         ; 
8E3D: E0 0A           CPX     #$0A                ; 
8E3F: D0 AB           BNE     $8DEC               ; {hard.MMC1_0+DEC}
8E41: 60              RTS                         ; 
8E42: 08              PHP                         ; 
8E43: 04                              ;
8E44: B5 AC           LDA     $AC,X               ; {ram.00AC}
8E46: D0 4A           BNE     $8E92               ; {hard.MMC1_0+E92}
8E48: BD 4F 03        LDA     $034F,X             ; {ram.034F}
8E4B: C9 65           CMP     #$65                ; 
8E4D: F0 05           BEQ     $8E54               ; {hard.MMC1_0+E54}
8E4F: AD 65 06        LDA     $0665               ; {ram.0665}
8E52: F0 3D           BEQ     $8E91               ; {hard.MMC1_0+E91}
8E54: 20 5A 8F        JSR     $8F5A               ; {hard.MMC1_0+F5A}
8E57: B0 38           BCS     $8E91               ; {hard.MMC1_0+E91}
8E59: A5 70           LDA     <$70                ; {ram.0070}
8E5B: D5 70           CMP     $70,X               ; {ram.0070}
8E5D: D0 32           BNE     $8E91               ; {hard.MMC1_0+E91}
8E5F: A0 00           LDY     #$00                ; 
...
8E69: 10 06           BPL     $8E71               ; {hard.MMC1_0+E71}
8E6B: C8              INY                         ; 
8E6C: 49 FF           EOR     #$FF                ; 
8E6E: 18              CLC                         ; 
8E6F: 69 01           ADC     #$01                ; 
8E71: C9 11           CMP     #$11                ; 
8E73: B0 1C           BCS     $8E91               ; {hard.MMC1_0+E91}
8E75: AD F8 03        LDA     $03F8               ; {ram.03F8}
8E78: 29 0C           AND     #$0C                ; 
8E7A: F0 15           BEQ     $8E91               ; {hard.MMC1_0+E91}
8E7C: D9 42 8E        CMP     $8E42,Y             ; {hard.MMC1_0+E42}
8E7F: D0 10           BNE     $8E91               ; {hard.MMC1_0+E91}
...
8E8C: A9 26           LDA     #$26                ; 
8E8E: 20 62 E8        JSR     $E862               ; {hard.MMC1_2+2862}
8E91: 60              RTS                         ; 
8E92: B5 98           LDA     $98,X               ; {ram.0098}
8E94: 85 0F           STA     <$0F                ; {ram.000F}
8E96: 20 8D F0        JSR     $F08D               ; {hard.MMC1_3+108D}
8E99: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
8E9C: C6 01           DEC     <$01                ; {ram.GP_01}
8E9E: 20 DF 77        JSR     $77DF               ; {ram.77DF}
8EA1: BD 94 03        LDA     $0394,X             ; {ram.0394}
8EA4: C9 10           CMP     #$10                ; 
8EA6: F0 04           BEQ     $8EAC               ; {hard.MMC1_0+EAC}
8EA8: C9 F0           CMP     #$F0                ; 
8EAA: D0 E5           BNE     $8E91               ; {hard.MMC1_0+E91}
8EAC: A5 EB           LDA     <$EB                ; {ram.00EB}
8EAE: 48              PHA                         ; 
8EAF: BD 12 04        LDA     $0412,X             ; {ram.0412}
8EB2: 85 EB           STA     <$EB                ; {ram.00EB}
8EB4: 20 C6 E6        JSR     $E6C6               ; {hard.MMC1_2+26C6}
8EB7: 68              PLA                         ; 
8EB8: 85 EB           STA     <$EB                ; {ram.00EB}
8EBA: A9 C8           LDA     #$C8                ; 
8EBC: BC 4F 03        LDY     $034F,X             ; {ram.034F}
8EBF: C0 62           CPY     #$62                ; 
8EC1: F0 08           BEQ     $8ECB               ; {hard.MMC1_0+ECB}
8EC3: A9 BC           LDA     #$BC                ; 
8EC5: C0 65           CPY     #$65                ; 
8EC7: F0 02           BEQ     $8ECB               ; {hard.MMC1_0+ECB}
8EC9: A9 C0           LDA     #$C0                ; 
8ECB: E6 F7           INC     <$F7                ; {ram.00F7}
8ECD: 20 62 E8        JSR     $E862               ; {hard.MMC1_2+2862}
8ED0: A9 70           LDA     #$70                ; 
...
8EE2: 20 62 E8        JSR     $E862               ; {hard.MMC1_2+2862}
8EE5: 20 5F B1        JSR     $B15F               ; {hard.MMC1_1+115F}
8EE8: 4C 81 90        JMP     $9081               ; {hard.MMC1_0+1081}
8EEB: 20 5A 8F        JSR     $8F5A               ; {hard.MMC1_0+F5A}
8EEE: B0 1D           BCS     $8F0D               ; {hard.MMC1_0+F0D}
8EF0: A0 10           LDY     #$10                ; 
8EF2: B9 AC 00        LDA     $00AC,Y             ; {ram.00AC}
8EF5: C9 13           CMP     #$13                ; 
8EF7: F0 08           BEQ     $8F01               ; {hard.MMC1_0+F01}
8EF9: C8              INY                         ; 
8EFA: B9 AC 00        LDA     $00AC,Y             ; {ram.00AC}
8EFD: C9 13           CMP     #$13                ; 
8EFF: D0 0C           BNE     $8F0D               ; {hard.MMC1_0+F0D}
8F01: 84 00           STY     <$00                ; {ram.GP_00}
8F03: 20 3F 8F        JSR     $8F3F               ; {hard.MMC1_0+F3F}
8F06: F0 05           BEQ     $8F0D               ; {hard.MMC1_0+F0D}
8F08: A9 24           LDA     #$24                ; 
8F0A: 20 34 8F        JSR     $8F34               ; {hard.MMC1_0+F34}
8F0D: 60              RTS                         ; 
8F0E: 20 5A 8F        JSR     $8F5A               ; {hard.MMC1_0+F5A}
8F11: B0 2B           BCS     $8F3E               ; {hard.MMC1_0+F3E}
8F13: A0 10           LDY     #$10                ; 
8F15: B9 AC 00        LDA     $00AC,Y             ; {ram.00AC}
8F18: C9 22           CMP     #$22                ; 
8F1A: F0 08           BEQ     $8F24               ; {hard.MMC1_0+F24}
8F1C: C8              INY                         ; 
8F1D: B9 AC 00        LDA     $00AC,Y             ; {ram.00AC}
8F20: C9 22           CMP     #$22                ; 
8F22: D0 1A           BNE     $8F3E               ; {hard.MMC1_0+F3E}
8F24: 84 00           STY     <$00                ; {ram.GP_00}
8F26: B9 28 00        LDA     $0028,Y             ; {ram.0028}
8F29: C9 02           CMP     #$02                ; 
8F2B: B0 11           BCS     $8F3E               ; {hard.MMC1_0+F3E}
8F2D: 20 3F 8F        JSR     $8F3F               ; {hard.MMC1_0+F3F}
8F30: F0 0C           BEQ     $8F3E               ; {hard.MMC1_0+F3E}
8F32: A9 70           LDA     #$70                ; 
8F34: 20 E0 8E        JSR     $8EE0               ; {hard.MMC1_0+EE0}
8F37: 20 CE E6        JSR     $E6CE               ; {hard.MMC1_2+26CE}
8F3A: 09 80           ORA     #$80                ; 
...
8F61: 4A              LSR     A                   ; 
8F62: 4A              LSR     A                   ; 
8F63: F0 0D           BEQ     $8F72               ; {hard.MMC1_0+F72}
8F65: A8              TAY                         ; 
8F66: B9 57 8F        LDA     $8F57,Y             ; {hard.MMC1_0+F57}
8F69: A4 16           LDY     <$16                ; {ram.0016}
8F6B: D9 2D 06        CMP     $062D,Y             ; 
8F6E: F0 02           BEQ     $8F72               ; {hard.MMC1_0+F72}
8F70: 38              SEC                         ; 
8F71: 60              RTS                         ; 
8F72: 18              CLC                         ; 
8F73: 60              RTS                         ; 
...
8F79: F0 34           BEQ     $8FAF               ; {hard.MMC1_0+FAF}
8F7B: B5 AC           LDA     $AC,X               ; {ram.00AC}
8F7D: D0 31           BNE     $8FB0               ; {hard.MMC1_0+FB0}
8F7F: A9 80           LDA     #$80                ; 
8F81: A4 EB           LDY     <$EB                ; {ram.00EB}
8F83: C0 55           CPY     #$55                ; 
8F85: F0 02           BEQ     $8F89               ; {hard.MMC1_0+F89}
8F87: A9 60           LDA     #$60                ; 
8F89: C5 70           CMP     <$70                ; {ram.0070}
8F8B: D0 22           BNE     $8FAF               ; {hard.MMC1_0+FAF}
8F8D: 95 70           STA     $70,X               ; {ram.0070}
8F8F: A0 01           LDY     #$01                ; 
8F91: A5 84           LDA     <$84                ; {ram.0084}
8F93: C9 3D           CMP     #$3D                ; 
8F95: F0 05           BEQ     $8F9C               ; {hard.MMC1_0+F9C}
8F97: C8              INY                         ; 
8F98: C9 7D           CMP     #$7D                ; 
8F9A: D0 13           BNE     $8FAF               ; {hard.MMC1_0+FAF}
8F9C: 94 AC           STY     $AC,X               ; {ram.00AC}
8F9E: 18              CLC                         ; 
8F9F: 69 06           ADC     #$06                ; 
8FA1: 95 84           STA     $84,X               ; {ram.0084}
8FA3: 20 81 90        JSR     $9081               ; {hard.MMC1_0+1081}
8FA6: A9 40           LDA     #$40                ; 
8FA8: 85 AC           STA     <$AC                ; {ram.00AC}
8FAA: B9 73 8F        LDA     $8F73,Y             ; {hard.MMC1_0+F73}
8FAD: 85 98           STA     <$98                ; {ram.0098}
8FAF: 60              RTS                         ; 
8FB0: B4 AC           LDY     $AC,X               ; {ram.00AC}
8FB2: 88              DEY                         ; 
8FB3: F0 14           BEQ     $8FC9               ; {hard.MMC1_0+FC9}
8FB5: D6 84           DEC     $84,X               ; {ram.0084}
8FB7: C6 84           DEC     <$84                ; {ram.0084}
8FB9: A5 84           LDA     <$84                ; {ram.0084}
8FBB: C9 3D           CMP     #$3D                ; 
8FBD: D0 1F           BNE     $8FDE               ; {hard.MMC1_0+FDE}
8FBF: 8A              TXA                         ; 
8FC0: 48              PHA                         ; 
8FC1: 20 82 F1        JSR     $F182               ; {hard.MMC1_3+1182}
8FC4: 68              PLA                         ; 
8FC5: AA              TAX                         ; 
8FC6: 4C D8 8F        JMP     $8FD8               ; {hard.MMC1_0+FD8}
8FC9: F6 84           INC     $84,X               ; {ram.0084}
8FCB: E6 84           INC     <$84                ; {ram.0084}
8FCD: A5 84           LDA     <$84                ; {ram.0084}
8FCF: C9 7F           CMP     #$7F                ; 
8FD1: D0 0B           BNE     $8FDE               ; {hard.MMC1_0+FDE}
8FD3: A9 02           LDA     #$02                ; 
...
8FDE: 8A              TXA                         ; 
8FDF: 48              PHA                         ; 
8FE0: 20 13 F2        JSR     $F213               ; {hard.MMC1_3+1213}
8FE3: 68              PLA                         ; 
8FE4: AA              TAX                         ; 
8FE5: 20 4F FA        JSR     $FA4F               ; {hard.MMC1_3+1A4F}
8FE8: A9 00           LDA     #$00                ; 
8FEA: A0 09           LDY     #$09                ; 
8FEC: 4C 0C 79        JMP     $790C               ; {ram.790C}
8FEF: AD 6C 06        LDA     $066C               ; {ram.066C}
8FF2: D0 06           BNE     $8FFA               ; {hard.MMC1_0+FFA}
8FF4: 20 05 90        JSR     $9005               ; {hard.MMC1_0+1005}
8FF7: 20 88 B2        JSR     $B288               ; {hard.MMC1_1+1288}
8FFA: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
8FFD: BD 37 04        LDA     $0437,X             ; {ram.0437}
9000: 29 01           AND     #$01                ; 
9002: 4C 8D 8C        JMP     $8C8D               ; {hard.MMC1_0+C8D}
9005: BD 44 04        LDA     $0444,X             ; 
9008: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
900B: 66 B2           ROR     <$B2                ; {ram.00B2}
900D: 17                              ;
900E: 90 08           BCC     $9018               ; {hard.MMC1_0+1018}
9010: B3                              ;
9011: 78              SEI                         ; 
9012: B3                              ;
9013: 60              RTS                         ; 
...
901B: C9 A0           CMP     #$A0                ; 
901D: B0 06           BCS     $9025               ; {hard.MMC1_0+1025}
901F: C8              INY                         ; 
9020: C9 08           CMP     #$08                ; 
9022: B0 01           BCS     $9025               ; {hard.MMC1_0+1025}
9024: C8              INY                         ; 
9025: 4C 77 90        JMP     $9077               ; {hard.MMC1_0+1077}
9028: B5 C0           LDA     $C0,X               ; {ram.00C0}
902A: F0 06           BEQ     $9032               ; {hard.MMC1_0+1032}
902C: 20 B8 EE        JSR     $EEB8               ; {hard.MMC1_2+2EB8}
902F: 4C 3F 90        JMP     $903F               ; {hard.MMC1_0+103F}
9032: AD 6C 06        LDA     $066C               ; {ram.066C}
9035: 15 3D           ORA     $3D,X               ; {ram.003D}
9037: D0 F6           BNE     $902F               ; {hard.MMC1_0+102F}
9039: 20 57 90        JSR     $9057               ; {hard.MMC1_0+1057}
903C: 20 88 B2        JSR     $B288               ; {hard.MMC1_1+1288}
903F: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
9042: BD 37 04        LDA     $0437,X             ; {ram.0437}
9045: 29 01           AND     #$01                ; 
9047: 20 DB 77        JSR     $77DB               ; {ram.77DB}
904A: BD 44 04        LDA     $0444,X             ; 
904D: C9 05           CMP     #$05                ; 
904F: F0 03           BEQ     $9054               ; {hard.MMC1_0+1054}
9051: 4C A7 7A        JMP     $7AA7               ; {ram.7AA7}
9054: 4C D0 79        JMP     $79D0               ; {ram.79D0}
9057: BD 44 04        LDA     $0444,X             ; 
905A: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
...
906D: C9 B0           CMP     #$B0                ; 
906F: B0 06           BCS     $9077               ; {hard.MMC1_0+1077}
9071: C8              INY                         ; 
9072: C9 20           CMP     #$20                ; 
9074: B0 01           BCS     $9077               ; {hard.MMC1_0+1077}
9076: C8              INY                         ; 
9077: 98              TYA                         ; 
...
90DF: 04                              ;
90E0: 00              BRK                         ; 
90E1: F0 3D           BEQ     $9120               ; {hard.MMC1_0+1120}
90E3: DD B5 AC        CMP     $ACB5,X             ; {hard.MMC1_1+CB5}
90E6: F0 03           BEQ     $90EB               ; {hard.MMC1_0+10EB}
90E8: 4C 7D 91        JMP     $917D               ; {hard.MMC1_0+117D}
90EB: A5 29           LDA     <$29                ; {ram.0029}
90ED: D0 06           BNE     $90F5               ; {hard.MMC1_0+10F5}
90EF: A5 AC           LDA     <$AC                ; {ram.00AC}
90F1: C9 40           CMP     #$40                ; 
90F3: D0 01           BNE     $90F6               ; {hard.MMC1_0+10F6}
90F5: 60              RTS                         ; 
90F6: A5 70           LDA     <$70                ; {ram.0070}
90F8: C9 29           CMP     #$29                ; 
90FA: 90 04           BCC     $9100               ; {hard.MMC1_0+1100}
90FC: C9 C8           CMP     #$C8                ; 
90FE: 90 0A           BCC     $910A               ; {hard.MMC1_0+110A}
9100: A5 84           LDA     <$84                ; {ram.0084}
9102: C9 6D           CMP     #$6D                ; 
9104: 90 EF           BCC     $90F5               ; {hard.MMC1_0+10F5}
9106: C9 B5           CMP     #$B5                ; 
9108: B0 EB           BCS     $90F5               ; {hard.MMC1_0+10F5}
910A: A5 70           LDA     <$70                ; {ram.0070}
910C: C9 20           CMP     #$20                ; 
910E: F0 04           BEQ     $9114               ; {hard.MMC1_0+1114}
9110: C9 D0           CMP     #$D0                ; 
9112: D0 1D           BNE     $9131               ; {hard.MMC1_0+1131}
...
9120: A0 20           LDY     #$20                ; 
9122: A9 00           LDA     #$00                ; 
9124: 20 62 92        JSR     $9262               ; {hard.MMC1_0+1262}
9127: A5 04           LDA     <$04                ; {ram.0004}
9129: 95 84           STA     $84,X               ; {ram.0084}
912B: B9 E0 90        LDA     $90E0,Y             ; {hard.MMC1_0+10E0}
912E: 4C 55 91        JMP     $9155               ; {hard.MMC1_0+1155}
9131: A5 84           LDA     <$84                ; {ram.0084}
9133: C9 5D           CMP     #$5D                ; 
9135: F0 04           BEQ     $913B               ; {hard.MMC1_0+113B}
9137: C9 BD           CMP     #$BD                ; 
9139: D0 BA           BNE     $90F5               ; {hard.MMC1_0+10F5}
...
9147: A0 5D           LDY     #$5D                ; 
9149: A9 20           LDA     #$20                ; 
914B: 20 62 92        JSR     $9262               ; {hard.MMC1_0+1262}
914E: B9 E2 90        LDA     $90E2,Y             ; {hard.MMC1_0+10E2}
9151: 95 84           STA     $84,X               ; {ram.0084}
9153: A5 04           LDA     <$04                ; {ram.0004}
9155: 95 70           STA     $70,X               ; {ram.0070}
9157: BC 12 04        LDY     $0412,X             ; {ram.0412}
915A: B9 A0 90        LDA     $90A0,Y             ; {hard.MMC1_0+10A0}
915D: 29 0F           AND     #$0F                ; 
...
917F: F0 06           BEQ     $9187               ; {hard.MMC1_0+1187}
9181: 20 B8 EE        JSR     $EEB8               ; {hard.MMC1_2+2EB8}
9184: 4C D3 91        JMP     $91D3               ; {hard.MMC1_0+11D3}
9187: AD 6C 06        LDA     $066C               ; {ram.066C}
918A: 15 3D           ORA     $3D,X               ; {ram.003D}
918C: D0 F6           BNE     $9184               ; {hard.MMC1_0+1184}
918E: B5 98           LDA     $98,X               ; {ram.0098}
9190: 85 0F           STA     <$0F                ; {ram.000F}
9192: 20 8D F0        JSR     $F08D               ; {hard.MMC1_3+108D}
9195: BD 94 03        LDA     $0394,X             ; {ram.0394}
9198: C9 10           CMP     #$10                ; 
919A: F0 04           BEQ     $91A0               ; {hard.MMC1_0+11A0}
919C: C9 F0           CMP     #$F0                ; 
919E: D0 33           BNE     $91D3               ; {hard.MMC1_0+11D3}
91A0: A9 00           LDA     #$00                ; 
91A2: 9D 94 03        STA     $0394,X             ; {ram.0394}
91A5: FE 12 04        INC     $0412,X             ; {ram.0412}
91A8: BC 12 04        LDY     $0412,X             ; {ram.0412}
91AB: B9 A0 90        LDA     $90A0,Y             ; {hard.MMC1_0+10A0}
91AE: 29 0F           AND     #$0F                ; 
91B0: 95 98           STA     $98,X               ; {ram.0098}
91B2: FE 1F 04        INC     $041F,X             ; {ram.041F}
91B5: BD 1F 04        LDA     $041F,X             ; {ram.041F}
91B8: C9 07           CMP     #$07                ; 
91BA: 90 17           BCC     $91D3               ; {hard.MMC1_0+11D3}
91BC: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
91BF: F0 0F           BEQ     $91D0               ; {hard.MMC1_0+11D0}
91C1: 20 8A 82        JSR     $828A               ; {hard.MMC1_0+28A}
91C4: A9 03           LDA     #$03                ; 
...
91D6: D0 45           BNE     $921D               ; {hard.MMC1_0+121D}
91D8: 20 D0 79        JSR     $79D0               ; {ram.79D0}
91DB: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
91DE: F0 08           BEQ     $91E8               ; {hard.MMC1_0+11E8}
91E0: A9 40           LDA     #$40                ; 
...
91EB: 48              PHA                         ; 
91EC: 20 42 92        JSR     $9242               ; {hard.MMC1_0+1242}
...
9225: 20 13 F2        JSR     $F213               ; {hard.MMC1_3+1213}
9228: 20 FB 6E        JSR     $6EFB               ; {ram.6EFB}
922B: AE 40 03        LDX     $0340               ; {ram.0340}
922E: 20 42 92        JSR     $9242               ; {hard.MMC1_0+1242}
9231: A9 01           LDA     #$01                ; 
9233: 9D E4 03        STA     $03E4,X             ; {ram.03E4}
9236: 20 93 82        JSR     $8293               ; {hard.MMC1_0+293}
9239: A9 40           LDA     #$40                ; 
923B: 85 00           STA     <$00                ; {ram.GP_00}
923D: A9 44           LDA     #$44                ; 
923F: 4C FF 91        JMP     $91FF               ; {hard.MMC1_0+11FF}
9242: A9 08           LDA     #$08                ; 
9244: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
9247: BC 12 04        LDY     $0412,X             ; {ram.0412}
924A: B9 A0 90        LDA     $90A0,Y             ; {hard.MMC1_0+10A0}
924D: 29 F0           AND     #$F0                ; 
924F: 09 01           ORA     #$01                ; 
9251: 20 88 79        JSR     $7988               ; {ram.7988}
9254: 29 40           AND     #$40                ; 
9256: F0 09           BEQ     $9261               ; {hard.MMC1_0+1261}
...
926C: F0 02           BEQ     $9270               ; {hard.MMC1_0+1270}
926E: A9 32           LDA     #$32                ; 
9270: A4 98           LDY     <$98                ; {ram.0098}
9272: C4 02           CPY     <$02                ; {ram.GP_02}
9274: D0 10           BNE     $9286               ; {hard.MMC1_0+1286}
9276: 48              PHA                         ; 
...
9291: F0 0A           BEQ     $929D               ; {hard.MMC1_0+129D}
...
92A0: 20 A5 92        JSR     $92A5               ; {hard.MMC1_0+12A5}
...
934D: F0 07           BEQ     $9356               ; {hard.MMC1_0+1356}
...
9367: C9 08           CMP     #$08                ; 
9369: B0 CC           BCS     $9337               ; {hard.MMC1_0+1337}
936B: A9 02           LDA     #$02                ; 
936D: 95 98           STA     $98,X               ; {ram.0098}
936F: A5 70           LDA     <$70                ; {ram.0070}
9371: D5 70           CMP     $70,X               ; {ram.0070}
9373: B0 BB           BCS     $9330               ; {hard.MMC1_0+1330}
9375: 90 BB           BCC     $9332               ; {hard.MMC1_0+1332}
9377: A9 80           LDA     #$80                ; 
9379: 20 6E 80        JSR     $806E               ; {hard.MMC1_0+6E}
937C: 20 D0 79        JSR     $79D0               ; {ram.79D0}
937F: A9 08           LDA     #$08                ; 
9381: 20 76 84        JSR     $8476               ; {hard.MMC1_0+476}
9384: A9 20           LDA     #$20                ; 
9386: 85 01           STA     <$01                ; {ram.GP_01}
9388: A4 16           LDY     <$16                ; {ram.0016}
938A: B9 2D 06        LDA     $062D,Y             ; 
938D: F0 52           BEQ     $93E1               ; {hard.MMC1_0+13E1}
938F: BD 51 04        LDA     $0451,X             ; 
9392: D0 06           BNE     $939A               ; {hard.MMC1_0+139A}
9394: B5 18           LDA     $18,X               ; {ram.0018}
9396: C9 F8           CMP     #$F8                ; 
9398: 90 47           BCC     $93E1               ; {hard.MMC1_0+13E1}
939A: A5 01           LDA     <$01                ; {ram.GP_01}
939C: 48              PHA                         ; 
939D: A0 00           LDY     #$00                ; 
939F: BD F0 04        LDA     $04F0,X             ; {ram.04F0}
93A2: D0 0D           BNE     $93B1               ; {hard.MMC1_0+13B1}
93A4: BC 51 04        LDY     $0451,X             ; 
93A7: 88              DEY                         ; 
93A8: 10 07           BPL     $93B1               ; {hard.MMC1_0+13B1}
93AA: BD 12 04        LDA     $0412,X             ; {ram.0412}
93AD: F0 2E           BEQ     $93DD               ; {hard.MMC1_0+13DD}
93AF: A0 30           LDY     #$30                ; 
93B1: 98              TYA                         ; 
93B2: 9D 51 04        STA     $0451,X             ; 
93B5: F0 26           BEQ     $93DD               ; {hard.MMC1_0+13DD}
93B7: C0 10           CPY     #$10                ; 
93B9: D0 1E           BNE     $93D9               ; {hard.MMC1_0+13D9}
93BB: AD 6C 06        LDA     $066C               ; {ram.066C}
93BE: 15 3D           ORA     $3D,X               ; {ram.003D}
93C0: D0 17           BNE     $93D9               ; {hard.MMC1_0+13D9}
93C2: A9 57           LDA     #$57                ; 
93C4: 85 00           STA     <$00                ; {ram.GP_00}
93C6: 20 79 B1        JSR     $B179               ; {hard.MMC1_1+1179}
93C9: 90 07           BCC     $93D2               ; {hard.MMC1_0+13D2}
93CB: A9 80           LDA     #$80                ; 
93CD: 95 28           STA     $28,X               ; {ram.0028}
93CF: DE 37 04        DEC     $0437,X             ; {ram.0437}
93D2: 90 09           BCC     $93DD               ; {hard.MMC1_0+13DD}
93D4: A9 00           LDA     #$00                ; 
...
9417: 88              DEY                         ; 
9418: 10 CA           BPL     $93E4               ; {hard.MMC1_0+13E4}
941A: A5 1D           LDA     <$1D                ; {ram.001D}
941C: 29 07           AND     #$07                ; 
941E: A8              TAY                         ; 
941F: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
9422: 85 9D           STA     <$9D                ; {ram.009D}
9424: 8D 85 03        STA     $0385               ; {ram.0385}
9427: A5 22           LDA     <$22                ; {ram.0022}
9429: 29 07           AND     #$07                ; 
942B: A8              TAY                         ; 
942C: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
...
9461: 29 07           AND     #$07                ; 
9463: A8              TAY                         ; 
9464: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
...
9478: 60              RTS                         ; 
9479: 20 5A 94        JSR     $945A               ; {hard.MMC1_0+145A}
947C: A9 38           LDA     #$38                ; 
...
9490: C9 80           CMP     #$80                ; 
9492: 90 01           BCC     $9495               ; {hard.MMC1_0+1495}
9494: C8              INY                         ; 
9495: 94 98           STY     $98,X               ; {ram.0098}
9497: 60              RTS                         ; 
9498: B5 98           LDA     $98,X               ; {ram.0098}
949A: F0 65           BEQ     $9501               ; {hard.MMC1_0+1501}
949C: AD 6C 06        LDA     $066C               ; {ram.066C}
949F: D0 06           BNE     $94A7               ; {hard.MMC1_0+14A7}
94A1: 20 02 95        JSR     $9502               ; {hard.MMC1_0+1502}
94A4: 20 88 B2        JSR     $B288               ; {hard.MMC1_1+1288}
94A7: A9 02           LDA     #$02                ; 
...
94C2: F0 3D           BEQ     $9501               ; {hard.MMC1_0+1501}
94C4: A9 20           LDA     #$20                ; 
94C6: 9D 85 04        STA     $0485,X             ; 
94C9: 20 9A 97        JSR     $979A               ; {hard.MMC1_0+179A}
94CC: A0 FF           LDY     #$FF                ; 
94CE: E0 06           CPX     #$06                ; 
94D0: 90 02           BCC     $94D4               ; {hard.MMC1_0+14D4}
94D2: A0 04           LDY     #$04                ; 
94D4: C8              INY                         ; 
94D5: B9 50 03        LDA     $0350,Y             ; {ram.0350}
94D8: C9 41           CMP     #$41                ; 
94DA: D0 F8           BNE     $94D4               ; {hard.MMC1_0+14D4}
94DC: A9 11           LDA     #$11                ; 
...
94F1: C0 04           CPY     #$04                ; 
94F3: F0 0C           BEQ     $9501               ; {hard.MMC1_0+1501}
94F5: C0 09           CPY     #$09                ; 
94F7: F0 08           BEQ     $9501               ; {hard.MMC1_0+1501}
94F9: A9 5D           LDA     #$5D                ; 
94FB: 99 50 03        STA     $0350,Y             ; {ram.0350}
94FE: 20 DA FE        JSR     $FEDA               ; {hard.MMC1_3+1EDA}
9501: 60              RTS                         ; 
9502: BD 44 04        LDA     $0444,X             ; 
9505: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
9508: 10 95           BPL     $949F               ; {hard.MMC1_0+149F}
950A: 10 95           BPL     $94A1               ; {hard.MMC1_0+14A1}
950C: 10 95           BPL     $94A3               ; {hard.MMC1_0+14A3}
950E: 2B                              ;
950F: 95 E0           STA     $E0,X               ; {ram.??SND_E0??}
9511: 05 F0           ORA     <$F0                ; {ram.00F0}
9513: 04                              ;
9514: E0 0A           CPX     #$0A                ; 
9516: D0 53           BNE     $956B               ; {hard.MMC1_0+156B}
9518: 20 08 B3        JSR     $B308               ; {hard.MMC1_1+1308}
951B: B5 28           LDA     $28,X               ; {ram.0028}
951D: D0 1B           BNE     $953A               ; {hard.MMC1_0+153A}
951F: 20 6C 95        JSR     $956C               ; {hard.MMC1_0+156C}
9522: A9 10           LDA     #$10                ; 
9524: 95 28           STA     $28,X               ; {ram.0028}
9526: B5 97           LDA     $97,X               ; {ram.0097}
9528: D0 10           BNE     $953A               ; {hard.MMC1_0+153A}
952A: 60              RTS                         ; 
952B: E0 05           CPX     #$05                ; 
952D: F0 04           BEQ     $9533               ; {hard.MMC1_0+1533}
952F: E0 0A           CPX     #$0A                ; 
9531: D0 38           BNE     $956B               ; {hard.MMC1_0+156B}
9533: 20 78 B3        JSR     $B378               ; {hard.MMC1_1+1378}
9536: B5 28           LDA     $28,X               ; {ram.0028}
9538: F0 E5           BEQ     $951F               ; {hard.MMC1_0+151F}
953A: B5 28           LDA     $28,X               ; {ram.0028}
953C: C9 10           CMP     #$10                ; 
953E: D0 2B           BNE     $956B               ; {hard.MMC1_0+156B}
9540: BD BC 03        LDA     $03BC,X             ; {ram.03BC}
9543: F0 07           BEQ     $954C               ; {hard.MMC1_0+154C}
...
9550: A0 00           LDY     #$00                ; 
9552: E0 05           CPX     #$05                ; 
9554: F0 02           BEQ     $9558               ; {hard.MMC1_0+1558}
9556: A0 05           LDY     #$05                ; 
...
9564: D0 F2           BNE     $9558               ; {hard.MMC1_0+1558}
...
9570: C9 40           CMP     #$40                ; 
9572: B0 01           BCS     $9575               ; {hard.MMC1_0+1575}
9574: C8              INY                         ; 
9575: 98              TYA                         ; 
...
957E: 60              RTS                         ; 
957F: 00              BRK                         ; 
9580: 10 00           BPL     $9582               ; {hard.MMC1_0+1582}
9582: F0 00           BEQ     $9584               ; {hard.MMC1_0+1584}
9584: 10 F0           BPL     $9576               ; {hard.MMC1_0+1576}
9586: 10 88           BPL     $9510               ; {hard.MMC1_0+1510}
9588: D0 0F           BNE     $9599               ; {hard.MMC1_0+1599}
958A: BD 6B 04        LDA     $046B,X             ; 
958D: D0 6D           BNE     $95FC               ; {hard.MMC1_0+15FC}
958F: A9 40           LDA     #$40                ; 
9591: 95 28           STA     $28,X               ; {ram.0028}
9593: EE 1B 05        INC     $051B               ; {ram.051B}
9596: 4C 21 96        JMP     $9621               ; {hard.MMC1_0+1621}
9599: B5 28           LDA     $28,X               ; {ram.0028}
959B: F0 11           BEQ     $95AE               ; {hard.MMC1_0+15AE}
959D: 29 07           AND     #$07                ; 
959F: D0 0A           BNE     $95AB               ; {hard.MMC1_0+15AB}
95A1: BD 6B 04        LDA     $046B,X             ; 
95A4: 49 01           EOR     #$01                ; 
95A6: 9D 6B 04        STA     $046B,X             ; 
95A9: F0 76           BEQ     $9621               ; {hard.MMC1_0+1621}
95AB: 4C 58 96        JMP     $9658               ; {hard.MMC1_0+1658}
...
95BA: 48              PHA                         ; 
95BB: E8              INX                         ; 
95BC: 20 5A 94        JSR     $945A               ; {hard.MMC1_0+145A}
95BF: A9 18           LDA     #$18                ; 
...
95DB: D0 DE           BNE     $95BB               ; {hard.MMC1_0+15BB}
95DD: 68              PLA                         ; 
95DE: AA              TAX                         ; 
95DF: 20 10 B0        JSR     $B010               ; {hard.MMC1_1+1010}
95E2: A9 00           LDA     #$00                ; 
95E4: 9D 4F 03        STA     $034F,X             ; {ram.034F}
95E7: 4C 58 96        JMP     $9658               ; {hard.MMC1_0+1658}
95EA: 20 1A B3        JSR     $B31A               ; {hard.MMC1_1+131A}
95ED: 4C 10 96        JMP     $9610               ; {hard.MMC1_0+1610}
95F0: AD 6C 06        LDA     $066C               ; {ram.066C}
95F3: 15 3D           ORA     $3D,X               ; {ram.003D}
95F5: D0 1C           BNE     $9613               ; {hard.MMC1_0+1613}
95F7: AC 1B 05        LDY     $051B               ; {ram.051B}
95FA: D0 8B           BNE     $9587               ; {hard.MMC1_0+1587}
95FC: 20 8E 96        JSR     $968E               ; {hard.MMC1_0+168E}
95FF: B5 28           LDA     $28,X               ; {ram.0028}
9601: D0 0D           BNE     $9610               ; {hard.MMC1_0+1610}
9603: A9 10           LDA     #$10                ; 
9605: 95 28           STA     $28,X               ; {ram.0028}
9607: B5 18           LDA     $18,X               ; {ram.0018}
9609: C9 80           CMP     #$80                ; 
960B: B0 DD           BCS     $95EA               ; {hard.MMC1_0+15EA}
960D: 20 88 B3        JSR     $B388               ; {hard.MMC1_1+1388}
9610: 20 EB 96        JSR     $96EB               ; {hard.MMC1_0+16EB}
9613: BD 6B 04        LDA     $046B,X             ; 
9616: F0 09           BEQ     $9621               ; {hard.MMC1_0+1621}
9618: 20 CD B2        JSR     $B2CD               ; {hard.MMC1_1+12CD}
961B: 20 D0 79        JSR     $79D0               ; {ram.79D0}
961E: 4C 48 97        JMP     $9748               ; {hard.MMC1_0+1748}
...
967C: 20 48 97        JSR     $9748               ; {hard.MMC1_0+1748}
967F: 68              PLA                         ; 
...
96E5: F0 03           BEQ     $96EA               ; {hard.MMC1_0+16EA}
...
9706: F0 07           BEQ     $970F               ; {hard.MMC1_0+170F}
...
9715: F0 06           BEQ     $971D               ; {hard.MMC1_0+171D}
...
9723: F0 06           BEQ     $972B               ; {hard.MMC1_0+172B}
...
9731: F0 06           BEQ     $9739               ; {hard.MMC1_0+1739}
9733: B5 84           LDA     $84,X               ; {ram.0084}
9735: E5 03           SBC     <$03                ; {ram.GP_03}
9737: 95 84           STA     $84,X               ; {ram.0084}
9739: 4C 93 FA        JMP     $FA93               ; {hard.MMC1_3+1A93}
973C: 00              BRK                         ; 
973D: 10 00           BPL     $973F               ; {hard.MMC1_0+173F}
973F: 10 00           BPL     $9741               ; {hard.MMC1_0+1741}
9741: 00              BRK                         ; 
9742: 10 10           BPL     $9754               ; {hard.MMC1_0+1754}
9744: 03                              ;
9745: 03                              ;
9746: 83                              ;
9747: 83                              ;
9748: A9 06           LDA     #$06                ; 
974A: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
974D: BD 6B 04        LDA     $046B,X             ; 
9750: D0 2B           BNE     $977D               ; {hard.MMC1_0+177D}
9752: A0 00           LDY     #$00                ; 
9754: B5 70           LDA     $70,X               ; {ram.0070}
9756: 18              CLC                         ; 
9757: 79 3C 97        ADC     $973C,Y             ; {hard.MMC1_0+173C}
975A: 85 00           STA     <$00                ; {ram.GP_00}
975C: B5 84           LDA     $84,X               ; {ram.0084}
975E: 18              CLC                         ; 
975F: 79 40 97        ADC     $9740,Y             ; {hard.MMC1_0+1740}
9762: 85 01           STA     <$01                ; {ram.GP_01}
9764: B9 44 97        LDA     $9744,Y             ; {hard.MMC1_0+1744}
...
9777: C8              INY                         ; 
9778: C0 04           CPY     #$04                ; 
977A: D0 D8           BNE     $9754               ; {hard.MMC1_0+1754}
977C: 60              RTS                         ; 
977D: 20 FB 9A        JSR     $9AFB               ; {hard.MMC1_0+1AFB}
9780: BD E4 03        LDA     $03E4,X             ; {ram.03E4}
9783: 4C DB 77        JMP     $77DB               ; {ram.77DB}
9786: AD 6C 06        LDA     $066C               ; {ram.066C}
9789: D0 06           BNE     $9791               ; {hard.MMC1_0+1791}
978B: 20 A2 97        JSR     $97A2               ; {hard.MMC1_0+17A2}
978E: 20 EF 97        JSR     $97EF               ; {hard.MMC1_0+17EF}
9791: 20 4C 98        JSR     $984C               ; {hard.MMC1_0+184C}
9794: 20 D0 79        JSR     $79D0               ; {ram.79D0}
9797: 20 00 80        JSR     $8000               ; {hard.MMC1_0}
979A: 20 0D 80        JSR     $800D               ; {hard.MMC1_0+D}
979D: 4C E4 EE        JMP     $EEE4               ; {hard.MMC1_2+2EE4}
97A0: 01 FF           ORA     ($FF,X)             ; {ram.CUR_2000}
97A2: BD 94 03        LDA     $0394,X             ; {ram.0394}
97A5: D0 12           BNE     $97B9               ; {hard.MMC1_0+17B9}
...
97BB: 29 07           AND     #$07                ; 
97BD: D0 2F           BNE     $97EE               ; {hard.MMC1_0+17EE}
97BF: B5 70           LDA     $70,X               ; {ram.0070}
97C1: C9 88           CMP     #$88                ; 
97C3: B0 0A           BCS     $97CF               ; {hard.MMC1_0+17CF}
97C5: A9 88           LDA     #$88                ; 
97C7: 95 70           STA     $70,X               ; {ram.0070}
97C9: A9 01           LDA     #$01                ; 
97CB: 95 98           STA     $98,X               ; {ram.0098}
97CD: D0 0C           BNE     $97DB               ; {hard.MMC1_0+17DB}
97CF: C9 C8           CMP     #$C8                ; 
97D1: 90 0D           BCC     $97E0               ; {hard.MMC1_0+17E0}
97D3: A9 C7           LDA     #$C7                ; 
...
97E5: 18              CLC                         ; 
97E6: 79 A0 97        ADC     $97A0,Y             ; {hard.MMC1_0+17A0}
97E9: 95 70           STA     $70,X               ; {ram.0070}
97EB: DE 94 03        DEC     $0394,X             ; {ram.0394}
97EE: 60              RTS                         ; 
97EF: B5 28           LDA     $28,X               ; {ram.0028}
97F1: D0 1F           BNE     $9812               ; {hard.MMC1_0+1812}
97F3: B5 18           LDA     $18,X               ; {ram.0018}
97F5: 09 70           ORA     #$70                ; 
97F7: 95 28           STA     $28,X               ; {ram.0028}
97F9: 20 2F 98        JSR     $982F               ; {hard.MMC1_0+182F}
97FC: A9 00           LDA     #$00                ; 
97FE: 99 78 04        STA     $0478,Y             ; 
9801: 20 2F 98        JSR     $982F               ; {hard.MMC1_0+182F}
9804: A9 01           LDA     #$01                ; 
9806: 99 78 04        STA     $0478,Y             ; 
9809: 20 2F 98        JSR     $982F               ; {hard.MMC1_0+182F}
980C: A9 FF           LDA     #$FF                ; 
...
9817: C9 55           CMP     #$55                ; 
9819: D0 0D           BNE     $9828               ; {hard.MMC1_0+1828}
981B: A5 15           LDA     <$15                ; {ram.0015}
981D: 4A              LSR     A                   ; 
981E: B0 08           BCS     $9828               ; {hard.MMC1_0+1828}
9820: B5 84           LDA     $84,X               ; {ram.0084}
9822: 18              CLC                         ; 
9823: 7D 78 04        ADC     $0478,X             ; 
9826: 95 84           STA     $84,X               ; {ram.0084}
9828: CA              DEX                         ; 
9829: 10 E9           BPL     $9814               ; {hard.MMC1_0+1814}
982B: AE 40 03        LDX     $0340               ; {ram.0340}
982E: 60              RTS                         ; 
982F: A9 55           LDA     #$55                ; 
9831: 4C AF 82        JMP     $82AF               ; {hard.MMC1_0+2AF}
9834: CC C4 C8        CPY     $C8C4               ; {hard.MMC1_2+8C4}
9837: C2                              ;
9838: C6 CA           DEC     <$CA                ; {ram.00CA}
983A: CC C4 C8        CPY     $C8C4               ; {hard.MMC1_2+8C4}
983D: CE D0 D2        DEC     $D2D0               ; {hard.MMC1_2+12D0}
9840: 00              BRK                         ; 
9841: 00              BRK                         ; 
9842: 00              BRK                         ; 
9843: 10 10           BPL     $9855               ; {hard.MMC1_0+1855}
9845: 10 00           BPL     $9847               ; {hard.MMC1_0+1847}
9847: 08              PHP                         ; 
9848: 10 00           BPL     $984A               ; {hard.MMC1_0+184A}
984A: 08              PHP                         ; 
984B: 10 A0           BPL     $97ED               ; {hard.MMC1_0+17ED}
984D: 05 A5           ORA     <$A5                ; {ram.00A5}
984F: 15 29           ORA     $29,X               ; {ram.0029}
9851: 10 D0           BPL     $9823               ; {hard.MMC1_0+1823}
9853: 02                              ;
9854: A0 0B           LDY     #$0B                ; 
...
9860: 18              CLC                         ; 
9861: 79 46 98        ADC     $9846,Y             ; {hard.MMC1_0+1846}
9864: 85 00           STA     <$00                ; {ram.GP_00}
9866: B5 84           LDA     $84,X               ; {ram.0084}
9868: 18              CLC                         ; 
9869: 79 40 98        ADC     $9840,Y             ; {hard.MMC1_0+1840}
...
9879: B9 34 98        LDA     $9834,Y             ; {hard.MMC1_0+1834}
987C: CD 34 98        CMP     $9834               ; {hard.MMC1_0+1834}
987F: D0 08           BNE     $9889               ; {hard.MMC1_0+1889}
9881: B4 28           LDY     $28,X               ; {ram.0028}
9883: C0 20           CPY     #$20                ; 
9885: B0 02           BCS     $9889               ; {hard.MMC1_0+1889}
9887: A9 C0           LDA     #$C0                ; 
9889: 20 93 98        JSR     $9893               ; {hard.MMC1_0+1893}
988C: C6 0A           DEC     <$0A                ; {ram.000A}
988E: C6 0B           DEC     <$0B                ; {ram.000B}
9890: 10 CA           BPL     $985C               ; {hard.MMC1_0+185C}
9892: 60              RTS                         ; 
9893: 48              PHA                         ; 
...
98A9: 20 BD 98        JSR     $98BD               ; {hard.MMC1_0+18BD}
98AC: 20 5F 99        JSR     $995F               ; {hard.MMC1_0+195F}
98AF: 20 B9 99        JSR     $99B9               ; {hard.MMC1_0+19B9}
98B2: 4C 84 9A        JMP     $9A84               ; {hard.MMC1_0+1A84}
98B5: 10 F0           BPL     $98A7               ; {hard.MMC1_0+18A7}
98B7: 10 FF           BPL     $98B8               ; {hard.MMC1_0+18B8}
98B9: F0 20           BEQ     $98DB               ; {hard.MMC1_0+18DB}
98BB: 40              RTI                         ; 
98BC: 40              RTI                         ; 
98BD: B5 AC           LDA     $AC,X               ; {ram.00AC}
98BF: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
98C2: C8              INY                         ; 
98C3: 98              TYA                         ; 
98C4: 00              BRK                         ; 
98C5: 99 F2 98        STA     $98F2,Y             ; {hard.MMC1_0+18F2}
98C8: A0 00           LDY     #$00                ; 
98CA: B5 98           LDA     $98,X               ; {ram.0098}
98CC: 29 0D           AND     #$0D                ; 
98CE: F0 09           BEQ     $98D9               ; {hard.MMC1_0+18D9}
...
98E0: 20 94 80        JSR     $8094               ; {hard.MMC1_0+94}
98E3: 68              PLA                         ; 
98E4: 18              CLC                         ; 
98E5: 75 70           ADC     <$70,X              ; {ram.0070}
98E7: 95 70           STA     $70,X               ; {ram.0070}
98E9: C9 20           CMP     #$20                ; 
98EB: B0 04           BCS     $98F1               ; {hard.MMC1_0+18F1}
98ED: A9 01           LDA     #$01                ; 
98EF: 95 98           STA     $98,X               ; {ram.0098}
98F1: 60              RTS                         ; 
98F2: BC 3D 00        LDY     $003D,X             ; {ram.003D}
98F5: 88              DEY                         ; 
98F6: F0 60           BEQ     $9958               ; {hard.MMC1_0+1958}
98F8: 10 05           BPL     $98FF               ; {hard.MMC1_0+18FF}
98FA: A9 20           LDA     #$20                ; 
98FC: 9D 3D 00        STA     $003D,X             ; {ram.003D}
98FF: 60              RTS                         ; 
9900: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
9903: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
9906: 10 99           BPL     $98A1               ; {hard.MMC1_0+18A1}
9908: 10 99           BPL     $98A3               ; {hard.MMC1_0+18A3}
990A: 10 99           BPL     $98A5               ; {hard.MMC1_0+18A5}
990C: 52                              ;
990D: 99 58 99        STA     $9958,Y             ; {hard.MMC1_0+1958}
9910: BC 5E 04        LDY     $045E,X             ; 
9913: 88              DEY                         ; 
9914: F0 22           BEQ     $9938               ; {hard.MMC1_0+1938}
9916: 10 36           BPL     $994E               ; {hard.MMC1_0+194E}
9918: BC 2C 04        LDY     $042C,X             ; {ram.!SplashMode}
991B: B9 BA 98        LDA     $98BA,Y             ; {hard.MMC1_0+18BA}
991E: 9D 5E 04        STA     $045E,X             ; 
9921: C0 00           CPY     #$00                ; 
9923: D0 29           BNE     $994E               ; {hard.MMC1_0+194E}
9925: A0 10           LDY     #$10                ; 
9927: A9 00           LDA     #$00                ; 
...
9935: 4C 4E 99        JMP     $994E               ; {hard.MMC1_0+194E}
9938: FE 2C 04        INC     $042C,X             ; {ram.!SplashMode}
993B: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
993E: C9 02           CMP     #$02                ; 
9940: 90 0C           BCC     $994E               ; {hard.MMC1_0+194E}
9942: BC 37 04        LDY     $0437,X             ; {ram.0437}
9945: C0 02           CPY     #$02                ; 
9947: B0 05           BCS     $994E               ; {hard.MMC1_0+194E}
9949: A9 04           LDA     #$04                ; 
994B: 9D 2C 04        STA     $042C,X             ; {ram.!SplashMode}
994E: DE 5E 04        DEC     $045E,X             ; 
9951: 60              RTS                         ; 
9952: 20 A6 FE        JSR     $FEA6               ; {hard.MMC1_3+1EA6}
9955: 20 10 B0        JSR     $B010               ; {hard.MMC1_1+1010}
9958: 20 55 F8        JSR     $F855               ; {hard.MMC1_3+1855}
995B: 9D 2C 04        STA     $042C,X             ; {ram.!SplashMode}
995E: 60              RTS                         ; 
995F: 20 8A 99        JSR     $998A               ; {hard.MMC1_0+198A}
9962: BD F0 04        LDA     $04F0,X             ; {ram.04F0}
9965: D0 19           BNE     $9980               ; {hard.MMC1_0+1980}
9967: B5 98           LDA     $98,X               ; {ram.0098}
9969: C9 04           CMP     #$04                ; 
996B: B0 1C           BCS     $9989               ; {hard.MMC1_0+1989}
996D: B5 70           LDA     $70,X               ; {ram.0070}
996F: 48              PHA                         ; 
9970: 18              CLC                         ; 
9971: 69 10           ADC     #$10                ; 
9973: 95 70           STA     $70,X               ; {ram.0070}
9975: 20 8A 99        JSR     $998A               ; {hard.MMC1_0+198A}
9978: 68              PLA                         ; 
9979: 95 70           STA     $70,X               ; {ram.0070}
997B: BD F0 04        LDA     $04F0,X             ; {ram.04F0}
997E: F0 09           BEQ     $9989               ; {hard.MMC1_0+1989}
9980: 20 52 99        JSR     $9952               ; {hard.MMC1_0+1952}
9983: A9 0A           LDA     #$0A                ; 
...
9994: C9 02           CMP     #$02                ; 
9996: D0 F1           BNE     $9989               ; {hard.MMC1_0+1989}
9998: A9 FE           LDA     #$FE                ; 
999A: 9D B2 04        STA     $04B2,X             ; 
999D: 20 2D 7A        JSR     $7A2D               ; {ram.7A2D}
99A0: A0 0D           LDY     #$0D                ; 
99A2: 4C 29 7D        JMP     $7D29               ; {ram.7D29}
99A5: F0 00           BEQ     $99A7               ; {hard.MMC1_0+19A7}
99A7: F8              SED                         ; 
99A8: FF                              ;
99A9: F8              SED                         ; 
99AA: 00              BRK                         ; 
99AB: 10 08           BPL     $99B5               ; {hard.MMC1_0+19B5}
99AD: FF                              ;
99AE: 08              PHP                         ; 
99AF: FC                              ;
99B0: FC                              ;
99B1: F0 FF           BEQ     $99B2               ; {hard.MMC1_0+19B2}
99B3: 00              BRK                         ; 
99B4: 04                              ;
99B5: 04                              ;
99B6: 00              BRK                         ; 
99B7: FF                              ;
99B8: 10 B5           BPL     $996F               ; {hard.MMC1_0+196F}
...
99C4: C0 04           CPY     #$04                ; 
99C6: B0 02           BCS     $99CA               ; {hard.MMC1_0+19CA}
99C8: 69 08           ADC     #$08                ; 
...
99E5: F0 13           BEQ     $99FA               ; {hard.MMC1_0+19FA}
99E7: C9 12           CMP     #$12                ; 
99E9: F0 10           BEQ     $99FB               ; {hard.MMC1_0+19FB}
99EB: C9 20           CMP     #$20                ; 
99ED: B0 0B           BCS     $99FA               ; {hard.MMC1_0+19FA}
99EF: A0 00           LDY     #$00                ; 
99F1: 20 32 9A        JSR     $9A32               ; {hard.MMC1_0+1A32}
99F4: D0 04           BNE     $99FA               ; {hard.MMC1_0+19FA}
99F6: A9 02           LDA     #$02                ; 
99F8: 95 AC           STA     $AC,X               ; {ram.00AC}
99FA: 60              RTS                         ; 
99FB: A0 01           LDY     #$01                ; 
99FD: 20 32 9A        JSR     $9A32               ; {hard.MMC1_0+1A32}
9A00: D0 2B           BNE     $9A2D               ; {hard.MMC1_0+1A2D}
9A02: A9 01           LDA     #$01                ; 
...
9A0C: D9 A5 99        CMP     $99A5,Y             ; {hard.MMC1_0+19A5}
9A0F: 30 1C           BMI     $9A2D               ; {hard.MMC1_0+1A2D}
9A11: D9 AA 99        CMP     $99AA,Y             ; {hard.MMC1_0+19AA}
9A14: 10 17           BPL     $9A2D               ; {hard.MMC1_0+1A2D}
9A16: 98              TYA                         ; 
9A17: 18              CLC                         ; 
9A18: 69 0A           ADC     #$0A                ; 
9A1A: A8              TAY                         ; 
...
9A1F: 10 EB           BPL     $9A0C               ; {hard.MMC1_0+1A0C}
...
9A31: F0 B9           BEQ     $99EC               ; {hard.MMC1_0+19EC}
9A33: 2E 9A 85        ROL     $859A               ; {hard.MMC1_0+59A}
9A36: 06 B9           ASL     <$B9                ; {ram.00B9}
9A38: 30 9A           BMI     $99D4               ; {hard.MMC1_0+19D4}
...
9A4B: 10 09           BPL     $9A56               ; {hard.MMC1_0+1A56}
9A4D: C5 07           CMP     <$07                ; {ram.0007}
9A4F: 30 05           BMI     $9A56               ; {hard.MMC1_0+1A56}
9A51: 99 04 00        STA     $0004,Y             ; {ram.0004}
9A54: 46 08           LSR     <$08                ; {ram.0008}
9A56: 88              DEY                         ; 
9A57: 10 E9           BPL     $9A42               ; {hard.MMC1_0+1A42}
...
9A82: FF                              ;
9A83: 00              BRK                         ; 
9A84: 20 FB 9A        JSR     $9AFB               ; {hard.MMC1_0+1AFB}
9A87: B5 98           LDA     $98,X               ; {ram.0098}
9A89: 4A              LSR     A                   ; 
9A8A: 85 00           STA     <$00                ; {ram.GP_00}
9A8C: B4 AC           LDY     $AC,X               ; {ram.00AC}
9A8E: F0 26           BEQ     $9AB6               ; {hard.MMC1_0+1AB6}
9A90: A9 20           LDA     #$20                ; 
9A92: 88              DEY                         ; 
9A93: D0 23           BNE     $9AB8               ; {hard.MMC1_0+1AB8}
9A95: BC 2C 04        LDY     $042C,X             ; {ram.!SplashMode}
9A98: F0 1C           BEQ     $9AB6               ; {hard.MMC1_0+1AB6}
9A9A: C0 02           CPY     #$02                ; 
9A9C: F0 0D           BEQ     $9AAB               ; {hard.MMC1_0+1AAB}
9A9E: C0 03           CPY     #$03                ; 
9AA0: F0 09           BEQ     $9AAB               ; {hard.MMC1_0+1AAB}
9AA2: A5 00           LDA     <$00                ; {ram.GP_00}
9AA4: 18              CLC                         ; 
9AA5: 69 14           ADC     #$14                ; 
9AA7: A8              TAY                         ; 
9AA8: 4C C3 9A        JMP     $9AC3               ; {hard.MMC1_0+1AC3}
9AAB: A5 15           LDA     <$15                ; {ram.0015}
9AAD: 29 02           AND     #$02                ; 
9AAF: F0 4F           BEQ     $9B00               ; {hard.MMC1_0+1B00}
9AB1: A4 00           LDY     <$00                ; {ram.GP_00}
9AB3: 4C C3 9A        JMP     $9AC3               ; {hard.MMC1_0+1AC3}
9AB6: A9 08           LDA     #$08                ; 
9AB8: A4 00           LDY     <$00                ; {ram.GP_00}
9ABA: 25 15           AND     <$15                ; {ram.0015}
9ABC: F0 05           BEQ     $9AC3               ; {hard.MMC1_0+1AC3}
9ABE: 98              TYA                         ; 
9ABF: 18              CLC                         ; 
9AC0: 69 05           ADC     #$05                ; 
9AC2: A8              TAY                         ; 
9AC3: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
9AC6: 98              TYA                         ; 
9AC7: 48              PHA                         ; 
9AC8: B9 66 9A        LDA     $9A66,Y             ; {hard.MMC1_0+1A66}
9ACB: 85 0F           STA     <$0F                ; {ram.000F}
9ACD: B9 5C 9A        LDA     $9A5C,Y             ; {hard.MMC1_0+1A5C}
9AD0: C9 07           CMP     #$07                ; 
9AD2: F0 04           BEQ     $9AD8               ; {hard.MMC1_0+1AD8}
9AD4: C9 09           CMP     #$09                ; 
9AD6: D0 06           BNE     $9ADE               ; {hard.MMC1_0+1ADE}
9AD8: 20 DB 77        JSR     $77DB               ; {ram.77DB}
9ADB: 4C E1 9A        JMP     $9AE1               ; {hard.MMC1_0+1AE1}
9ADE: 20 DF 77        JSR     $77DF               ; {ram.77DF}
9AE1: 68              PLA                         ; 
9AE2: A8              TAY                         ; 
9AE3: B5 98           LDA     $98,X               ; {ram.0098}
9AE5: 29 03           AND     #$03                ; 
9AE7: F0 17           BEQ     $9B00               ; {hard.MMC1_0+1B00}
9AE9: B5 70           LDA     $70,X               ; {ram.0070}
9AEB: 18              CLC                         ; 
9AEC: 69 10           ADC     #$10                ; 
9AEE: 85 00           STA     <$00                ; {ram.GP_00}
9AF0: 20 FB 9A        JSR     $9AFB               ; {hard.MMC1_0+1AFB}
9AF3: B9 5C 9A        LDA     $9A5C,Y             ; {hard.MMC1_0+1A5C}
9AF6: 49 01           EOR     #$01                ; 
...
9B2A: C0 0B           CPY     #$0B                ; 
9B2C: F0 02           BEQ     $9B30               ; {hard.MMC1_0+1B30}
9B2E: A9 28           LDA     #$28                ; 
9B30: 9D BC 03        STA     $03BC,X             ; {ram.03BC}
9B33: 4C 25 80        JMP     $8025               ; {hard.MMC1_0+25}
9B36: A9 80           LDA     #$80                ; 
9B38: 20 6E 80        JSR     $806E               ; {hard.MMC1_0+6E}
9B3B: 20 D0 79        JSR     $79D0               ; {ram.79D0}
9B3E: A9 08           LDA     #$08                ; 
9B40: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
9B43: 20 72 FA        JSR     $FA72               ; {hard.MMC1_3+1A72}
9B46: A9 00           LDA     #$00                ; 
9B48: 4C DF 77        JMP     $77DF               ; {ram.77DF}
9B4B: A9 80           LDA     #$80                ; 
9B4D: 20 6E 80        JSR     $806E               ; {hard.MMC1_0+6E}
9B50: 20 D0 79        JSR     $79D0               ; {ram.79D0}
9B53: A9 00           LDA     #$00                ; 
9B55: 95 3D           STA     $3D,X               ; {ram.003D}
9B57: A9 08           LDA     #$08                ; 
9B59: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
9B5C: B5 98           LDA     $98,X               ; {ram.0098}
9B5E: C9 02           CMP     #$02                ; 
9B60: D0 02           BNE     $9B64               ; {hard.MMC1_0+1B64}
9B62: E6 0F           INC     <$0F                ; {ram.000F}
9B64: 4A              LSR     A                   ; 
9B65: 4A              LSR     A                   ; 
9B66: BC E4 03        LDY     $03E4,X             ; {ram.03E4}
9B69: F0 0B           BEQ     $9B76               ; {hard.MMC1_0+1B76}
9B6B: 18              CLC                         ; 
9B6C: 69 03           ADC     #$03                ; 
9B6E: B4 98           LDY     $98,X               ; {ram.0098}
9B70: C0 08           CPY     #$08                ; 
9B72: D0 02           BNE     $9B76               ; {hard.MMC1_0+1B76}
...
9B8C: FF                              ;
9B8D: FF                              ;
9B8E: FD FD FF        SBC     $FFFD,X             ; {hard.MMC1_3+1FFD}
9B91: FF                              ;
9B92: FF                              ;
9B93: FF                              ;
9B94: FF                              ;
...
9B9B: 20 20 E0        JSR     $E020               ; {hard.MMC1_2+2020}
9B9E: 01 02           ORA     ($02,X)             ; {ram.GP_02}
9BA0: 04                              ;
9BA1: 08              PHP                         ; 
9BA2: E0 01           CPX     #$01                ; 
9BA4: D0 00           BNE     $9BA6               ; {hard.MMC1_0+1BA6}
9BA6: AD 6C 06        LDA     $066C               ; {ram.066C}
9BA9: 15 3D           ORA     $3D,X               ; {ram.003D}
9BAB: D0 4D           BNE     $9BFA               ; {hard.MMC1_0+1BFA}
9BAD: A5 15           LDA     <$15                ; {ram.0015}
9BAF: 4A              LSR     A                   ; 
9BB0: B0 74           BCS     $9C26               ; {hard.MMC1_0+1C26}
9BB2: 20 BD 9C        JSR     $9CBD               ; {hard.MMC1_0+1CBD}
9BB5: B5 AC           LDA     $AC,X               ; {ram.00AC}
9BB7: F0 06           BEQ     $9BBF               ; {hard.MMC1_0+1BBF}
9BB9: 20 3A 9C        JSR     $9C3A               ; {hard.MMC1_0+1C3A}
9BBC: 4C CF 9B        JMP     $9BCF               ; {hard.MMC1_0+1BCF}
9BBF: BD 94 03        LDA     $0394,X             ; {ram.0394}
9BC2: F0 39           BEQ     $9BFD               ; {hard.MMC1_0+1BFD}
9BC4: DE 94 03        DEC     $0394,X             ; {ram.0394}
9BC7: B5 84           LDA     $84,X               ; {ram.0084}
9BC9: 18              CLC                         ; 
9BCA: 79 84 9B        ADC     $9B84,Y             ; {hard.MMC1_0+1B84}
9BCD: 95 84           STA     $84,X               ; {ram.0084}
9BCF: 20 8F 9C        JSR     $9C8F               ; {hard.MMC1_0+1C8F}
9BD2: 90 26           BCC     $9BFA               ; {hard.MMC1_0+1BFA}
9BD4: BD 1F 04        LDA     $041F,X             ; {ram.041F}
9BD7: 29 FC           AND     #$FC                ; 
9BD9: C9 B0           CMP     #$B0                ; 
9BDB: F0 20           BEQ     $9BFD               ; {hard.MMC1_0+1BFD}
9BDD: C9 F4           CMP     #$F4                ; 
9BDF: B0 1C           BCS     $9BFD               ; {hard.MMC1_0+1BFD}
9BE1: B5 98           LDA     $98,X               ; {ram.0098}
9BE3: 29 03           AND     #$03                ; 
9BE5: D0 09           BNE     $9BF0               ; {hard.MMC1_0+1BF0}
9BE7: B5 98           LDA     $98,X               ; {ram.0098}
9BE9: 49 0C           EOR     #$0C                ; 
9BEB: 95 98           STA     $98,X               ; {ram.0098}
9BED: 4C 26 9C        JMP     $9C26               ; {hard.MMC1_0+1C26}
9BF0: 49 03           EOR     #$03                ; 
9BF2: 95 98           STA     $98,X               ; {ram.0098}
9BF4: 20 BD 9C        JSR     $9CBD               ; {hard.MMC1_0+1CBD}
9BF7: 20 BD 9C        JSR     $9CBD               ; {hard.MMC1_0+1CBD}
9BFA: 4C 26 9C        JMP     $9C26               ; {hard.MMC1_0+1C26}
9BFD: B5 AC           LDA     $AC,X               ; {ram.00AC}
9BFF: D0 25           BNE     $9C26               ; {hard.MMC1_0+1C26}
9C01: F6 AC           INC     $AC,X               ; {ram.00AC}
9C03: B4 98           LDY     $98,X               ; {ram.0098}
9C05: 88              DEY                         ; 
9C06: B5 84           LDA     $84,X               ; {ram.0084}
9C08: C9 78           CMP     #$78                ; 
9C0A: B0 02           BCS     $9C0E               ; {hard.MMC1_0+1C0E}
9C0C: A0 03           LDY     #$03                ; 
9C0E: C9 A8           CMP     #$A8                ; 
9C10: 90 02           BCC     $9C14               ; {hard.MMC1_0+1C14}
9C12: A0 07           LDY     #$07                ; 
9C14: B9 8E 9B        LDA     $9B8E,Y             ; {hard.MMC1_0+1B8E}
9C17: 9D 12 04        STA     $0412,X             ; {ram.0412}
9C1A: B5 84           LDA     $84,X               ; {ram.0084}
9C1C: 18              CLC                         ; 
9C1D: 79 96 9B        ADC     $9B96,Y             ; {hard.MMC1_0+1B96}
9C20: 9D 2C 04        STA     $042C,X             ; {ram.!SplashMode}
9C23: C8              INY                         ; 
9C24: 94 98           STY     $98,X               ; {ram.0098}
9C26: A9 08           LDA     #$08                ; 
9C28: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
...
9C53: 30 39           BMI     $9C8E               ; {hard.MMC1_0+1C8E}
9C55: B5 84           LDA     $84,X               ; {ram.0084}
9C57: DD 2C 04        CMP     $042C,X             ; {ram.!SplashMode}
9C5A: 90 32           BCC     $9C8E               ; {hard.MMC1_0+1C8E}
9C5C: A9 00           LDA     #$00                ; 
...
9C68: 29 03           AND     #$03                ; 
9C6A: A8              TAY                         ; 
9C6B: B9 9E 9B        LDA     $9B9E,Y             ; {hard.MMC1_0+1B9E}
...
9C8E: 60              RTS                         ; 
9C8F: 20 AE 9C        JSR     $9CAE               ; {hard.MMC1_0+1CAE}
9C92: B0 19           BCS     $9CAD               ; {hard.MMC1_0+1CAD}
...
9CA4: 20 AE 9C        JSR     $9CAE               ; {hard.MMC1_0+1CAE}
9CA7: 68              PLA                         ; 
...
9CAD: 60              RTS                         ; 
9CAE: A0 00           LDY     #$00                ; 
9CB0: 20 10 EE        JSR     $EE10               ; {hard.MMC1_2+2E10}
...
9CC2: 18              CLC                         ; 
9CC3: 79 7A 9B        ADC     $9B7A,Y             ; {hard.MMC1_0+1B7A}
9CC6: 95 70           STA     $70,X               ; {ram.0070}
9CC8: 60              RTS                         ; 
9CC9: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
9CCC: D0 49           BNE     $9D17               ; {hard.MMC1_0+1D17}
9CCE: A9 80           LDA     #$80                ; 
9CD0: 20 6E 80        JSR     $806E               ; {hard.MMC1_0+6E}
9CD3: DE D0 03        DEC     $03D0,X             ; {ram.03D0}
9CD6: D0 0F           BNE     $9CE7               ; {hard.MMC1_0+1CE7}
9CD8: A9 08           LDA     #$08                ; 
...
9CE7: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
...
9CF6: F0 1E           BEQ     $9D16               ; {hard.MMC1_0+1D16}
...
9D1C: 90 0C           BCC     $9D2A               ; {hard.MMC1_0+1D2A}
9D1E: DE D0 03        DEC     $03D0,X             ; {ram.03D0}
9D21: D0 07           BNE     $9D2A               ; {hard.MMC1_0+1D2A}
9D23: 0A              ASL     A                   ; 
...
9D30: C9 60           CMP     #$60                ; 
9D32: 90 0A           BCC     $9D3E               ; {hard.MMC1_0+1D3E}
9D34: A9 00           LDA     #$00                ; 
9D36: 8D 76 06        STA     $0676               ; {ram.0676}
9D39: A9 C0           LDA     #$C0                ; 
9D3B: 9D 2C 04        STA     $042C,X             ; {ram.!SplashMode}
9D3E: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
9D41: BD E4 03        LDA     $03E4,X             ; {ram.03E4}
9D44: 20 97 82        JSR     $8297               ; {hard.MMC1_0+297}
9D47: 20 D0 79        JSR     $79D0               ; {ram.79D0}
9D4A: BD 05 04        LDA     $0405,X             ; {ram.0405}
9D4D: F0 C7           BEQ     $9D16               ; {hard.MMC1_0+1D16}
9D4F: A9 00           LDA     #$00                ; 
9D51: 8D 12 05        STA     $0512               ; {ram.0512}
9D54: 4C 8A 82        JMP     $828A               ; {hard.MMC1_0+28A}
9D57: 20 82 9D        JSR     $9D82               ; {hard.MMC1_0+1D82}
9D5A: B5 AC           LDA     $AC,X               ; {ram.00AC}
9D5C: C9 02           CMP     #$02                ; 
9D5E: B0 06           BCS     $9D66               ; {hard.MMC1_0+1D66}
9D60: 20 BD 9D        JSR     $9DBD               ; {hard.MMC1_0+1DBD}
9D63: 4C D1 9D        JMP     $9DD1               ; {hard.MMC1_0+1DD1}
9D66: EE 4E 03        INC     $034E               ; {ram.034E}
9D69: 20 B1 FE        JSR     $FEB1               ; {hard.MMC1_3+1EB1}
9D6C: A0 01           LDY     #$01                ; 
9D6E: 98              TYA                         ; 
9D6F: 48              PHA                         ; 
9D70: 20 BB FE        JSR     $FEBB               ; {hard.MMC1_3+1EBB}
9D73: F0 07           BEQ     $9D7C               ; {hard.MMC1_0+1D7C}
9D75: A9 1C           LDA     #$1C                ; 
9D77: 85 00           STA     <$00                ; {ram.GP_00}
9D79: 20 95 B1        JSR     $B195               ; {hard.MMC1_1+1195}
9D7C: 68              PLA                         ; 
9D7D: A8              TAY                         ; 
9D7E: 88              DEY                         ; 
9D7F: 10 ED           BPL     $9D6E               ; {hard.MMC1_0+1D6E}
9D81: 60              RTS                         ; 
9D82: B5 AC           LDA     $AC,X               ; {ram.00AC}
9D84: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
9D87: 9B                              ;
9D88: 9D F1 84        STA     $84F1,X             ; {hard.MMC1_0+4F1}
9D8B: 00              BRK                         ; 
9D8C: FD FE FF        SBC     $FFFE,X             ; {hard.MMC1_3+1FFE}
9D8F: FF                              ;
9D90: 00              BRK                         ; 
9D91: FF                              ;
9D92: 00              BRK                         ; 
...
9DE6: D0 0C           BNE     $9DF4               ; {hard.MMC1_0+1DF4}
9DE8: 20 F7 9D        JSR     $9DF7               ; {hard.MMC1_0+1DF7}
9DEB: 20 58 9F        JSR     $9F58               ; {hard.MMC1_0+1F58}
9DEE: BD 94 03        LDA     $0394,X             ; {ram.0394}
9DF1: 4A              LSR     A                   ; 
9DF2: B0 23           BCS     $9E17               ; {hard.MMC1_0+1E17}
9DF4: 4C 40 A0        JMP     $A040               ; {hard.MMC1_1+40}
9DF7: B5 28           LDA     $28,X               ; {ram.0028}
9DF9: D0 11           BNE     $9E0C               ; {hard.MMC1_0+1E0C}
9DFB: BD 94 03        LDA     $0394,X             ; {ram.0394}
9DFE: F0 06           BEQ     $9E06               ; {hard.MMC1_0+1E06}
9E00: DE 94 03        DEC     $0394,X             ; {ram.0394}
9E03: 4C 20 9E        JMP     $9E20               ; {hard.MMC1_0+1E20}
9E06: 20 FC 9E        JSR     $9EFC               ; {hard.MMC1_0+1EFC}
9E09: 4C 62 9E        JMP     $9E62               ; {hard.MMC1_0+1E62}
9E0C: C9 10           CMP     #$10                ; 
9E0E: B0 08           BCS     $9E18               ; {hard.MMC1_0+1E18}
9E10: C9 01           CMP     #$01                ; 
9E12: D0 03           BNE     $9E17               ; {hard.MMC1_0+1E17}
9E14: 20 BC 9E        JSR     $9EBC               ; {hard.MMC1_0+1EBC}
9E17: 60              RTS                         ; 
9E18: A5 15           LDA     <$15                ; {ram.0015}
9E1A: 4A              LSR     A                   ; 
9E1B: B0 3E           BCS     $9E5B               ; {hard.MMC1_0+1E5B}
9E1D: 20 58 9E        JSR     $9E58               ; {hard.MMC1_0+1E58}
9E20: 20 9D 9E        JSR     $9E9D               ; {hard.MMC1_0+1E9D}
9E23: 20 2C 9F        JSR     $9F2C               ; {hard.MMC1_0+1F2C}
9E26: 90 2F           BCC     $9E57               ; {hard.MMC1_0+1E57}
9E28: BD 1F 04        LDA     $041F,X             ; {ram.041F}
9E2B: 29 FC           AND     #$FC                ; 
9E2D: C9 B0           CMP     #$B0                ; 
9E2F: F0 04           BEQ     $9E35               ; {hard.MMC1_0+1E35}
9E31: C9 F4           CMP     #$F4                ; 
9E33: 90 08           BCC     $9E3D               ; {hard.MMC1_0+1E3D}
9E35: BD 94 03        LDA     $0394,X             ; {ram.0394}
9E38: D0 DD           BNE     $9E17               ; {hard.MMC1_0+1E17}
9E3A: 4C EB 9E        JMP     $9EEB               ; {hard.MMC1_0+1EEB}
9E3D: B4 98           LDY     $98,X               ; {ram.0098}
9E3F: 98              TYA                         ; 
9E40: 29 0C           AND     #$0C                ; 
9E42: F0 06           BEQ     $9E4A               ; {hard.MMC1_0+1E4A}
9E44: 98              TYA                         ; 
9E45: 49 0C           EOR     #$0C                ; 
...
9E4A: 98              TYA                         ; 
9E4B: 29 03           AND     #$03                ; 
9E4D: F0 05           BEQ     $9E54               ; {hard.MMC1_0+1E54}
9E4F: 98              TYA                         ; 
9E50: 49 03           EOR     #$03                ; 
9E52: 95 98           STA     $98,X               ; {ram.0098}
9E54: 4C 9D 9E        JMP     $9E9D               ; {hard.MMC1_0+1E9D}
9E57: 60              RTS                         ; 
9E58: FE 12 04        INC     $0412,X             ; {ram.0412}
9E5B: BD 12 04        LDA     $0412,X             ; {ram.0412}
9E5E: 29 3F           AND     #$3F                ; 
9E60: D0 4D           BNE     $9EAF               ; {hard.MMC1_0+1EAF}
9E62: BD 12 04        LDA     $0412,X             ; {ram.0412}
9E65: 29 40           AND     #$40                ; 
9E67: D0 0C           BNE     $9E75               ; {hard.MMC1_0+1E75}
9E69: A9 02           LDA     #$02                ; 
9E6B: B4 70           LDY     $70,X               ; {ram.0070}
9E6D: C4 70           CPY     <$70                ; {ram.0070}
9E6F: B0 01           BCS     $9E72               ; {hard.MMC1_0+1E72}
9E71: 4A              LSR     A                   ; 
9E72: 4C 7E 9E        JMP     $9E7E               ; {hard.MMC1_0+1E7E}
9E75: A9 08           LDA     #$08                ; 
9E77: B4 84           LDY     $84,X               ; {ram.0084}
9E79: C4 84           CPY     <$84                ; {ram.0084}
9E7B: B0 01           BCS     $9E7E               ; {hard.MMC1_0+1E7E}
9E7D: 4A              LSR     A                   ; 
9E7E: D5 98           CMP     $98,X               ; {ram.0098}
9E80: F0 2D           BEQ     $9EAF               ; {hard.MMC1_0+1EAF}
9E82: 95 98           STA     $98,X               ; {ram.0098}
9E84: 4C 02 9F        JMP     $9F02               ; {hard.MMC1_0+1F02}
9E87: 00              BRK                         ; 
...
9EA1: 18              CLC                         ; 
9EA2: 79 87 9E        ADC     $9E87,Y             ; {hard.MMC1_0+1E87}
9EA5: 95 70           STA     $70,X               ; {ram.0070}
9EA7: B5 84           LDA     $84,X               ; {ram.0084}
9EA9: 18              CLC                         ; 
9EAA: 79 92 9E        ADC     $9E92,Y             ; {hard.MMC1_0+1E92}
...
9EC3: 48              PHA                         ; 
9EC4: 18              CLC                         ; 
9EC5: 79 B0 9E        ADC     $9EB0,Y             ; {hard.MMC1_0+1EB0}
9EC8: 95 70           STA     $70,X               ; {ram.0070}
9ECA: B5 84           LDA     $84,X               ; {ram.0084}
9ECC: 48              PHA                         ; 
9ECD: 18              CLC                         ; 
9ECE: 79 B4 9E        ADC     $9EB4,Y             ; {hard.MMC1_0+1EB4}
9ED1: 95 84           STA     $84,X               ; {ram.0084}
9ED3: 98              TYA                         ; 
9ED4: 48              PHA                         ; 
9ED5: B9 B8 9E        LDA     $9EB8,Y             ; {hard.MMC1_0+1EB8}
9ED8: A8              TAY                         ; 
9ED9: 20 2E 9F        JSR     $9F2E               ; {hard.MMC1_0+1F2E}
9EDC: 68              PLA                         ; 
9EDD: A8              TAY                         ; 
9EDE: 68              PLA                         ; 
...
9EE4: B0 16           BCS     $9EFC               ; {hard.MMC1_0+1EFC}
9EE6: B9 B8 9E        LDA     $9EB8,Y             ; {hard.MMC1_0+1EB8}
...
9EF8: A9 00           LDA     #$00                ; 
9EFA: F0 04           BEQ     $9F00               ; {hard.MMC1_0+1F00}
...
9F31: 48              PHA                         ; 
9F32: 18              CLC                         ; 
9F33: 79 18 9F        ADC     $9F18,Y             ; {hard.MMC1_0+1F18}
9F36: 95 70           STA     $70,X               ; {ram.0070}
9F38: B5 84           LDA     $84,X               ; {ram.0084}
9F3A: 48              PHA                         ; 
9F3B: 18              CLC                         ; 
9F3C: 79 22 9F        ADC     $9F22,Y             ; {hard.MMC1_0+1F22}
9F3F: 95 84           STA     $84,X               ; {ram.0084}
9F41: 20 4B 9F        JSR     $9F4B               ; {hard.MMC1_0+1F4B}
9F44: 68              PLA                         ; 
9F45: 95 84           STA     $84,X               ; {ram.0084}
9F47: 68              PLA                         ; 
9F48: 95 70           STA     $70,X               ; {ram.0070}
9F4A: 60              RTS                         ; 
9F4B: 20 F4 ED        JSR     $EDF4               ; {hard.MMC1_2+2DF4}
...
9F5B: D0 21           BNE     $9F7E               ; {hard.MMC1_0+1F7E}
9F5D: A5 15           LDA     <$15                ; {ram.0015}
9F5F: 29 1F           AND     #$1F                ; 
9F61: D0 1B           BNE     $9F7E               ; {hard.MMC1_0+1F7E}
...
9F6F: D0 0E           BNE     $9F7F               ; {hard.MMC1_0+1F7F}
9F71: A9 02           LDA     #$02                ; 
9F73: B4 70           LDY     $70,X               ; {ram.0070}
9F75: C4 70           CPY     <$70                ; {ram.0070}
9F77: B0 01           BCS     $9F7A               ; {hard.MMC1_0+1F7A}
9F79: 4A              LSR     A                   ; 
9F7A: D5 98           CMP     $98,X               ; {ram.0098}
9F7C: F0 1A           BEQ     $9F98               ; {hard.MMC1_0+1F98}
9F7E: 60              RTS                         ; 
...
9F89: D0 F3           BNE     $9F7E               ; {hard.MMC1_0+1F7E}
9F8B: A9 08           LDA     #$08                ; 
9F8D: B4 84           LDY     $84,X               ; {ram.0084}
9F8F: C4 84           CPY     <$84                ; {ram.0084}
9F91: B0 01           BCS     $9F94               ; {hard.MMC1_0+1F94}
9F93: 4A              LSR     A                   ; 
9F94: D5 98           CMP     $98,X               ; {ram.0098}
9F96: D0 E6           BNE     $9F7E               ; {hard.MMC1_0+1F7E}
9F98: A9 58           LDA     #$58                ; 
9F9A: 85 00           STA     <$00                ; {ram.GP_00}
9F9C: AD 6C 06        LDA     $066C               ; {ram.066C}
9F9F: D0 DD           BNE     $9F7E               ; {hard.MMC1_0+1F7E}
9FA1: A9 04           LDA     #$04                ; 
9FA3: 8D 04 06        STA     $0604               ; {ram.SND_Request}
9FA6: 4C 80 B1        JMP     $B180               ; {hard.MMC1_1+1180}
9FA9: AD 6C 06        LDA     $066C               ; {ram.066C}
9FAC: F0 03           BEQ     $9FB1               ; {hard.MMC1_0+1FB1}
9FAE: 4C 40 A0        JMP     $A040               ; {hard.MMC1_1+40}
...
9FBC: 4A              LSR     A                   ; 
9FBD: 4A              LSR     A                   ; 
9FBE: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
9FC1: 34                              ;
9FC2: A0 ED           LDY     #$ED                ; 
9FC4: 9F                              ;
...
9FD1: 00              BRK                         ; 
9FD2: 00              BRK                         ; 
9FD3: D0 30           BNE     $A005               ; {hard.MMC1_1+5}
9FD5: 00              BRK                         ; 
9FD6: 00              BRK                         ; 
9FD7: B0 50           BCS     $A029               ; {hard.MMC1_1+29}
9FD9: E0 20           CPX     #$20                ; 
9FDB: 00              BRK                         ; 
9FDC: 00              BRK                         ; 
9FDD: C0 40           CPY     #$40                ; 
9FDF: 00              BRK                         ; 
9FE0: 00              BRK                         ; 
9FE1: D0 30           BNE     $A013               ; {hard.MMC1_1+13}
9FE3: 00              BRK                         ; 
9FE4: 00              BRK                         ; 
9FE5: B0 50           BCS     $A037               ; {hard.MMC1_1+37}
9FE7: 00              BRK                         ; 
9FE8: 00              BRK                         ; 
9FE9: 04                              ;
9FEA: 08              PHP                         ; 
...
9FEF: C9 7F           CMP     #$7F                ; 
9FF1: D0 04           BNE     $9FF7               ; {hard.MMC1_0+1FF7}
9FF3: A9 4F           LDA     #$4F                ; 
9FF5: 95 AC           STA     $AC,X               ; {ram.00AC}
9FF7: FE 94 03        INC     $0394,X             ; {ram.0394}
9FFA: 4C EE 9D        JMP     $9DEE               ; {hard.MMC1_0+1DEE}
9FFD: B4 AC           LDY     $AC,X               ; {ram.00AC}
9FFF: C8              INY                         ; 
A000: D0 EB           BNE     $9FED               ; {hard.MMC1_0+1FED}
A002: B5 18           LDA     $18,X               ; {ram.0018}
A004: 48              PHA                         ; 
A005: 29 03           AND     #$03                ; 
A007: A8              TAY                         ; 
A008: B9 E9 9F        LDA     $9FE9,Y             ; {hard.MMC1_0+1FE9}
A00B: 95 98           STA     $98,X               ; {ram.0098}
A00D: 68              PLA                         ; 
A00E: 29 0F           AND     #$0F                ; 
A010: A8              TAY                         ; 
A011: A5 70           LDA     <$70                ; {ram.0070}
A013: 79 C9 9F        ADC     $9FC9,Y             ; {hard.MMC1_0+1FC9}
A016: 29 F0           AND     #$F0                ; 
A018: 95 70           STA     $70,X               ; {ram.0070}
A01A: A5 84           LDA     <$84                ; {ram.0084}
A01C: 18              CLC                         ; 
A01D: 69 03           ADC     #$03                ; 
A01F: 79 D9 9F        ADC     $9FD9,Y             ; {hard.MMC1_0+1FD9}
A022: 20 10 9F        JSR     $9F10               ; {hard.MMC1_0+1F10}
A025: C9 5D           CMP     #$5D                ; 
A027: 90 09           BCC     $A032               ; {hard.MMC1_1+32}
A029: C9 C4           CMP     #$C4                ; 
A02B: B0 05           BCS     $A032               ; {hard.MMC1_1+32}
A02D: 20 2C 9F        JSR     $9F2C               ; {hard.MMC1_0+1F2C}
A030: 90 02           BCC     $A034               ; {hard.MMC1_1+34}
A032: F6 AC           INC     $AC,X               ; {ram.00AC}
A034: 60              RTS                         ; 
A035: B5 AC           LDA     $AC,X               ; {ram.00AC}
A037: C9 B0           CMP     #$B0                ; 
A039: D0 05           BNE     $A040               ; {hard.MMC1_1+40}
A03B: A9 59           LDA     #$59                ; 
A03D: 20 9A 9F        JSR     $9F9A               ; {hard.MMC1_0+1F9A}
A040: A9 F6           LDA     #$F6                ; 
A042: 9D B2 04        STA     $04B2,X             ; 
A045: 20 2D 7A        JSR     $7A2D               ; {ram.7A2D}
A048: BD F0 04        LDA     $04F0,X             ; {ram.04F0}
A04B: D0 14           BNE     $A061               ; {hard.MMC1_1+61}
A04D: A0 0E           LDY     #$0E                ; 
...
A069: 29 01           AND     #$01                ; 
A06B: 48              PHA                         ; 
A06C: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
A06F: B5 98           LDA     $98,X               ; {ram.0098}
A071: 29 08           AND     #$08                ; 
A073: D0 0B           BNE     $A080               ; {hard.MMC1_1+80}
...
A087: 6F                              ;
A088: 74                              ;
A089: 79 7E 83        ADC     $837E,Y             ; {hard.MMC1_0+37E}
A08C: 88              DEY                         ; 
A08D: A9 10           LDA     #$10                ; 
...
A0A4: BD 87 A0        LDA     $A087,X             ; {hard.MMC1_1+87}
...
A0C7: CA              DEX                         ; 
A0C8: 10 CA           BPL     $A094               ; {hard.MMC1_1+94}
...
A105: 00              BRK                         ; 
A106: 00              BRK                         ; 
A107: F0 10           BEQ     $A119               ; {hard.MMC1_1+119}
A109: 00              BRK                         ; 
A10A: 00              BRK                         ; 
A10B: 00              BRK                         ; 
A10C: A9 40           LDA     #$40                ; 
...
A113: 29 07           AND     #$07                ; 
A115: A8              TAY                         ; 
A116: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
...
A12C: B9 00 A1        LDA     $A100,Y             ; {hard.MMC1_1+100}
...
A176: 4C D6 FE        JMP     $FED6               ; {hard.MMC1_3+1ED6}
A179: 20 1D 84        JSR     $841D               ; {hard.MMC1_0+41D}
A17C: A9 E0           LDA     #$E0                ; 
...
A186: 60              RTS                         ; 
A187: E0 05           CPX     #$05                ; 
A189: D0 41           BNE     $A1CC               ; {hard.MMC1_1+1CC}
A18B: AD 83 03        LDA     $0383               ; {ram.0383}
A18E: F0 1B           BEQ     $A1AB               ; {hard.MMC1_1+1AB}
A190: A0 04           LDY     #$04                ; 
...
A1A3: 88              DEY                         ; 
A1A4: 10 EC           BPL     $A192               ; {hard.MMC1_1+192}
A1A6: A9 00           LDA     #$00                ; 
A1A8: 8D 83 03        STA     $0383               ; {ram.0383}
A1AB: AD 85 03        LDA     $0385               ; {ram.0385}
A1AE: F0 03           BEQ     $A1B3               ; {hard.MMC1_1+1B3}
A1B0: 20 85 A2        JSR     $A285               ; {hard.MMC1_1+285}
A1B3: B5 28           LDA     $28,X               ; {ram.0028}
A1B5: D0 15           BNE     $A1CC               ; {hard.MMC1_1+1CC}
A1B7: A9 10           LDA     #$10                ; 
A1B9: 95 28           STA     $28,X               ; {ram.0028}
A1BB: B5 18           LDA     $18,X               ; {ram.0018}
A1BD: C9 80           CMP     #$80                ; 
A1BF: B0 5E           BCS     $A21F               ; {hard.MMC1_1+21F}
A1C1: 20 88 B3        JSR     $B388               ; {hard.MMC1_1+1388}
A1C4: A5 9D           LDA     <$9D                ; {ram.009D}
A1C6: 8D 85 03        STA     $0385               ; {ram.0385}
A1C9: 20 85 A2        JSR     $A285               ; {hard.MMC1_1+285}
A1CC: E0 05           CPX     #$05                ; 
A1CE: D0 05           BNE     $A1D5               ; {hard.MMC1_1+1D5}
A1D0: B5 98           LDA     $98,X               ; {ram.0098}
A1D2: 8D 84 03        STA     $0384               ; {ram.0384}
A1D5: 20 8E A2        JSR     $A28E               ; {hard.MMC1_1+28E}
A1D8: 20 25 A2        JSR     $A225               ; {hard.MMC1_1+225}
A1DB: B5 98           LDA     $98,X               ; {ram.0098}
A1DD: CD 84 03        CMP     $0384               ; {ram.0384}
A1E0: F0 03           BEQ     $A1E5               ; {hard.MMC1_1+1E5}
...
A1FA: E0 05           CPX     #$05                ; 
A1FC: F0 1E           BEQ     $A21C               ; {hard.MMC1_1+21C}
A1FE: BD 78 04        LDA     $0478,X             ; 
A201: DD 37 04        CMP     $0437,X             ; {ram.0437}
A204: F0 16           BEQ     $A21C               ; {hard.MMC1_1+21C}
A206: 9D 37 04        STA     $0437,X             ; {ram.0437}
A209: 4A              LSR     A                   ; 
A20A: B0 10           BCS     $A21C               ; {hard.MMC1_1+21C}
A20C: B5 19           LDA     $19,X               ; {ram.0019}
A20E: C9 E0           CMP     #$E0                ; 
A210: 90 0A           BCC     $A21C               ; {hard.MMC1_1+21C}
A212: AD 56 03        LDA     $0356               ; {ram.0356}
A215: D0 05           BNE     $A21C               ; {hard.MMC1_1+21C}
A217: A9 56           LDA     #$56                ; 
A219: 20 AF 82        JSR     $82AF               ; {hard.MMC1_0+2AF}
A21C: 4C EF A2        JMP     $A2EF               ; {hard.MMC1_1+2EF}
A21F: 20 1A B3        JSR     $B31A               ; {hard.MMC1_1+131A}
A222: 4C C4 A1        JMP     $A1C4               ; {hard.MMC1_1+1C4}
...
A234: E0 05           CPX     #$05                ; 
A236: D0 05           BNE     $A23D               ; {hard.MMC1_1+23D}
A238: A9 00           LDA     #$00                ; 
A23A: 9D F0 04        STA     $04F0,X             ; {ram.04F0}
A23D: 20 00 80        JSR     $8000               ; {hard.MMC1_0}
A240: BD 05 04        LDA     $0405,X             ; {ram.0405}
A243: F0 37           BEQ     $A27C               ; {hard.MMC1_1+27C}
A245: 20 E4 EE        JSR     $EEE4               ; {hard.MMC1_2+2EE4}
A248: E0 05           CPX     #$05                ; 
A24A: D0 06           BNE     $A252               ; {hard.MMC1_1+252}
A24C: 9D 05 04        STA     $0405,X             ; {ram.0405}
A24F: 4C 7C A2        JMP     $A27C               ; {hard.MMC1_1+27C}
A252: A0 03           LDY     #$03                ; 
A254: A9 00           LDA     #$00                ; 
A256: 85 00           STA     <$00                ; {ram.GP_00}
A258: B9 50 03        LDA     $0350,Y             ; {ram.0350}
A25B: C9 3C           CMP     #$3C                ; 
A25D: D0 02           BNE     $A261               ; {hard.MMC1_1+261}
A25F: E6 00           INC     <$00                ; {ram.GP_00}
A261: 88              DEY                         ; 
A262: 10 F4           BPL     $A258               ; {hard.MMC1_1+258}
A264: C6 00           DEC     <$00                ; {ram.GP_00}
A266: 30 02           BMI     $A26A               ; {hard.MMC1_1+26A}
A268: D0 13           BNE     $A27D               ; {hard.MMC1_1+27D}
A26A: 20 10 B0        JSR     $B010               ; {hard.MMC1_1+1010}
A26D: A9 5D           LDA     #$5D                ; 
...
A282: 4C 79 A2        JMP     $A279               ; {hard.MMC1_1+279}
A285: A0 04           LDY     #$04                ; 
A287: 99 99 00        STA     $0099,Y             ; {ram.0099}
A28A: 88              DEY                         ; 
A28B: 10 FA           BPL     $A287               ; {hard.MMC1_1+287}
A28D: 60              RTS                         ; 
...
A2A9: F0 07           BEQ     $A2B2               ; {hard.MMC1_1+2B2}
...
A2B8: F0 06           BEQ     $A2C0               ; {hard.MMC1_1+2C0}
...
A2C6: F0 06           BEQ     $A2CE               ; {hard.MMC1_1+2CE}
...
A2D4: F0 06           BEQ     $A2DC               ; {hard.MMC1_1+2DC}
...
A2E9: 20 CD B2        JSR     $B2CD               ; {hard.MMC1_1+12CD}
A2EC: 4C 93 FA        JMP     $FA93               ; {hard.MMC1_3+1A93}
A2EF: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
...
A393: 4A              LSR     A                   ; 
A394: 90 03           BCC     $A399               ; {hard.MMC1_1+399}
A396: DE 2C 04        DEC     $042C,X             ; {ram.!SplashMode}
A399: BD 44 04        LDA     $0444,X             ; 
A39C: F0 2A           BEQ     $A3C8               ; {hard.MMC1_1+3C8}
A39E: DE 44 04        DEC     $0444,X             ; 
A3A1: A0 02           LDY     #$02                ; 
A3A3: C9 70           CMP     #$70                ; 
A3A5: B0 05           BCS     $A3AC               ; {hard.MMC1_1+3AC}
A3A7: C9 10           CMP     #$10                ; 
A3A9: 90 01           BCC     $A3AC               ; {hard.MMC1_1+3AC}
A3AB: C8              INY                         ; 
A3AC: 98              TYA                         ; 
A3AD: 9D 6B 04        STA     $046B,X             ; 
A3B0: DE 80 03        DEC     $0380,X             ; 
A3B3: D0 0A           BNE     $A3BF               ; {hard.MMC1_1+3BF}
A3B5: A9 41           LDA     #$41                ; 
A3B7: 9D 80 03        STA     $0380,X             ; 
A3BA: A9 56           LDA     #$56                ; 
A3BC: 20 AF 82        JSR     $82AF               ; {hard.MMC1_0+2AF}
A3BF: BD 6B 04        LDA     $046B,X             ; 
A3C2: 20 E3 A3        JSR     $A3E3               ; {hard.MMC1_1+3E3}
A3C5: 4C 22 A4        JMP     $A422               ; {hard.MMC1_1+422}
A3C8: FE 78 04        INC     $0478,X             ; 
A3CB: BD 78 04        LDA     $0478,X             ; 
A3CE: C9 08           CMP     #$08                ; 
A3D0: D0 DE           BNE     $A3B0               ; {hard.MMC1_1+3B0}
A3D2: A9 00           LDA     #$00                ; 
A3D4: 9D 78 04        STA     $0478,X             ; 
A3D7: BD 6B 04        LDA     $046B,X             ; 
A3DA: 29 01           AND     #$01                ; 
A3DC: 49 01           EOR     #$01                ; 
A3DE: 4C AD A3        JMP     $A3AD               ; {hard.MMC1_1+3AD}
A3E1: F0 10           BEQ     $A3F3               ; {hard.MMC1_1+3F3}
A3E3: 48              PHA                         ; 
A3E4: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
A3E7: 20 19 A4        JSR     $A419               ; {hard.MMC1_1+419}
A3EA: 68              PLA                         ; 
A3EB: 20 DB 77        JSR     $77DB               ; {ram.77DB}
A3EE: A9 10           LDA     #$10                ; 
A3F0: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
A3F3: A0 01           LDY     #$01                ; 
A3F5: 20 FA A3        JSR     $A3FA               ; {hard.MMC1_1+3FA}
A3F8: A0 00           LDY     #$00                ; 
A3FA: B5 70           LDA     $70,X               ; {ram.0070}
A3FC: 18              CLC                         ; 
A3FD: 79 E1 A3        ADC     $A3E1,Y             ; {hard.MMC1_1+3E1}
A400: 85 00           STA     <$00                ; {ram.GP_00}
A402: B5 84           LDA     $84,X               ; {ram.0084}
A404: 85 01           STA     <$01                ; {ram.GP_01}
A406: 20 19 A4        JSR     $A419               ; {hard.MMC1_1+419}
A409: 20 72 FA        JSR     $FA72               ; {hard.MMC1_3+1A72}
A40C: 98              TYA                         ; 
A40D: 18              CLC                         ; 
...
A43A: D0 F2           BNE     $A42E               ; {hard.MMC1_1+42E}
A43C: 68              PLA                         ; 
A43D: 95 70           STA     $70,X               ; {ram.0070}
A43F: 60              RTS                         ; 
A440: C0 12           CPY     #$12                ; 
A442: D0 0A           BNE     $A44E               ; {hard.MMC1_1+44E}
A444: A9 28           LDA     #$28                ; 
...
A450: C9 03           CMP     #$03                ; 
A452: F0 04           BEQ     $A458               ; {hard.MMC1_1+458}
A454: C9 04           CMP     #$04                ; 
A456: D0 19           BNE     $A471               ; {hard.MMC1_1+471}
A458: BD 6B 04        LDA     $046B,X             ; 
A45B: C9 03           CMP     #$03                ; 
A45D: D0 12           BNE     $A471               ; {hard.MMC1_1+471}
A45F: B9 98 00        LDA     $0098,Y             ; {ram.0098}
A462: C9 08           CMP     #$08                ; 
A464: D0 0B           BNE     $A471               ; {hard.MMC1_1+471}
A466: A9 02           LDA     #$02                ; 
A468: 8D 01 06        STA     $0601               ; {ram.??SND_601??}
A46B: 20 54 7C        JSR     $7C54               ; {ram.7C54}
A46E: 20 0D 80        JSR     $800D               ; {hard.MMC1_0+D}
A471: A9 01           LDA     #$01                ; 
A473: 8D 04 06        STA     $0604               ; {ram.SND_Request}
A476: 60              RTS                         ; 
A477: 20 AC A4        JSR     $A4AC               ; {hard.MMC1_1+4AC}
A47A: 20 88 B2        JSR     $B288               ; {hard.MMC1_1+1288}
A47D: BD 37 04        LDA     $0437,X             ; {ram.0437}
A480: 29 01           AND     #$01                ; 
A482: D0 10           BNE     $A494               ; {hard.MMC1_1+494}
A484: B5 19           LDA     $19,X               ; {ram.0019}
A486: C9 20           CMP     #$20                ; 
A488: B0 0A           BCS     $A494               ; {hard.MMC1_1+494}
A48A: AD 5A 03        LDA     $035A               ; {ram.035A}
A48D: D0 05           BNE     $A494               ; {hard.MMC1_1+494}
A48F: A9 56           LDA     #$56                ; 
A491: 20 AF 82        JSR     $82AF               ; {hard.MMC1_0+2AF}
A494: A9 01           LDA     #$01                ; 
A496: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
A499: BD E4 03        LDA     $03E4,X             ; {ram.03E4}
A49C: 20 DB 77        JSR     $77DB               ; {ram.77DB}
A49F: 20 D0 79        JSR     $79D0               ; {ram.79D0}
A4A2: 20 DA FE        JSR     $FEDA               ; {hard.MMC1_3+1EDA}
A4A5: 20 E6 EE        JSR     $EEE6               ; {hard.MMC1_2+2EE6}
A4A8: 9D F0 04        STA     $04F0,X             ; {ram.04F0}
A4AB: 60              RTS                         ; 
A4AC: BD 44 04        LDA     $0444,X             ; 
A4AF: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
...
A4BE: C9 D0           CMP     #$D0                ; 
A4C0: 90 01           BCC     $A4C3               ; {hard.MMC1_1+4C3}
A4C2: C8              INY                         ; 
A4C3: 4C C1 84        JMP     $84C1               ; {hard.MMC1_0+4C1}
A4C6: 38              SEC                         ; 
A4C7: 52                              ;
...
A4D4: 04                              ;
A4D5: 03                              ;
A4D6: 20 2D 81        JSR     $812D               ; {hard.MMC1_0+12D}
A4D9: A9 04           LDA     #$04                ; 
A4DB: 04                              ;
A4DC: 03                              ;
A4DD: 03                              ;
A4DE: 20 25 A8        JSR     $A825               ; {hard.MMC1_1+825}
A4E1: AD 50 03        LDA     $0350               ; {ram.0350}
A4E4: 38              SEC                         ; 
A4E5: E9 42           SBC     #$42                ; 
A4E7: 8D D7 04        STA     $04D7               ; {ram.04D7}
A4EA: AC D7 04        LDY     $04D7               ; {ram.04D7}
A4ED: B9 BE E6        LDA     $E6BE,Y             ; {hard.MMC1_2+26BE}
A4F0: 2C 11 05        BIT     $0511               ; {ram.0511}
A4F3: F0 03           BEQ     $A4F8               ; {hard.MMC1_1+4F8}
A4F5: 4C 47 A5        JMP     $A547               ; {hard.MMC1_1+547}
A4F8: 20 4D A5        JSR     $A54D               ; {hard.MMC1_1+54D}
...
A50A: 88              DEY                         ; 
A50B: 10 EE           BPL     $A4FB               ; {hard.MMC1_1+4FB}
A50D: A5 15           LDA     <$15                ; {ram.0015}
A50F: 29 03           AND     #$03                ; 
A511: 85 00           STA     <$00                ; {ram.GP_00}
A513: E4 00           CPX     <$00                ; {ram.GP_00}
A515: D0 18           BNE     $A52F               ; {hard.MMC1_1+52F}
A517: 20 76 A5        JSR     $A576               ; {hard.MMC1_1+576}
A51A: 20 A4 A7        JSR     $A7A4               ; {hard.MMC1_1+7A4}
A51D: A2 05           LDX     #$05                ; 
A51F: B5 18           LDA     $18,X               ; {ram.0018}
A521: C9 20           CMP     #$20                ; 
A523: B0 0A           BCS     $A52F               ; {hard.MMC1_1+52F}
A525: AD 5A 03        LDA     $035A               ; {ram.035A}
A528: D0 05           BNE     $A52F               ; {hard.MMC1_1+52F}
A52A: A9 56           LDA     #$56                ; 
A52C: 20 AF 82        JSR     $82AF               ; {hard.MMC1_0+2AF}
A52F: 20 E5 A6        JSR     $A6E5               ; {hard.MMC1_1+6E5}
A532: 20 4D A5        JSR     $A54D               ; {hard.MMC1_1+54D}
...
A544: 88              DEY                         ; 
A545: 10 EE           BPL     $A535               ; {hard.MMC1_1+535}
A547: CE D7 04        DEC     $04D7               ; {ram.04D7}
A54A: 10 9E           BPL     $A4EA               ; {hard.MMC1_1+4EA}
A54C: 60              RTS                         ; 
A54D: AE D7 04        LDX     $04D7               ; {ram.04D7}
A550: BD C6 A4        LDA     $A4C6,X             ; {hard.MMC1_1+4C6}
A553: 85 00           STA     <$00                ; {ram.GP_00}
A555: BD CA A4        LDA     $A4CA,X             ; {hard.MMC1_1+4CA}
A558: 85 01           STA     <$01                ; {ram.GP_01}
A55A: BD CE A4        LDA     $A4CE,X             ; {hard.MMC1_1+4CE}
A55D: 85 02           STA     <$02                ; {ram.GP_02}
A55F: BD D2 A4        LDA     $A4D2,X             ; {hard.MMC1_1+4D2}
A562: 85 03           STA     <$03                ; {ram.GP_03}
A564: BD D6 A4        LDA     $A4D6,X             ; {hard.MMC1_1+4D6}
A567: 85 04           STA     <$04                ; {ram.0004}
A569: BD DA A4        LDA     $A4DA,X             ; {hard.MMC1_1+4DA}
A56C: 85 05           STA     <$05                ; {ram.0005}
A56E: A0 05           LDY     #$05                ; 
A570: 60              RTS                         ; 
A571: 4A              LSR     A                   ; 
A572: 4A              LSR     A                   ; 
A573: 4C 85 A5        JMP     $A585               ; {hard.MMC1_1+585}
A576: A5 75           LDA     <$75                ; {ram.0075}
A578: 38              SEC                         ; 
A579: E5 71           SBC     <$71                ; {ram.0071}
A57B: 10 F4           BPL     $A571               ; {hard.MMC1_1+571}
...
A58B: A2 00           LDX     #$00                ; 
A58D: 20 21 A6        JSR     $A621               ; {hard.MMC1_1+621}
...
A599: 4A              LSR     A                   ; 
A59A: E8              INX                         ; 
A59B: 20 21 A6        JSR     $A621               ; {hard.MMC1_1+621}
A59E: A2 00           LDX     #$00                ; 
...
A5AB: 90 0F           BCC     $A5BC               ; {hard.MMC1_1+5BC}
A5AD: B5 72           LDA     $72,X               ; {ram.0072}
A5AF: A8              TAY                         ; 
A5B0: C8              INY                         ; 
A5B1: C8              INY                         ; 
A5B2: D5 71           CMP     $71,X               ; {ram.0071}
A5B4: 90 04           BCC     $A5BA               ; {hard.MMC1_1+5BA}
A5B6: 88              DEY                         ; 
A5B7: 88              DEY                         ; 
A5B8: 88              DEY                         ; 
A5B9: 88              DEY                         ; 
...
A5C7: 90 0F           BCC     $A5D8               ; {hard.MMC1_1+5D8}
A5C9: B5 86           LDA     $86,X               ; {ram.0086}
A5CB: A8              TAY                         ; 
A5CC: C8              INY                         ; 
A5CD: C8              INY                         ; 
A5CE: D5 85           CMP     $85,X               ; {ram.0085}
A5D0: 90 04           BCC     $A5D6               ; {hard.MMC1_1+5D6}
A5D2: 88              DEY                         ; 
A5D3: 88              DEY                         ; 
A5D4: 88              DEY                         ; 
A5D5: 88              DEY                         ; 
...
A5D8: E8              INX                         ; 
A5D9: E0 04           CPX     #$04                ; 
A5DB: D0 C3           BNE     $A5A0               ; {hard.MMC1_1+5A0}
A5DD: A2 00           LDX     #$00                ; 
A5DF: 20 43 A6        JSR     $A643               ; {hard.MMC1_1+643}
A5E2: E8              INX                         ; 
A5E3: E0 03           CPX     #$03                ; 
A5E5: 90 F8           BCC     $A5DF               ; {hard.MMC1_1+5DF}
A5E7: A2 02           LDX     #$02                ; 
A5E9: 8A              TXA                         ; 
A5EA: A8              TAY                         ; 
...
A5F1: 88              DEY                         ; 
A5F2: 10 F9           BPL     $A5ED               ; {hard.MMC1_1+5ED}
A5F4: B4 72           LDY     $72,X               ; {ram.0072}
A5F6: C8              INY                         ; 
A5F7: D5 72           CMP     $72,X               ; {ram.0072}
A5F9: B0 02           BCS     $A5FD               ; {hard.MMC1_1+5FD}
A5FB: 88              DEY                         ; 
A5FC: 88              DEY                         ; 
A5FD: 94 72           STY     $72,X               ; {ram.0072}
A5FF: CA              DEX                         ; 
A600: 10 E7           BPL     $A5E9               ; {hard.MMC1_1+5E9}
A602: A2 01           LDX     #$01                ; 
A604: B5 87           LDA     $87,X               ; {ram.0087}
A606: D5 86           CMP     $86,X               ; {ram.0086}
A608: B0 09           BCS     $A613               ; {hard.MMC1_1+613}
A60A: D5 88           CMP     $88,X               ; 
A60C: B0 0F           BCS     $A61D               ; {hard.MMC1_1+61D}
A60E: F6 87           INC     $87,X               ; {ram.0087}
A610: 4C 1D A6        JMP     $A61D               ; {hard.MMC1_1+61D}
A613: D5 86           CMP     $86,X               ; {ram.0086}
A615: 90 06           BCC     $A61D               ; {hard.MMC1_1+61D}
A617: D5 88           CMP     $88,X               ; 
A619: 90 02           BCC     $A61D               ; {hard.MMC1_1+61D}
A61B: D6 87           DEC     $87,X               ; {ram.0087}
A61D: CA              DEX                         ; 
A61E: 10 E4           BPL     $A604               ; {hard.MMC1_1+604}
A620: 60              RTS                         ; 
A621: C9 04           CMP     #$04                ; 
A623: 90 02           BCC     $A627               ; {hard.MMC1_1+627}
A625: A9 04           LDA     #$04                ; 
A627: 9D D9 04        STA     $04D9,X             ; {ram.04D9}
A62A: 18              CLC                         ; 
A62B: 69 04           ADC     #$04                ; 
A62D: C9 08           CMP     #$08                ; 
A62F: 90 02           BCC     $A633               ; {hard.MMC1_1+633}
A631: A9 08           LDA     #$08                ; 
A633: 9D DB 04        STA     $04DB,X             ; {ram.04DB}
A636: 18              CLC                         ; 
A637: 69 04           ADC     #$04                ; 
A639: C9 0B           CMP     #$0B                ; 
A63B: 90 02           BCC     $A63F               ; {hard.MMC1_1+63F}
A63D: A9 0B           LDA     #$0B                ; 
...
A650: 90 01           BCC     $A653               ; {hard.MMC1_1+653}
A652: C8              INY                         ; 
A653: CD DB 04        CMP     $04DB               ; {ram.04DB}
A656: 90 01           BCC     $A659               ; {hard.MMC1_1+659}
A658: C8              INY                         ; 
...
A664: 90 03           BCC     $A669               ; {hard.MMC1_1+669}
A666: C8              INY                         ; 
A667: C8              INY                         ; 
A668: C8              INY                         ; 
A669: CD DC 04        CMP     $04DC               ; {ram.04DC}
A66C: 90 03           BCC     $A671               ; {hard.MMC1_1+671}
A66E: C8              INY                         ; 
A66F: C8              INY                         ; 
A670: C8              INY                         ; 
A671: 98              TYA                         ; 
A672: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
A675: 87                              ;
...
A688: 18              CLC                         ; 
A689: 10 1F           BPL     $A6AA               ; {hard.MMC1_1+6AA}
A68B: B5 86           LDA     $86,X               ; {ram.0086}
A68D: A8              TAY                         ; 
A68E: C8              INY                         ; 
A68F: C8              INY                         ; 
A690: D5 87           CMP     $87,X               ; {ram.0087}
A692: F0 02           BEQ     $A696               ; {hard.MMC1_1+696}
A694: B0 04           BCS     $A69A               ; {hard.MMC1_1+69A}
A696: 88              DEY                         ; 
A697: 88              DEY                         ; 
A698: 88              DEY                         ; 
A699: 88              DEY                         ; 
...
A6A4: F0 F4           BEQ     $A69A               ; {hard.MMC1_1+69A}
A6A6: 90 F2           BCC     $A69A               ; {hard.MMC1_1+69A}
A6A8: B0 EC           BCS     $A696               ; {hard.MMC1_1+696}
A6AA: B5 72           LDA     $72,X               ; {ram.0072}
A6AC: A8              TAY                         ; 
A6AD: C8              INY                         ; 
A6AE: C8              INY                         ; 
A6AF: D5 73           CMP     $73,X               ; {ram.0073}
A6B1: B0 0F           BCS     $A6C2               ; {hard.MMC1_1+6C2}
A6B3: 90 09           BCC     $A6BE               ; {hard.MMC1_1+6BE}
A6B5: B5 72           LDA     $72,X               ; {ram.0072}
A6B7: A8              TAY                         ; 
A6B8: C8              INY                         ; 
A6B9: C8              INY                         ; 
A6BA: D5 73           CMP     $73,X               ; {ram.0073}
A6BC: 90 04           BCC     $A6C2               ; {hard.MMC1_1+6C2}
A6BE: 88              DEY                         ; 
A6BF: 88              DEY                         ; 
A6C0: 88              DEY                         ; 
A6C1: 88              DEY                         ; 
...
A6C7: 10 EC           BPL     $A6B5               ; {hard.MMC1_1+6B5}
A6C9: 30 D2           BMI     $A69D               ; {hard.MMC1_1+69D}
A6CB: A0 03           LDY     #$03                ; 
...
A6D5: 0A              ASL     A                   ; 
A6D6: E0 05           CPX     #$05                ; 
A6D8: F0 03           BEQ     $A6DD               ; {hard.MMC1_1+6DD}
A6DA: 18              CLC                         ; 
A6DB: 69 20           ADC     #$20                ; 
A6DD: A8              TAY                         ; 
A6DE: 68              PLA                         ; 
A6DF: 20 A5 79        JSR     $79A5               ; {ram.79A5}
A6E2: 4C FA A6        JMP     $A6FA               ; {hard.MMC1_1+6FA}
A6E5: A2 05           LDX     #$05                ; 
A6E7: A9 DA           LDA     #$DA                ; 
A6E9: E0 05           CPX     #$05                ; 
A6EB: D0 02           BNE     $A6EF               ; {hard.MMC1_1+6EF}
A6ED: A9 DC           LDA     #$DC                ; 
A6EF: E0 05           CPX     #$05                ; 
A6F1: F0 D8           BEQ     $A6CB               ; {hard.MMC1_1+6CB}
A6F3: E0 01           CPX     #$01                ; 
A6F5: F0 D4           BEQ     $A6CB               ; {hard.MMC1_1+6CB}
A6F7: 20 8D 79        JSR     $798D               ; {ram.798D}
A6FA: E0 05           CPX     #$05                ; 
A6FC: F0 07           BEQ     $A705               ; {hard.MMC1_1+705}
A6FE: E0 01           CPX     #$01                ; 
A700: F0 03           BEQ     $A705               ; {hard.MMC1_1+705}
A702: 4C 84 A7        JMP     $A784               ; {hard.MMC1_1+784}
A705: 20 D0 79        JSR     $79D0               ; {ram.79D0}
A708: BD C0 00        LDA     $00C0,X             ; {ram.00C0}
A70B: F0 08           BEQ     $A715               ; {hard.MMC1_1+715}
A70D: A9 06           LDA     #$06                ; 
A70F: 8D E6 04        STA     $04E6               ; {ram.04E6}
A712: 8D 10 05        STA     $0510               ; {ram.0510}
A715: 20 E4 EE        JSR     $EEE4               ; {hard.MMC1_2+2EE4}
A718: E0 01           CPX     #$01                ; 
A71A: F0 65           BEQ     $A781               ; {hard.MMC1_1+781}
A71C: 20 00 80        JSR     $8000               ; {hard.MMC1_0}
A71F: BD 05 04        LDA     $0405,X             ; {ram.0405}
A722: F0 60           BEQ     $A784               ; {hard.MMC1_1+784}
A724: A9 60           LDA     #$60                ; 
A726: 9D 85 04        STA     $0485,X             ; 
A729: 8A              TXA                         ; 
A72A: 48              PHA                         ; 
A72B: E0 05           CPX     #$05                ; 
A72D: D0 19           BNE     $A748               ; {hard.MMC1_1+748}
...
A75C: B9 BE E6        LDA     $E6BE,Y             ; {hard.MMC1_2+26BE}
...
A76D: 69 00           ADC     #$00                ; 
A76F: 88              DEY                         ; 
A770: D0 F9           BNE     $A76B               ; {hard.MMC1_1+76B}
A772: 85 00           STA     <$00                ; {ram.GP_00}
A774: AD 50 03        LDA     $0350               ; {ram.0350}
A777: 38              SEC                         ; 
A778: E9 41           SBC     #$41                ; 
A77A: C5 00           CMP     <$00                ; {ram.GP_00}
A77C: F0 0E           BEQ     $A78C               ; {hard.MMC1_1+78C}
A77E: 4C DA FE        JMP     $FEDA               ; {hard.MMC1_3+1EDA}
A781: 20 DA FE        JSR     $FEDA               ; {hard.MMC1_3+1EDA}
A784: CA              DEX                         ; 
A785: E0 01           CPX     #$01                ; 
A787: 90 71           BCC     $A7FA               ; {hard.MMC1_1+7FA}
A789: 4C E7 A6        JMP     $A6E7               ; {hard.MMC1_1+6E7}
A78C: 20 12 75        JSR     $7512               ; {ram.7512}
A78F: 20 10 B0        JSR     $B010               ; {hard.MMC1_1+1010}
A792: A9 11           LDA     #$11                ; 
...
A7E9: C9 06           CMP     #$06                ; 
A7EB: 90 0D           BCC     $A7FA               ; {hard.MMC1_1+7FA}
A7ED: A9 00           LDA     #$00                ; 
...
A7FE: 60              RTS                         ; 
A7FF: D0 04           BNE     $A805               ; {hard.MMC1_1+805}
A801: 18              CLC                         ; 
A802: 69 01           ADC     #$01                ; 
A804: 60              RTS                         ; 
A805: 38              SEC                         ; 
...
A80F: CC C4 CE        CPY     $CEC4               ; {hard.MMC1_2+EC4}
A812: C2                              ;
...
A822: 4C 44 A8        JMP     $A844               ; {hard.MMC1_1+844}
A825: AD E6 04        LDA     $04E6               ; {ram.04E6}
A828: D0 F5           BNE     $A81F               ; {hard.MMC1_1+81F}
A82A: A9 10           LDA     #$10                ; 
A82C: AC 10 05        LDY     $0510               ; {ram.0510}
A82F: F0 05           BEQ     $A836               ; {hard.MMC1_1+836}
...
A84B: BE 1B A8        LDX     $A81B,Y             ; {hard.MMC1_1+81B}
A84E: A9 00           LDA     #$00                ; 
...
A864: BD 09 A8        LDA     $A809,X             ; {hard.MMC1_1+809}
A867: 99 01 02        STA     $0201,Y             ; {ram.0201}
A86A: AD F5 04        LDA     $04F5               ; {ram.04F5}
A86D: D0 02           BNE     $A871               ; {hard.MMC1_1+871}
A86F: A9 03           LDA     #$03                ; 
A871: 29 03           AND     #$03                ; 
...
A888: C9 03           CMP     #$03                ; 
A88A: 90 C6           BCC     $A852               ; {hard.MMC1_1+852}
A88C: E6 06           INC     <$06                ; {ram.0006}
A88E: A5 06           LDA     <$06                ; {ram.0006}
A890: C9 02           CMP     #$02                ; 
A892: 90 BA           BCC     $A84E               ; {hard.MMC1_1+84E}
A894: 60              RTS                         ; 
A895: FF                              ;
A896: FF                              ;
A897: FF                              ;
...
A8C0: 78              SEI                         ; 
A8C1: 60              RTS                         ; 
A8C2: 70 80           BVS     $A844               ; {hard.MMC1_1+844}
A8C4: 90 88           BCC     $A84E               ; {hard.MMC1_1+84E}
A8C6: B5 9D           LDA     $9D,X               ; {ram.009D}
A8C8: 9D B5 A2        STA     $A2B5,X             ; {hard.MMC1_1+2B5}
A8CB: 05 BD           ORA     <$BD                ; {ram.00BD}
A8CD: BF                              ;
A8CE: A8              TAY                         ; 
A8CF: 95 70           STA     $70,X               ; {ram.0070}
A8D1: BD C4 A8        LDA     $A8C4,X             ; {hard.MMC1_1+8C4}
A8D4: 95 84           STA     $84,X               ; {ram.0084}
A8D6: A9 3F           LDA     #$3F                ; 
A8D8: 9D 4F 03        STA     $034F,X             ; {ram.034F}
A8DB: CA              DEX                         ; 
A8DC: D0 EE           BNE     $A8CC               ; {hard.MMC1_1+8CC}
A8DE: A9 37           LDA     #$37                ; 
...
A90D: 88              DEY                         ; 
A90E: 10 D6           BPL     $A8E6               ; {hard.MMC1_1+8E6}
A910: A9 08           LDA     #$08                ; 
...
A955: C0 47           CPY     #$47                ; 
A957: F0 02           BEQ     $A95B               ; {hard.MMC1_1+95B}
A959: A9 26           LDA     #$26                ; 
A95B: A0 02           LDY     #$02                ; 
...
A969: C8              INY                         ; 
A96A: C0 0A           CPY     #$0A                ; 
A96C: D0 F1           BNE     $A95F               ; {hard.MMC1_1+95F}
A96E: 60              RTS                         ; 
A96F: A9 FA           LDA     #$FA                ; 
...
A984: 4C D6 FE        JMP     $FED6               ; {hard.MMC1_3+1ED6}
A987: 20 CA 79        JSR     $79CA               ; {ram.79CA}
A98A: B5 AC           LDA     $AC,X               ; {ram.00AC}
A98C: D0 2A           BNE     $A9B8               ; {hard.MMC1_1+9B8}
A98E: A5 70           LDA     <$70                ; {ram.0070}
A990: C9 70           CMP     #$70                ; 
A992: 90 23           BCC     $A9B7               ; {hard.MMC1_1+9B7}
A994: C9 81           CMP     #$81                ; 
A996: B0 1F           BCS     $A9B7               ; {hard.MMC1_1+9B7}
A998: A5 84           LDA     <$84                ; {ram.0084}
A99A: C9 95           CMP     #$95                ; 
A99C: D0 19           BNE     $A9B7               ; {hard.MMC1_1+9B7}
...
A9B7: 60              RTS                         ; 
A9B8: 20 29 F2        JSR     $F229               ; {hard.MMC1_3+1229}
A9BB: B5 28           LDA     $28,X               ; {ram.0028}
A9BD: D0 F8           BNE     $A9B7               ; {hard.MMC1_1+9B7}
...
A9D5: 4C D8 E8        JMP     $E8D8               ; {hard.MMC1_2+28D8}
A9D8: A9 06           LDA     #$06                ; 
A9DA: 20 76 84        JSR     $8476               ; {hard.MMC1_0+476}
A9DD: 20 D0 79        JSR     $79D0               ; {ram.79D0}
A9E0: BD 05 04        LDA     $0405,X             ; {ram.0405}
A9E3: F0 05           BEQ     $A9EA               ; {hard.MMC1_1+9EA}
A9E5: A9 5D           LDA     #$5D                ; 
A9E7: 9D 4F 03        STA     $034F,X             ; {ram.034F}
A9EA: 60              RTS                         ; 
A9EB: B5 98           LDA     $98,X               ; {ram.0098}
A9ED: F0 FB           BEQ     $A9EA               ; {hard.MMC1_1+9EA}
A9EF: AD 6C 06        LDA     $066C               ; {ram.066C}
A9F2: D0 0E           BNE     $AA02               ; {hard.MMC1_1+A02}
A9F4: 20 24 AB        JSR     $AB24               ; {hard.MMC1_1+B24}
A9F7: E0 05           CPX     #$05                ; 
A9F9: F0 04           BEQ     $A9FF               ; {hard.MMC1_1+9FF}
A9FB: E0 0A           CPX     #$0A                ; 
A9FD: D0 03           BNE     $AA02               ; {hard.MMC1_1+A02}
A9FF: 20 70 AA        JSR     $AA70               ; {hard.MMC1_1+A70}
...
AA11: A9 9E           LDA     #$9E                ; 
AA13: E0 05           CPX     #$05                ; 
AA15: F0 06           BEQ     $AA1D               ; {hard.MMC1_1+A1D}
AA17: E0 0A           CPX     #$0A                ; 
AA19: F0 02           BEQ     $AA1D               ; {hard.MMC1_1+A1D}
AA1B: A9 A0           LDA     #$A0                ; 
...
AA2F: F0 B9           BEQ     $A9EA               ; {hard.MMC1_1+9EA}
AA31: 20 E4 EE        JSR     $EEE4               ; {hard.MMC1_2+2EE4}
AA34: A9 20           LDA     #$20                ; 
AA36: 9D 85 04        STA     $0485,X             ; 
AA39: A0 FF           LDY     #$FF                ; 
AA3B: E0 06           CPX     #$06                ; 
AA3D: 90 02           BCC     $AA41               ; {hard.MMC1_1+A41}
AA3F: A0 04           LDY     #$04                ; 
AA41: C8              INY                         ; 
AA42: B9 50 03        LDA     $0350,Y             ; {ram.0350}
AA45: CD E7 04        CMP     $04E7               ; {ram.04E7}
AA48: D0 F7           BNE     $AA41               ; {hard.MMC1_1+A41}
AA4A: A9 11           LDA     #$11                ; 
...
AA5F: C0 04           CPY     #$04                ; 
AA61: F0 87           BEQ     $A9EA               ; {hard.MMC1_1+9EA}
AA63: C0 09           CPY     #$09                ; 
AA65: F0 83           BEQ     $A9EA               ; {hard.MMC1_1+9EA}
AA67: A9 5D           LDA     #$5D                ; 
AA69: 99 50 03        STA     $0350,Y             ; {ram.0350}
AA6C: 4C DA FE        JMP     $FEDA               ; {hard.MMC1_3+1EDA}
AA6F: 60              RTS                         ; 
AA70: B5 70           LDA     $70,X               ; {ram.0070}
AA72: 29 07           AND     #$07                ; 
AA74: D0 F9           BNE     $AA6F               ; {hard.MMC1_1+A6F}
AA76: B5 84           LDA     $84,X               ; {ram.0084}
AA78: 18              CLC                         ; 
AA79: 69 03           ADC     #$03                ; 
AA7B: 29 07           AND     #$07                ; 
AA7D: D0 F0           BNE     $AA6F               ; {hard.MMC1_1+A6F}
AA7F: A9 04           LDA     #$04                ; 
AA81: 85 00           STA     <$00                ; {ram.GP_00}
AA83: A0 00           LDY     #$00                ; 
AA85: E0 05           CPX     #$05                ; 
AA87: F0 02           BEQ     $AA8B               ; {hard.MMC1_1+A8B}
AA89: A0 05           LDY     #$05                ; 
AA8B: B9 9A 00        LDA     $009A,Y             ; {ram.009A}
AA8E: 99 99 00        STA     $0099,Y             ; {ram.0099}
AA91: C8              INY                         ; 
AA92: C6 00           DEC     <$00                ; {ram.GP_00}
AA94: D0 F5           BNE     $AA8B               ; {hard.MMC1_1+A8B}
AA96: B5 70           LDA     $70,X               ; {ram.0070}
AA98: 29 0F           AND     #$0F                ; 
AA9A: D0 5D           BNE     $AAF9               ; {hard.MMC1_1+AF9}
AA9C: B5 84           LDA     $84,X               ; {ram.0084}
AA9E: 18              CLC                         ; 
AA9F: 69 03           ADC     #$03                ; 
AAA1: 29 0F           AND     #$0F                ; 
AAA3: D0 54           BNE     $AAF9               ; {hard.MMC1_1+AF9}
...
AABA: C9 80           CMP     #$80                ; 
AABC: 90 3C           BCC     $AAFA               ; {hard.MMC1_1+AFA}
AABE: B5 98           LDA     $98,X               ; {ram.0098}
AAC0: B4 19           LDY     $19,X               ; {ram.0019}
AAC2: C0 80           CPY     #$80                ; 
AAC4: B0 12           BCS     $AAD8               ; {hard.MMC1_1+AD8}
AAC6: 4A              LSR     A                   ; 
AAC7: 90 02           BCC     $AACB               ; {hard.MMC1_1+ACB}
AAC9: A9 08           LDA     #$08                ; 
AACB: 2C 0F 05        BIT     $050F               ; {ram.050F}
AACE: F0 F6           BEQ     $AAC6               ; {hard.MMC1_1+AC6}
AAD0: C0 40           CPY     #$40                ; 
AAD2: B0 04           BCS     $AAD8               ; {hard.MMC1_1+AD8}
AAD4: A0 40           LDY     #$40                ; 
AAD6: 90 EE           BCC     $AAC6               ; {hard.MMC1_1+AC6}
AAD8: 95 98           STA     $98,X               ; {ram.0098}
AADA: 85 0F           STA     <$0F                ; {ram.000F}
AADC: 20 B8 6F        JSR     $6FB8               ; {ram.6FB8}
AADF: A5 0F           LDA     <$0F                ; {ram.000F}
AAE1: D0 0E           BNE     $AAF1               ; {hard.MMC1_1+AF1}
AAE3: B5 98           LDA     $98,X               ; {ram.0098}
AAE5: 4A              LSR     A                   ; 
AAE6: 90 02           BCC     $AAEA               ; {hard.MMC1_1+AEA}
AAE8: A9 08           LDA     #$08                ; 
AAEA: 2C 0F 05        BIT     $050F               ; {ram.050F}
AAED: D0 E9           BNE     $AAD8               ; {hard.MMC1_1+AD8}
AAEF: F0 F4           BEQ     $AAE5               ; {hard.MMC1_1+AE5}
AAF1: 20 FA ED        JSR     $EDFA               ; {hard.MMC1_2+2DFA}
AAF4: CD 4A 03        CMP     $034A               ; {ram.034A}
AAF7: B0 EA           BCS     $AAE3               ; {hard.MMC1_1+AE3}
AAF9: 60              RTS                         ; 
AAFA: A9 01           LDA     #$01                ; 
...
AB03: B0 02           BCS     $AB07               ; {hard.MMC1_1+B07}
...
AB3C: F0 07           BEQ     $AB45               ; {hard.MMC1_1+B45}
...
AB4B: F0 07           BEQ     $AB54               ; {hard.MMC1_1+B54}
...
AB5A: F0 07           BEQ     $AB63               ; {hard.MMC1_1+B63}
AB5C: B5 84           LDA     $84,X               ; {ram.0084}
AB5E: ED E6 04        SBC     $04E6               ; {ram.04E6}
AB61: 95 84           STA     $84,X               ; {ram.0084}
AB63: 60              RTS                         ; 
AB64: FF                              ;
AB65: 50 20           BVC     $AB87               ; {hard.MMC1_1+B87}
AB67: AE AB A9        LDX     $A9AB               ; {hard.MMC1_1+9AB}
AB6A: 00              BRK                         ; 
AB6B: 9D 6B 04        STA     $046B,X             ; 
AB6E: 9D 78 04        STA     $0478,X             ; 
AB71: 20 88 B2        JSR     $B288               ; {hard.MMC1_1+1288}
AB74: A9 02           LDA     #$02                ; 
AB76: 20 76 84        JSR     $8476               ; {hard.MMC1_0+476}
AB79: A0 08           LDY     #$08                ; 
AB7B: B9 50 03        LDA     $0350,Y             ; {ram.0350}
AB7E: C9 25           CMP     #$25                ; 
AB80: F0 13           BEQ     $AB95               ; {hard.MMC1_1+B95}
AB82: C9 26           CMP     #$26                ; 
AB84: F0 0F           BEQ     $AB95               ; {hard.MMC1_1+B95}
AB86: 88              DEY                         ; 
AB87: D0 F2           BNE     $AB7B               ; {hard.MMC1_1+B7B}
AB89: 20 D0 79        JSR     $79D0               ; {ram.79D0}
AB8C: 20 00 80        JSR     $8000               ; {hard.MMC1_0}
AB8F: 20 0D 80        JSR     $800D               ; {hard.MMC1_0+D}
AB92: 4C 98 AB        JMP     $AB98               ; {hard.MMC1_1+B98}
AB95: 20 A7 7A        JSR     $7AA7               ; {ram.7AA7}
AB98: B5 29           LDA     $29,X               ; {ram.0029}
AB9A: 0D 97 03        ORA     $0397               ; {ram.0397}
AB9D: D0 0E           BNE     $ABAD               ; {hard.MMC1_1+BAD}
AB9F: BD 5E 04        LDA     $045E,X             ; 
ABA2: 49 01           EOR     #$01                ; 
ABA4: 9D 5E 04        STA     $045E,X             ; 
ABA7: 98              TYA                         ; 
ABA8: B9 64 AB        LDA     $AB64,Y             ; {hard.MMC1_1+B64}
ABAB: 95 29           STA     $29,X               ; {ram.0029}
ABAD: 60              RTS                         ; 
ABAE: BD 44 04        LDA     $0444,X             ; 
ABB1: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
...
ABC0: C9 40           CMP     #$40                ; 
ABC2: B0 01           BCS     $ABC5               ; {hard.MMC1_1+BC5}
ABC4: C8              INY                         ; 
ABC5: 98              TYA                         ; 
...
ABCE: 60              RTS                         ; 
ABCF: 14                              ;
ABD0: 10 0C           BPL     $ABDE               ; {hard.MMC1_1+BDE}
ABD2: 08              PHP                         ; 
ABD3: 04                              ;
ABD4: 00              BRK                         ; 
ABD5: 1C                              ;
...
ABDC: D0 3F           BNE     $AC1D               ; {hard.MMC1_1+C1D}
ABDE: E0 02           CPX     #$02                ; 
ABE0: F0 11           BEQ     $ABF3               ; {hard.MMC1_1+BF3}
ABE2: A5 AE           LDA     <$AE                ; {ram.00AE}
ABE4: F0 36           BEQ     $AC1C               ; {hard.MMC1_1+C1C}
ABE6: 8A              TXA                         ; 
ABE7: 38              SEC                         ; 
ABE8: E9 03           SBC     #$03                ; 
ABEA: A8              TAY                         ; 
ABEB: AD 96 03        LDA     $0396               ; {ram.0396}
ABEE: D9 CF AB        CMP     $ABCF,Y             ; {hard.MMC1_1+BCF}
ABF1: D0 29           BNE     $AC1C               ; {hard.MMC1_1+C1C}
ABF3: E0 09           CPX     #$09                ; 
ABF5: D0 02           BNE     $ABF9               ; {hard.MMC1_1+BF9}
...
AC0D: C0 25           CPY     #$25                ; 
AC0F: F0 02           BEQ     $AC13               ; {hard.MMC1_1+C13}
AC11: A9 18           LDA     #$18                ; 
...
AC36: C0 25           CPY     #$25                ; 
AC38: F0 02           BEQ     $AC3C               ; {hard.MMC1_1+C3C}
AC3A: A9 60           LDA     #$60                ; 
AC3C: 20 59 B4        JSR     $B459               ; {hard.MMC1_1+1459}
AC3F: AC 5F 04        LDY     $045F               ; {ram.045F}
AC42: BD 4F 03        LDA     $034F,X             ; {ram.034F}
AC45: C9 25           CMP     #$25                ; 
AC47: D0 0C           BNE     $AC55               ; {hard.MMC1_1+C55}
AC49: B9 D6 AB        LDA     $ABD6,Y             ; {hard.MMC1_1+BD6}
AC4C: 48              PHA                         ; 
AC4D: B9 D8 AB        LDA     $ABD8,Y             ; {hard.MMC1_1+BD8}
AC50: A8              TAY                         ; 
AC51: 68              PLA                         ; 
AC52: 4C 59 AC        JMP     $AC59               ; {hard.MMC1_1+C59}
AC55: B9 D7 AB        LDA     $ABD7,Y             ; {hard.MMC1_1+BD7}
AC58: A8              TAY                         ; 
AC59: 20 BD B3        JSR     $B3BD               ; {hard.MMC1_1+13BD}
AC5C: 95 84           STA     $84,X               ; {ram.0084}
AC5E: 20 71 AC        JSR     $AC71               ; {hard.MMC1_1+C71}
AC61: A5 AD           LDA     <$AD                ; {ram.00AD}
AC63: F0 0B           BEQ     $AC70               ; {hard.MMC1_1+C70}
AC65: 20 D0 79        JSR     $79D0               ; {ram.79D0}
AC68: BD 05 04        LDA     $0405,X             ; {ram.0405}
AC6B: F0 03           BEQ     $AC70               ; {hard.MMC1_1+C70}
AC6D: 20 E5 A9        JSR     $A9E5               ; {hard.MMC1_1+9E5}
AC70: 60              RTS                         ; 
AC71: 20 86 79        JSR     $7986               ; {ram.7986}
AC74: 20 89 FA        JSR     $FA89               ; {hard.MMC1_3+1A89}
AC77: BD E4 03        LDA     $03E4,X             ; {ram.03E4}
AC7A: 4C DF 77        JMP     $77DF               ; {ram.77DF}
AC7D: AD 45 04        LDA     $0445               ; {ram.0445}
AC80: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
AC83: 89                              ;
AC84: AC C6 AC        LDY     $ACC6               ; {hard.MMC1_1+CC6}
AC87: E4 AC           CPX     <$AC                ; {ram.00AC}
AC89: A9 1B           LDA     #$1B                ; 
AC8B: 8D 05 05        STA     $0505               ; {ram.0505}
AC8E: A5 28           LDA     <$28                ; {ram.0028}
AC90: D0 2A           BNE     $ACBC               ; {hard.MMC1_1+CBC}
AC92: 8A              TXA                         ; 
AC93: 48              PHA                         ; 
AC94: 20 BE B1        JSR     $B1BE               ; {hard.MMC1_1+11BE}
AC97: 68              PLA                         ; 
AC98: AA              TAX                         ; 
AC99: A9 00           LDA     #$00                ; 
...
ACA1: C9 C0           CMP     #$C0                ; 
ACA3: D0 05           BNE     $ACAA               ; {hard.MMC1_1+CAA}
ACA5: A9 02           LDA     #$02                ; 
ACA7: 8D 00 06        STA     $0600               ; {ram.SND_ReqMusic}
ACAA: AD 1C 05        LDA     $051C               ; {ram.051C}
ACAD: 29 0F           AND     #$0F                ; 
ACAF: C9 04           CMP     #$04                ; 
ACB1: D0 29           BNE     $ACDC               ; {hard.MMC1_1+CDC}
ACB3: A9 C0           LDA     #$C0                ; 
ACB5: 85 28           STA     <$28                ; {ram.0028}
ACB7: EE 45 04        INC     $0445               ; {ram.0445}
ACBA: D0 20           BNE     $ACDC               ; {hard.MMC1_1+CDC}
ACBC: C9 01           CMP     #$01                ; 
ACBE: D0 05           BNE     $ACC5               ; {hard.MMC1_1+CC5}
ACC0: A9 02           LDA     #$02                ; 
...
ACCD: D0 0D           BNE     $ACDC               ; {hard.MMC1_1+CDC}
...
ACE1: 4C B5 AE        JMP     $AEB5               ; {hard.MMC1_1+EB5}
ACE4: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
ACE7: D0 64           BNE     $AD4D               ; {hard.MMC1_1+D4D}
ACE9: 20 E4 AE        JSR     $AEE4               ; {hard.MMC1_1+EE4}
ACEC: 20 00 80        JSR     $8000               ; {hard.MMC1_0}
ACEF: B5 AC           LDA     $AC,X               ; {ram.00AC}
ACF1: D0 3C           BNE     $AD2F               ; {hard.MMC1_1+D2F}
ACF3: B5 28           LDA     $28,X               ; {ram.0028}
ACF5: F0 13           BEQ     $AD0A               ; {hard.MMC1_1+D0A}
ACF7: C9 01           CMP     #$01                ; 
ACF9: D0 4E           BNE     $AD49               ; {hard.MMC1_1+D49}
ACFB: A9 A0           LDA     #$A0                ; 
ACFD: 95 84           STA     $84,X               ; {ram.0084}
ACFF: A5 15           LDA     <$15                ; {ram.0015}
AD01: 29 01           AND     #$01                ; 
AD03: A8              TAY                         ; 
AD04: B9 2D AD        LDA     $AD2D,Y             ; {hard.MMC1_1+D2D}
AD07: 95 70           STA     $70,X               ; {ram.0070}
AD09: 60              RTS                         ; 
AD0A: FE 6B 04        INC     $046B,X             ; 
AD0D: BD 6B 04        LDA     $046B,X             ; 
AD10: C9 06           CMP     #$06                ; 
AD12: D0 05           BNE     $AD19               ; {hard.MMC1_1+D19}
AD14: A9 00           LDA     #$00                ; 
AD16: 9D 6B 04        STA     $046B,X             ; 
AD19: A9 01           LDA     #$01                ; 
AD1B: 9D 94 03        STA     $0394,X             ; {ram.0394}
AD1E: 20 1D 9E        JSR     $9E1D               ; {hard.MMC1_0+1E1D}
AD21: A5 15           LDA     <$15                ; {ram.0015}
AD23: 29 3F           AND     #$3F                ; 
AD25: D0 05           BNE     $AD2C               ; {hard.MMC1_1+D2C}
AD27: A9 56           LDA     #$56                ; 
AD29: 20 AF 82        JSR     $82AF               ; {hard.MMC1_0+2AF}
AD2C: 60              RTS                         ; 
AD2D: 30 B0           BMI     $ACDF               ; {hard.MMC1_1+CDF}
AD2F: A5 15           LDA     <$15                ; {ram.0015}
AD31: 4A              LSR     A                   ; 
AD32: 90 0A           BCC     $AD3E               ; {hard.MMC1_1+D3E}
AD34: D6 AC           DEC     $AC,X               ; {ram.00AC}
AD36: D0 06           BNE     $AD3E               ; {hard.MMC1_1+D3E}
AD38: 20 FB AC        JSR     $ACFB               ; {hard.MMC1_1+CFB}
AD3B: 4C 71 AF        JMP     $AF71               ; {hard.MMC1_1+F71}
AD3E: B5 AC           LDA     $AC,X               ; {ram.00AC}
AD40: C9 30           CMP     #$30                ; 
AD42: B0 05           BCS     $AD49               ; {hard.MMC1_1+D49}
AD44: A5 15           LDA     <$15                ; {ram.0015}
AD46: 4A              LSR     A                   ; 
AD47: 90 03           BCC     $AD4C               ; {hard.MMC1_1+D4C}
AD49: 20 B5 AE        JSR     $AEB5               ; {hard.MMC1_1+EB5}
AD4C: 60              RTS                         ; 
AD4D: FE 2C 04        INC     $042C,X             ; {ram.!SplashMode}
AD50: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
AD53: D0 05           BNE     $AD5A               ; {hard.MMC1_1+D5A}
AD55: A9 FF           LDA     #$FF                ; 
AD57: 9D 2C 04        STA     $042C,X             ; {ram.!SplashMode}
AD5A: C9 50           CMP     #$50                ; 
AD5C: 90 EB           BCC     $AD49               ; {hard.MMC1_1+D49}
AD5E: D0 1A           BNE     $AD7A               ; {hard.MMC1_1+D7A}
AD60: 20 75 AF        JSR     $AF75               ; {hard.MMC1_1+F75}
...
AD6F: 20 B1 AD        JSR     $ADB1               ; {hard.MMC1_1+DB1}
AD72: 20 10 B0        JSR     $B010               ; {hard.MMC1_1+1010}
AD75: A9 02           LDA     #$02                ; 
AD77: 8D 00 06        STA     $0600               ; {ram.SND_ReqMusic}
AD7A: 20 9F AF        JSR     $AF9F               ; {hard.MMC1_1+F9F}
AD7D: BD 2C 04        LDA     $042C,X             ; {ram.!SplashMode}
AD80: C9 A0           CMP     #$A0                ; 
AD82: 90 67           BCC     $ADEB               ; {hard.MMC1_1+DEB}
AD84: D0 0E           BNE     $AD94               ; {hard.MMC1_1+D94}
AD86: 20 A7 AF        JSR     $AFA7               ; {hard.MMC1_1+FA7}
...
ADA7: 00              BRK                         ; 
ADA8: 00              BRK                         ; 
ADA9: EE EE E8        INC     $E8EE               ; {hard.MMC1_2+28EE}
ADAC: 30 30           BMI     $ADDE               ; {hard.MMC1_1+DDE}
ADAE: E8              INX                         ; 
ADAF: 30 30           BMI     $ADE1               ; {hard.MMC1_1+DE1}
ADB1: A0 07           LDY     #$07                ; 
...
ADC2: B9 95 AD        LDA     $AD95,Y             ; {hard.MMC1_1+D95}
ADC5: 99 9A 00        STA     $009A,Y             ; {ram.009A}
ADC8: 88              DEY                         ; 
ADC9: 10 E8           BPL     $ADB3               ; {hard.MMC1_1+DB3}
ADCB: 60              RTS                         ; 
...
ADD7: C0 06           CPY     #$06                ; 
ADD9: B0 02           BCS     $ADDD               ; {hard.MMC1_1+DDD}
ADDB: A9 0D           LDA     #$0D                ; 
ADDD: A0 00           LDY     #$00                ; 
...
ADEE: F0 09           BEQ     $ADF9               ; {hard.MMC1_1+DF9}
ADF0: A5 15           LDA     <$15                ; {ram.0015}
ADF2: 29 07           AND     #$07                ; 
ADF4: D0 03           BNE     $ADF9               ; {hard.MMC1_1+DF9}
ADF6: DE 78 04        DEC     $0478,X             ; 
ADF9: 20 6D AE        JSR     $AE6D               ; {hard.MMC1_1+E6D}
ADFC: 20 7F AE        JSR     $AE7F               ; {hard.MMC1_1+E7F}
ADFF: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE02: 20 76 AE        JSR     $AE76               ; {hard.MMC1_1+E76}
AE05: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE08: 20 6D AE        JSR     $AE6D               ; {hard.MMC1_1+E6D}
AE0B: 20 88 AE        JSR     $AE88               ; {hard.MMC1_1+E88}
AE0E: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE11: 20 76 AE        JSR     $AE76               ; {hard.MMC1_1+E76}
AE14: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE17: B5 70           LDA     $70,X               ; {ram.0070}
AE19: 85 00           STA     <$00                ; {ram.GP_00}
AE1B: 20 7F AE        JSR     $AE7F               ; {hard.MMC1_1+E7F}
AE1E: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE21: 20 88 AE        JSR     $AE88               ; {hard.MMC1_1+E88}
AE24: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE27: 20 6D AE        JSR     $AE6D               ; {hard.MMC1_1+E6D}
AE2A: B5 84           LDA     $84,X               ; {ram.0084}
AE2C: 85 01           STA     <$01                ; {ram.GP_01}
AE2E: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE31: 20 76 AE        JSR     $AE76               ; {hard.MMC1_1+E76}
AE34: 20 CC AD        JSR     $ADCC               ; {hard.MMC1_1+DCC}
AE37: AD 40 03        LDA     $0340               ; {ram.0340}
AE3A: 48              PHA                         ; 
AE3B: A2 02           LDX     #$02                ; 
AE3D: 8E 40 03        STX     $0340               ; {ram.0340}
AE40: E0 05           CPX     #$05                ; 
AE42: 90 0A           BCC     $AE4E               ; {hard.MMC1_1+E4E}
AE44: E0 07           CPX     #$07                ; 
AE46: F0 06           BEQ     $AE4E               ; {hard.MMC1_1+E4E}
AE48: A5 15           LDA     <$15                ; {ram.0015}
AE4A: 29 03           AND     #$03                ; 
AE4C: F0 03           BEQ     $AE51               ; {hard.MMC1_1+E51}
AE4E: 20 9D 9E        JSR     $9E9D               ; {hard.MMC1_0+1E9D}
AE51: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
AE54: A5 15           LDA     <$15                ; {ram.0015}
AE56: 29 03           AND     #$03                ; 
AE58: 1D 9D AD        ORA     $AD9D,X             ; {hard.MMC1_1+D9D}
AE5B: 85 03           STA     <$03                ; {ram.GP_03}
AE5D: BD A7 AD        LDA     $ADA7,X             ; {hard.MMC1_1+DA7}
AE60: 20 91 79        JSR     $7991               ; {ram.7991}
AE63: E8              INX                         ; 
AE64: E0 0A           CPX     #$0A                ; 
AE66: 90 D5           BCC     $AE3D               ; {hard.MMC1_1+E3D}
AE68: 68              PLA                         ; 
...
AEA9: 00              BRK                         ; 
AEAA: 10 00           BPL     $AEAC               ; {hard.MMC1_1+EAC}
AEAC: 10 00           BPL     $AEAE               ; {hard.MMC1_1+EAE}
AEAE: 00              BRK                         ; 
AEAF: 10 10           BPL     $AEC1               ; {hard.MMC1_1+EC1}
AEB1: 00              BRK                         ; 
...
AEB9: 18              CLC                         ; 
AEBA: 79 A9 AE        ADC     $AEA9,Y             ; {hard.MMC1_1+EA9}
AEBD: 85 00           STA     <$00                ; {ram.GP_00}
AEBF: B5 84           LDA     $84,X               ; {ram.0084}
AEC1: 18              CLC                         ; 
AEC2: 79 AD AE        ADC     $AEAD,Y             ; {hard.MMC1_1+EAD}
AEC5: 85 01           STA     <$01                ; {ram.GP_01}
AEC7: B9 B1 AE        LDA     $AEB1,Y             ; {hard.MMC1_1+EB1}
...
AED7: A8              TAY                         ; 
AED8: B9 91 AE        LDA     $AE91,Y             ; {hard.MMC1_1+E91}
AEDB: 20 DF 77        JSR     $77DF               ; {ram.77DF}
AEDE: 68              PLA                         ; 
AEDF: A8              TAY                         ; 
AEE0: 88              DEY                         ; 
AEE1: 10 D4           BPL     $AEB7               ; {hard.MMC1_1+EB7}
AEE3: 60              RTS                         ; 
...
AEF5: D0 0D           BNE     $AF04               ; {hard.MMC1_1+F04}
...
AF64: 07                              ;
AF65: 17                              ;
AF66: 30 16           BMI     $AF7E               ; {hard.MMC1_1+F7E}
AF68: 2C 3C 27        BIT     $273C               ; 
AF6B: 06 16           ASL     <$16                ; {ram.0016}
AF6D: A0 02           LDY     #$02                ; 
AF6F: D0 06           BNE     $AF77               ; {hard.MMC1_1+F77}
AF71: A0 05           LDY     #$05                ; 
AF73: D0 02           BNE     $AF77               ; {hard.MMC1_1+F77}
AF75: A0 08           LDY     #$08                ; 
AF77: 98              TYA                         ; 
AF78: 48              PHA                         ; 
AF79: AE 01 03        LDX     $0301               ; {ram.0301}
AF7C: A0 00           LDY     #$00                ; 
AF7E: B9 5C AF        LDA     $AF5C,Y             ; {hard.MMC1_1+F5C}
AF81: 9D 02 03        STA     $0302,X             ; {ram.0302}
AF84: E8              INX                         ; 
AF85: C8              INY                         ; 
AF86: C0 08           CPY     #$08                ; 
AF88: D0 F4           BNE     $AF7E               ; {hard.MMC1_1+F7E}
AF8A: 8E 01 03        STX     $0301               ; {ram.0301}
AF8D: 68              PLA                         ; 
AF8E: A8              TAY                         ; 
AF8F: A2 02           LDX     #$02                ; 
AF91: B9 64 AF        LDA     $AF64,Y             ; {hard.MMC1_1+F64}
AF94: 9D 06 03        STA     $0306,X             ; {ram.0306}
AF97: 88              DEY                         ; 
AF98: CA              DEX                         ; 
AF99: 10 F6           BPL     $AF91               ; {hard.MMC1_1+F91}
AF9B: AE 40 03        LDX     $0340               ; {ram.0340}
AF9E: 60              RTS                         ; 
AF9F: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
AFA2: A9 0B           LDA     #$0B                ; 
AFA4: 4C DF 77        JMP     $77DF               ; {ram.77DF}
AFA7: A5 BF           LDA     <$BF                ; {ram.00BF}
AFA9: F0 0E           BEQ     $AFB9               ; {hard.MMC1_1+FB9}
AFAB: 20 14 73        JSR     $7314               ; {ram.7314}
AFAE: D0 09           BNE     $AFB9               ; {hard.MMC1_1+FB9}
AFB0: A9 00           LDA     #$00                ; 
...
B003: 4A              LSR     A                   ; 
B004: B0 04           BCS     $B00A               ; {hard.MMC1_1+100A}
B006: 68              PLA                         ; 
B007: 29 F0           AND     #$F0                ; 
B009: 60              RTS                         ; 
B00A: 68              PLA                         ; 
...
B03B: 0A              ASL     A                   ; 
B03C: 14                              ;
B03D: 1E 50 98        ASL     $9850,X             ; {hard.MMC1_0+1850}
B040: 68              PLA                         ; 
B041: 68              PLA                         ; 
B042: 22                              ;
B043: 18              CLC                         ; 
...
B071: A0 06           LDY     #$06                ; 
B073: D9 1B B0        CMP     $B01B,Y             ; {hard.MMC1_1+101B}
B076: F0 7D           BEQ     $B0F5               ; {hard.MMC1_1+10F5}
B078: 88              DEY                         ; 
B079: 10 F8           BPL     $B073               ; {hard.MMC1_1+1073}
B07B: A0 05           LDY     #$05                ; 
B07D: D9 22 B0        CMP     $B022,Y             ; {hard.MMC1_1+1022}
B080: F0 1D           BEQ     $B09F               ; {hard.MMC1_1+109F}
B082: 88              DEY                         ; 
B083: 10 F8           BPL     $B07D               ; {hard.MMC1_1+107D}
B085: E6 01           INC     <$01                ; {ram.GP_01}
B087: A0 08           LDY     #$08                ; 
B089: D9 28 B0        CMP     $B028,Y             ; {hard.MMC1_1+1028}
B08C: F0 11           BEQ     $B09F               ; {hard.MMC1_1+109F}
B08E: 88              DEY                         ; 
B08F: 10 F8           BPL     $B089               ; {hard.MMC1_1+1089}
B091: E6 01           INC     <$01                ; {ram.GP_01}
B093: A0 08           LDY     #$08                ; 
B095: D9 31 B0        CMP     $B031,Y             ; {hard.MMC1_1+1031}
B098: F0 05           BEQ     $B09F               ; {hard.MMC1_1+109F}
B09A: 88              DEY                         ; 
B09B: 10 F8           BPL     $B095               ; {hard.MMC1_1+1095}
B09D: E6 01           INC     <$01                ; {ram.GP_01}
B09F: E0 01           CPX     #$01                ; 
B0A1: D0 08           BNE     $B0AB               ; {hard.MMC1_1+10AB}
B0A3: C9 2A           CMP     #$2A                ; 
B0A5: F0 4E           BEQ     $B0F5               ; {hard.MMC1_1+10F5}
B0A7: C9 30           CMP     #$30                ; 
B0A9: F0 4A           BEQ     $B0F5               ; {hard.MMC1_1+10F5}
B0AB: A4 01           LDY     <$01                ; {ram.GP_01}
B0AD: B9 3A B0        LDA     $B03A,Y             ; {hard.MMC1_1+103A}
B0B0: 18              CLC                         ; 
B0B1: 6D 2A 05        ADC     $052A               ; {ram.052A}
B0B4: A8              TAY                         ; 
B0B5: B9 42 B0        LDA     $B042,Y             ; {hard.MMC1_1+1042}
B0B8: 85 00           STA     <$00                ; {ram.GP_00}
B0BA: A9 23           LDA     #$23                ; 
B0BC: AC 27 06        LDY     $0627               ; {ram.0627}
B0BF: C0 10           CPY     #$10                ; 
B0C1: F0 0E           BEQ     $B0D1               ; {hard.MMC1_1+10D1}
B0C3: A5 50           LDA     <$50                ; {ram.0050}
B0C5: C9 0A           CMP     #$0A                ; 
B0C7: 90 12           BCC     $B0DB               ; {hard.MMC1_1+10DB}
B0C9: A9 0F           LDA     #$0F                ; 
B0CB: A4 51           LDY     <$51                ; {ram.0051}
B0CD: F0 02           BEQ     $B0D1               ; {hard.MMC1_1+10D1}
B0CF: A9 00           LDA     #$00                ; 
B0D1: 85 00           STA     <$00                ; {ram.GP_00}
B0D3: A9 00           LDA     #$00                ; 
B0D5: 85 50           STA     <$50                ; {ram.0050}
B0D7: 85 51           STA     <$51                ; {ram.0051}
B0D9: F0 09           BEQ     $B0E4               ; {hard.MMC1_1+10E4}
B0DB: A4 01           LDY     <$01                ; {ram.GP_01}
B0DD: B5 18           LDA     $18,X               ; {ram.0018}
B0DF: D9 3E B0        CMP     $B03E,Y             ; {hard.MMC1_1+103E}
B0E2: B0 11           BCS     $B0F5               ; {hard.MMC1_1+10F5}
B0E4: A9 FF           LDA     #$FF                ; 
B0E6: 9D A8 03        STA     $03A8,X             ; {ram.03A8}
B0E9: A5 00           LDA     <$00                ; {ram.GP_00}
B0EB: 95 AC           STA     $AC,X               ; {ram.00AC}
B0ED: C9 23           CMP     #$23                ; 
B0EF: D0 03           BNE     $B0F4               ; {hard.MMC1_1+10F4}
B0F1: 4C F4 B1        JMP     $B1F4               ; {hard.MMC1_1+11F4}
B0F4: 60              RTS                         ; 
B0F5: 4C 5F B1        JMP     $B15F               ; {hard.MMC1_1+115F}
B0F8: 00              BRK                         ; 
B0F9: 0F                              ;
B0FA: 0D 12 A5        ORA     $A512               ; {hard.MMC1_1+512}
B0FD: 15 4A           ORA     $4A,X               ; {ram.004A}
B0FF: 90 03           BCC     $B104               ; {hard.MMC1_1+1104}
B101: DE A8 03        DEC     $03A8,X             ; {ram.03A8}
B104: BD A8 03        LDA     $03A8,X             ; {ram.03A8}
B107: F0 56           BEQ     $B15F               ; {hard.MMC1_1+115F}
B109: B5 AC           LDA     $AC,X               ; {ram.00AC}
B10B: C9 23           CMP     #$23                ; 
B10D: F0 06           BEQ     $B115               ; {hard.MMC1_1+1115}
B10F: 20 0E E7        JSR     $E70E               ; {hard.MMC1_2+270E}
B112: 4C 18 B1        JMP     $B118               ; {hard.MMC1_1+1118}
B115: 20 1D B2        JSR     $B21D               ; {hard.MMC1_1+121D}
B118: A5 AC           LDA     <$AC                ; {ram.00AC}
B11A: 29 C0           AND     #$C0                ; 
B11C: C9 40           CMP     #$40                ; 
B11E: F0 3E           BEQ     $B15E               ; {hard.MMC1_1+115E}
B120: A9 04           LDA     #$04                ; 
...
B12C: BE F7 B0        LDX     $B0F7,Y             ; {hard.MMC1_1+10F7}
B12F: B5 70           LDA     $70,X               ; {ram.0070}
B131: 85 70           STA     <$70                ; {ram.0070}
B133: B5 84           LDA     $84,X               ; {ram.0084}
B135: 85 84           STA     <$84                ; {ram.0084}
B137: E0 00           CPX     #$00                ; 
B139: F0 06           BEQ     $B141               ; {hard.MMC1_1+1141}
B13B: B5 AC           LDA     $AC,X               ; {ram.00AC}
B13D: F0 0C           BEQ     $B14B               ; {hard.MMC1_1+114B}
B13F: 30 0A           BMI     $B14B               ; {hard.MMC1_1+114B}
...
B156: C9 FF           CMP     #$FF                ; 
B158: F0 05           BEQ     $B15F               ; {hard.MMC1_1+115F}
B15A: C6 0D           DEC     <$0D                ; {ram.000D}
B15C: D0 C6           BNE     $B124               ; {hard.MMC1_1+1124}
B15E: 60              RTS                         ; 
B15F: A9 00           LDA     #$00                ; 
B161: 9D 4F 03        STA     $034F,X             ; {ram.034F}
B164: 20 E6 EE        JSR     $EEE6               ; {hard.MMC1_2+2EE6}
...
B17E: F0 3C           BEQ     $B1BC               ; {hard.MMC1_1+11BC}
B180: 20 BB FE        JSR     $FEBB               ; {hard.MMC1_3+1EBB}
B183: F0 37           BEQ     $B1BC               ; {hard.MMC1_1+11BC}
B185: A5 00           LDA     <$00                ; {ram.GP_00}
B187: C9 53           CMP     #$53                ; 
B189: 90 0A           BCC     $B195               ; {hard.MMC1_1+1195}
B18B: AD 4C 03        LDA     $034C               ; {ram.034C}
B18E: C9 04           CMP     #$04                ; 
B190: B0 2A           BCS     $B1BC               ; {hard.MMC1_1+11BC}
B192: EE 4C 03        INC     $034C               ; {ram.034C}
B195: A6 59           LDX     <$59                ; {ram.0059}
B197: A5 00           LDA     <$00                ; {ram.GP_00}
B199: 20 B3 FE        JSR     $FEB3               ; {hard.MMC1_3+1EB3}
...
B1C1: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
B1C4: CA              DEX                         ; 
B1C5: B1 E4           LDA     ($E4),Y             ; {ram.00E4}
B1C7: B1 DC           LDA     ($DC),Y             ; 
B1C9: B1 A4           LDA     ($A4),Y             ; {ram.00A4}
B1CB: EB                              ;
B1CC: 20 EA B1        JSR     $B1EA               ; {hard.MMC1_1+11EA}
B1CF: F0 0B           BEQ     $B1DC               ; {hard.MMC1_1+11DC}
B1D1: A9 C0           LDA     #$C0                ; 
...
B1E2: F0 F5           BEQ     $B1D9               ; {hard.MMC1_1+11D9}
B1E4: 20 B7 74        JSR     $74B7               ; {ram.74B7}
B1E7: F0 F4           BEQ     $B1DD               ; {hard.MMC1_1+11DD}
B1E9: 60              RTS                         ; 
B1EA: A5 10           LDA     <$10                ; {ram.0010}
B1EC: F0 05           BEQ     $B1F3               ; {hard.MMC1_1+11F3}
B1EE: B9 7E 6A        LDA     $6A7E,Y             ; 
B1F1: 29 80           AND     #$80                ; 
B1F3: 60              RTS                         ; 
B1F4: A9 08           LDA     #$08                ; 
B1F6: 8D 02 06        STA     $0602               ; {ram.SND_ReqMusEff}
B1F9: 20 0B B2        JSR     $B20B               ; {hard.MMC1_1+120B}
B1FC: A9 08           LDA     #$08                ; 
...
B21C: 60              RTS                         ; 
B21D: 20 35 B2        JSR     $B235               ; {hard.MMC1_1+1235}
B220: 20 88 B2        JSR     $B288               ; {hard.MMC1_1+1288}
B223: 20 93 FA        JSR     $FA93               ; {hard.MMC1_3+1A93}
...
B238: 20 E2 E5        JSR     $E5E2               ; {hard.MMC1_2+25E2}
...
B2D7: C9 20           CMP     #$20                ; 
B2D9: F0 03           BEQ     $B2DE               ; {hard.MMC1_1+12DE}
B2DB: 20 73 6F        JSR     $6F73               ; {ram.6F73}
B2DE: A5 0F           LDA     <$0F                ; {ram.000F}
B2E0: D0 16           BNE     $B2F8               ; {hard.MMC1_1+12F8}
B2E2: 20 9F B3        JSR     $B39F               ; {hard.MMC1_1+139F}
B2E5: 98              TYA                         ; 
B2E6: 18              CLC                         ; 
B2E7: 69 04           ADC     #$04                ; 
B2E9: 29 07           AND     #$07                ; 
...
B2EF: C9 41           CMP     #$41                ; 
B2F1: F0 06           BEQ     $B2F9               ; {hard.MMC1_1+12F9}
B2F3: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
B2F6: 95 98           STA     $98,X               ; {ram.0098}
B2F8: 60              RTS                         ; 
B2F9: E0 05           CPX     #$05                ; 
B2FB: F0 04           BEQ     $B301               ; {hard.MMC1_1+1301}
B2FD: E0 0A           CPX     #$0A                ; 
B2FF: D0 06           BNE     $B307               ; {hard.MMC1_1+1307}
B301: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
B304: 9D BC 03        STA     $03BC,X             ; {ram.03BC}
B307: 60              RTS                         ; 
B308: B5 28           LDA     $28,X               ; {ram.0028}
B30A: D0 FB           BNE     $B307               ; {hard.MMC1_1+1307}
B30C: DE 2C 04        DEC     $042C,X             ; {ram.!SplashMode}
B30F: D0 05           BNE     $B316               ; {hard.MMC1_1+1316}
B311: A9 01           LDA     #$01                ; 
B313: 4C 7A B2        JMP     $B27A               ; {hard.MMC1_1+127A}
B316: A9 10           LDA     #$10                ; 
...
B323: F0 05           BEQ     $B32A               ; {hard.MMC1_1+132A}
B325: B0 01           BCS     $B328               ; {hard.MMC1_1+1328}
B327: C8              INY                         ; 
B328: 84 00           STY     <$00                ; {ram.GP_00}
B32A: A0 01           LDY     #$01                ; 
B32C: A5 62           LDA     <$62                ; {ram.0062}
B32E: D5 84           CMP     $84,X               ; {ram.0084}
B330: F0 0A           BEQ     $B33C               ; {hard.MMC1_1+133C}
B332: B0 01           BCS     $B335               ; {hard.MMC1_1+1335}
B334: C8              INY                         ; 
B335: 98              TYA                         ; 
B336: 0A              ASL     A                   ; 
B337: 0A              ASL     A                   ; 
...
B33C: 20 9F B3        JSR     $B39F               ; {hard.MMC1_1+139F}
B33F: A9 03           LDA     #$03                ; 
...
B345: 29 07           AND     #$07                ; 
B347: A8              TAY                         ; 
B348: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
B34B: C5 00           CMP     <$00                ; {ram.GP_00}
B34D: F0 20           BEQ     $B36F               ; {hard.MMC1_1+136F}
B34F: 88              DEY                         ; 
B350: C6 01           DEC     <$01                ; {ram.GP_01}
B352: D0 F0           BNE     $B344               ; {hard.MMC1_1+1344}
B354: A9 03           LDA     #$03                ; 
...
B35A: 29 07           AND     #$07                ; 
B35C: A8              TAY                         ; 
B35D: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
B360: 24 00           BIT     <$00                ; {ram.GP_00}
B362: D0 0C           BNE     $B370               ; {hard.MMC1_1+1370}
B364: C8              INY                         ; 
B365: C6 01           DEC     <$01                ; {ram.GP_01}
B367: D0 F0           BNE     $B359               ; {hard.MMC1_1+1359}
B369: 88              DEY                         ; 
B36A: B9 4E B2        LDA     $B24E,Y             ; {hard.MMC1_1+124E}
B36D: 95 98           STA     $98,X               ; {ram.0098}
B36F: 60              RTS                         ; 
B370: 05 00           ORA     <$00                ; {ram.GP_00}
B372: C9 07           CMP     #$07                ; 
B374: B0 EE           BCS     $B364               ; {hard.MMC1_1+1364}
B376: 90 F2           BCC     $B36A               ; {hard.MMC1_1+136A}
B378: B5 28           LDA     $28,X               ; {ram.0028}
B37A: D0 30           BNE     $B3AC               ; {hard.MMC1_1+13AC}
B37C: DE 2C 04        DEC     $042C,X             ; {ram.!SplashMode}
B37F: D0 03           BNE     $B384               ; {hard.MMC1_1+1384}
B381: 4C 11 B3        JMP     $B311               ; {hard.MMC1_1+1311}
B384: A9 10           LDA     #$10                ; 
B386: 95 28           STA     $28,X               ; {ram.0028}
B388: 20 9F B3        JSR     $B39F               ; {hard.MMC1_1+139F}
B38B: B5 19           LDA     $19,X               ; {ram.0019}
B38D: C9 A0           CMP     #$A0                ; 
B38F: B0 07           BCS     $B398               ; {hard.MMC1_1+1398}
B391: C8              INY                         ; 
B392: C9 50           CMP     #$50                ; 
B394: B0 02           BCS     $B398               ; {hard.MMC1_1+1398}
B396: 88              DEY                         ; 
B397: 88              DEY                         ; 
B398: 98              TYA                         ; 
B399: 29 07           AND     #$07                ; 
B39B: A8              TAY                         ; 
B39C: 4C 6A B3        JMP     $B36A               ; {hard.MMC1_1+136A}
B39F: A0 07           LDY     #$07                ; 
B3A1: B5 98           LDA     $98,X               ; {ram.0098}
B3A3: D9 4E B2        CMP     $B24E,Y             ; {hard.MMC1_1+124E}
B3A6: F0 04           BEQ     $B3AC               ; {hard.MMC1_1+13AC}
B3A8: 88              DEY                         ; 
B3A9: 10 F6           BPL     $B3A1               ; {hard.MMC1_1+13A1}
B3AB: C8              INY                         ; 
B3AC: 60              RTS                         ; 
B3AD: 00              BRK                         ; 
B3AE: 18              CLC                         ; 
B3AF: 30 47           BMI     $B3F8               ; {hard.MMC1_1+13F8}
B3B1: 5A                              ;
B3B2: 6A              ROR     A                   ; 
...
B3EA: 4C FA B3        JMP     $B3FA               ; {hard.MMC1_1+13FA}
...
B448: 90 0B           BCC     $B455               ; {hard.MMC1_1+1455}
B44A: A5 02           LDA     <$02                ; {ram.GP_02}
B44C: 18              CLC                         ; 
B44D: 65 01           ADC     <$01                ; {ram.GP_01}
B44F: 85 02           STA     <$02                ; {ram.GP_02}
B451: 90 02           BCC     $B455               ; {hard.MMC1_1+1455}
B453: E6 03           INC     <$03                ; {ram.GP_03}
B455: 88              DEY                         ; 
B456: D0 EA           BNE     $B442               ; {hard.MMC1_1+1442}
B458: 60              RTS                         ; 
