...
8837: B9 00 80        LDA     $8000,Y             ; {code.StringTable} Get ...
883A: 85 00           STA     <$00                ; {ram.GP_00} ... LSB
883C: C8              INY                         ; Next byte in pointer
883D: B9 00 80        LDA     $8000,Y             ; {code.StringTable} Get ...
...
BF6A: 8D 00 80        STA     $8000               ; {code.StringTable} ... ...
...
BF98: 8D 00 80        STA     $8000               ; {code.StringTable} MMC Register 0 (control): --edcba ...
BF9B: 4A              LSR     A                   ; ... mirroring
BF9C: 8D 00 80        STA     $8000               ; {code.StringTable} ... mirroring
BF9F: 4A              LSR     A                   ; ... switch: c=0 high ROM, C=1 low ROM
BFA0: 8D 00 80        STA     $8000               ; {code.StringTable} ... size: d=0 32K (full), D=1 16K (half)
BFA3: 4A              LSR     A                   ; ... chrrom mode: e=0 8K banks, B=1 4K banks
BFA4: 8D 00 80        STA     $8000               ; {code.StringTable} The MMC is write-trigger (write to ROM ...
BFA7: 4A              LSR     A                   ; .. has no affect anyway).
BFA8: 8D 00 80        STA     $8000               ; {code.StringTable} Bits are written from LSB to MSB ...
