...
A8B4: 29 FB         AND   #$FB                ;
A8B6: 85 FF         STA   <$FF                ; 
A8B8: 8D 00 20      STA   $2000               ; [NES] PPU setup #1
...
B5BD: 48            PHA                       ;
B5BE: A0 0E         LDY   #$0E                ;
B5C0: B9 05 03      LDA   $0305,Y             ;
B5C3: 99 06 03      STA   $0306,Y             ;
B5C6: 88            DEY                       ;
B5C7: 10 F7         BPL   $B5C0               ; 
B5C9: 68            PLA                       ;
B5CA: 8D 05 03      STA   $0305               ; 
B5CD: CA            DEX                       ;
