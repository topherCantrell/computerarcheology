...
0673: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
0676: E6 84           LDB     ,X                  ; Get player location
0678: F7 01 D5        STB     $01D5               ; {ram.CUR_ROOM} Current room
067B: 8E 15 A1        LDX     #$15A1              ; Room scripts
067E: BD 0A 60        JSR     $0A60               ; {code.FindSublist} Find sublist ... script for current room
...
06D4: BD 0A 60        JSR     $0A60               ; {code.FindSublist} Look for an entry for the given verb
06D7: 24 13           BCC     $6EC                ; {} No entry ... use the word as-is
06D9: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length of entry
06DC: BD 0A 99        JSR     $0A99               ; {code.CompareXY} End of list?
...
076D: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ID and load end
...
077F: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ID and load end
...
083D: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} ... being commanded
0840: 20 16           BRA     $858                ; {} Allow other objects to move
 
0842: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip size
0845: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute command handler
...
087C: BD 0A 60        JSR     $0A60               ; {code.FindSublist} Get pointer to next object that matches word
...
0899: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip the id and end
...
08A5: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip the id and length
08A8: BD 0A 99        JSR     $0A99               ; {code.CompareXY} End of adjective list?
...
08C6: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip id and end
...
;
08EB: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip size
...
0925: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ID and load end
0928: BD 0A 99        JSR     $0A99               ; {code.CompareXY} At end of object data?
...
0940: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ID and load end
...
0968: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ID and load end
...
0A62: BD 0A 85        JSR     $0A85               ; {code.LoadEnd} Read end of list to Y
0A65: 7F 01 E1        CLR     $01E1               ; {ram.tmp1E1} Clear index of sublist
0A68: BD 0A 99        JSR     $0A99               ; {code.CompareXY} Compare X to Y
...
0A77: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ID and read end of list to Y
...
0AA7: BD 0B 6C        JSR     $0B6C               ; {code.GetKey} Get a key from the keyboard
...
0B19: 7E 0A A1        JMP     $0AA1               ; {code.GetInputLine} Go get another key
;   
...
```code
GetKey:
0B6C: BD 13 19        JSR     $1319               ; {code.Com_2B_generate_random} Get random number every key
0B6F: AD 9F A0 00     JSR     [$A000]             ; {hard.POLCAT} Get key from user
0B73: 4D              TSTA                        ; Anything pressed?
0B74: 27 F6           BEQ     $B6C                ; {code.GetKey} No ... keep waiting
...
0B91: 24 EE           BCC     $B81                ; {code.DecodeBuffer} No ... skip till we find one
0B93: 10 8E 3B D5     LDY     #$3BD5              ; Word token table
0B97: BD 0B CC        JSR     $0BCC               ; {code.DecodeWord} Try first list
0B9A: 27 E7           BEQ     $B83                ; {} Found a match ... ignore it
0B9C: C6 01           LDB     #$01                ; Staring list number
0B9E: 31 21           LEAY    1,Y                 ; Next list of words
0BA0: BD 0B CC        JSR     $0BCC               ; {code.DecodeWord} Try and match
...
0C26: 7C 01 A8        INC     $01A8               ; {ram.tmp1A7+1} Point to next character past space (start of next word)
0C29: B6 01 A8        LDA     $01A8               ; {ram.tmp1A7+1} Keep ...
...
0C41: 7E 0B CC        JMP     $0BCC               ; {code.DecodeWord} Keep trying
```
...
0C51: BD 0A 60        JSR     $0A60               ; {code.FindSublist} Find common command
0C54: 24 06           BCC     $C5C                ; {} Not found ... skip
0C56: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length of command
0C59: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute command
...
0C68: BD 0A 85        JSR     $0A85               ; {code.LoadEnd} Read length of command
0C6B: BD 0A 99        JSR     $0A99               ; {code.CompareXY} Are we past the end?
0C6E: 24 0C           BCC     $C7C                ; {} Yes ... end successfully
0C70: 34 20           PSHS    Y                   ; Hold the end
0C72: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute the command
...
Com_0E_while_fail:
; while_fail:
0C80: BD 0A 85        JSR     $0A85               ; {code.LoadEnd} Load the end
0C83: BD 0A 99        JSR     $0A99               ; {code.CompareXY} Reached end of list?
0C86: 24 0C           BCC     $C94                ; {} Yes ... error
0C88: 34 20           PSHS    Y                   ; Hold end of command
0C8A: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute command
...
Com_0B_switch:
; switch:
0C99: BD 0A 85        JSR     $0A85               ; {code.LoadEnd} Get size of switch list
0C9C: E6 80           LDB     ,X+                 ; Get function to call
0C9E: BD 0A 99        JSR     $0A99               ; {code.CompareXY} End of options?
...
0CB0: BD 0A 85        JSR     $0A85               ; {code.LoadEnd} Size of pass script
0CB3: 1E 12           EXG     X,Y                 ; Skip over this option
0CB5: 35 20           PULS    Y                   ; End of script
0CB7: 20 E5           BRA     $C9E                ; {} Keep looking
0CB9: BD 0A 85        JSR     $0A85               ; {code.LoadEnd} Skip length
0CBC: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute
0CBF: 35 10           PULS    X                   ; Restore script
0CC1: 39              RTS                         ; Done

Com_00_move_ACTIVE_and_look:
; move_ACTIVE_and_look(room)
0CC2: BD 0C CE        JSR     $0CCE               ; {code.Com_19_move_ACTIVE} Move active object to new room
...
0D5F: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ID and length
0D62: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute general script
...
0D99: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
0D9C: 30 01           LEAX    1,X                 ; 
...
0DB1: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute preamble script
0DB4: 35 10           PULS    X                   ; Restore script
0DB6: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip script length
0DB9: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute description script
...
0DC7: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
0DCA: 34 20           PSHS    Y                   ; Hold end
0DCC: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip this object's length
...
0DE5: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
0DE8: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Print object description
...
0E04: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Print door closed status.
...
0E10: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Print period and 2 spaces
...
0E1B: BD 0A 99        JSR     $0A99               ; {code.CompareXY} Are we at the end of objects?
...
0E57: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip the length
...
0E7E: BD 0A 85        JSR     $0A85               ; {code.LoadEnd} Skip to ...
0E81: 1E 12           EXG     X,Y                 ; ... end of packed message.
0E83: 20 03           BRA     $E88                ; {} Return OK but no printing
0E85: BD 11 99        JSR     $1199               ; {code.PrintPackedMessage} Print packed message at X
0E88: 4F              CLRA                        ; OK
0E89: 39              RTS                         ; Done
...
;
0E9C: BD 0A 99        JSR     $0A99               ; {code.CompareXY} CompareXY
0E9F: 24 2A           BCC     $ECB                ; {} End of list ... out
0EA1: 34 20           PSHS    Y                   ; Hold end of master list of objects
0EA3: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Get pointer to next object
...
0F09: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
0F1A: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
0F2B: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip id and length
...
0F37: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip id and length
0F3A: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute
...
0F47: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ...
...
0F53: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip header
0F56: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute script
...
0F68: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip ...
...
0F74: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip the id and length
0F77: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute script (use return)
...
0F9F: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip object ...
...
0FAD: BD 11 99        JSR     $1199               ; {code.PrintPackedMessage} Print packed message at X
...
0FC8: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip the pointer-to-next object
...
0FE9: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip the pointer-to-next object
...
1004: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip the pointer-to-next object
...
1013: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute command
...
1024: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip over length
...
1036: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
1057: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
105A: BD 0A 99        JSR     $0A99               ; {code.CompareXY} End of objects?
105D: 24 D1           BCC     $1030               ; {} Yes ... out
105F: 7C 01 D0        INC     $01D0               ; {ram.tmp1DO} Next object number
1062: 34 20           PSHS    Y                   ; Hold end-of-objects
1064: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
107B: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
107E: 34 10           PSHS    X                   ; Hold pointer
1080: BD 13 19        JSR     $1319               ; {code.Com_2B_generate_random} Generate random number
...
1098: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
10A9: BD 0A 60        JSR     $0A60               ; {code.FindSublist} ... scripts for object
10AC: BF 01 D6        STX     $01D6               ; {ram.CUR_ROOM_DATA} Hold
10AF: 35 10           PULS    X                   ; Restore turn-script
10B1: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute turn-script
...
10D2: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
10E2: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
1103: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip id and length
1106: BD 0C 44        JSR     $0C44               ; {code.ProcessCommand} Execute "being killed" script
...
111D: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
1128: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
1145: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
1151: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip length
...
Com_24_endless_loop:
; endless_loop()
117B: 20 FE           BRA     $117B               ; {code.Com_24_endless_loop} Endless loop

; Find object index in B
117D: 8E 1B 42        LDX     #$1B42              ; Start of objects
1180: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Skip end
1183: 5A              DECB                        ; Found desired object?
1184: 27 F4           BEQ     $117A               ; {} Yes ... out OK
1186: BD 0A 83        JSR     $0A83               ; {code.SkipIDLoadEnd} Length of object
...
11B2: BD 12 59        JSR     $1259               ; {code.UnpackBytes} Decompress and print two bytes pointed to by X
...
11F9: 96 89           LDA     <$89                ; {ram.printCursor+1} LSB of screen position (we know MSB is 4 or 5)
...
1235: 2B 01           BMI     $1238               ; {code.MorePrompt} Yes ... do it and out
1237: 39              RTS                         ; Done
...
124A: BD 0B 6C        JSR     $0B6C               ; {code.GetKey} Get a key
