...
static ADDRESS lastpc;
static ADDRESS A11;		/* PC bit 11 */
static ADDRESS A11ff;
static Byte bs; 		/* Register Bank (part of psw) */
static Byte f0;			/* Flag Bit (part of psw) */
static Byte f1;			/* Flag Bit 1 */
static Byte ac;			/* Aux Carry (part of psw) */
static Byte cy;	    	/* Carry flag (part of psw) */
static Byte xirq_en;	/* external IRQ's enabled */
static Byte tirq_en;	/* Timer IRQ enabled */
static Byte irq_ex;		/* IRQ executing */
