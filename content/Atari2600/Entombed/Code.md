...
B443: 20 A5 BC        JSR     $BCA5               ; {code.GetRandom}
B446: 0A              ASL     A                   
...
B779: 0A              ASL     A                   
B77A: 60              RTS                         
B77B: 20 A5 BC        JSR     $BCA5               ; {code.GetRandom}
B77E: 0A              ASL     A                   
...
BAF1: 20 A5 BC        JSR     $BCA5               ; {code.GetRandom}
BAF4: 0A              ASL     A                   
BAF5: 90 02           BCC     $BAF9               ; {}
BAF7: B0 1D           BCS     $BB16               ; {}
BAF9: A9 01           LDA     #$01                
...
BB09: 20 A5 BC        JSR     $BCA5               ; {code.GetRandom}
BB0C: 0A              ASL     A                   
BB0D: 90 07           BCC     $BB16               ; {}
BB0F: A9 00           LDA     #$00                
...
BB23: 20 A5 BC        JSR     $BCA5               ; {code.GetRandom}
BB26: 0A              ASL     A                   
BB27: 90 D0           BCC     $BAF9               ; {}
BB29: A9 00           LDA     #$00                
...
BB3C: C9 08           CMP     #$08                
BB3E: D0 4A           BNE     $BB8A               ; {}
BB40: 20 A5 BC        JSR     $BCA5               ; {code.GetRandom}
BB43: 29 0F           AND     #$0F                
BB45: C9 06           CMP     #$06                
BB47: B0 37           BCS     $BB80               ; {}
BB49: A9 3E           LDA     #$3E                
...
BB75: 20 A5 BC        JSR     $BCA5               ; {code.GetRandom}
BB78: 29 0F           AND     #$0F                
BB7A: C9 08           CMP     #$08                
BB7C: D0 07           BNE     $BB85               ; {}
BB7E: F0 0F           BEQ     $BB8F               ; {}
