...
FCDA: 85 2C           STA     $2C                 ; {hard.CXCLR} CXCLR clear all collision flags
FCDC: AD 84 02        LDA     $0284               ; {hard.INTIM} ??? Time to draw the visible screen?
FCDF: 10 FB           BPL     $FCDC               ; {} ??? No ... keep waiting
FCE1: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FCE3: A2 03           LDX     #$03                ; Start the ...
FCE5: 86 00           STX     $00                 ; {hard.VSYNC} ... VSYNC
FCE7: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FCE9: AD E6 FF        LDA     $FFE6               ; {} Switch in bank 6
FCEC: 20 CB F3        JSR     $F3CB               
FCEF: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FCF1: 86 00           STX     $00                 ; {hard.VSYNC} X has 0 at this point ... release the VSYNC
FCF3: A9 22           LDA     #$22                ; 34 ticks = 2176 machine cycles ...
FCF5: 8D 96 02        STA     $0296               ; {hard.TIM64T} ... 2176/(228/3) = 28.6 scanlines
FCF8: 24 F6           BIT     $F6                 ; {ram.mF6}
FCFA: 70 06           BVS     $FD02               ; {}
...
FD0E: AD 84 02        LDA     $0284               ; {hard.INTIM} Time to draw the visible screen?
...
FD2A: A9 DF           LDA     #$DF                
FD2C: 85 06           STA     $06                 ; {hard.COLUP0} COLUP0
FD2E: 85 07           STA     $07                 ; {hard.COLUP1} COLUP1
FD30: AD 58 F9        LDA     $F958               ; {}
FD33: 85 F2           STA     $F2                 ; {ram.mF2}
FD35: A5 D1           LDA     $D1                 ; {ram.mD1}
FD37: 85 F3           STA     $F3                 ; {ram.mF3}
FD39: A2 03           LDX     #$03                
FD3B: 20 96 F7        JSR     $F796               
FD3E: A0 05           LDY     #$05                
FD40: 20 4F F7        JSR     $F74F               
FD43: A9 0D           LDA     #$0D                
FD45: 85 06           STA     $06                 ; {hard.COLUP0} COLUP0
FD47: A9 35           LDA     #$35                
FD49: 85 07           STA     $07                 ; {hard.COLUP1} COLUP1
FD4B: A9 31           LDA     #$31                
FD4D: 85 0A           STA     $0A                 ; {hard.CTRLPF} CTRLPF
...
FD67: 85 0B           STA     $0B                 ; {hard.REFP0} ... REFP0 player 1
FD69: EA              NOP                         
FD6A: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FD6C: EA              NOP                         
FD6D: EA              NOP                         
FD6E: A0 78           LDY     #$78                
FD70: B1 C9           LDA     ($C9),Y             ; {ram.mC9}
FD72: 4C 16 FE        JMP     $FE16               ; {}
FD75: A9 00           LDA     #$00                ; For clearing
FD77: 85 0A           STA     $0A                 ; {hard.CTRLPF} CTRLPF
FD79: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FD7B: 85 0D           STA     $0D                 ; {hard.PF0} PF0
FD7D: 85 0E           STA     $0E                 ; {hard.PF1} PF1
FD7F: 85 0F           STA     $0F                 ; {hard.PF2} PF2
FD81: 85 1D           STA     $1D                 ; {hard.ENAM0} ENAM0
FD83: 85 1E           STA     $1E                 ; {hard.ENAM1} ENAM1
FD85: 85 1F           STA     $1F                 ; {hard.ENABL} ENABL
FD87: 85 1B           STA     $1B                 ; {hard.GRP0} GRP0
FD89: 85 1C           STA     $1C                 ; {hard.GRP1} GRP1
FD8B: A9 1F           LDA     #$1F                
FD8D: 85 08           STA     $08                 ; {hard.COLUPF} COLUPF
FD8F: A0 12           LDY     #$12                
FD91: A2 03           LDX     #$03                
FD93: 86 C7           STX     $C7                 ; {ram.mC7}
FD95: A2 00           LDX     #$00                
FD97: F0 12           BEQ     $FDAB               ; {}
FD99: A9 03           LDA     #$03                
FD9B: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FD9D: 85 C7           STA     $C7                 ; {ram.mC7}
FD9F: A9 00           LDA     #$00                ; Clear
FDA1: 85 0E           STA     $0E                 ; {hard.PF1} PF1
FDA3: 85 0F           STA     $0F                 ; {hard.PF2} PF2
FDA5: BD E8 F7        LDA     $F7E8,X             
FDA8: 85 08           STA     $08                 ; {hard.COLUPF} COLUPF
FDAA: 88              DEY                         
FDAB: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FDAD: B9 EC F7        LDA     $F7EC,Y             
FDB0: 3D 72 F9        AND     $F972,X             ; {}
FDB3: 85 0E           STA     $0E                 ; {hard.PF1} PF1
FDB5: B9 EC F7        LDA     $F7EC,Y             
FDB8: 3D 77 F9        AND     $F977,X             ; {}
FDBB: 85 0F           STA     $0F                 ; {hard.PF2} PF2
FDBD: EA              NOP                         
FDBE: EA              NOP                         
FDBF: B9 EC F7        LDA     $F7EC,Y             
FDC2: 3D 7C F9        AND     $F97C,X             ; {}
FDC5: 85 0E           STA     $0E                 ; {hard.PF1} PF1
FDC7: B9 EC F7        LDA     $F7EC,Y             
FDCA: 3D 81 F9        AND     $F981,X             ; {}
FDCD: 85 0F           STA     $0F                 ; {hard.PF2} PF2
FDCF: 88              DEY                         
FDD0: 30 08           BMI     $FDDA               ; {}
FDD2: C6 C7           DEC     $C7                 ; {ram.mC7}
FDD4: 10 D5           BPL     $FDAB               ; {}
FDD6: E8              INX                         
FDD7: 4C 99 FD        JMP     $FD99               ; {}
FDDA: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FDDC: A9 92           LDA     #$92                
FDDE: 85 08           STA     $08                 ; {hard.COLUPF} COLUPF
FDE0: A9 42           LDA     #$42                
FDE2: 85 0E           STA     $0E                 ; {hard.PF1} PF1
FDE4: 85 0F           STA     $0F                 ; {hard.PF2} PF2
FDE6: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FDE8: A9 3C           LDA     #$3C                
FDEA: 85 0E           STA     $0E                 ; {hard.PF1} PF1
FDEC: 85 0F           STA     $0F                 ; {hard.PF2} PF2
FDEE: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FDF0: A9 00           LDA     #$00                
FDF2: 85 0E           STA     $0E                 ; {hard.PF1} PF1
FDF4: 85 0F           STA     $0F                 ; {hard.PF2} PF2
FDF6: A0 00           LDY     #$00                
FDF8: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FDFA: 88              DEY                         
FDFB: 10 FB           BPL     $FDF8               ; {}
...
;            
FE04: A9 00           LDA     #$00                
FE06: 85 85           STA     $85                 ; {ram.m85}
FE08: A5 C7           LDA     $C7                 ; {ram.mC7}
FE0A: 4C 43 FE        JMP     $FE43               ; {}
                   
FE0D: A9 00           LDA     #$00                
FE0F: 85 87           STA     $87                 ; {ram.m87}
FE11: A5 C7           LDA     $C7                 ; {ram.mC7}
FE13: 4C 76 FE        JMP     $FE76               ; {}
                   
FE16: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FE18: 85 0D           STA     $0D                 ; {hard.PF0}
FE1A: A5 B1           LDA     $B1                 ; {ram.mB1}
FE1C: 85 0A           STA     $0A                 ; {hard.CTRLPF}
FE1E: B1 E4           LDA     ($E4),Y             ; {ram.mE4}
FE20: 85 1B           STA     $1B                 ; {hard.GRP0}
FE22: B1 CB           LDA     ($CB),Y             ; {ram.mCB}
FE24: 85 0E           STA     $0E                 ; {hard.PF1}
FE26: B1 CD           LDA     ($CD),Y             ; {ram.mCD}
FE28: 85 0F           STA     $0F                 ; {hard.PF2}
FE2A: B1 EA           LDA     ($EA),Y             ; {ram.mEA}
FE2C: 85 1E           STA     $1E                 ; {hard.ENAM1}
FE2E: B1 EC           LDA     ($EC),Y             ; {ram.mEC}
FE30: 85 1F           STA     $1F                 ; {hard.ENABL}
FE32: 88              DEY                         
FE33: 30 CC           BMI     $FE01               ; {}
FE35: 98              TYA                         
FE36: A6 89           LDX     $89                 ; {ram.m89}
FE38: D5 8D           CMP     $8D,X               ; {ram.m8D}
FE3A: B0 C8           BCS     $FE04               ; {}
FE3C: B5 A1           LDA     $A1,X               ; {ram.mA1}
FE3E: 85 85           STA     $85                 ; {ram.m85}
FE40: E8              INX                         
FE41: 86 89           STX     $89                 ; {ram.m89}
FE43: A9 00           LDA     #$00                
FE45: 85 0D           STA     $0D                 ; {hard.PF0}
FE47: A5 B2           LDA     $B2                 ; {ram.mB2}
FE49: 85 0A           STA     $0A                 ; {hard.CTRLPF}
FE4B: B1 E4           LDA     ($E4),Y             ; {ram.mE4}
FE4D: 85 1B           STA     $1B                 ; {hard.GRP0}
FE4F: A5 81           LDA     $81                 ; {ram.m81}
FE51: 85 0E           STA     $0E                 ; {hard.PF1}
FE53: A5 82           LDA     $82                 ; {ram.m82}
FE55: 85 0F           STA     $0F                 ; {hard.PF2}
FE57: B1 E2           LDA     ($E2),Y             ; {ram.mE2}
FE59: 85 1C           STA     $1C                 ; {hard.GRP1}
FE5B: A5 83           LDA     $83                 ; {ram.m83}
FE5D: 85 0E           STA     $0E                 ; {hard.PF1}
FE5F: B1 E8           LDA     ($E8),Y             ; {ram.mE8}
FE61: 85 1D           STA     $1D                 ; {hard.ENAM0}
FE63: A5 84           LDA     $84                 ; {ram.m84}
FE65: 88              DEY                         
FE66: 85 0F           STA     $0F                 ; {hard.PF2}
FE68: 98              TYA                         
FE69: A6 8B           LDX     $8B                 ; {ram.m8B}
FE6B: D5 97           CMP     $97,X               ; {ram.m97}
FE6D: B0 9E           BCS     $FE0D               ; {}
FE6F: B5 A9           LDA     $A9,X               ; {ram.mA9}
FE71: 85 87           STA     $87                 ; {ram.m87}
FE73: E8              INX                         
FE74: 86 8B           STX     $8B                 ; {ram.m8B}
FE76: B1 E4           LDA     ($E4),Y             ; {ram.mE4}
FE78: 85 1B           STA     $1B                 ; {hard.GRP0}
FE7A: A5 81           LDA     $81                 ; {ram.m81}
FE7C: 85 0E           STA     $0E                 ; {hard.PF1}
FE7E: B1 E2           LDA     ($E2),Y             ; {ram.mE2}
FE80: 85 1C           STA     $1C                 ; {hard.GRP1}
FE82: A5 82           LDA     $82                 ; {ram.m82}
FE84: 85 0F           STA     $0F                 ; {hard.PF2}
FE86: B1 EA           LDA     ($EA),Y             ; {ram.mEA}
FE88: 85 1E           STA     $1E                 ; {hard.ENAM1}
FE8A: A5 83           LDA     $83                 ; {ram.m83}
FE8C: 85 0E           STA     $0E                 ; {hard.PF1}
FE8E: 88              DEY                         
FE8F: A5 84           LDA     $84                 ; {ram.m84}
FE91: 85 0F           STA     $0F                 ; {hard.PF2}
FE93: B1 EC           LDA     ($EC),Y             ; {ram.mEC}
FE95: 85 1F           STA     $1F                 ; {hard.ENABL}
FE97: A6 8A           LDX     $8A                 ; {ram.m8A}
FE99: 98              TYA                         
FE9A: D5 92           CMP     $92,X               ; {ram.m92}
FE9C: B0 58           BCS     $FEF6               ; {}
FE9E: B5 A5           LDA     $A5,X               ; {ram.mA5}
FEA0: 85 86           STA     $86                 ; {ram.m86}
FEA2: E8              INX                         
FEA3: 86 8A           STX     $8A                 ; {ram.m8A}
FEA5: A5 81           LDA     $81                 ; {ram.m81}
FEA7: 85 0E           STA     $0E                 ; {hard.PF1}
FEA9: B1 E4           LDA     ($E4),Y             ; {ram.mE4}
FEAB: 85 1B           STA     $1B                 ; {hard.GRP0}
FEAD: A5 82           LDA     $82                 ; {ram.m82}
FEAF: 85 0F           STA     $0F                 ; {hard.PF2}
FEB1: B1 E2           LDA     ($E2),Y             ; {ram.mE2}
FEB3: 85 1C           STA     $1C                 ; {hard.GRP1}
FEB5: A5 83           LDA     $83                 ; {ram.m83}
FEB7: 85 0E           STA     $0E                 ; {hard.PF1}
FEB9: 88              DEY                         
FEBA: A5 84           LDA     $84                 ; {ram.m84}
FEBC: 85 0F           STA     $0F                 ; {hard.PF2}
FEBE: 98              TYA                         
FEBF: A6 8C           LDX     $8C                 ; {ram.m8C}
FEC1: D5 9C           CMP     $9C,X               ; {ram.m9C}
FEC3: B0 3A           BCS     $FEFF               ; {}
FEC5: B5 AD           LDA     $AD,X               ; {ram.mAD}
FEC7: 85 88           STA     $88                 ; {ram.m88}
FEC9: E8              INX                         
FECA: 86 8C           STX     $8C                 ; {ram.m8C}
FECC: B1 E4           LDA     ($E4),Y             ; {ram.mE4}
FECE: 85 1B           STA     $1B                 ; {hard.GRP0}
FED0: A5 81           LDA     $81                 ; {ram.m81}
FED2: 85 0E           STA     $0E                 ; {hard.PF1}
FED4: A5 82           LDA     $82                 ; {ram.m82}
FED6: 85 0F           STA     $0F                 ; {hard.PF2}
FED8: A5 85           LDA     $85                 ; {ram.m85}
FEDA: 85 81           STA     $81                 ; {ram.m81}
FEDC: A5 86           LDA     $86                 ; {ram.m86}
FEDE: 85 82           STA     $82                 ; {ram.m82}
FEE0: A5 83           LDA     $83                 ; {ram.m83}
FEE2: 85 0E           STA     $0E                 ; {hard.PF1}
FEE4: A5 87           LDA     $87                 ; {ram.m87}
FEE6: 85 83           STA     $83                 ; {ram.m83}
FEE8: A5 84           LDA     $84                 ; {ram.m84}
FEEA: 85 0F           STA     $0F                 ; {hard.PF2}
FEEC: A5 88           LDA     $88                 ; {ram.m88}
FEEE: 85 84           STA     $84                 ; {ram.m84}
FEF0: 88              DEY                         
FEF1: B1 C9           LDA     ($C9),Y             ; {ram.mC9}
FEF3: 4C 16 FE        JMP     $FE16               ; {}
FEF6: A9 00           LDA     #$00                
FEF8: 85 86           STA     $86                 ; {ram.m86}
FEFA: A5 C7           LDA     $C7                 ; {ram.mC7}
FEFC: 4C A5 FE        JMP     $FEA5               ; {}
FEFF: A9 00           LDA     #$00                
FF01: 85 88           STA     $88                 ; {ram.m88}
FF03: A5 C7           LDA     $C7                 ; {ram.mC7}
...
FF18: 85 02           STA     $02                 ; {hard.WSYNC} WSYNC
FF1A: 20 99 F6        JSR     $F699               
FF1D: F0 64           BEQ     $FF83               ; {}
FF1F: 90 E7           BCC     $FF08               ; {code.Startup}
FF21: 70 34           BVS     $FF57               ; {}
FF23: E6 DE           INC     $DE                 ; {ram.mDE}
FF25: AD 56 F9        LDA     $F956               ; {}
FF28: 29 10           AND     #$10                
FF2A: F0 0A           BEQ     $FF36               ; {}
FF2C: 24 80           BIT     $80                 ; {ram.m80}
FF2E: 30 27           BMI     $FF57               ; {}
FF30: 20 BA F6        JSR     $F6BA               
FF33: 4C D4 FC        JMP     $FCD4               ; {}
FF36: 2C 56 F9        BIT     $F956               ; {}
FF39: 10 1F           BPL     $FF5A               ; {}
FF3B: 24 80           BIT     $80                 ; {ram.m80}
FF3D: 30 18           BMI     $FF57               ; {}
