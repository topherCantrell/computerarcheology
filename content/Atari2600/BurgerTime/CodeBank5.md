...
F007: 8D 81 02        STA     $0281               ; {hard.SWACNT} ... port A all inputs
F00A: 8D 83 02        STA     $0283               ; {hard.SWBCNT} ... port B all inputs
F00D: 95 00           STA     $00,X               ; {hard.VSYNC} Clear ...
F00F: CA              DEX                         ; ... RAM and ...
...
F02B: 85 2C           STA     $2C                 ; {hard.CXCLR}
F02D: A9 FF           LDA     #$FF                
F02F: 85 DE           STA     $DE                 ; {ram.mDE}
F031: 20 D9 F2        JSR     $F2D9               ; {}
F034: 20 FF F2        JSR     $F2FF               ; {}
F037: 20 64 F5        JSR     $F564               ; {}
F03A: AD 82 02        LDA     $0282               ; {hard.SWCHB}
...
F08F: 85 B1           STA     $B1                 ; {ram.mB1}
F091: BD AC F1        LDA     $F1AC,X             ; {}
F094: AA              TAX                         
F095: A0 0D           LDY     #$0D                
F097: BD B1 F1        LDA     $F1B1,X             ; {}
F09A: 99 B9 00        STA     $00B9,Y             ; {ram.mB9}
F09D: CA              DEX                         
F09E: 88              DEY                         
F09F: 10 F6           BPL     $F097               ; {}
...
F0BB: 99 8D 00        STA     $008D,Y             ; {ram.m8D}
F0BE: BD 10 F2        LDA     $F210,X             ; {}
F0C1: 99 92 00        STA     $0092,Y             ; {ram.m92}
F0C4: BD 15 F2        LDA     $F215,X             ; {}
F0C7: 99 97 00        STA     $0097,Y             ; {ram.m97}
F0CA: BD 1A F2        LDA     $F21A,X             ; {}
F0CD: 99 9C 00        STA     $009C,Y             ; {ram.m9C}
F0D0: 8A              TXA                         
F0D1: 18              CLC                         
F0D2: 69 14           ADC     #$14                
F0D4: AA              TAX                         
...
F0E0: 85 A1           STA     $A1                 ; {ram.mA1}
F0E2: 85 A2           STA     $A2                 ; {ram.mA2}
F0E4: 85 A3           STA     $A3                 ; {ram.mA3}
F0E6: 85 A4           STA     $A4                 ; {ram.mA4}
F0E8: BD 60 F2        LDA     $F260,X             ; {}
F0EB: 85 A5           STA     $A5                 ; {ram.mA5}
F0ED: 85 A6           STA     $A6                 ; {ram.mA6}
F0EF: 85 A7           STA     $A7                 ; {ram.mA7}
F0F1: 85 A8           STA     $A8                 ; {ram.mA8}
F0F3: BD 65 F2        LDA     $F265,X             ; {}
F0F6: 85 A9           STA     $A9                 ; {ram.mA9}
F0F8: 85 AA           STA     $AA                 ; {ram.mAA}
F0FA: 85 AB           STA     $AB                 ; {ram.mAB}
F0FC: 85 AC           STA     $AC                 ; {ram.mAC}
F0FE: BD 6A F2        LDA     $F26A,X             ; {}
F101: 85 AD           STA     $AD                 ; {ram.mAD}
F103: 85 AE           STA     $AE                 ; {ram.mAE}
F105: 85 AF           STA     $AF                 ; {ram.mAF}
F107: 85 B0           STA     $B0                 ; {ram.mB0}
F109: A2 13           LDX     #$13                
F10B: A9 00           LDA     #$00                
...
F149: A5 DF           LDA     $DF                 ; {ram.mDF}
F14B: 29 0F           AND     #$0F                
F14D: 09 10           ORA     #$10                
F14F: 85 DF           STA     $DF                 ; {ram.mDF}
F151: A9 04           LDA     #$04                
...
F2FF: A5 BD           LDA     $BD                 ; {ram.mBD}
F301: 8D C8 00        STA     $00C8               ; {ram.mC8}
F304: AD 0A F9        LDA     $F90A               
F307: 20 0D F4        JSR     $F40D               ; {}
F30A: 18              CLC                         
F30B: 65 BD           ADC     $BD                 ; {ram.mBD}
F30D: 85 BD           STA     $BD                 ; {ram.mBD}
F30F: C9 02           CMP     #$02                
F311: F0 E6           BEQ     $F2F9               ; {}
F313: C9 9A           CMP     #$9A                
F315: F0 E2           BEQ     $F2F9               ; {}
...
F324: C9 06           CMP     #$06                
F326: F0 CE           BEQ     $F2F6               ; {}
F328: A5 BD           LDA     $BD                 ; {ram.mBD}
F32A: 18              CLC                         
F32B: 69 06           ADC     #$06                
F32D: AA              TAX                         
F32E: 4C 33 F3        JMP     $F333               ; {}
F331: A6 BD           LDX     $BD                 ; {ram.mBD}
F333: 38              SEC                         
F334: A9 69           LDA     #$69                
F336: E5 C2           SBC     $C2                 ; {ram.mC2}
F338: A8              TAY                         
...
F372: A8              TAY                         
F373: 85 C2           STA     $C2                 ; {ram.mC2}
F375: 20 6C F4        JSR     $F46C               ; {}
F378: B0 05           BCS     $F37F               ; {}
F37A: AD C8 00        LDA     $00C8               ; {ram.mC8}
F37D: 85 BD           STA     $BD                 ; {ram.mBD}
F37F: 4C FD F3        JMP     $F3FD               ; {}
F382: A5 C2           LDA     $C2                 ; {ram.mC2}
F384: 8D C8 00        STA     $00C8               ; {ram.mC8}
F387: AD 0B F9        LDA     $F90B               
F38A: 20 0D F4        JSR     $F40D               ; {}
F38D: 18              CLC                         
F38E: 65 C2           ADC     $C2                 ; {ram.mC2}
F390: 85 C2           STA     $C2                 ; {ram.mC2}
...
F39B: 38              SEC                         
F39C: A9 69           LDA     #$69                
F39E: ED C8 00        SBC     $00C8               ; {ram.mC8}
...
F3C8: 38              SEC                         
F3C9: A9 69           LDA     #$69                
F3CB: ED C8 00        SBC     $00C8               ; {ram.mC8}
...
F3E4: A8              TAY                         
F3E5: A5 BD           LDA     $BD                 ; {ram.mBD}
F3E7: 18              CLC                         
F3E8: 69 05           ADC     #$05                
F3EA: AA              TAX                         
F3EB: 20 6C F4        JSR     $F46C               ; {}
F3EE: 90 08           BCC     $F3F8               ; {}
F3F0: A6 BD           LDX     $BD                 ; {ram.mBD}
F3F2: E8              INX                         
F3F3: 20 6C F4        JSR     $F46C               ; {}
F3F6: B0 05           BCS     $F3FD               ; {}
F3F8: AD C8 00        LDA     $00C8               ; {ram.mC8}
F3FB: 85 C2           STA     $C2                 ; {ram.mC2}
F3FD: 60              RTS                         
F3FE: 00              BRK                         
F3FF: 00              BRK                         
F400: 0F ; ????
F401: 00              BRK                         
F402: 00              BRK                         
F403: A5 B3           LDA     $B3                 ; {ram.mB3}
F405: 18              CLC                         
F406: 69 17           ADC     #$17                
F408: 29 1F           AND     #$1F                
F40A: 85 B3           STA     $B3                 ; {ram.mB3}
F40C: 60              RTS                         
F40D: 18              CLC                         
F40E: 65 B3           ADC     $B3                 ; {ram.mB3}
F410: 4A              LSR     A                   
F411: 4A              LSR     A                   
F412: 4A              LSR     A                   
F413: 4A              LSR     A                   
...
F450: 85 C9           STA     $C9                 ; {ram.mC9}
F452: BD 47 F5        LDA     $F547,X             ; {}
F455: 85 CA           STA     $CA                 ; {ram.mCA}
F457: BD 48 F5        LDA     $F548,X             ; {}
F45A: 85 CB           STA     $CB                 ; {ram.mCB}
F45C: BD 49 F5        LDA     $F549,X             ; {}
F45F: 85 CC           STA     $CC                 ; {ram.mCC}
F461: BD 4A F5        LDA     $F54A,X             ; {}
F464: 85 CD           STA     $CD                 ; {ram.mCD}
F466: BD 4B F5        LDA     $F54B,X             ; {}
F469: 85 CE           STA     $CE                 ; {ram.mCE}
F46B: 60              RTS                         
F46C: 20 22 F4        JSR     $F422               ; {}
F46F: A6 C7           LDX     $C7                 ; {ram.mC7}
F471: E0 10           CPX     #$10                
F473: B0 0C           BCS     $F481               ; {}
F475: 8A              TXA                         
F476: 4A              LSR     A                   
...
F49D: 4A              LSR     A                   
F49E: AA              TAX                         
F49F: B1 CD           LDA     ($CD),Y             ; {ram.mCD}
F4A1: 3D 36 F5        AND     $F536,X             ; {}
F4A4: 4C 14 F5        JMP     $F514               ; {}
F4A7: A5 B1           LDA     $B1                 ; {ram.mB1}
F4A9: C9 01           CMP     #$01                
F4AB: F0 35           BEQ     $F4E2               ; {}
F4AD: E0 60           CPX     #$60                
F4AF: B0 0F           BCS     $F4C0               ; {}
...
F50D: 4A              LSR     A                   
F50E: AA              TAX                         
F50F: B1 C9           LDA     ($C9),Y             ; {ram.mC9}
F511: 3D 32 F5        AND     $F532,X             ; {}
F514: D0 04           BNE     $F51A               ; {}
F516: 18              CLC                         
F517: 4C 1B F5        JMP     $F51B               ; {}
F51A: 38              SEC                         
F51B: A6 C7           LDX     $C7                 ; {ram.mC7}
F51D: 60              RTS                         
F51E: 10 20           BPL     $F540               ; {}
F520: 40              RTI                         
F521: 80 ; ????
...
F543: 04 ; ????
F544: 02 ; ????
F545: 01 00           ORA     ($00,X)             ; {hard.CXM0P}
F547: FB ; ????
F548: 80 ; ????
F549: FB ; ????
F54A: 00              BRK                         
F54B: FC ; ????
F54C: 01 FB           ORA     ($FB,X)             ; {ram.mFB}
F54E: 81 FB           STA     ($FB,X)             ; {ram.mFB}
F550: 01 FC           ORA     ($FC,X)             ; {ram.mFC}
F552: 02 ; ????
F553: FB ; ????
F554: 82 ; ????
F555: FB ; ????
...
F5FB: F4 ; ????
F5FC: F4 ; ????
F5FD: A5 F5           LDA     $F5                 ; {ram.mF5}
F5FF: D0 08           BNE     $F609               ; {}
F601: 20 0C F6        JSR     $F60C               ; {}
F604: A9 01           LDA     #$01                
F606: 85 F5           STA     $F5                 ; {ram.mF5}
F608: 60              RTS                         
F609: A9 00           LDA     #$00                
F60B: 60              RTS                         
...
F61C: 85 CD           STA     $CD                 ; {ram.mCD}
F61E: BD 8A F6        LDA     $F68A,X             ; {}
F621: 85 CE           STA     $CE                 ; {ram.mCE}
F623: BD 91 F6        LDA     $F691,X             ; {}
F626: 85 CF           STA     $CF                 ; {ram.mCF}
F628: BD 92 F6        LDA     $F692,X             ; {}
F62B: 85 D0           STA     $D0                 ; {ram.mD0}
F62D: A0 35           LDY     #$35                
F62F: B9 55 F9        LDA     $F955,Y             
F632: 91 CD           STA     ($CD),Y             ; {ram.mCD}
F634: 88              DEY                         
F635: 10 F8           BPL     $F62F               ; {}
F637: AD E9 FF        LDA     $FFE9               ; RAM bank 1
F63A: A0 31           LDY     #$31                
F63C: B9 81 00        LDA     $0081,Y             ; {ram.m81}
F63F: 91 CF           STA     ($CF),Y             ; {ram.mCF}
F641: 88              DEY                         
F642: 10 F8           BPL     $F63C               ; {}
...
F65D: 85 CD           STA     $CD                 ; {ram.mCD}
F65F: BD 8E F6        LDA     $F68E,X             ; {}
F662: 85 CE           STA     $CE                 ; {ram.mCE}
F664: BD 95 F6        LDA     $F695,X             ; {}
F667: 85 CF           STA     $CF                 ; {ram.mCF}
F669: BD 96 F6        LDA     $F696,X             ; {}
F66C: 85 D0           STA     $D0                 ; {ram.mD0}
F66E: A0 35           LDY     #$35                
F670: B1 CD           LDA     ($CD),Y             ; {ram.mCD}
F672: 99 55 F8        STA     $F855,Y             
F675: 88              DEY                         
F676: 10 F8           BPL     $F670               ; {}
F678: AD E9 FF        LDA     $FFE9               ; RAM bank 1
F67B: A0 31           LDY     #$31                
F67D: B1 CF           LDA     ($CF),Y             ; {ram.mCF}
F67F: 99 81 00        STA     $0081,Y             ; {ram.m81}
F682: 88              DEY                         
F683: 10 F8           BPL     $F67D               ; {}
...
F699: A9 02           LDA     #$02                
F69B: 85 01           STA     $01                 ; {hard.VBLANK}
F69D: A9 39           LDA     #$39                
F69F: 8D 96 02        STA     $0296               ; {hard.TIM64T}
F6A2: A5 F5           LDA     $F5                 ; {ram.mF5}
F6A4: F0 08           BEQ     $F6AE               ; {}
F6A6: 20 48 F6        JSR     $F648               ; {}
F6A9: A9 00           LDA     #$00                
F6AB: 85 F5           STA     $F5                 ; {ram.mF5}
F6AD: 60              RTS                         
F6AE: 2C 82 02        BIT     $0282               ; {hard.SWCHB}
F6B1: AD 82 02        LDA     $0282               ; {hard.SWCHB}
F6B4: 85 F6           STA     $F6                 ; {ram.mF6}
F6B6: 4A              LSR     A                   
F6B7: A9 01           LDA     #$01                
F6B9: 60              RTS                         
