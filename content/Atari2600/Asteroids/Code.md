...
D003: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:lots 
D005: 85 2A         STA   $2A                 ;{-2_HMOVE} HMOVE Apply horizontal motionHMOVE:lots 
D007: 85 1C         STA   $1C                 ;{-2_GRP1} GRP1 Graphics player 1 bitsGRP1:lots 
D009: 86 05         STX   $05                 ;{-2_NUSIZ1} Number/size player 1 missileNUSIZ1:lots 
...
D012: EA            NOP                       
D013: A5 E9         LDA   $E9                 ;
D015: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D017: 85 20         STA   $20                 ;{-2_HMP0}HMP0:lots 
D019: A9 83         LDA   #$83                
D01B: 85 E3         STA   $E3                 ;
D01D: A6 E7         LDX   $E7                 ;
D01F: A9 00         LDA   #$00                
D021: CA            DEX                       
D022: D0 05         BNE   $D029               ;
D024: 85 10         STA   $10                 ;{-2_RESP0}
D026: 4C 00 D1      JMP   $D100               ;

D029: CA            DEX                       
D02A: D0 04         BNE   $D030               ;
D02C: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D02E: F0 F6         BEQ   $D026               ;
D030: CA            DEX                       
D031: D0 04         BNE   $D037               ;
D033: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D035: F0 EF         BEQ   $D026               ;
D037: CA            DEX                       
D038: D0 05         BNE   $D03F               ;
D03A: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D03C: 4C 00 D1      JMP   $D100               ;

D03F: CA            DEX                       
D040: EA            NOP                       
D041: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D043: 4C 02 D1      JMP   $D102               ;

D046: A6 E7         LDX   $E7                 ;
D048: CA            DEX                       
D049: D0 05         BNE   $D050               ;
D04B: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D04D: EA            NOP                       
D04E: F0 05         BEQ   $D055               ;
D050: CA            DEX                       
D051: D0 05         BNE   $D058               ;
D053: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D055: EA            NOP                       
D056: F0 05         BEQ   $D05D               ;
D058: CA            DEX                       
D059: D0 05         BNE   $D060               ;
D05B: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D05D: EA            NOP                       
D05E: F0 05         BEQ   $D065               ;
D060: CA            DEX                       
D061: D0 05         BNE   $D068               ;
D063: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D065: EA            NOP                       
D066: F0 05         BEQ   $D06D               ;
D068: CA            DEX                       
D069: D0 05         BNE   $D070               ;
D06B: 85 10         STA   $10                 ;{-2_RESP0}
D06D: EA            NOP                       
D06E: F0 04         BEQ   $D074               ;
D070: CA            DEX                       
D071: EA            NOP                       
D072: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D074: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D076: A5 E9         LDA   $E9                 ;
D078: 85 20         STA   $20                 ;{-2_HMP0}HMP0:lots 
D07A: A9 83         LDA   #$83                
D07C: 85 E3         STA   $E3                 ;
D07E: A9 00         LDA   #$00                
...
D08B: A6 DC         LDX   $DC                 ;
D08D: B5 95         LDA   $95,X               
D08F: 85 2B         STA   $2B                 ;{-2_HMCLR} Clear horizontal motion (strobe)HMCLR:lots 
D091: 85 E9         STA   $E9                 ;
D093: 4A            LSR   A                   
D094: 29 07         AND   #$07                
D096: 85 E7         STA   $E7                 ;
...
D0A2: 85 2B         STA   $2B                 ;{-2_HMCLR} Clear horizontal motion (strobe)HMCLR:lots 
D0A4: 85 20         STA   $20                 ;{-2_HMP0} Horizontal motion value (player 1)HMP0:lots 
D0A6: 85 F3         STA   $F3                 ;
D0A8: A6 F8         LDX   $F8                 ;
D0AA: BD 75 DE      LDA   $DE75,X             
D0AD: 85 06         STA   $06                 ;{-2_COLUP0} COLUP0 ... color of asteroidCOLUP0:lots 
...
D0C6: 85 EB         STA   $EB                 ;
D0C8: 85 EF         STA   $EF                 ;
D0CA: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D0CC: B5 A7         LDA   $A7,X               
D0CE: 29 07         AND   #$07                
D0D0: 85 F8         STA   $F8                 ;
D0D2: EA            NOP                       
...
D100: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:lots 
D102: 85 2A         STA   $2A                 ;{-2_HMOVE} HMOVE Apply horizontal motionHMOVE:lots 
D104: 85 1B         STA   $1B                 ;{-2_GRP0} GRP0 Graphics player 0GRP0:lots 
D106: 86 04         STX   $04                 ;{-2_NUSIZ0} Number/size player 0 missileNUSIZ0:lots 
...
D110: F0 E8         BEQ   $D0FA               ;
D112: A5 EA         LDA   $EA                 ;
D114: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D116: 85 21         STA   $21                 ;{-2_HMP1}HMP1:lots 
D118: A9 88         LDA   #$88                
D11A: 85 E5         STA   $E5                 ;
D11C: A6 E8         LDX   $E8                 ;
D11E: A9 00         LDA   #$00                
D120: CA            DEX                       
D121: D0 05         BNE   $D128               ;
D123: 85 11         STA   $11                 ;{-2_RESP1}
D125: 4C 03 D0      JMP   $D003               ;
D128: CA            DEX                       
D129: D0 04         BNE   $D12F               ;
D12B: 85 11         STA   $11                 ;{-2_RESP1}RESP1:lots 
D12D: F0 F6         BEQ   $D125               ;
D12F: CA            DEX                       
D130: D0 04         BNE   $D136               ;
D132: 85 11         STA   $11                 ;{-2_RESP1}RESP1:lots 
D134: F0 EF         BEQ   $D125               ;
D136: CA            DEX                       
D137: D0 05         BNE   $D13E               ;
D139: 85 11         STA   $11                 ;{-2_RESP1}RESP1:lots 
D13B: 4C 03 D0      JMP   $D003               ;
D13E: CA            DEX                       
D13F: EA            NOP                       
D140: 85 11         STA   $11                 ;{-2_RESP1}RESP1:lots 
D142: 4C 05 D0      JMP   $D005               ;
D145: A6 E8         LDX   $E8                 ;
D147: CA            DEX                       
D148: D0 05         BNE   $D14F               ;
D14A: 85 11         STA   $11                 ;{-2_RESP1}
D14C: EA            NOP                       
D14D: F0 05         BEQ   $D154               ;
D14F: CA            DEX                       
D150: D0 05         BNE   $D157               ;
D152: 85 11         STA   $11                 ;{-2_RESP1}RESP1:lots 
D154: EA            NOP                       
D155: F0 05         BEQ   $D15C               ;
D157: CA            DEX                       
D158: D0 05         BNE   $D15F               ;
D15A: 85 11         STA   $11                 ;{-2_RESP1}
D15C: EA            NOP                       
D15D: F0 05         BEQ   $D164               ;
D15F: CA            DEX                       
D160: D0 05         BNE   $D167               ;
D162: 85 11         STA   $11                 ;{-2_RESP1}RESP1:lots 
D164: EA            NOP                       
D165: F0 05         BEQ   $D16C               ;
D167: CA            DEX                       
D168: D0 05         BNE   $D16F               ;
D16A: 85 11         STA   $11                 ;{-2_RESP1}
D16C: EA            NOP                       
D16D: F0 04         BEQ   $D173               ;
D16F: CA            DEX                       
D170: EA            NOP                       
D171: 85 11         STA   $11                 ;{-2_RESP1}
D173: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D175: A5 EA         LDA   $EA                 ;
D177: 85 21         STA   $21                 ;{-2_HMP1}HMP1:lots 
D179: C8            INY                       
D17A: C0 59         CPY   #$59                
D17C: F0 4E         BEQ   $D1CC               ;
D17E: A9 88         LDA   #$88                
...
D190: A6 DD         LDX   $DD                 ;
D192: B5 95         LDA   $95,X               
D194: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D196: 85 EA         STA   $EA                 ;
D198: 4A            LSR   A                   
D199: 29 07         AND   #$07                
D19B: 85 E8         STA   $E8                 ;
...
D1AC: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D1AE: 85 21         STA   $21                 ;{-2_HMP1}HMP1:lots 
D1B0: 85 F3         STA   $F3                 ;
D1B2: A6 F9         LDX   $F9                 ;
D1B4: BD 75 DE      LDA   $DE75,X             
D1B7: 85 07         STA   $07                 ;{-2_COLUP1}COLUP1:lots 
D1B9: A2 00         LDX   #$00                
D1BB: A1 ED         LDA   ($ED,X)             
D1BD: E6 ED         INC   $ED                 ;
D1BF: E6 F1         INC   $F1                 ;
...
D1D5: 85 ED         STA   $ED                 ;
D1D7: 85 F1         STA   $F1                 ;
D1D9: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D1DB: B5 A7         LDA   $A7,X               
D1DD: 29 07         AND   #$07                
D1DF: 85 F9         STA   $F9                 ;
D1E1: 98            TYA                       
...
D21F: 85 02         STA   $02                 ;{-2_WSYNC} WSYNC Skip two ...WSYNC:41 
D221: 85 02         STA   $02                 ;{-2_WSYNC} WSYNC ... rowsWSYNC:42 

D223: 85 0D         STA   $0D                 ;{-2_PF0} PF0 value        ($DIGIT 0)PF0:43,45,47,49 
D225: A5 FD         LDA   $FD                 ; Set ...
D227: 85 0E         STA   $0E                 ;{-2_PF1} ... PF1 value    (DIGIT 1,2)PF1:43,45,47,49 
D229: A5 FE         LDA   $FE                 ; Set ...
D22B: 85 0F         STA   $0F                 ;{-2_PF2} PF2 value        ($DIGIT 3,4)PF2:43,45,47,49 

D22D: BD C8 DD      LDA   $DDC8,X             ; Set ...
D230: 85 1B         STA   $1B                 ;{-2_GRP0} ... GRP0 value   (?? Never seems to do anything)GRP0:43,45,47,49 
D232: BD D7 DD      LDA   $DDD7,X             ; Set ...
D235: 85 1C         STA   $1C                 ;{-2_GRP1} ... GRP1 value   (?? Never seems to do anything)GRP1:43,45,47,49 
D237: CA            DEX                       ;

D238: A9 00         LDA   #$00                ; 0 to ...
D23A: 85 0D         STA   $0D                 ;{-2_PF0} ... PF0 PlayfieldPF0:43,45,47,49 
D23C: A4 F7         LDY   $F7                 ; Value of DIGIT 1
D23E: 85 0E         STA   $0E                 ;{-2_PF1} 0 to PF1PF1:43,45,47,49 
D240: B1 F4         LDA   ($F4),Y             ; Image for DIGIT 1
D242: A4 FF         LDY   $FF                 ; Right number ...
D244: 84 0F         STY   $0F                 ;{-2_PF2}  ... PF2 value   (DIGIT 5,6)PF2:43,45,47,49 

D246: A4 FC         LDY   $FC                 ; Repeat DIGIT 0 ...
D248: 84 0D         STY   $0D                 ;{-2_PF0} .. on next line PF0PF0:43,45,47,49 
D24A: A4 FD         LDY   $FD                 ; Repeat DIGIT 1,2 ...
D24C: EA            NOP                       ; Pause
D24D: 84 0E         STY   $0E                 ;{-2_PF1} ... on next line PF1PF1:43,45,47,49 
...
D257: 85 0F         STA   $0F                 ;{-2_PF2} ... to PF2PF2:44,46,48,50 
...
;
D26B: 84 0D         STY   $0D                 ;{-2_PF0} PF0PF0:44,46,48,50 
D26D: 84 0E         STY   $0E                 ;{-2_PF1} PF1PF1:44,46,48,50 
D26F: A4 FF         LDY   $FF                 ; Store DIGIT 6 ...
D271: 84 0F         STY   $0F                 ;{-2_PF2} ... tio PF2PF2:44,46,48,50 
...
D2B1: 85 F6         STA   $F6                 ;
D2B3: A5 FC         LDA   $FC                 ;
D2B5: 85 0D         STA   $0D                 ;{-2_PF0}PF0:51 
D2B7: A5 FD         LDA   $FD                 ;
D2B9: 85 0E         STA   $0E                 ;{-2_PF1}PF1:52 
D2BB: A5 FE         LDA   $FE                 ;
D2BD: 85 0F         STA   $0F                 ;{-2_PF2}PF2:52 
D2BF: A2 00         LDX   #$00                
D2C1: B5 A7         LDA   $A7,X               
D2C3: 29 07         AND   #$07                
D2C5: 85 F8         STA   $F8                 ;
...
D2CC: A9 00         LDA   #$00                
D2CE: A0 FF         LDY   #$FF                
D2D0: 85 0D         STA   $0D                 ;{-2_PF0}PF0:52 
D2D2: 85 0E         STA   $0E                 ;{-2_PF1}PF1:52 
D2D4: EA            NOP                       
D2D5: A5 FF         LDA   $FF                 ;
D2D7: 85 0F         STA   $0F                 ;{-2_PF2}PF2:52 
;
...
D2DE: EA            NOP                       ; ... of ...
D2DF: EA            NOP                       ; ... row
D2E0: 86 06         STX   $06                 ;{-2_COLUP0} PF2 offCOLUP0:52 
D2E2: 85 1B         STA   $1B                 ;{-2_GRP0}GRP0 offGRP0:52 
D2E4: 85 1C         STA   $1C                 ;{-2_GRP1}GRP1 offGRP1:52 
D2E6: 85 0F         STA   $0F                 ;{-2_PF2}PF2:52 
D2E8: A6 F6         LDX   $F6                 ;
D2EA: 85 2A         STA   $2A                 ;{-2_HMOVE}HMOVE:53 
...
D2F7: A1 83         LDA   ($83,X)             ;CXBLPF:51 CXM1FB:51 INPT5:51 
D2F9: A1 83         LDA   ($83,X)             ;CXBLPF:51 CXM1FB:51 INPT5:51 
D2FB: A5 FC         LDA   $FC                 ;
D2FD: 85 0D         STA   $0D                 ;{-2_PF0}PF0:51 
D2FF: A5 FD         LDA   $FD                 ;
D301: 85 0E         STA   $0E                 ;{-2_PF1}PF1:51 
D303: A5 FE         LDA   $FE                 ;
D305: 85 0F         STA   $0F                 ;{-2_PF2}PF2:52 
D307: A1 83         LDA   ($83,X)             ;CXBLPF:52 CXM1FB:52 INPT5:52 
D309: A1 83         LDA   ($83,X)             ;CXBLPF:52 CXM1FB:52 INPT5:52 
D30B: A1 83         LDA   ($83,X)             ;CXBLPF:52 CXM1FB:52 INPT5:52 
D30D: A1 83         LDA   ($83,X)             ;CXBLPF:52 CXM1FB:52 INPT5:52 
D30F: A1 83         LDA   ($83,X)             ;CXBLPF:52 CXM1FB:52 INPT5:52 
D311: A2 1F         LDX   #$1F                ; Set stack to ENABL ...
D313: 9A            TXS                       ; ... makes for fast register writes with PUSH
D314: A9 00         LDA   #$00                
D316: 85 0D         STA   $0D                 ;{-2_PF0}PF0:52 
D318: 85 0E         STA   $0E                 ;{-2_PF1}PF1:52 
D31A: A5 FF         LDA   $FF                 ;
D31C: 85 0F         STA   $0F                 ;{-2_PF2}PF2:52 
D31E: A9 00         LDA   #$00                
D320: A8            TAY                       
D321: A6 E8         LDX   $E8                 ;
D323: 85 1B         STA   $1B                 ;{-2_GRP0}GRP0:52 
D325: 85 1C         STA   $1C                 ;{-2_GRP1}GRP1:52 
D327: 85 1B         STA   $1B                 ;{-2_GRP0}GRP0:52 
D329: 85 0F         STA   $0F                 ;{-2_PF2}PF2:52 
D32B: 86 08         STX   $08                 ;{-2_COLUPF}COLUPF:52 
D32D: 85 2A         STA   $2A                 ;{-2_HMOVE}HMOVE:53 
D32F: A5 C9         LDA   $C9                 ;
D331: 6A            ROR   A                   
D332: 29 07         AND   #$07                
D334: AA            TAX                       
D335: B0 36         BCS   $D36D               ;
D337: A5 E9         LDA   $E9                 ;
D339: 85 06         STA   $06                 ;{-2_COLUP0}
D33B: A5 EB         LDA   $EB                 ;
D33D: 85 25         STA   $25                 ;{-2_VDELP0}
D33F: 85 0B         STA   $0B                 ;{-2_REFP0}
D341: A5 C9         LDA   $C9                 ;
D343: 85 20         STA   $20                 ;{-2_HMP0}
D345: A9 00         LDA   #$00                
D347: 85 04         STA   $04                 ;{-2_NUSIZ0}
D349: A1 83         LDA   ($83,X)             
D34B: CA            DEX                       
D34C: D0 04         BNE   $D352               ;
D34E: 85 10         STA   $10                 ;{-2_RESP0}
D350: F0 31         BEQ   $D383               ;
D352: CA            DEX                       
D353: D0 04         BNE   $D359               ;
D355: 85 10         STA   $10                 ;{-2_RESP0}
D357: F0 2A         BEQ   $D383               ;
D359: CA            DEX                       
D35A: D0 04         BNE   $D360               ;
D35C: 85 10         STA   $10                 ;{-2_RESP0}
D35E: F0 23         BEQ   $D383               ;
D360: CA            DEX                       
D361: D0 04         BNE   $D367               ;
D363: 85 10         STA   $10                 ;{-2_RESP0}
D365: F0 1C         BEQ   $D383               ;
D367: CA            DEX                       
D368: EA            NOP                       
D369: 85 10         STA   $10                 ;{-2_RESP0}
D36B: F0 18         BEQ   $D385               ;
D36D: EA            NOP                       
D36E: CA            DEX                       
D36F: D0 FD         BNE   $D36E               ;
D371: 85 10         STA   $10                 ;{-2_RESP0}RESP0:53 
D373: A5 C9         LDA   $C9                 ;
D375: 85 20         STA   $20                 ;{-2_HMP0}HMP0:53 
D377: A5 E9         LDA   $E9                 ;
D379: 85 06         STA   $06                 ;{-2_COLUP0}COLUP0:53 
D37B: A5 EB         LDA   $EB                 ;
D37D: 85 25         STA   $25                 ;{-2_VDELP0}VDELP0:53 
D37F: 85 0B         STA   $0B                 ;{-2_REFP0}REFP0:53 
D381: 86 04         STX   $04                 ;{-2_NUSIZ0} NUSIZ0NUSIZ0:53 
D383: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:53 
D385: 85 2A         STA   $2A                 ;{-2_HMOVE} HMOVEHMOVE:54 
D387: A5 D1         LDA   $D1                 ;
D389: 6A            ROR   A                   
D38A: 29 07         AND   #$07                
D38C: AA            TAX                       
D38D: B0 36         BCS   $D3C5               ;
D38F: A5 EA         LDA   $EA                 ;
D391: 85 07         STA   $07                 ;{-2_COLUP1}COLUP1:54 
D393: A5 EC         LDA   $EC                 ;
D395: 85 26         STA   $26                 ;{-2_VDELP1}VDELP1:54 
D397: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:54 
D399: A5 D1         LDA   $D1                 ;
D39B: 85 21         STA   $21                 ;{-2_HMP1}HMP1:54 
D39D: A1 83         LDA   ($83,X)             ;CXM0P:54 
D39F: A9 00         LDA   #$00                
D3A1: 85 05         STA   $05                 ;{-2_NUSIZ1}NUSIZ1:54 
D3A3: CA            DEX                       
D3A4: D0 04         BNE   $D3AA               ;
D3A6: 85 11         STA   $11                 ;{-2_RESP1}
D3A8: F0 31         BEQ   $D3DB               ;
D3AA: CA            DEX                       
D3AB: D0 04         BNE   $D3B1               ;
D3AD: 85 11         STA   $11                 ;{-2_RESP1}
D3AF: F0 2A         BEQ   $D3DB               ;
D3B1: CA            DEX                       
D3B2: D0 04         BNE   $D3B8               ;
D3B4: 85 11         STA   $11                 ;{-2_RESP1}RESP1:54 
D3B6: F0 23         BEQ   $D3DB               ;
D3B8: CA            DEX                       
D3B9: D0 04         BNE   $D3BF               ;
D3BB: 85 11         STA   $11                 ;{-2_RESP1}
D3BD: F0 1C         BEQ   $D3DB               ;
D3BF: CA            DEX                       
D3C0: EA            NOP                       
D3C1: 85 11         STA   $11                 ;{-2_RESP1}
D3C3: F0 18         BEQ   $D3DD               ;
D3C5: EA            NOP                       
D3C6: CA            DEX                       
D3C7: D0 FD         BNE   $D3C6               ;
D3C9: 85 11         STA   $11                 ;{-2_RESP1}
D3CB: 85 2B         STA   $2B                 ;{-2_HMCLR}
D3CD: A5 D1         LDA   $D1                 ;
D3CF: 85 21         STA   $21                 ;{-2_HMP1}
D3D1: A5 EA         LDA   $EA                 ;
D3D3: 85 07         STA   $07                 ;{-2_COLUP1}
D3D5: A5 EC         LDA   $EC                 ;
D3D7: 85 26         STA   $26                 ;{-2_VDELP1}
D3D9: 86 05         STX   $05                 ;{-2_NUSIZ1}
D3DB: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:lots 
D3DD: 85 2A         STA   $2A                 ;{-2_HMOVE}HMOVE:lots 
D3DF: 86 1C         STX   $1C                 ;{-2_GRP1}GRP1:lots 
D3E1: C4 D8         CPY   $D8                 ;
...
D401: 8A            TXA                       
D402: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
D404: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:lots 
D406: 85 2A         STA   $2A                 ;{-2_HMOVE}HMOVE:lots 
D408: 85 1B         STA   $1B                 ;{-2_GRP0}GRP0:lots 
D40A: A2 00         LDX   #$00                
D40C: A1 E6         LDA   ($E6,X)             
D40E: C9 FF         CMP   #$FF                
D410: F0 04         BEQ   $D416               ;
...
D42B: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:232 
D42D: A9 00         LDA   #$00                
D42F: 85 1B         STA   $1B                 ;{-2_GRP0}GRP0:233 
D431: 85 1C         STA   $1C                 ;{-2_GRP1}GRP1:233 
D433: 85 1F         STA   $1F                 ;{-2_ENABL}ENABL:233 
D435: 85 1D         STA   $1D                 ;{-2_ENAM0}ENAM0:233 
D437: 85 1E         STA   $1E                 ;{-2_ENAM1}ENAM1:233 
...
D4BB: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:lots 
D4BD: 85 F3         STA   $F3                 ;
D4BF: BD 85 DE      LDA   $DE85,X             
D4C2: 85 20         STA   $20                 ;{-2_HMP0}HMP0:lots 
D4C4: 0A            ASL   A                   
D4C5: 0A            ASL   A                   
D4C6: 0A            ASL   A                   
D4C7: 0A            ASL   A                   
D4C8: 85 21         STA   $21                 ;{-2_HMP1}HMP1:lots 
D4CA: BD 8D DE      LDA   $DE8D,X             
D4CD: 85 04         STA   $04                 ;{-2_NUSIZ0}NUSIZ0:lots 
D4CF: 4A            LSR   A                   
D4D0: 4A            LSR   A                   
D4D1: 4A            LSR   A                   
D4D2: 4A            LSR   A                   
D4D3: 85 05         STA   $05                 ;{-2_NUSIZ1}NUSIZ1:lots 
D4D5: BC 95 DE      LDY   $DE95,X             
D4D8: 88            DEY                       
D4D9: 10 FD         BPL   $D4D8               ;
D4DB: 85 10         STA   $10                 ;{-2_RESP0}RESP0:lots 
D4DD: 85 11         STA   $11                 ;{-2_RESP1}RESP1:lots 
D4DF: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:lots 
D4E1: 85 2A         STA   $2A                 ;{-2_HMOVE}HMOVE:lots 
;
...
D53C: E0 04         CPX   #$04                
D53E: D0 E9         BNE   $D529               ;
D540: 85 2B         STA   $2B                 ;{-2_HMCLR}HMCLR:lots 
;
D542: A4 F6         LDY   $F6                 ;
D544: B1 F4         LDA   ($F4),Y             
D546: 85 FC         STA   $FC                 ;
...
D562: C6 F4         DEC   $F4                 ;
D564: A9 74         LDA   #$74                
D566: 85 06         STA   $06                 ;{-2_COLUP0}COLUP0:lots 
D568: 85 07         STA   $07                 ;{-2_COLUP1}COLUP1:lots 
D56A: A9 44         LDA   #$44                
D56C: 24 C7         BIT   $C7                 ;
D56E: 10 02         BPL   $D572               ;
D570: A9 D6         LDA   #$D6                
D572: 45 E0         EOR   $E0                 ;
D574: 85 08         STA   $08                 ;{-2_COLUPF}COLUPF:lots 
D576: A9 00         LDA   #$00                
D578: 85 25         STA   $25                 ;{-2_VDELP0}VDELP0:lots 
D57A: 85 26         STA   $26                 ;{-2_VDELP1}VDELP1:lots 
D57C: 85 0B         STA   $0B                 ;{-2_REFP0}REFP0:lots 
D57E: AD 84 02      LDA   $0284               ;{-2_INTIM}INTIM:lots 
D581: D0 FB         BNE   $D57E               ;
D583: 4C 1B D2      JMP   $D21B               ;{VisibleFrame}
;
D586: A9 00         LDA   #$00                
D588: 85 F7         STA   $F7                 ;
D58A: A9 F0         LDA   #$F0                
...
D599: 4C F0 DF      JMP   $DFF0               ;{SwitchToBank1} ... vector in bank 1
...
D61F: A0 C4         LDY   #$C4                
D621: 84 F7         STY   $F7                 ;
D623: 4C F0 DF      JMP   $DFF0               ;{SwitchToBank1} Bank switch to FAC4
...
D908: A0 80         LDY   #$80                
D90A: 84 F7         STY   $F7                 ;
D90C: 4C F0 DF      JMP   $DFF0               ;{SwitchToBank1} Bank switch to F480
...
D917: A0 0C         LDY   #$0C                
D919: 84 F7         STY   $F7                 ;
D91B: 4C F0 DF      JMP   $DFF0               ;{SwitchToBank1} Bank switch to F40C
...
F005: 8D 96 02      STA   $0296               ;{-2_TIM64T} ... 2304 clocksTIM64T:233 
F008: AD 82 02      LDA   $0282               ;{-2_SWCHB} Console switchesSWCHB:233 
F00B: 6A            ROR   A                   ; Check ...
...
F035: AD 82 02      LDA   $0282               ;{-2_SWCHB} Console switces
...
F05B: 29 BF         AND   #$BF                
F05D: 85 80         STA   $80                 ;
F05F: AD 82 02      LDA   $0282               ;{-2_SWCHB}SWCHB:233 
F062: 6A            ROR   A                   
F063: B0 18         BCS   $F07D               ;
F065: A9 00         LDA   #$00                
F067: 85 09         STA   $09                 ;{-2_COLUBK}
F069: A2 83         LDX   #$83                
F06B: 95 00         STA   $00,X               
F06D: E8            INX                       
F06E: D0 FB         BNE   $F06B               ;
...
F212: 90 09         BCC   $F21D               ;
F214: A9 00         LDA   #$00                
F216: 85 19         STA   $19                 ;{-2_AUDV0}AUDV0:237,235,236 
F218: 85 1A         STA   $1A                 ;{-2_AUDV1}AUDV1:237,235,236 
F21A: 4C 16 F3      JMP   $F316               ;{VerticalBlank}
F21D: A5 C5         LDA   $C5                 ;
F21F: 85 F4         STA   $F4                 ;
F221: A0 08         LDY   #$08                
F223: 66 F4         ROR   $F4                 ;
...
F248: 10 02         BPL   $F24C               ;
F24A: A9 00         LDA   #$00                
F24C: 84 15         STY   $15                 ;{-2_AUDC0}AUDC0:lots 
F24E: 86 17         STX   $17                 ;{-2_AUDF0}AUDF0:lots 
F250: 85 19         STA   $19                 ;{-2_AUDV0}AUDV0:lots 
F252: 66 F4         ROR   $F4                 ;
F254: 90 1E         BCC   $F274               ;
F256: A2 04         LDX   #$04                
F258: A0 0F         LDY   #$0F                
...
F2A2: 85 C4         STA   $C4                 ;
F2A4: A9 00         LDA   #$00                
F2A6: 85 1A         STA   $1A                 ;{-2_AUDV1}AUDV1:244 
F2A8: 4C 16 F3      JMP   $F316               ;{VerticalBlank}
F2AB: A0 0C         LDY   #$0C                
F2AD: A5 C4         LDA   $C4                 ;
F2AF: C9 08         CMP   #$08                
F2B1: 90 07         BCC   $F2BA               ;
...
F2BF: AA            TAX                       
F2C0: A9 0D         LDA   #$0D                
F2C2: 84 16         STY   $16                 ;{-2_AUDC1}AUDC1:lots 
F2C4: 86 18         STX   $18                 ;{-2_AUDF1}AUDF1:lots 
F2C6: 85 1A         STA   $1A                 ;{-2_AUDV1}AUDV1:lots 
F2C8: 10 4C         BPL   $F316               ;{VerticalBlank}
F2CA: A0 06         LDY   #$06                
F2CC: C6 C4         DEC   $C4                 ;
F2CE: D0 25         BNE   $F2F5               ;
F2D0: A5 C5         LDA   $C5                 ;
...
F31D: 86 01         STX   $01                 ;{-2_VBLANK} Vertical blank clearVBLANK:74,263 
F31F: 86 00         STX   $00                 ;{-2_VSYNC} Vertical sync clearVSYNC:74,263 
F321: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:1 
F323: 85 02         STA   $02                 ;{-2_WSYNC} WSYNC  3 linesWSYNC:2 
F325: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:3 
F327: 85 00         STA   $00                 ;{-2_VSYNC} Vertical syncVSYNC:4 
F329: 85 01         STA   $01                 ;{-2_VBLANK} Veritcal blankVBLANK:4 
F32B: A9 2D         LDA   #$2D                ; 45 * 64 = 2880 clocks
F32D: 8D 96 02      STA   $0296               ;{-2_TIM64T} Start TIM64T timer for vertical blankTIM64T:4 
...
F405: A0 0F         LDY   #$0F                
F407: 84 F7         STY   $F7                 ;
F409: 4C F0 FF      JMP   $FFF0               ;{SwitchToBank0} Bank switch to D90F
F40C: 29 08         AND   #$08                
F40E: D0 07         BNE   $F417               ;
F410: A5 EA         LDA   $EA                 ;
F412: 18            CLC                       
...
F479: A0 00         LDY   #$00                
F47B: 84 F7         STY   $F7                 ;
F47D: 4C F0 FF      JMP   $FFF0               ;{SwitchToBank0} Bank switch to D900
F480: 29 08         AND   #$08                
F482: D0 07         BNE   $F48B               ;
F484: A5 E9         LDA   $E9                 ;
F486: 18            CLC                       
...
F49E: AD 82 02      LDA   $0282               ;{-2_SWCHB}SWCHB:lots 
F4A1: 24 C7         BIT   $C7                 ;
F4A3: 30 01         BMI   $F4A6               ;
F4A5: 0A            ASL   A                   
F4A6: 0A            ASL   A                   
...
F5F7: 29 F0         AND   #$F0                
F5F9: D0 2B         BNE   $F626               ;
F5FB: 85 1A         STA   $1A                 ;{-2_AUDV1}AUDV1:5 
F5FD: A5 C8         LDA   $C8                 ;
F5FF: 6A            ROR   A                   
F600: B0 0D         BCS   $F60F               ;
F602: A2 01         LDX   #$01                
...
F61B: 69 00         ADC   #$00                
F61D: 29 F7         AND   #$F7                
F61F: 85 09         STA   $09                 ;{-2_COLUBK}COLUBK:5 
F621: 85 E0         STA   $E0                 ;
F623: 4C 34 F8      JMP   $F834               ;
F626: AD 80 02      LDA   $0280               ;{-2_SWCHA}SWCHA:5 
F629: 24 C7         BIT   $C7                 ;
F62B: 10 04         BPL   $F631               ;
F62D: 0A            ASL   A                   
F62E: 0A            ASL   A                   
...
F723: 30 02         BMI   $F727               ;
F725: A0 00         LDY   #$00                
F727: B9 3C 00      LDA   $003C,Y             ;INPT4:6 
F72A: 30 46         BMI   $F772               ;
F72C: A5 C7         LDA   $C7                 ;
F72E: 29 10         AND   #$10                
F730: D0 46         BNE   $F778               ;
...
F9AE: A8            TAY                       
F9AF: B5 95         LDA   $95,X               
F9B1: 85 02         STA   $02                 ;{-2_WSYNC} WSYNCWSYNC:lots 
F9B3: 99 22 00      STA   $0022,Y             ;HMM1:lots HMBL:10,17,15,16 HMM0:lots 
F9B6: 6A            ROR   A                   
F9B7: 29 07         AND   #$07                
F9B9: B0 0E         BCS   $F9C9               ;
F9BB: A2 06         LDX   #$06                
...
F9C2: CA            DEX                       
F9C3: D0 FD         BNE   $F9C2               ;
F9C5: 96 12         STX   $12,Y               ;RESM0:lots RESBL:10,17,15,16 RESM1:lots 
F9C7: F0 03         BEQ   $F9CC               ;
F9C9: AA            TAX                       
F9CA: B0 F6         BCS   $F9C2               ;
F9CC: C6 F6         DEC   $F6                 ;
...
FA2B: 85 D1         STA   $D1                 ;
FA2D: 85 C2         STA   $C2                 ;
FA2F: 4C 16 F3      JMP   $F316               ;{VerticalBlank}
FA32: B5 A7         LDA   $A7,X               
FA34: 4A            LSR   A                   
FA35: 4A            LSR   A                   
FA36: 4A            LSR   A                   
...
FABD: A0 00         LDY   #$00                
FABF: 84 F7         STY   $F7                 ;
FAC1: 4C F0 FF      JMP   $FFF0               ;{SwitchToBank0} Bank switch to D600
...
FF92: A9 D4         LDA   #$D4                
FF94: 85 F8         STA   $F8                 ;
FF96: 4C F0 FF      JMP   $FFF0               ;{SwitchToBank0} Bank switch to D43C
