...
OPCODES = [
    ...
    {"mnemonic":"LBRN s",           "code":"1021smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBHI s",           "code":"1022smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBLS s",           "code":"1023smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBHS s",           "code":"1024smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBCC s",           "code":"1024smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBLO s",           "code":"1025smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBCS s",           "code":"1025smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBNE s",           "code":"1026smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBEQ s",           "code":"1027smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBVC s",           "code":"1028smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBVS s",           "code":"1029smsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBPL s",           "code":"102Asmsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBMI s",           "code":"102Bsmsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBGE s",           "code":"102Csmsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBLT s",           "code":"102Dsmsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBGT s",           "code":"102Esmsl",         "use":"s=code_pcr",            },
    {"mnemonic":"LBLE s",           "code":"102Fsmsl",         "use":"s=code_pcr",            },
    {"mnemonic":"SWI2",             "code":"103F",             "use":"",             },
    {"mnemonic":"CMPD #w",          "code":"1083wmwl",         "use":"w=const",             },
    {"mnemonic":"CMPY #w",          "code":"108Cwmwl",         "use":"w=const",             },
    ...
    {"mnemonic":"CMPD t",           "code":"10B3tmtl",         "use":"t=data_r",            },
    {"mnemonic":"CMPY t",           "code":"10BCtmtl",         "use":"t=data_r",            },
    {"mnemonic":"LDY t",            "code":"10BEtmtl",         "use":"t=data_r",            },
    {"mnemonic":"STY t",            "code":"10BFtmtl",         "use":"t=data_w",            },
    {"mnemonic":"LDS #w",           "code":"10CEwmwl",         "use":"w=const",             },
    ...
    {"mnemonic":"LDS t",            "code":"10FEtmtl",         "use":"t=data_r",            },
    {"mnemonic":"STS t",            "code":"10FFtmtl",         "use":"t=data_w",            },
    {"mnemonic":"SWI3",             "code":"113F",             "use":"",             },
    {"mnemonic":"CMPU #w",          "code":"1183wmwl",         "use":"w=const",             },
    {"mnemonic":"CMPS #w",          "code":"118Cwmwl",         "use":"w=const",             },    
    ...
    {"mnemonic":"CMPU t",           "code":"11B3tmtl",         "use":"t=data_r",            },
    {"mnemonic":"CMPS t",           "code":"11BCtmtl",         "use":"t=data_r",            },
    {"mnemonic":"NOP",              "code":"12",               "use":"",             },
    {"mnemonic":"SYNC",             "code":"13",               "use":"",             },
    {"mnemonic":"LBRA s",           "code":"16smsl",           "use":"s=code_pcr",            },
    {"mnemonic":"LBSR s",           "code":"17smsl",           "use":"s=code_pc",            },
    ...
    {"mnemonic":"CMPX #w",          "code":"8Cwmwl",           "use":"w=const",             },
    {"mnemonic":"BSR r",            "code":"8Drr",             "use":"r=code_pcr",            },
    {"mnemonic":"LDX #w",           "code":"8Ewmwl",           "use":"w=const",             },    
    ...
    {"mnemonic":"CMPX t",           "code":"BCtmtl",           "use":"t=data_r",            },
    {"mnemonic":"JSR t",            "code":"BDtmtl",           "use":"t=code",            },
    {"mnemonic":"LDX t",            "code":"BEtmtl",           "use":"t=data_r",            },
    {"mnemonic":"STX t",            "code":"BFtmtl",           "use":"t=data_w",            },    
    ...
    {"mnemonic":"LDU #w",           "code":"CEwmwl",           "use":"w=const",             },    
    ...
    {"mnemonic":"LDU t",            "code":"FEtmtl",           "use":"t=data_r",            },
    {"mnemonic":"STU t",            "code":"FFtmtl",           "use":"t=data_w",            },
]
...
POSTS = [
    ...
    {"post":"k,X",              "code":"89kmkl",           "use":"k=const",      },
    {"post":"D,X",              "code":"8B",               "use":"",             },
    {"post":"i,PC",             "code":"8Cii",             "use":"i=code_pcr",   },
    {"post":"k,PC",             "code":"8Dkmkl",           "use":"k=code_pcr",   },
    {"post":"[,X++]",           "code":"91",               "use":"",             },
    {"post":"[,--X]",           "code":"93",               "use":"",             },
    {"post":"[,X]",             "code":"94",               "use":"",             },
    ...
    {"post":"[k,X]",            "code":"99kmkl",           "use":"k=const",      },
    {"post":"[D,X]",            "code":"9B",               "use":"",             },
    {"post":"[i,PC]",           "code":"9Cii",             "use":"i=code_pcr",   },
    {"post":"[k,PC]",           "code":"9Dkmkl",           "use":"k=code_pcr",   },
    {"post":"[t]",              "code":"9Ftmtl",           "use":"t=data",       },
    {"post":",Y+",              "code":"A0",               "use":"",             },
    {"post":",Y++",             "code":"A1",               "use":"",             },
    {"post":",-Y",              "code":"A2",               "use":"",             },
    {"post":",--Y",             "code":"A3",               "use":"",             },
    ...
    {"post":"k,Y",              "code":"A9kmkl",           "use":"k=const",      },
    {"post":"D,Y",              "code":"AB",               "use":"",             },
    {"post":"i,PC",             "code":"ACii",             "use":"i=code_pcr",   },
    {"post":"k,PC",             "code":"ADkmkl",           "use":"k=code_pcr",   },
    {"post":"[,Y++]",           "code":"B1",               "use":"",             },
    {"post":"[,--Y]",           "code":"B3",               "use":"",             },
    {"post":"[,Y]",             "code":"B4",               "use":"",             },
    ...
    {"post":"[k,Y]",            "code":"B9kmkl",           "use":"k=const",      },
    {"post":"[D,Y]",            "code":"BB",               "use":"",             },
    {"post":"[i,PC]",           "code":"BCii",             "use":"i=code_pcr",   },
    {"post":"[k,PC]",           "code":"BDkmkl",           "use":"k=code_pcr",   },
    {"post":"[t]",              "code":"BFtmtl",           "use":"t=data",       },
    {"post":",U+",              "code":"C0",               "use":"",             },
    {"post":",U++",             "code":"C1",               "use":"",             },
    {"post":",-U",              "code":"C2",               "use":"",             },
    {"post":",--U",             "code":"C3",               "use":"",             },
    ...
    {"post":"k,U",              "code":"C9kmkl",           "use":"k=const",      },
    {"post":"D,U",              "code":"CB",               "use":"",             },
    {"post":"i,PC",             "code":"CCii",             "use":"i=code_pcr",   },
    {"post":"k,PC",             "code":"CDkmkl",           "use":"k=code_pcr",   },
    {"post":"[,U++]",           "code":"D1",               "use":"",             },
    {"post":"[,--U]",           "code":"D3",               "use":"",             },
    {"post":"[,U]",             "code":"D4",               "use":"",             },
    ...
    {"post":"[k,U]",            "code":"D9kmkl",           "use":"k=const",      },
    {"post":"[D,U]",            "code":"DB",               "use":"",             },
    {"post":"[i,PC]",           "code":"DCii",             "use":"i=code_pcr",   },
    {"post":"[k,PC]",           "code":"DDkmkl",           "use":"k=code_pcr",   },
    {"post":"[t]",              "code":"DFtmtl",           "use":"t=data",       },
    {"post":",S+",              "code":"E0",               "use":"",             },
    {"post":",S++",             "code":"E1",               "use":"",             },
    {"post":",-S",              "code":"E2",               "use":"",             },
    {"post":",--S",             "code":"E3",               "use":"",             },
    ...
    {"post":"[k,S]",            "code":"F9kmkl",           "use":"k=const",      },
    {"post":"[D,S]",            "code":"FB",               "use":"",             },
    {"post":"[i,PC]",           "code":"FCii",             "use":"i=code_pcr",   },
    {"post":"[k,PC]",           "code":"FDkmkl",           "use":"k=code_pcr",   },
    {"post":"[t]",              "code":"FFtmtl",           "use":"t=data",       },
]
