...
OPCODES = [
    ...
    {"mnemonic": "ADC A,(IX+i)", "code": "DD8Eii", "use": ""},
    {"mnemonic": "ADC A,(IY+i)", "code": "FD8Eii", "use": ""},
    ...
    {"mnemonic": "AND (IX+i)", "code": "DDA6ii", "use": ""},
    {"mnemonic": "AND (IY+i)", "code": "FDA6ii", "use": ""},
    {"mnemonic": "AND b", "code": "E6bb", "use": ""},
    ...
    {"mnemonic": "OR (IX+i)", "code": "DDB6ii", "use": ""},
    {"mnemonic": "OR (IY+i)", "code": "FDB6ii", "use": ""},
    {"mnemonic": "OR b", "code": "F6bb", "use": ""},
    ...
    {"mnemonic": "XOR (IX+i)", "code": "DDAEii", "use": ""},
    {"mnemonic": "XOR (IY+i)", "code": "FDAEii", "use": ""},
    {"mnemonic": "XOR b", "code": "EEbb", "use": ""},
    ...
    {"mnemonic": "BIT 0,(IX+i)", "code": "DDCBii46", "use": ""},
    {"mnemonic": "BIT 0,(IY+i)", "code": "FDCBii46", "use": ""},
    {"mnemonic": "BIT 1,(IX+i)", "code": "DDCBii4E", "use": ""},
    {"mnemonic": "BIT 1,(IY+i)", "code": "FDCBii4E", "use": ""},
    {"mnemonic": "BIT 2,(IX+i)", "code": "DDCBii56", "use": ""},
    {"mnemonic": "BIT 2,(IY+i)", "code": "FDCBii56", "use": ""},
    {"mnemonic": "BIT 3,(IX+i)", "code": "DDCBii5E", "use": ""},
    {"mnemonic": "BIT 3,(IY+i)", "code": "FDCBii5E", "use": ""},
    {"mnemonic": "BIT 4,(IX+i)", "code": "DDCBii66", "use": ""},
    {"mnemonic": "BIT 4,(IY+i)", "code": "FDCBii66", "use": ""},
    {"mnemonic": "BIT 5,(IX+i)", "code": "DDCBii6E", "use": ""},
    {"mnemonic": "BIT 5,(IY+i)", "code": "FDCBii6E", "use": ""},
    {"mnemonic": "BIT 6,(IX+i)", "code": "DDCBii76", "use": ""},
    {"mnemonic": "BIT 6,(IY+i)", "code": "FDCBii76", "use": ""},
    {"mnemonic": "BIT 7,(IX+i)", "code": "DDCBii7E", "use": ""},
    {"mnemonic": "BIT 7,(IY+i)", "code": "FDCBii7E", "use": ""},
    {"mnemonic": "CALL t", "code": "CDtltm", "use": "x"},
    {"mnemonic": "CALL NZ,t", "code": "C4tltm", "use": "x"},
    {"mnemonic": "CALL Z,t", "code": "CCtltm", "use": "x"},
    {"mnemonic": "CALL NC,t", "code": "D4tltm", "use": "x"},
    {"mnemonic": "CALL C,t", "code": "DCtltm", "use": "x"},
    {"mnemonic": "CALL C,t", "code": "FDDCtltm", "use": "x"},
    {"mnemonic": "CALL PO,t", "code": "E4tltm", "use": "x"},
    {"mnemonic": "CALL PE,t", "code": "ECtltm", "use": "x"},
    {"mnemonic": "CALL P,t", "code": "F4tltm", "use": "x"},
    {"mnemonic": "CALL M,t", "code": "FCtltm", "use": "x"},
    ...
    {"mnemonic": "CP (IX+i)", "code": "DDBEii", "use": ""},
    {"mnemonic": "CP (IY+i)", "code": "FDBEii", "use": ""},
    {"mnemonic": "CP b", "code": "FEbb", "use": ""},
    ...
    {"mnemonic": "DEC (IX+i)", "code": "DD35ii", "use": ""},
    {"mnemonic": "DEC (IY+i)", "code": "FD35ii", "use": ""},
    ...
    {"mnemonic": "IN A,(o)", "code": "DBoo", "use": "pr"},
    ...
    {"mnemonic": "INC (IX+i)", "code": "DD34ii", "use": ""},
    {"mnemonic": "INC (IY+i)", "code": "FD34ii", "use": ""},
    ...
    {"mnemonic": "JP t", "code": "C3tltm", "use": "x"},
    {"mnemonic": "JP NZ,t", "code": "C2tltm", "use": "x"},
    {"mnemonic": "JP Z,t", "code": "CAtltm", "use": "x"},
    {"mnemonic": "JP NC,t", "code": "D2tltm", "use": "x"},
    {"mnemonic": "JP C,t", "code": "DAtltm", "use": "x"},
    {"mnemonic": "JP PO,t", "code": "E2tltm", "use": "x"},
    {"mnemonic": "JP PE,t", "code": "EAtltm", "use": "x"},
    {"mnemonic": "JP P,t", "code": "F2tltm", "use": "x"},
    {"mnemonic": "JP M,t", "code": "FAtltm", "use": "x"},
    {"mnemonic": "JR r", "code": "18rr", "use": "x"},
    {"mnemonic": "JR NZ,r", "code": "20rr", "use": "x"},
    {"mnemonic": "JR Z,r", "code": "28rr", "use": "x"},
    {"mnemonic": "JR NC,r", "code": "30rr", "use": "x"},
    {"mnemonic": "JR C,r", "code": "38rr", "use": "x"},
    ...
    {"mnemonic": "LD A,(IX+i)", "code": "DD7Eii", "use": ""},
    {"mnemonic": "LD A,(IY+i)", "code": "FD7Eii", "use": ""},
    ...
    {"mnemonic": "LD B,(IX+i)", "code": "DD46ii", "use": ""},
    {"mnemonic": "LD B,(IY+i)", "code": "FD46ii", "use": ""},
    ...
    {"mnemonic": "LD C,(IX+i)", "code": "DD4Eii", "use": ""},
    {"mnemonic": "LD C,(IY+i)", "code": "FD4Eii", "use": ""},
    ...
    {"mnemonic": "LD D,(IX+i)", "code": "DD56ii", "use": ""},
    {"mnemonic": "LD D,(IY+i)", "code": "FD56ii", "use": ""},
    ...
    {"mnemonic": "LD E,(IX+i)", "code": "DD5Eii", "use": ""},
    {"mnemonic": "LD E,(IY+i)", "code": "FD5Eii", "use": ""},
    ...
    {"mnemonic": "LD H,(IX+i)", "code": "DD66ii", "use": ""},
    {"mnemonic": "LD H,(IY+i)", "code": "FD66ii", "use": ""},
    ...
    {"mnemonic": "LD L,(IX+i)", "code": "DD6Eii", "use": ""},
    {"mnemonic": "LD L,(IY+i)", "code": "FD6Eii", "use": ""},
    ...
    {"mnemonic": "LD (IX+i),A", "code": "DD77ii", "use": ""},
    {"mnemonic": "LD (IX+i),B", "code": "DD70ii", "use": ""},
    {"mnemonic": "LD (IX+i),C", "code": "DD71ii", "use": ""},
    {"mnemonic": "LD (IX+i),D", "code": "DD72ii", "use": ""},
    {"mnemonic": "LD (IX+i),E", "code": "DD73ii", "use": ""},
    {"mnemonic": "LD (IX+i),H", "code": "DD74ii", "use": ""},
    {"mnemonic": "LD (IX+i),L", "code": "DD75ii", "use": ""},
    {"mnemonic": "LD (IY+i),A", "code": "FD77ii", "use": ""},
    {"mnemonic": "LD (IY+i),B", "code": "FD70ii", "use": ""},
    {"mnemonic": "LD (IY+i),C", "code": "FD71ii", "use": ""},
    {"mnemonic": "LD (IY+i),D", "code": "FD72ii", "use": ""},
    {"mnemonic": "LD (IY+i),E", "code": "FD73ii", "use": ""},
    {"mnemonic": "LD (IY+i),H", "code": "FD74ii", "use": ""},
    {"mnemonic": "LD (IY+i),L", "code": "FD75ii", "use": ""},
    ...
    {"mnemonic": "LD A,(t)", "code": "3Atltm", "use": "r"},
    {"mnemonic": "LD HL,(t)", "code": "2Atltm", "use": "r"},
    {"mnemonic": "LD BC,(t)", "code": "ED4Btltm", "use": "r"},
    {"mnemonic": "LD DE,(t)", "code": "ED5Btltm", "use": "r"},
    {"mnemonic": "LD HL,(t)", "code": "ED6Btltm", "use": "r"},
    {"mnemonic": "LD SP,(t)", "code": "ED7Btltm", "use": "r"},
    {"mnemonic": "LD IX,(t)", "code": "DD2Atltm", "use": "r"},
    {"mnemonic": "LD IY,(t)", "code": "FD2Atltm", "use": "r"},
    {"mnemonic": "LD (t),A", "code": "32tltm", "use": "w"},
    {"mnemonic": "LD (t),HL", "code": "22tltm", "use": "w"},
    {"mnemonic": "LD (t),BC", "code": "ED43tltm", "use": "w"},
    {"mnemonic": "LD (t),DE", "code": "ED53tltm", "use": "w"},
    {"mnemonic": "LD (t),IX", "code": "DD22tltm", "use": "w"},
    {"mnemonic": "LD (t),IY", "code": "FD22tltm", "use": "w"},
    {"mnemonic": "LD (t),SP", "code": "ED73tltm", "use": "w"},
    {"mnemonic": "LD (IX+i),b", "code": "DD36iibb", "use": ""},
    {"mnemonic": "LD (IY+i),b", "code": "FD36iibb", "use": ""},
    {"mnemonic": "LD BC,w", "code": "01wlwm", "use": ""},
    {"mnemonic": "LD DE,w", "code": "11wlwm", "use": ""},
    {"mnemonic": "LD HL,w", "code": "21wlwm", "use": ""},
    {"mnemonic": "LD SP,w", "code": "31wlwm", "use": ""},
    {"mnemonic": "LD IX,w", "code": "DD21wlwm", "use": ""},
    {"mnemonic": "LD IY,w", "code": "FD21wlwm", "use": ""},
    {"mnemonic": "LD A,b", "code": "3Ebb", "use": ""},
    {"mnemonic": "LD B,b", "code": "06bb", "use": ""},
    {"mnemonic": "LD C,b", "code": "0Ebb", "use": ""},
    {"mnemonic": "LD D,b", "code": "16bb", "use": ""},
    {"mnemonic": "LD E,b", "code": "1Ebb", "use": ""},
    {"mnemonic": "LD H,b", "code": "26bb", "use": ""},
    {"mnemonic": "LD L,b", "code": "2Ebb", "use": ""},
    {"mnemonic": "LD (HL),b", "code": "36bb", "use": ""},
    ...
    {"mnemonic": "OUT (o),A", "code": "D3oo", "use": "pw"},
    ...
    {"mnemonic": "RES 0,(IX+i)", "code": "DDCBii86", "use": ""},
    {"mnemonic": "RES 0,(IY+i)", "code": "FDCBii86", "use": ""},
    {"mnemonic": "RES 1,(IX+i)", "code": "DDCBii8E", "use": ""},
    {"mnemonic": "RES 1,(IY+i)", "code": "FDCBii8E", "use": ""},
    {"mnemonic": "RES 2,(IX+i)", "code": "DDCBii96", "use": ""},
    {"mnemonic": "RES 2,(IY+i)", "code": "FDCBii96", "use": ""},
    {"mnemonic": "RES 3,(IX+i)", "code": "DDCBii9E", "use": ""},
    {"mnemonic": "RES 3,(IY+i)", "code": "FDCBii9E", "use": ""},
    {"mnemonic": "RES 4,(IX+i)", "code": "DDCBiiA6", "use": ""},
    {"mnemonic": "RES 4,(IY+i)", "code": "FDCBiiA6", "use": ""},
    {"mnemonic": "RES 5,(IX+i)", "code": "DDCBiiAE", "use": ""},
    {"mnemonic": "RES 5,(IY+i)", "code": "FDCBiiAE", "use": ""},
    {"mnemonic": "RES 6,(IX+i)", "code": "DDCBiiB6", "use": ""},
    {"mnemonic": "RES 6,(IY+i)", "code": "FDCBiiB6", "use": ""},
    {"mnemonic": "RES 7,(IX+i)", "code": "DDCBiiBE", "use": ""},
    {"mnemonic": "RES 7,(IY+i)", "code": "FDCBiiBE", "use": ""},
    ...
    {"mnemonic": "SET 0,(IX+i)", "code": "DDCBiiC6", "use": ""},
    {"mnemonic": "SET 0,(IY+i)", "code": "FDCBiiC6", "use": ""},
    {"mnemonic": "SET 1,(IX+i)", "code": "DDCBiiCE", "use": ""},
    {"mnemonic": "SET 1,(IY+i)", "code": "FDCBiiCE", "use": ""},
    {"mnemonic": "SET 2,(IX+i)", "code": "DDCBiiD6", "use": ""},
    {"mnemonic": "SET 2,(IY+i)", "code": "FDCBiiD6", "use": ""},
    {"mnemonic": "SET 3,(IX+i)", "code": "DDCBiiDE", "use": ""},
    {"mnemonic": "SET 3,(IY+i)", "code": "FDCBiiDE", "use": ""},
    {"mnemonic": "SET 4,(IX+i)", "code": "DDCBiiE6", "use": ""},
    {"mnemonic": "SET 4,(IY+i)", "code": "FDCBiiE6", "use": ""},
    {"mnemonic": "SET 5,(IX+i)", "code": "DDCBiiEE", "use": ""},
    {"mnemonic": "SET 5,(IY+i)", "code": "FDCBiiEE", "use": ""},
    {"mnemonic": "SET 6,(IX+i)", "code": "DDCBiiF6", "use": ""},
    {"mnemonic": "SET 6,(IY+i)", "code": "FDCBiiF6", "use": ""},
    {"mnemonic": "SET 7,(IX+i)", "code": "DDCBiiFE", "use": ""},
    {"mnemonic": "SET 7,(IY+i)", "code": "FDCBiiFE", "use": ""},
    ...
    {"mnemonic": "RL (IX+i)", "code": "DDCBii16", "use": ""},
    {"mnemonic": "RL (IY+i)", "code": "FDCBii16", "use": ""},
    ...
    {"mnemonic": "RLC (IX+i)", "code": "DDCBii06", "use": ""},
    {"mnemonic": "RLC (IY+i)", "code": "FDCBii06", "use": ""},
    ...
    {"mnemonic": "RR (IX+i)", "code": "DDCBii1E", "use": ""},
    {"mnemonic": "RR (IY+i)", "code": "FDCBii1E", "use": ""},
    ...
    {"mnemonic": "RRC (IX+i)", "code": "DDCBii0E", "use": ""},
    {"mnemonic": "RRC (IY+i)", "code": "FDCBii0E", "use": ""},
    ...
    {"mnemonic": "SLA (IX+i)", "code": "DDCBii26", "use": ""},
    {"mnemonic": "SLA (IY+i)", "code": "FDCBii26", "use": ""},
    ...
    {"mnemonic": "SRA (IX+i)", "code": "DDCBii2E", "use": ""},
    {"mnemonic": "SRA (IY+i)", "code": "FDCBii2E", "use": ""},
    ...
    {"mnemonic": "SRL (IX+i)", "code": "DDCBii3E", "use": ""},
    {"mnemonic": "SRL (IY+i)", "code": "FDCBii3E", "use": ""},
    ...
    {"mnemonic": "SBC A,(IX+i)", "code": "DD9Eii", "use": ""},
    {"mnemonic": "SBC A,(IY+i)", "code": "FD9Eii", "use": ""},
    ...
    {"mnemonic": "SUB (IX+i)", "code": "DD96ii", "use": ""},
    {"mnemonic": "SUB (IY+i)", "code": "FD96ii", "use": ""},
    {"mnemonic": "SUB b", "code": "D6bb", "use": ""},
    {"mnemonic": "LD A,(BC)", "code": "DD0A", "use": ""},
    {"mnemonic": "DEC DE", "code": "DD1B", "use": ""},
    {"mnemonic": "LD IXH,b", "code": "DD26bb", "use": ""},
    {"mnemonic": "INC IXL", "code": "DD2C", "use": ""},
    {"mnemonic": "DEC IXL", "code": "DD2D", "use": ""},
    {"mnemonic": "LD IXL,b", "code": "DD2Ebb", "use": ""},
