...
OPCODES = [
    {"mnemonic": "LD (t),SP",        "code": "08t0t1",           "use": "t=data_w"     },
    {"mnemonic": "STOP b",           "code": "10bb",             "use": "b=const"      },
    ...
    {"mnemonic": "LDFF00 (b),A",     "code": "E0bb",             "use": "b=const"      },
    {"mnemonic": "LDFF00 (C),A",     "code": "E2",               "use": ""             },
    {"mnemonic": "ADD SP,b",         "code": "E8bb",             "use": "b=const"      },
    {"mnemonic": "LD (t),A",         "code": "EAt0t1",           "use": "t=data_w"     },
    {"mnemonic": "LD A,(p)",         "code": "F0pp",             "use": "p=data_r"     },
    {"mnemonic": "LDHL SP,b",        "code": "F8bb",             "use": "b=const"      },
    {"mnemonic": "LD A,(t)",         "code": "FAt0t1",           "use": "t=data_r"     },
...
class CPU_Z80GB(opcodetools.cpu.base_cpu.CPU):
